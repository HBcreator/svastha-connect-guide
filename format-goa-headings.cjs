...
const urls = [
  "veda5-wellness-retreat-hospital-goa-india",
  "ayurvedic-natural-health-center-hospital-goa-india",
  "ayur-touch-ayurvedic-healthcare-hospital-goa-india",
  "yashraj-ayurveda-clinic-hospital-goa-india",
  "shree-shanti-wellness-hospital-goa-india",
  "natural-touch-ayurveda-hospital-goa-india",
  "kare-health-hospital-goa-india"
];
...
for (const url of urls) {
  ...
  if (!match) {
    // loose match
    const looseUrl = url.split('-hospital-goa-india')[0];
