...
const conditionsList = [
  { name: "Burnout & Chronic Stress",       path: "/ayurveda-packages/ayurvedic-burnout-recovery-program-in-india",           tag: "Highly Requested", desc: "Reset exhausted adrenal function and restore deep, restorative sleep cycles.",                     keywords: "stress fatigue exhaustion adrenal burnout" },
  { name: "Rheumatoid Arthritis Care",      path: "/ayurveda-packages/ayurveda-treatment-for-rheumatoid-arthritis-in-india",           tag: "Specialized",      desc: "Reduce chronic joint inflammation and restore pain-free mobility naturally.",                       keywords: "arthritis joint inflammation rheumatoid auto-immune" },
  { name: "Sciatica & Back Pain",           path: "/ayurveda-packages/ayurveda-treatment-for-sciatica-in-india",                                          tag: "Clinical Protocol", desc: "Relieve compressed sciatic nerve pain and lumbar disc pressure with targeted therapies.",           keywords: "sciatica back pain lumbar nerve spine" },
  { name: "Psoriasis & Skin Detox",         path: "/ayurveda-packages/ayurvedic-psoriasis-treatment-program-in-india",                      tag: "Specialized",      desc: "Calm chronic epidermal flare-ups through deep blood purification and cooling Takradhara.",          keywords: "psoriasis skin scaling dermatology eczema" },
  { name: "Migraine & Neuro Relief",        path: "/ayurveda-packages/ayurvedic-treatment-for-migraine-in-india",         tag: "Targeted",         desc: "Soothe hyper-excited cranial pathways using therapeutic Shirodhara and Nasya protocols.",           keywords: "migraine headache neuro vascular cranial" },
  { name: "Cervical Spondylosis Care",      path: "/ayurveda-packages/ayurveda-treatment-for-cervical-spondylosis-in-india",           tag: "Clinical Protocol", desc: "Relieve neck stiffness, nerve tingling, and disc degeneration with localized Greeva Basti.",        keywords: "cervical neck spondylosis spine disc" },
  { name: "Immunity Boosting Detox",        path: "/ayurveda-packages/immunity-boosting-detox-program-in-india",    tag: "Popular",          desc: "Strengthen adaptive immune defense with intestinal cleansing and Ojas-building internal tonics.",   keywords: "immunity detox immune boost gut infection" },
  { name: "Sustainable Weight Loss",        path: "/ayurveda-packages/ayurvedic-weight-loss-program-in-india",      tag: "Popular",          desc: "Mobilize visceral fat without crash by rebalancing digestive fire through Udwarthanam therapy.",    keywords: "weight loss obesity fat metabolism slimming" },
  { name: "Anti-Aging Rejuvenation",        path: "/ayurveda-packages/anti-aging-ayurveda-program-in-india",        tag: "Luxury Care",      desc: "Arrest oxidative cellular decline and replenish structural tissue vitality using Rasayana.",        keywords: "aging rasayana rejuvenation skin longevity" },
  { name: "Osteoarthritis & Joint Care",    path: "/ayurveda-packages/ayurveda-treatment-for-osteoarthritis-in-india",                                    tag: "Clinical Protocol", desc: "Lubricate degraded cartilage and restore joint shock-absorption with Pizhichil oil streaming.",     keywords: "osteoarthritis knee joint cartilage degenerative" },
  { name: "Stress Management Retreat",      path: "/ayurveda-packages/stress-management-ayurveda-retreat-in-india", tag: "Mental Calm",      desc: "Uncouple chronic somatic tension and rebuild emotional resilience through nature immersion.",        keywords: "stress anxiety mental calm nervous insomnia sleep" },
  { name: "Skin Rejuvenation Therapy",      path: "/ayurveda-packages/ayurvedic-skin-rejuvenation-therapy-in-india",       tag: "Beauty Focus",     desc: "Target pigmentation, wrinkles, and dull tone via systemic purification and herbal nourishing packs.", keywords: "skin glow pigmentation wrinkle beauty face" },
];

const therapiesList = [
  { name: "Authentic Panchakarma",            path: "/holistic-healing/panchakarma",                                                  desc: "Full-body bio-purification and cellular elimination protocols.",              keywords: "panchakarma detox purification five karma cleanse" },
  { name: "Traditional Ayurveda",             path: "/holistic-healing/ayurveda-ancient-wisdom-for-modern-wellness-in-india",         desc: "Root cause diagnosis driven by personalized body dosha alignment.",         keywords: "ayurveda dosha vata pitta kapha herbs traditional" },
  { name: "Yoga & Meditation Interventions",  path: "/holistic-healing/yoga-meditation",                                              desc: "Therapeutic breathing and mindfulness integration for stress.",             keywords: "yoga meditation pranayama mindfulness breathing stress" },
  { name: "Touch & Bodywork Therapies",       path: "/holistic-healing/touch-and-bodywork-therapies-in-india",                        desc: "Abhyanga, Shirodhara, and specialized external herbal massage protocols.",  keywords: "abhyanga shirodhara massage bodywork touch oil therapy" },
  { name: "Biological & Plant Therapies",     path: "/holistic-healing/biological-and-natural-plant-based-therapies-in-india",        desc: "Fresh organic internal formulations and pharmacy preparations.",           keywords: "herbs plants botanical formulation organic pharmacy natural" },
  { name: "Mind-Body & Energy Interventions", path: "/holistic-healing/mind-body-interventions-therapies-in-india",                   desc: "Deep relaxation and emotional release frameworks.",                        keywords: "mind body energy chakra relaxation emotional pranic" },
];
