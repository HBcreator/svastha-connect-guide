        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              ATHREYA AYURVEDIC CENTER KERALA
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-4xl font-bold leading-relaxed mb-4">Athreya Ayurvedic Center</h1>
            ...
            <>
              ...
              {lightboxOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-[#EDE8D0]/80 backdrop-blur-sm">
                  ...
                  <div className="bg-background/90 rounded-xl shadow-2xl p-4 w-full max-w-5xl">
                    <div className="text-center text-primary text-2xl font-bold mb-3 leading-relaxed">Athreya Ayurvedic Center</div>
              ...
              <div className="mb-12 rounded-3xl p-6 md:p-6 lg:p-12" style={{ backgroundColor: "#EDE8D0" }} id="wellness">
                ...
                <div className="text-center mb-8">
                  <div
                    className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-green-100 border-2 mb-4"
              ...
              {whyItems.length > 0 && (
                <div className="mb-12" id="why-choose">
                  <div className="text-center mb-10">
                    <h2 className="text-2xl md:text-4xl font-bold text-primary mb-3">Why Choose Athreya for Your Healing Journey?</h2>
                    {whyIntro && (
                ...
                <div className="mb-12" id="testimonial-videos" ref={testimonialSectionRef}>
                  <div className="text-center mb-8 md:mb-10 px-4">
                    <h2 className="text-xl md:text-4xl font-extrabold text-primary mb-2 leading-tight tracking-tight">
                      Testimonials of Athreya Center
                    </h2>
                      ...
                      <CardContent className="p-0">
                        <div className="aspect-video w-full relative">
                          <iframe
                            ...
                            title="Athreya Testimonial Video"
              ...
              <div className="mb-12 rounded-3xl p-8 md:p-12" style={{ backgroundColor: "#EDE8D0" }} id="founder">
                        ...
                        <div className="rounded-2xl bg-white/70 p-1 shadow-lg border-2 border-primary/20 overflow-hidden">
                          <div className="rounded-xl overflow-hidden">
                            <div className="relative w-full aspect-[800/600]">
                              <iframe
                                title="Athreya Ayurvedic Center Map"
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d8058169.402913361!2d66.754882625!3d9.538842999999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b06297baaaaaaab%3A0x2dc7203891c4f5b3!2sAthreya%20Ayurvedic%20Center!5e0!3m2!1sen!2sin!4v1768999464523!5m2!1sen!2sin"
              ...
              <div className="mb-12">
                <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#234A50" }}>
                  <div className="md:hidden">
                    <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                      <img
                        ...
                        className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                      />
                      <h2 className="text-xl font-bold text-white text-center mb-4">Begin Your Holistic Healing Journey at Athreya Ayurvedic Center</h2>
                      <div className="space-y-3">
                        <Button
                          size="lg"
                      ...
                      <div className="mt-4 flex items-center justify-center gap-2 text-white/90 text-sm">
                        ...
                        <button onClick={() => setQuoteModalOpen(true)} className="underline hover:text-white">Call us</button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
                    <div>
                      <h2 className="text-2xl md:text-4xl font-bold text-white mb-3">Begin Your Holistic Healing Journey at Athreya Ayurvedic Center</h2>
                      <div className="flex flex-wrap gap-3">
