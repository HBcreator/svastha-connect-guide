...
export default function SKKAyurvedaPanchakarma() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Detailed analysis of your Prakriti and health history by senior consultants Dr. Tarun Gupta or Dr. Rani Gupta.",
    ...
    },
    {
      ...
      description: "Administering customized Vamana, Virechana, Nasya, or Basti therapies under strict medical supervision.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "In-House Monitoring",
      description: "Careful daily observation by doctors to adjust herbal dosages, treatments, and monitor progress.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Saatvic Diet Integration",
      description: "Aligning custom, nourishing meals with your treatment to maximize tissue recovery and digestion.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Post-Treatment Blueprint",
      description: "Providing custom lifestyle guidelines, herbal prescriptions, and yoga routines to maintain long-term balance.",
...
completely regulated my cycles within three months.`,
      ...
      condition: "PCOD & Gynecological Care",
      rating: 5
    },
    {
...
prescribed by the doctors completely cleared my skin.`,
      ...
      condition: "Psoriasis & Eczema Recovery",
      rating: 5
    },
    {
...
which completely relieved my pain and tension.`,
  ...
  const faqItems = [
    {
      question: "Is SKK Ayurveda Clinic accredited and empanelled?",
      answer: "Yes. SKK Ayurveda & Panchakarma is NABH accredited, which ensures high quality and safety standards. We are also empanelled with major government healthcare schemes including CGHS, ECHS, CAPF, and NDMC for eligible beneficiaries."
    },
    {
      question: "Who are the lead doctors at the Janakpuri clinic?",
      answer: "The clinic is directed by Dr. Tarun Gupta (Senior Ayurvedic Consultant with BAMS and 20+ years experience) and Dr. Rani Gupta (Ayurvedic Gynecologist, MD in Ayurveda, and Gold Medalist), who oversee all consultations and customized treatment designs."
    },
    {
      question: "What are your consultation fees and scheduling?",
      answer: "Our clinic consultation fee is ₹800. For international patients, we offer online consultations at $25 USD. Standard clinic operating hours are from 9:00 AM to 8:00 PM daily. Please call ahead to confirm availability and schedule appointments."
    },
    {
      question: "What is your approach to Panchakarma treatments?",
      answer: "We do not offer pre-packaged, standardized treatment plans. Every Panchakarma therapy is fully customized following a detailed constitutional Prakriti analysis. We focus on traditional five-fold detoxification (Vamana, Virechana, Nasya, Basti, Raktamokshana) using organic formulations."
    },
    {
      question: "How far is the Janakpuri clinic from key transit points?",
      answer: "Our clinic is located in C-2/95, Janakpuri, New Delhi. It is approximately 11-13 km from Indira Gandhi International (IGI) Airport Terminal 3, about 5.5 km from Delhi Cantonment Railway Station (DEC), and 19 km from New Delhi Railway Station (NDLS). We are also around 1.2 km away from Janakpuri West and Janakpuri East Metro Stations."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Tailored Vamana, Virechana, Nasya, Basti, and Raktamokshana therapies determined after body constitution analysis.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Ayurvedic Gynecological Care",
      description: "Specialized treatments for female disorders, PCOD/PCOS, and natural conception under gold-medalist Dr. Rani Gupta.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Spine & Joint Rehab",
      description: "Targeted localized oil pooling (Kati/Greeva Basti) and herbal poultice massage to treat sciatica, slip disc, and arthritis.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Dermatology Detox",
      description: "Steroid-free clinical treatments to clear chronic psoriasis, eczema, acne, and stubborn allergies using pure formulations.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Digestive & Metabolic Reset",
      description: "Addressing chronic acidity, bloating, constipation, and IBS through custom gut cleansing and internal herbal regimens.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stress & Anxiety Recovery",
      description: "Calmative Shirodhara, customized head oil treatments, and guided breathing exercises to quieten the nervous system and cure insomnia.",
  ...
  const whyChooseUs = [
    ...
    {
      title: "Senior Vaidya Expertise",
      description: "Led by Dr. Tarun Gupta and gold-medalist gynecologist Dr. Rani Gupta with 20+ years experience.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Empanelled Healthcare",
      description: "Empanelled with CGHS, ECHS, CAPF, and NDMC, offering seamless support for eligible government beneficiaries.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Fully Tailored Therapies",
      description: "No standardized packages; every treatment is individually designed based on Prakriti pulse diagnostics.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Authentic Panchakarma",
      description: "Traditional five-fold biological detoxification processes utilizing high-quality in-house organic formulations.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Hygienic West Delhi Setup",
      description: "A modern, sanitized, and highly accessible clinical facility located in the residential hub of Janakpuri.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
  ...
  useEffect(() => {
    document.title = "SKK Ayurveda & Panchakarma Delhi | Customized Healing & Gynecology";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic clinical Ayurvedic Panchakarma, Nadi Pariksha diagnosis, and personalized treatments under Dr. Tarun Gupta and Dr. Rani Gupta at the NABH-accredited SKK Ayurveda & Panchakarma Clinic in Janakpuri, West Delhi.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              SKK Ayurveda Panchakarma and Janak Puri New Delhi
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>SKK Ayurveda & Panchakarma</h1>
                <p className="text-xl mb-4 opacity-90">NABH Accredited Clinical Center</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Janak Puri, New Delhi, India</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.9</span>
                  <span className="opacity-90">(810 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">SKK Ayurveda & Panchakarma</strong>, West Delhi's premier destination for authentic, NABH-accredited Ayurvedic clinical care and root-cause healing. Conveniently located near Kendriya Vidyalaya in Janakpuri, our clinic features a hygienic clinical setup combined with traditional Vedic therapeutic wisdom. Founded and led by senior consultants Dr. Tarun Gupta (BAMS, 20+ years experience) and gold-medalist Ayurvedic gynecologist Dr. Rani Gupta (M.D. in Ayurveda), we specialize in detailed constitutional (Prakriti) analysis to design highly customized recovery plans.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP cneters/delhi/SKK Ayurveda & Panchakarma/secondary.avif" 
                          alt="SKK Ayurveda & Panchakarma accommodation"
                  ...
                  <p>
                    As a NABH-accredited hospital empanelled with CGHS, ECHS, CAPF, and NDMC, we maintain the highest standards of safety, quality, and traditional authenticity. We do not offer rigid packages; instead, every treatment is tailored to the individual. Our doctors specialize in treating chronic joint pain, spine disorders, sciatica, gynecological and fertility issues, psoriasis, eczema, IBS, and chronic stress. Every treatment at SKK Ayurveda is supported by classic preparatory detox therapies (Snehan and Swedan), core Panchakarma purification, personalized herbal formulations, and dietary guidance to help you regain perfect balance.
                  </p>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/delhi/SKK Ayurveda & Panchakarma/main.jpg" 
                      alt="SKK Ayurveda & Panchakarma main view"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP cneters/delhi/SKK Ayurveda & Panchakarma/secondary.avif" 
                        alt="SKK Ayurveda & Panchakarma therapy room"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with SKK Ayurveda & Panchakarma today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> SKK Ayurveda & Panchakarma
</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> SKK Ayurveda & Panchakarma
</h2>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> SKK Ayurveda & Panchakarma
</h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP cneters/delhi/SKK Ayurveda & Panchakarma/main.jpg"
                  alt="SKK Ayurveda & Panchakarma view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at SKK Ayurveda & Panchakarma?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at SKK Ayurveda & Panchakarma?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, consultations, and transit options at SKK Ayurveda & Panchakarma.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Approx. 11-13 km from Indira Gandhi International (IGI) Airport (Terminal 3)</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Approx. 5.5 km from Delhi Cantonment Railway Station (DEC)</span>
                      </li>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.3067990496315!2d77.084598!3d28.620565699999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d04b0c99566a1%3A0xf63b6cb273850331!2sSKK%20AYURVEDA%20%26%20Panchakarma%20-%20CGHS%2C%20CAPF%20and%20ECHS%20panel!5e0!3m2!1sen!2sin!4v1780635957256!5m2!1sen!2sin"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="SKK Ayurveda & Panchakarma Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or therapy program at SKK Ayurveda & Panchakarma.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919811441562?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20SKK%20Ayurveda%20%26%20Panchakarma."
              target="_blank"
              rel="noreferrer"
