...
export default function SomaiyaAyurvihar() {
  ...
  const treatmentProcess = [
    {
      number: 1,
      title: "Clinical Ayurvedic Assessment",
      description: "A thorough diagnostic session with our qualified institutional physicians to assess your Dosha imbalances and medical history.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Inpatient/Outpatient Planning",
      description: "Determining whether an outpatient protocol or an immersive inpatient admission in our hospital cottages is required.",
      icon: <Building2 className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Purvakarma (Preparation)",
      description: "Preparing the body for deep cleansing through Snehana (oleation) and Swedana (sudation) using classical methods.",
      icon: <Leaf className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Pradhana Karma (Detox)",
      description: "Executing core Panchakarma procedures like Vamana, Virechana, or Basti under strict clinical and nursing supervision.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Paschat Karma (Recovery)",
      description: "A strict post-treatment dietary and lifestyle regimen (Samsarjana Krama) to safely restore the digestive fire and energy.",
      icon: <Heart className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Long-term Management",
      description: "Providing customized herbal medicines from our pharmacy and holistic lifestyle advice for sustained health.",
  ...
  const testimonials = [
    {
      title: "Exceptional Hospital Care",
      review: "The inpatient Panchakarma facility is excellent. Having a dedicated nursing team and doctors available round the clock made my Virechana treatment feel extremely safe and comfortable.",
    ...
    {
      title: "Great Relief from Joint Pain",
      review: "I underwent a 14-day Basti treatment for severe arthritis. The campus is very peaceful, and the classical approach they follow is highly effective. My mobility has improved significantly.",
      name: "Meenakshi Iyer",
      verified: true,
    ...
    {
      title: "Authentic and Disciplined",
      review: "They follow a very strict classical Ayurvedic protocol. The diet provided during the residential stay is simple and perfectly aligned with the treatment. Highly recommended for genuine healing.",
      name: "Prakash Patel",
      verified: true,
    ...
    },
    {
      ...
      review: "The physicians take their time to understand your complete medical history. The Raktamokshan therapy for my chronic skin condition was handled with utmost clinical precision and hygiene.",
    ...
    {
      title: "Peaceful Environment in the City",
      review: "Despite being in Worli, the campus is incredibly lush and serene. The therapy rooms are clean, and the therapists are very well trained. A great institutional setup for Ayurvedic care.",
      name: "Rohit Verma",
      verified: true,
      location: "Mahim, Mumbai",
      condition: "Stress & Rejuvenation",
      rating: 3
    }
  ];
  ...
  const faqItems = [
    {
      question: "Where is Somaiya Ayurvihar located?",
      answer: "The Somaiya Ayurvihar Panchakarma Centre is located within the prestigious K.J. Somaiya Medical College campus in Worli, Mumbai, offering a serene hospital environment."
    },
    {
      question: "Do you offer inpatient residential facilities?",
      answer: "Yes, we provide state-of-the-art inpatient facilities, including dedicated Panchakarma cottages, with round-the-clock nursing support and customized Ayurvedic diets."
    },
    {
      question: "What Panchakarma procedures are available?",
      answer: "We offer the complete suite of classical Panchakarma therapies including Vamana, Virechana, Basti, Nasya, and Raktamokshana, performed under strict medical supervision."
    },
    {
      question: "Are there separate facilities for male and female patients?",
      answer: "Yes, we maintain separate, fully-equipped therapy rooms for male and female patients, staffed by highly trained therapists of the respective genders."
    },
    {
      question: "Can I do a Panchakarma treatment as an outpatient?",
      answer: "Certain therapies and partial Panchakarma procedures can be done on an outpatient basis. However, for deep classical detoxification, our doctors generally recommend inpatient admission for optimal monitoring."
    }
  ];

  const programs = [
    {
      title: "Classical Inpatient Panchakarma",
      description: "Full-scale classical detoxification programs requiring hospital admission, strict dietary control, and daily monitoring by physicians.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Musculoskeletal Disorders",
      description: "Targeted Basti, Kati Basti, and Pinda Sweda protocols for arthritis, spondylosis, sciatica, and chronic back pain.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Blood Purification",
      description: "Specialized Virechana and Raktamokshana (bloodletting) therapies for managing psoriasis, eczema, and chronic skin conditions.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Respiratory & Allergy Care",
      description: "Authentic Vamana and Nasya therapies to effectively manage asthma, chronic sinusitis, and severe respiratory allergies.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Digestive Restoration",
      description: "Comprehensive treatments focusing on restoring Agni (digestive fire) to cure IBS, chronic acidity, and metabolic disorders.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Post-Surgical Rehab",
      description: "Ayurvedic physiotherapy and rejuvenation treatments to accelerate healing and restore mobility post-surgery.",
  ...
  const whyChooseUs = [
    {
      ...
      description: "Backed by the prestigious K.J. Somaiya medical institution, ensuring high standards of clinical governance and ethics.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "24/7 Medical Supervision",
      description: "Unlike standalone clinics, our hospital setup provides round-the-clock doctor availability and nursing care for inpatients.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Lush Green Campus",
      description: "A remarkably serene, green, and peaceful hospital campus in the heart of Worli, ideal for deep healing and recovery.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Classical Protocol Adherence",
      description: "We strictly adhere to the classical Ayurvedic texts for all Panchakarma procedures, diets, and post-treatment care.",
      icon: <FileSearch className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Dedicated Cottages",
      description: "Comfortable and well-equipped Panchakarma cottages designed specifically for residential patients undergoing deep therapies.",
      icon: <Globe className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Qualified Support Team",
      description: "A highly trained team of Panchakarma therapists, dieticians, and nursing staff supporting our expert physicians.",
  ...
  useEffect(() => {
    document.title = "Somaiya Ayurvihar Panchakarma Centre Worli | Premium Ayurvedic Hospital";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic inpatient Panchakarma at Somaiya Ayurvihar in Worli, Mumbai. A prestigious institutional Ayurvedic centre offering classical treatments.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Somaiya Ayurvihar – Panchakarma Center Mumbai
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Somaiya Ayurvihar – Panchakarma Center</h1>
                <p className="text-xl mb-4 opacity-90">Institutional Excellence in Ayurveda & Panchakarma</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Worli, Mumbai, Maharashtra, India</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">3.8</span>
                  <span className="opacity-90">(137+ Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to the <strong className="font-bold text-[#2C4E5A]">Somaiya Ayurvihar Panchakarma Centre</strong>, a highly specialized facility operated under the prestigious umbrella of the K.J. Somaiya Medical College. Located within a lush, serene campus in Worli, Mumbai, we provide a rare combination of deeply authentic classical Ayurvedic care and modern institutional standards. 
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/Somaiya Ayurvihar – Panchakarma Centre/image 2.jpg" 
                          alt="Somaiya Ayurvihar interior"
                  ...
                  <p>
                    Our center is designed for patients seeking serious, clinical Ayurvedic interventions. We offer comprehensive inpatient and outpatient Panchakarma programs in state-of-the-art facilities featuring separate male and female therapy rooms, luxurious residential cottages, and a dedicated nursing staff. With expert consultations by our highly qualified institutional physicians and a strict adherence to classical protocols including diet and lifestyle regimens, Somaiya Ayurvihar is a trusted destination for complete detoxification and the management of chronic conditions.
                  </p>
                  
                  <p>
                    The integration of traditional Ayurvedic principles with the diagnostic capabilities of a leading medical college allows us to address complex health issues effectively. Our lush, expansive campus provides an unexpectedly tranquil retreat right in the bustling heart of Mumbai, creating an ideal healing environment. From authentic Kerala-style therapies to specially formulated herbal preparations from our in-house pharmacy, every aspect of your treatment is carefully curated to restore your body's natural balance and vitality.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/Somaiya Ayurvihar – Panchakarma Centre/image 1.jpg" 
                      alt="Somaiya Ayurvihar facility"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP centers/mumbai pune nashik/Somaiya Ayurvihar – Panchakarma Centre/image 2.jpg" 
                        alt="Somaiya Ayurvihar consultation"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/7.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Somaiya Ayurvihar today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Somaiya Ayurvihar
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Somaiya Ayurvihar
              </h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Discover the security and discipline of an institutional Ayurvedic hospital paired with classical healing protocols.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Somaiya Ayurvihar
            </h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/Somaiya Ayurvihar – Panchakarma Centre/image 2.jpg"
                  alt="Somaiya Ayurvihar view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/7.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Somaiya Ayurvihar?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Somaiya Ayurvihar?</h2>
      ...
      <section id="reviews" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70" style={{ color: "#7F543D" }}>Real stories of clinical healing and recovery from our hospital patients.</p>
          </div>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about hospital admissions, treatments, and facilities at Somaiya Ayurvihar.</p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              ...
              <p className="text-lg text-foreground/70" style={{ color: "#7F543D" }}>Reach out to us to schedule your consultation or inquire about inpatient admissions.</p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Somaiya Ayurvihar Panchakarma Centre<br />
                      K.J. Somaiya Medical College Campus<br />
                      Worli, Mumbai<br />
                      Maharashtra, India
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <div>+91 99305 28007 / +91 99305 28004</div>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Located prominently inside the K.J. Somaiya Medical Campus in Worli.</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Ample parking available for patients and their families.</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=K.J.+Somaiya+Medical+College+Campus+Worli+Mumbai&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Somaiya Ayurvihar Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Discover institutional Ayurvedic excellence at Somaiya Ayurvihar.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919930528007?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Somaiya%20Ayurvihar."
              target="_blank"
              rel="noreferrer"
