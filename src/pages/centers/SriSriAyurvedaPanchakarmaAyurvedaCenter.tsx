...
export default function SriSriAyurvedaPanchakarmaAyurvedaCenter() {
  ...
  const treatmentProcess = [
    {
      number: 1,
      title: "Constitutional Nadi Pariksha",
      description: "Detailed analysis of your Prakriti, body type, and chronic issues by consulting physician Dr. Lalita Bhatt.",
  ...
  const testimonials = [
    {
      title: "Accurate Nadi Pariksha & Back Pain",
      review: "I was highly impressed by the Nadi Pariksha (pulse diagnosis) by Dr. Lalita Bhatt. She accurately identified my chronic digestive issues and back pain just by reading my pulse. The treatments and herbal medicines did wonders.",
      name: "Emilia Ström",
      verified: true,
      location: "Stockholm, Sweden",
      condition: "Nadi Pariksha & Back Pain",
      rating: 5
    },
    {
      ...
      condition: "Panchakarma Detox & Rejuvenation",
      rating: 5
    },
    {
      title: "Relief from Severe Anxiety & Stress",
      review: "I had chronic stress and sleep issues. Dr. Lalita suggested Takradhara and Shirodhara therapies. The cooling effect of the treatment completely relaxed my mind and restored my sleep cycle. Wonderful experience.",
      name: "Chloé Moreau",
      verified: true,
    ...
    {
      title: "Skin Rejuvenation & Eczema Control",
      review: "My eczema flares up every summer. With custom Lepam (herbal pack) applications and dietary modifications, my skin has cleared up. Dr. Bhatt’s holistic approach to skin care is brilliant.",
      name: "Teo Rodríguez",
      verified: true,
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "The leading doctor at the Jhilmil center is Dr. Lalita Bhatt. She holds a BAMS degree with over 19 years of clinical experience, specializing in traditional Nadi Pariksha (pulse diagnosis) and classical Ayurvedic therapies."
    },
    {
    ...
    },
    {
      ...
      answer: "We offer Nadi Pariksha (pulse diagnosis), classical Panchakarma detox (Virechana, Basti, Nasya), joint and spine care (Kati Basti, Janu Basti), stress relief (Takradhara, Shirodhara), weight management (Lekhanavasti), and treatments for skin/hair health."
    },
    {
      question: "How far is the center from key transit hubs in East Delhi?",
      answer: "Our center is located at Triveni Apartment, Jhilmil, near Vivek Vihar Police Station, New Delhi. It is approximately 1.5 km from Jhilmil Metro Station (Red Line) and Vivek Vihar Railway Station. It is about 22-25 km from Indira Gandhi International (IGI) Airport (T3)."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Accurate, non-invasive pulse diagnosis by Dr. Lalita Bhatt to identify root causes of physical and mental imbalances.",
      icon: <FileSearch className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Classical Panchakarma Detox",
      description: "Systematic detoxification therapies (Vamana, Virechana, Nasya, Vasti) tailored to purify tissues and restore Dosha balance.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Spine & Joint Care",
      description: "Specialized Ayurvedic warm-oil and herbal therapies (Kati Basti, Janu Basti) to relieve arthritis, joint pain, and stiffness.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stress & Sleep Management",
      description: "Calming therapies like Takradhara, Ksheera Dhara, and Shirodhara to soothe the nervous system and resolve insomnia.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Weight & Metabolic Reset",
      description: "Natural body contouring, customized herbal therapy (Lekhanavasti), and dietary reset for healthy weight loss.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Hair Rejuvenation",
      description: "Traditional Lepam (herbal masks) and deep nourishing treatments for psoriasis, eczema, and scalp health.",
  ...
  const whyChooseUs = [
    ...
    },
    {
      ...
      description: "Accurate pulse diagnosis to understand your unique body constitution (Prakriti) and current imbalances.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "19+ Years Doctor Expertise",
      description: "Consultations led by Dr. Lalita Bhatt, renowned for her diagnostic accuracy and personalized care.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Classical Panchakarma",
      description: "Complete detoxification and rejuvenation therapies delivered by trained and experienced therapists.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "High Patient Satisfaction",
      description: "Rated 4.8 out of 5 stars by patients for compassionate care, diagnostic accuracy, and effective remedies.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Prime Jhilmil Location",
      description: "Easily accessible, clean, and tranquil wellness environment in Jhilmil Colony, near Vivek Vihar.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Sri Sri Ayurveda Panchakarma Ayurveda Center Jhilmil New Delhi
            </li>
          </ol>
        </div>
      </nav>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Sri Sri Ayurveda Panchakarma Ayurveda Center
</h2>
            </div>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP cneters/delhi/Sri Sri Ayurveda Panchakarma Ayurveda Center/secondary.webp" 
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/delhi/Sri Sri Ayurveda Panchakarma Ayurveda Center/main.webp" 
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Sri Sri Ayurveda Panchakarma Ayurveda Center
</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Sri Sri Ayurveda Panchakarma Ayurveda Center
</h2>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Sri Sri Ayurveda Panchakarma Ayurveda Center
</h2>
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Approx. 1.5 km from Jhilmil Metro Station (Red Line) / Vivek Vihar Railway Station</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Approx. 22-25 km from Indira Gandhi International (IGI) Airport (T3)</span>
                      </li>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919560113189?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Sri%20Sri%20Tattva%20Ayurveda%20Jhilmil%20Center."
              target="_blank"
              rel="noreferrer"
