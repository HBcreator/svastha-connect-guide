...
export default function AryaVaidyaSala() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Senior Kerala physicians evaluate your health history, symptoms, and body constitution (Prakriti).",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Individualized Therapy Plan",
      description: "Determining the specific combination of Panchakarma and special Kerala therapies based on your health goals.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Preparatory Therapies (Purvakarma)",
      description: "Preparing the body with internal and external oleation (Snehana) and sweating (Swedana) to mobilize toxins.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Core Purification",
      description: "Conducting purification procedures like Virechana or Basti under constant clinical monitoring.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Post-Treatment Care",
      description: "Gradual transition back to a normal routine with personalized diet, lifestyle rules, and pathya guidelines.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Follow-Up & Maintenance",
      description: "Outlining home care protocols and prescribing authentic Kottakkal herbal supplements to maintain long-term wellness.",
  ...
  const testimonials = [
    {
      title: "Chronic Rheumatoid Arthritis",
      review: "I flew all the way from Australia after struggling with painful joint inflammation for six years. The traditional Kerala therapies here, especially the hot medicated oil massage (Pizhichil) and herbal leaf poultice (Elakizhi), worked wonders.",
      name: "Emily Watson",
      verified: true,
    ...
    {
      title: "Chronic Insomnia & Stress",
      review: "As a software engineer dealing with severe burnout and sleep issues, this hospital was a lifesaver. The warm oil pouring over the forehead (Shirodhara) and traditional body treatments were deeply relaxing. Unlike back home, they didn't just give me pills; they treated the root cause.",
      name: "Lars Sorensen",
      verified: true,
      location: "Copenhagen, Denmark",
      condition: "Chronic Insomnia & Stress",
      rating: 5
    },
    {
      title: "Psoriasis & Skin Detoxification",
      review: "I've had stubborn psoriasis for a decade and tried every cream possible. Coming to Karkardooma for a full Panchakarma cleanse was the best decision of my life. The therapeutic purgation (Virechana) and daily medicated butter baths completely healed my skin patches.",
      name: "Sophie Dubois",
      verified: true,
    ...
    {
      title: "Lumbar Spondylosis & Sciatica",
      review: "A herniated disc left me with constant shooting pain down my left leg. The oil pooling treatment on my lower back (Kati Basti) combined with daily gentle stretching sessions under their guidance did what months of physical therapy couldn't.",
      name: "Beatrix Meer",
      verified: true,
      location: "Amsterdam, Netherlands",
      condition: "Lumbar Spondylosis & Sciatica",
      rating: 5
    },
    {
      title: "Chronic Indigestion & IBS",
      review: "Severe bloating and acid reflux made my daily life miserable. The tailored internal oiling (Snehapana) and medicated enemas (Basti) completely rebooted my digestive system. I felt so well-supported by the staff.",
      name: "Max Weber",
      verified: true,
  ...
  const faqItems = [
    {
      question: "What is the therapeutic approach of Arya Vaidya Sala Kottakkal Delhi?",
      answer: "We adhere strictly to the classical Kerala Ayurvedic healing tradition. Under the guidance of qualified Kerala-trained doctors, we use authentic, raw Kottakkal formulations and standardized Panchakarma protocols to treat both chronic illness and general health issues at their source."
    },
    {
      question: "What room styles are available for overnight patient stays?",
      answer: "Our Hargobind Enclave facility has a range of clean accommodations to fit all budgets, including Deluxe rooms (fully air-conditioned with attached private therapy rooms, television, refrigerator, telephone, and bathroom), Standard rooms, and well-maintained general wards."
    },
    {
      question: "Are the medicines used here genuine Kottakkal products?",
      answer: "Yes, 100%. As an official branch of Arya Vaidya Sala Kottakkal, every single formulation, oil, and herbal powder used in our clinical therapies is manufactured directly at AVS's certified production units in Kerala and Nanjangud."
    },
    {
      question: "What chronic medical conditions does this clinic treat?",
      answer: "We specialize in resolving musculoskeletal disorders (rheumatoid and osteoarthritis, cervical spondylosis, slip disc, sciatica), stroke rehabilitation, neurological problems, skin disorders (psoriasis, eczema), and stress-related conditions."
    },
    {
      question: "How far is the Hargobind Enclave hospital from transit points?",
      answer: "Our East Delhi hospital is roughly 3.2 km from Anand Vihar Railway Terminal (10 min drive), about 12 km from New Delhi Railway Station (NDLS), and 26 km from Indira Gandhi International (IGI) Airport. We are also just an 800-meter walk from the Karkardooma Metro Station (Blue/Pink Lines)."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Comprehensive classic treatments like Vamanam, Virechanam, Nasyam, Snehavasthi, and Kashayavasthi.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Chronic Ailment Recovery",
      description: "Specialized protocols for Rheumatoid Arthritis, Osteoarthritis, Lumbar Spondylosis, Sciatica, and Stroke rehabilitation.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Authentic Kerala Massages",
      description: "Healing therapies including Pizhichil (warm medicated oil bath), Navarakkizhi (rice poultice), and Elakizhi (herbal leaf poultice).",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Hair Care",
      description: "Natural therapies for Psoriasis, Eczema, Dermatitis, and hair loss using pure herbal extracts.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stress & Burnout Relief",
      description: "Deeply calming Sirodhara (head oil pouring), Sirovasthi, and herbal inhalation therapies.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Rejuvenation & Longevity",
      description: "Classical Rasayana therapies to boost immunity, restore tissue vitality, and promote healthy aging.",
  ...
  const whyChooseUs = [
    {
      title: "120+ Years of Legacy",
      description: "Backed by Vaidyaratnam P.S. Varier's pioneering charitable trust founded in 1902.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Authentic Kottakkal Medicines",
      description: "Exclusively using genuine, high-quality formulations from AVS manufacturing units.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Kerala-Trained Doctors",
      description: "Dedicated senior BAMS/MD physicians and highly experienced male/female therapists.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "49-Bed Inpatient Facility",
      description: "Fully equipped hospital setup in Hargobind Enclave with modern clinical standards and 24/7 care.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Versatile Accommodations",
      description: "Ranging from Deluxe suites with attached therapy rooms to standard cabins and general wards.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Holistic Wellness Approach",
      description: "Blending customized treatments with dietary advice and personalized lifestyle counseling.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  ...
                  <p>
                    Our inpatient facility at Hargobind Enclave offers a range of rooms including Deluxe suites (with AC, attached treatment room, TV, telephone, and refrigerator), Standard rooms, and clean general wards to suit all budgets. Every treatment is conducted using original classical Ayurvedic medicines manufactured at Kottakkal's official production units. We specialize in managing chronic musculoskeletal disorders, arthritis, paralysis, skin diseases, spondylosis, stroke rehabilitation, stress-related conditions, and digestive complaints.
                  </p>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Arya Vaidya Sala Kottakkal Delhi today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Programs at Arya Vaidya Sala Kottakkal Delhi</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Arya Vaidya Sala Kottakkal Delhi</h2>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  ...
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Arya Vaidya Sala Kottakkal Delhi?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Arya Vaidya Sala Kottakkal Delhi?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and therapies at Arya Vaidya Sala Kottakkal Delhi.</p>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Approx. 26 km from Indira Gandhi International (IGI) Airport</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Approx. 3.2 km from Anand Vihar Railway Terminal (ANVT)</span>
                      </li>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  ...
                  title="Kottakkal Arya Vaidya Sala Hospital Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or retreat program at Arya Vaidya Sala Kottakkal Delhi.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/911122106500?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Arya%20Vaidya%20Sala%20Kottakkal%20Delhi."
              target="_blank"
              rel="noreferrer"
