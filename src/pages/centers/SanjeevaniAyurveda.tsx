...
export default function SanjeevaniAyurveda() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Detailed analysis of your Prakriti, body type, and chronic issues by Chief Consultant Dr. C. P. Verma.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Therapy Design & Dosha Analysis",
      description: "Selecting specialized medicated oils and traditional Kerala therapies to address the root cause of imbalances.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Purvakarma Preparation",
      description: "Preparing the body with Snehanam oil massages and Swedanam herbal steam to mobilize deep-seated toxins.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Main Panchakarma Detox",
      description: "Administering customized Basti, Nasyam, or Virechana cleanses under strict clinical observation.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "In-Clinic Monitoring & Diet",
      description: "Daily health checkups by doctors coupled with personalized Saatvic diet charts to support metabolic recovery.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Post-Care Restoration Blueprint",
      description: "Providing custom herbal prescriptions, exercises, and dietary guidelines to sustain long-term wellness.",
  ...
  const testimonials = [
    {
      title: "Cervical Spondylosis & Spine Care",
      review: "I suffered from severe neck pain and numbness in my hands due to cervical spondylosis. The localized oil treatments (Greeva Basti) and herbal massages at Sanjeevani Dwarka brought incredible relief. The pain is completely gone.",
      name: "Charlotte Vance",
      verified: true,
      location: "London, UK",
      condition: "Cervical Spondylosis & Spine Care",
      rating: 5
    },
    {
      title: "Kerala Panchakarma & Detox",
      review: "The authentic Kerala style Panchakarma detox here is outstanding. Dr. Verma diagnosed my body constitution accurately. The therapies and personalized Saatvic diet completely rejuvenated my digestive system.",
      name: "Hans-Dieter Weber",
      verified: true,
    ...
    {
      title: "Severe Sciatica & Joint Pain",
      review: "Severe sciatica made it painful to walk or stand. The intensive spine care therapies and classical warm-oil treatments at Sanjeevani restored my mobility in just two weeks. Highly professional team.",
      name: "Aveline Tremblay",
      verified: true,
      location: "Montreal, Canada",
      condition: "Severe Sciatica & Joint Pain",
      rating: 5
    },
    {
      title: "Anxiety, Stress & Shirodhara",
      review: "I was dealing with chronic work stress and insomnia. A series of Sirodhara sessions coupled with breathing techniques suggested by Dr. Verma helped calm my nervous system. I now sleep like a baby.",
      name: "Lukas Nilsson",
      verified: true,
      location: "Stockholm, Sweden",
      condition: "Anxiety, Stress & Shirodhara",
      rating: 5
    },
    {
      title: "Chronic Eczema & Skin Care",
      review: "My stubborn eczema patches would flare up with changes in weather. The blood-purifying herbal remedies and custom Virechana detox at Sanjeevani cleared my skin and boosted my immunity.",
      name: "Marta Kovacs",
      verified: true,
      location: "Budapest, Hungary",
      condition: "Chronic Eczema & Skin Care",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "Is Sanjeevani Ayurveda accredited and empanelled?",
      answer: "Yes. Sanjeevani Ayurveda in Dwarka is NABH accredited, ensuring the highest standards of safety, quality, and hygiene. We are also empanelled with CGHS for central government healthcare benefits."
    },
    {
      question: "Who is the lead doctor at the Dwarka clinic?",
      answer: "The clinic is directed by Dr. C. P. Verma (BAMS, MD in Panchakarma, CRAV under Ministry of AYUSH), who is a certified NABH Assessor with over 20 years of clinical experience in Kerala Ayurvedic medicine."
    },
    {
      question: "What are your clinic operating hours and off days?",
      answer: "Sanjeevani Ayurveda is open daily from 8:00 AM to 8:00 PM. Our consulting hours are 10:00 AM to 1:00 PM and 4:00 PM to 7:00 PM. Please note that the clinic is closed on Wednesday."
    },
    {
      question: "What treatments do you specialize in?",
      answer: "We specialize in pain management (disc prolapse, spondylosis, slip disc, sciatica, arthritis), classical Kerala Panchakarma detox, neuro-rehabilitation, stress management, skin/hair care, and lifestyle disorders."
    },
    {
      question: "How far is the clinic from key transit hubs?",
      answer: "We are located at Plot no-54, Upper Ground Floor, Sector 13 B, Dwarka, New Delhi. It is approximately 400-500 meters from Dwarka Sector 13 Metro Station (Blue Line), 10-12 km from IGI Airport (T3), and 12-14 km from Delhi Cantt Railway Station (DEC)."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Targeted treatments (Podi Kizhi, Kati Basti, Elakizhi, Swedanam) to resolve spondylosis, disc prolapse, sciatica, and arthritis.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Classical Kerala Panchakarma",
      description: "Systematic purification therapies (Vamana, Virechana, Snehanam, Nasyam, Basti) tailored to restore systemic Dosha equilibrium.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Neuro-Rehabilitation",
      description: "Specialized therapies (Sirodhara, Thalam, herbal oil treatments) for paralysis, hemiplegia, and neurological recovery.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "De-Stress & Mental Wellness",
      description: "Calmative Sirodhara, customized head oil therapies, and guided pranayama to treat chronic anxiety, stress, and insomnia.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Lifestyle & Metabolic Reset",
      description: "Integrative treatment plans for diabetes management, thyroid regulation, and Ayurvedic weight loss.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Hair Rejuvenation",
      description: "Steroid-free herbal protocols to manage psoriasis, chronic eczema, urticaria, and scalp treatments for hair fall.",
  ...
  const whyChooseUs = [
    {
      ...
      description: "Adhering to strict national quality, safety, therapist hygiene, and medical standards.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "CGHS Empanelled",
      description: "Providing treatment benefits and cashless/reimbursable support for central government cardholders.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Rashtriya Ayurveda Training",
      description: "Guided by Dr. C. P. Verma, trained in the traditional Guru Shishya Parampara of Rashtriya Ayurveda Vidyapeeth.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Authentic Kerala Therapies",
      description: "Rhythmic oil massages, specialized steam chambers, and fresh herbal formulations sourced under expert care.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Over 20 Years Experience",
      description: "High clinical success rates in resolving joint disorders, chronic pain, and spine issues non-surgically.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Modern Dwarka Location",
      description: "Easily accessible, sanitized, and patient-friendly setup in close proximity to the metro station.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
  ...
  useEffect(() => {
    document.title = "Sanjeevani Ayurveda Dwarka | Authentic Kerala Panchakarma & Joint Care";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Kerala Ayurvedic therapies, systematic Panchakarma detox, and spine & joint rehabilitation under Chief Consultant Dr. C. P. Verma at the NABH-accredited and CGHS-empanelled Sanjeevani Ayurveda clinic in Dwarka, New Delhi.");
  ...
  return (
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Sanjeevani Ayurveda</h1>
                <p className="text-xl mb-4 opacity-90">NABH Accredited Clinical Center | Authentic Kerala Panchakarma (Since 2013)</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="opacity-90">(1070 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Sanjeevani Ayurveda</strong>, Dwarka's premier destination for authentic, NABH-accredited Ayurvedic clinical care and root-cause healing. Founded in 2013 by Dr. C. P. Verma, Sanjeevani Ayurveda was established to offer systematic and affordable Kerala-style Ayurvedic therapies. Conveniently located near Reliance Mall in Dwarka Sector 13 B, our clinic combines classical Panchakarma wisdom with modern diagnostics to restore biological balance. Under the leadership of Dr. C. P. Verma (BAMS, MD in Panchakarma, and certified NABH Assessor), our center is recognized for its therapeutic excellence in joint rehabilitation and chronic disorders.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP cneters/delhi/Sanjeevani Ayurveda/secondary.webp" 
                          alt="Sanjeevani Ayurveda accommodation"
                  ...
                  <p>
                    As a NABH-accredited and CGHS-empanelled clinic, we maintain the highest standards of safety, quality, and traditional authenticity. We do not offer rigid packages; instead, every treatment is tailored to the individual. Our doctors specialize in treating cervical and lumbar spondylosis, slip disc, sciatica, osteoarthritis, metabolic disorders, neurological rehabilitation, and chronic stress. Every treatment at Sanjeevani Ayurveda is supported by classic preparatory detox therapies (Snehanam and Swedanam), core Panchakarma purification, personalized herbal formulations, and dietary guidance to help you regain perfect balance.
                  </p>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/delhi/Sanjeevani Ayurveda/main.webp" 
                      alt="Sanjeevani Ayurveda main view"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP cneters/delhi/Sanjeevani Ayurveda/secondary.webp" 
                        alt="Sanjeevani Ayurveda therapy room"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Sanjeevani Ayurveda today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages in Sanjeevani Ayurveda</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Sanjeevani Ayurveda</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience NABH-accredited quality standards, expert diagnostics, and CGHS-empanelled healthcare services in a hygienic clinical environment.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Your Healing Journey in Sanjeevani Ayurveda</h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP cneters/delhi/Sanjeevani Ayurveda/main.webp"
                  alt="Sanjeevani Ayurveda view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Sanjeevani Ayurveda?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Sanjeevani Ayurveda?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, consultations, and transit options at Sanjeevani Ayurveda.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Approx. 10-12 km from Indira Gandhi International (IGI) Airport (Terminal 3)</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Approx. 12-14 km from Delhi Cantonment Railway Station (DEC)</span>
                      </li>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3503.032640258867!2d77.0349024!3d28.598797599999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d1ad0942df779%3A0x6238ed8be5dbc47b!2sSanjeevani%20Ayurveda!5e0!3m2!1sen!2sin!4v1780638164242!5m2!1sen!2sin"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Sanjeevani Ayurveda Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or therapy program at Sanjeevani Ayurveda.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919560113189?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Sanjeevani%20Ayurveda."
              target="_blank"
              rel="noreferrer"
