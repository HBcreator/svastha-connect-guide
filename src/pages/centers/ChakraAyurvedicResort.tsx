...
export default function ChakraAyurvedicResort() {
  ...
  const treatmentProcess = [
    {
      number: 1,
      title: "Detailed Physician Consultation",
      description: "An initial in-depth check-up and physical evaluation by experienced Ayurvedic doctors to diagnose body constitution (prakriti) and detect specific dosha imbalances.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Tailored Treatment Formulation",
      description: "Compiling a customized therapy schedule, detailing specific herbal oils, nutritional diets, and gentle restorative yoga routines to address your health goals.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Purva Karma Preparations",
      description: "Administering warm synchronized massage (Abhyangam) and customized steam baths (Swedana) to loosen deep metabolic wastes and soothe muscles.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Supervised Panchakarma Purification",
      description: "Carefully administering traditional biological purification procedures (such as Virechana, Vasti, or Nasyam) to detoxify the body and balance vital functions.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Paschat Karma Rejuvenation",
      description: "Integrating post-treatment wellness routines, including guided seaside yoga, beach meditation, and gentle, revitalizing natural therapies.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Integrated Daily Routine Guidance",
      description: "Prescribing personalized home dietary guidelines, breathing techniques, recommended natural herbs, and routine advice to maintain long-term vital health.",
  ...
  const testimonials = [
    {
      ...
      condition: "Panchakarma Detox & Stress Reset",
      rating: 5
    },
    {
      ...
      condition: "Spine & Joint Wellness",
      rating: 5
    },
    {
      ...
      verified: true,
      location: "London, UK",
      condition: "Anti-Stress & Sleep Care",
      rating: 5
    },
    {
      ...
      condition: "Immunization & Longevity",
      rating: 5
    },
    {
      ...
      condition: "Weight Management & Detox",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "What makes Chakra Ayurvedic Resort in Kovalam unique?",
      answer: "Chakra Ayurvedic Resort is a serene coastal wellness destination located along Palace Road, Kovalam Beach, Trivandrum, Kerala. We blend authentic classical Ayurvedic treatments and experienced physician consultations with a relaxing beach holiday experience, featuring comfortable rooms and sea-view organic dining."
    },
    {
      question: "How are the Ayurvedic treatments personalized for guests?",
      answer: "Every guest undergoes a detailed personal consultation with our panel of experienced resident Ayurvedic doctors upon arrival. The doctors evaluate your body constitution (prakriti), detect specific dosha imbalances, and design a customized therapy schedule, herbal medicines, and dietary plan."
    },
    {
      question: "What are the primary packages and treatments available?",
      answer: "We specialize in authentic Classical Panchakarma (body purification and detoxification), Body Immunization & Longevity, Anti-Stress Shirodhara, Customized Weight Management, and targeted treatments for Spine & Joint Wellness."
    },
    {
      question: "What type of accommodation and facilities are offered?",
      answer: "The resort offers comfortable beachside rooms set within a green coastal garden. Other amenities include a restaurant serving healthy Ayurvedic vegetarian cuisine, an in-house Ayurvedic pharmacy, regular yoga/meditation sessions, and doctor-on-call services."
    },
    {
      question: "Can the resort assist with health insurance claims?",
      answer: "Yes, our clinical administrative team provides comprehensive medical certificates, doctor consultation logs, pharmacy invoices, and detailed treatment records to support private health insurance reimbursement claims."
    }
  ];

  const programs = [
    {
      title: "Panchakarma Body Purification",
      description: "Supervised physiological purification and detoxification therapies to cleanse deep tissue toxins and restore absolute dosha balance.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Body Immunization & Longevity",
      description: "Specialized anti-aging and cell-restorative therapies designed to build natural immunity, improve vitality, and promote healthy longevity.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Spine & Joint Wellness",
      description: "Targeted oil retention therapies (Kati Vasti, Janu Vasti) and synchronized massages to relieve lower back pain, chronic stiffness, and cervical spondylosis.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Anti-Stress & Sleep Care",
      description: "Seaside meditation, targeted warm-oil pouring therapies (Shirodhara), and therapeutic yoga to soothe the nervous system and calm the mind.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Customized Weight Management",
      description: "Specialized dry-herb powder massages (Udwarthanam) and physician-supervised vegetarian dietary planning to support natural, healthy weight loss.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Rheumatic & Joint Recovery",
      description: "Intensive localized therapeutic programs (including Kizhi and medicinal wraps) to ease joint inflammation and promote natural musculoskeletal movement.",
  ...
  const whyChooseUs = [
    {
      title: "Kovalam Beach Location",
      description: "Set directly near Hawa Beach and Lighthouse Beach along Palace Road, offering a soothing marine breeze and beautiful sea-facing views.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Resident Doctor Supervision",
      description: "Every treatment regimen is customized, monitored, and guided by experienced resident doctors and executed by trained therapists.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Traditional Beachside Rooms",
      description: "Stay in comfortable rooms set within a quiet, green garden landscape overlooking the ocean to facilitate complete recovery.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Customized Vegetarian Dining",
      description: "Freshly prepared vegetarian meals tailored strictly to your Ayurvedic diet plan, designed to facilitate cellular balance.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "In-House Ayurvedic Pharmacy",
      description: "Equipped with an in-house pharmacy to support and supply authentic, high-potency classical formulations for all treatments.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "AYUSH Reimbursement Support",
      description: "Providing detailed diagnostic papers, clinical case sheets, and support to facilitate smooth private insurance claims.",
  ...
  useEffect(() => {
    document.title = "Chakra Ayurvedic Resort | Beachside Panchakarma & Rejuvenation in Kovalam, Trivandrum";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Book a consultation at Chakra Ayurvedic Resort on Kovalam Beach, Trivandrum. Discover authentic, doctor-guided Panchakarma, stress reset, weight loss, and yoga programs.");
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Chakra Ayurvedic Resort</h1>
                <p className="text-xl mb-4 opacity-90">Beachside Wellness Haven & Authentic Panchakarma Centre</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Kovalam, Thiruvananthapuram, Kerala, India</span>
                </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] leading-tight md:leading-[1.1] max-w-4xl mx-auto px-2">
                Authentic Coastal Healing <br className="hidden lg:block" />
                at Chakra Ayurvedic Resort
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP cneters/kerela/Chakra Ayurvedic Resort/secondary.webp" 
                          alt="Chakra Ayurvedic Resort"
                  ...
                  <p>
                    Every healing program at Chakra begins with a comprehensive, in-depth consultation with our panel of experienced resident Ayurvedic physicians to diagnose your body constitution and specific dosha imbalances. The resort features comfortable rooms, an in-house pharmacy, a vegetarian dining facility customized to support therapy plans, seaside yoga pavilions, and comprehensive documentation to facilitate private and corporate AYUSH health insurance claims.
                  </p>

                  <p>
                    The soothing sounds of the Arabian Sea waves and the gentle coastal breeze create a highly therapeutic natural environment that profoundly deepens the healing process.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/kerela/Chakra Ayurvedic Resort/main.jpg" 
                      alt="Chakra Ayurvedic Resort Exterior"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP cneters/kerela/Chakra Ayurvedic Resort/secondary.webp" 
                        alt="Therapy Chamber at Chakra Ayurvedic Resort"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Chakra Ayurvedic Resort today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at Chakra</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Chakra</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience authentic coastal healing with dedicated medical doctors, sea-view organic dining, and personalized care.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A highly standardized clinical approach integrating authentic Keralite Vaidya care, fresh oils, and strict patient-centered procedures.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  ...
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Chakra Ayurvedic Resort?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Chakra Ayurvedic Resort?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at Chakra Ayurvedic Resort.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Chakra Ayurvedic Resort<br />
                      Palace Road, Kovalam Beach<br />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1.5" style={{ color: "#7F543D" }}>
                      <li>• Approx. 12 km from Thiruvananthapuram International Airport</li>
                      <li>• Approx. 13 km from Trivandrum Central Railway Station</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3947.0748603064926!2d76.97377727501151!3d8.394298191643859!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b05afb955555555%3A0xb6ae9b29b20121ef!2sChakra%20Ayurvedic%20Resort!5e0!3m2!1sen!2sin!4v1779864436783!5m2!1sen!2sin"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Chakra Ayurvedic Resort Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment program at Chakra Ayurvedic Resort.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919995125000?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Chakra%20Ayurvedic%20Resort."
              target="_blank"
              rel="noreferrer"
