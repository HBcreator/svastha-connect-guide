...
export default function HarithaAyurvedaAcademyPanchakarmaCenter() {
  ...
  const testimonials = [
    {
      title: "Life-Changing Massage Training in Rishikesh",
      review: "I enrolled in the 14-day Ayurveda Massage and Abhyanga course at Haritha, and it completely exceeded my expectations. The instructors are so patient and explain the connection between the 3 Doshas and the physical bodywork beautifully.",
      name: "Sophia Durand",
      verified: true,
      location: "Paris, France",
      condition: "Ayurveda Massage & Abhyanga Course",
      rating: 5
    },
    {
      title: "A Deep and Authentic Healing Experience",
      review: "The 14-day Panchakarma detox at Haritha was exactly what I needed. I had been struggling with sluggish digestion and chronic fatigue for years. The team of doctors carefully assessed my Prakriti and designed a personalized schedule of therapies.",
      name: "Liam O'Connor",
      verified: true,
    ...
    {
      title: "Deep and Meticulous Teachings on Vital Energy Points",
      review: "As a physiotherapist, I wanted to learn the ancient art of Marma points, and Haritha provided the perfect academic depth. The teacher explained the 107 Marma points with extreme anatomical precision and spiritual context.",
      name: "Elena Rostova",
      verified: true,
      location: "Prague, Czech Republic",
      condition: "Marma Therapeutic Course",
      rating: 5
    },
    {
      title: "A Practical and Enriching Culinary Journey",
      review: "I took the 7-day Ayurvedic cooking course to learn how to prepare meals that balance the Doshas. The classes were so practical and engaging. We learned how to identify spices, understand their pharmacology, and prepare delicious sattvic dishes at their accompanying restaurant.",
      name: "Alistair Lead",
      verified: true,
      location: "Edinburgh, Scotland",
      condition: "Ayurvedic Cooking & Diet",
      rating: 5
    },
    {
      title: "Incredible Natural Skin Care Methods",
      review: "I completed the 5-day Ayurvedic herbal beauty course at Haritha and loved every minute of it. Learning how to create kitchen cosmetics and organic treatments for skin and hair was fascinating.",
      name: "Chloe Mercier",
      verified: true,
      location: "Geneva, Switzerland",
      condition: "Ayurveda Beauty & Facial Care",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "What are the certifications offered at Haritha Ayurveda?",
      answer: "All educational and training courses completed at Haritha Ayurveda are recognized and certified under the STED Council (Scientific and Technical Education Development Council), an Indian Government registered organization. This certification is recognized globally, providing excellent professional opportunities in the wellness and Ayurveda industries."
    },
    {
      question: "Are accommodations and dining options available in-house?",
      answer: "Yes, we offer comfortable deluxe and semi-deluxe in-house accommodations equipped with modern amenities. We also offer food options featuring a pure vegetarian (sattvic) menu at our accompanying restaurant, tailored to complement your Ayurvedic cleansing and learning journey."
    },
    {
      question: "How long do the Ayurveda courses and retreats last?",
      answer: "We offer both short-term courses (ranging from 5 to 14 days, such as for Ayurveda massage, Marma therapy, beauty care, and cooking) and long-term professional courses (such as the 28-day Panchakarma course and the 45-day or 90-day Advanced Panchakarma Diploma)."
    },
    {
      question: "Do you use high-quality authentic Ayurvedic oils and medicines?",
      answer: "Yes. To ensure absolute authenticity and maximum clinical benefits, all herbal formulations, medicated oils, and powders used during our treatments and classes are sourced from highly trusted, leading brands like Kottakkal Arya Vaidya Sala and Kerala Ayurveda."
    },
    {
      question: "What transit options are available to reach Haritha Ayurveda?",
      answer: "Our academy is located in Swarg Ashram, Rishikesh. The closest airport is Jolly Grant Airport (Dehradun) located approximately 25 km away. Yog Nagari Rishikesh Railway Station is about 5 km away, while Haridwar Railway Station is approximately 25 km away."
    }
  ];

  const programs = [
    {
      title: "Ayurveda Massage & Abhyanga",
      description: "Learn fundamental Ayurvedic principles, body type analysis (Prakriti), the 3 Doshas, the 7 Dhatus, and get practical training in traditional bodywork.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Ayurveda Panchakarma Course",
      description: "A comprehensive 28-day certificate course designed for beginners, providing deep theoretical and practical training in five-fold detoxification.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Advanced Panchakarma Diploma",
      description: "An advanced 45-day or 90-day professional curriculum offering globally recognized STED Council double-certification for career opportunities.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Marma Therapeutic Course",
      description: "Master the stimulation of the 107 vital energy points of the body, coupled with preparation of medicated oils and targeted healing therapies.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Ayurvedic Cooking & Nutrition",
      description: "A 7-day or 14-day practical culinary training to understand spices, dietary habits, and preparation of custom meals for different body types.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Ayurveda Beauty & Facial Care",
      description: "A 5-day herbal beautician course covering kitchen cosmetics, Ayurvedic facial care (Mukhlepanam), head/face massage, and hair treatments.",
  ...
  const whyChooseUs = [
    {
      title: "STED Council Certification",
      description: "Receive globally recognized, Government-registered professional certifications that open career opportunities in wellness worldwide.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Experienced Teaching Vaidyas",
      description: "Learn from dedicated Ayurvedic doctors and clinical practitioners with years of hands-on teaching and therapeutic experience.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Kerala Ayurveda Medicines",
      description: "We use only authentic, top-grade medicated oils and formulations sourced from Kottakkal Arya Vaidya Sala and Kerala Ayurveda.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Swarg Ashram Spiritual Setting",
      description: "Located at Narayan Kunj, Swarg Ashram, Jonk, in the heart of Rishikesh's peaceful and historic spiritual sanctuary.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "In-House Accommodations",
      description: "Deluxe and semi-deluxe lodging options equipped with modern amenities to make your stay comfortable and convenient.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Accompanying Sattvic Restaurant",
      description: "Enjoy clean, pure vegetarian meals designed according to Ayurvedic dietary principles to support your cleansing and learning.",
  ...
  useEffect(() => {
    document.title = "Haritha Ayurveda Academy & Panchakarma Center | Swarg Ashram, Rishikesh";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience certified Ayurveda courses (STED Council recognized), traditional Panchakarma detoxification, and Ayurvedic beauty care at Haritha Ayurveda Academy in Swarg Ashram, Rishikesh.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Haritha Ayurveda Academy & Panchakarma Center Rishikesh Uttarakhand
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Haritha Ayurveda Academy & Panchakarma Center</h1>
                <p className="text-xl mb-4 opacity-90">Certified Ayurveda Courses and Traditional Panchakarma in Rishikesh</p>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Haritha Ayurveda Academy & Panchakarma Center
</h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Haritha Ayurveda Academy & Panchakarma Center</strong>, a highly esteemed academy and wellness clinic in Rishikesh. Situated at Narayan Kunj, Swarg Ashram, Jonk, we offer a serene space dedicated to Ayurvedic education, traditional treatments, and certified courses. Registered under the STED Council (Scientific and Technical Education Development Council), our academy delivers globally recognized certifications in Ayurveda massage, Panchakarma therapies, Marma therapy, beauty care, and cooking.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/himalayas-rishikesh-uttarakhand-north-east/Haritha Ayurveda Academy & Panchakarma Center/secondary.webp" 
                          alt="Haritha Ayurveda gardens and view"
                  ...
                  <p>
                    Whether you are a beginner seeking authentic knowledge or an experienced therapist looking for advanced certifications, our curriculum is designed to support you. Alongside our educational programs, we provide complete Panchakarma clinical cleanses, herbal beauty treatments, and therapeutic packages under doctor supervision. We utilize high-quality medicated formulations sourced from Kottakkal and Kerala Ayurveda, and support your retreat with comfortable in-house accommodations and pure sattvic food.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/himalayas-rishikesh-uttarakhand-north-east/Haritha Ayurveda Academy & Panchakarma Center/main.webp" 
                      alt="Haritha Ayurveda Academy & Panchakarma Center"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP centers/himalayas-rishikesh-uttarakhand-north-east/Haritha Ayurveda Academy & Panchakarma Center/secondary.webp" 
                        alt="Therapy Room at Haritha Ayurveda"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Haritha Ayurveda Academy today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Haritha Ayurveda Academy & Panchakarma Center
</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Haritha Ayurveda Academy & Panchakarma Center
</h2>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Haritha Ayurveda Academy & Panchakarma Center
</h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/himalayas-rishikesh-uttarakhand-north-east/Haritha Ayurveda Academy & Panchakarma Center/main.webp"
                  alt="Haritha Ayurveda"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Haritha Ayurveda?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Haritha Ayurveda?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about courses and retreats at Haritha Ayurveda.</p>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-[#2C4E5A] mb-2">Academy Address</h3>
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Haritha Ayurveda Academy & Panchakarma Center<br />
                      Narayan Kunj, Swarg Ashram, Jonk<br />
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Approx. 25 km from Jolly Grant Airport</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3451.099514658862!2d78.31561017555661!3d30.11996577488566!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3909166a82630bf5%3A0x1afc2caaf3e44ef9!2sHaritha%20Ayurveda%20Academy%20%26%20Panchakarma%20Center%20-%20A%20Complete%20Wellness%20Center%20In%20Rishikesh%2C%20India!5e0!3m2!1sen!2sin!4v1780490656004!5m2!1sen!2sin"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Haritha Ayurveda Academy Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or course program at Haritha Ayurveda Academy.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919758881169?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Haritha%20Ayurveda%20Academy."
              target="_blank"
              rel="noreferrer"
