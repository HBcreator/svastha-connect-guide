...
export default function DrSIBYAyurvedaCenter() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Undergoing an initial detailed health consultation and traditional pulse diagnosis (Nadi Pariksha) with Dr. Sibi to assess your constitution (Prakriti) and current imbalances.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Custom Therapy Program",
      description: "Designing a personalized package of daily Panchakarma cleansing therapies, therapeutic traditional massages, specific herbal decoctions, and tailored diet charts.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Poorva Karma preparation",
      description: "Beginning your healing process with preparatory procedures such as classical Abhyangam oil bodywork and localized oil poolings to mobilize deep-seated toxins.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Core Panchakarma Detox",
      description: "Administering specific purification treatments such as classical Shirodhara, Vamana, Virechana, or customized herbal Basti based on your body's therapeutic requirements.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Chakra Healing & Yoga",
      description: "Incorporating spiritual wellness, energy channel stimulation, and therapeutic yoga to enhance nervous system function and mental tranquility.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Dinacharya Integration",
      description: "Receiving practical lifestyle blueprints and dietary advice from Dr. Siby to maintain your rejuvenated state and prevent future imbalances back home.",
...
Dr. Siby's understanding of the body's energy channels is truly remarkable.`,
      ...
      condition: "Chakra Open Massage & Rejuvenation",
      rating: 5
    },
    {
...
My body feels completely reset, lighter, and full of natural energy.`,
      ...
      condition: "14 Days Classic Panchakarma",
      rating: 5
    },
    {
...
I highly recommend this center to anyone visiting the Dharamshala region.`,
      ...
      verified: true,
      location: "Rome, Italy",
      condition: "2-Hour Full Body Ayurvedic Massage",
      rating: 5
    },
    {
...
The pain has reduced by eighty percent and my range of motion is restored.`,
      ...
      condition: "Kateevasthi & Spine Wellness",
      rating: 5
    },
    {
...
I feel physically renewed and mentally clearer than I have in a long time.`,
      ...
      condition: "21 Days Panchakarma Detox",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "What therapies and courses are offered at Dr. SIBY's Ayurveda Center?",
      answer: "We specialize in authentic Kerala Ayurveda treatments (such as Pizhichil, Njavarakkizhi, Shirodhara, and customized Panchakarma detox programs) as well as globally recognized training courses in Ayurvedic massage, yoga, and chakra energy bodywork."
    },
    {
      question: "Where is the center located and do you have other branches?",
      answer: "Our main center is in Bhagsunag (near McLeod Ganj, Dharamshala) nestled in a serene forest setting. We also operate a branch in Yol (near Dharamshala) and run a winter clinic at Varkala Beach in Kerala from December to February."
    },
    {
      question: "Are the massage training programs certified?",
      answer: "Yes, we offer practical, hands-on training courses in Ayurvedic massage and Panchakarma therapies that are globally certified, suitable for international students, healers, and practitioners."
    },
    {
      question: "Who supervises the consultations and treatments?",
      answer: "All consultations and clinical procedures are directly guided by Dr. Sibi George (Dr. Siby), an experienced Ayurvedic practitioner who has been practicing traditional Kerala Ayurveda and pulse diagnostics since 1986."
    },
    {
      question: "How do I reach the center in Dharamshala?",
      answer: "The nearest airport is Gaggal Airport (DHM) at Kangra, approximately 18 km away. Kangra Railway Station (local narrow gauge) is 22 km away, and Pathankot Railway Station (broad gauge) is about 90 km away, which connects to major cities."
    }
  ];

  const programs = [
    {
      title: "7 to 45 Days Panchakarma Detox",
      description: "Comprehensive classical cleansing including Vamana, Virechana, Kashayavasti, Snehavasthi, and Nasya to restore systemic balance and vitality.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "2-Hour Full Body Ayurvedic Massage",
      description: "Traditional deep tissue bodywork utilizing customized warm medicated herbal oils to relieve physical fatigue and soothe the nervous system.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Spine & Joint Care Treatments",
      description: "Specialized therapies like Kateevasthi and Urovasti involving localized pooling of warm oils to treat stiffness, chronic back pain, and joint issues.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Chakra Open & Yogic Massages",
      description: "Therapeutic stimulation of Marma (vital energy) points and endocrine pathways to release emotional blocks and align the body's energy field.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Rejuvenation & Pizhichil Bath",
      description: "A luxurious and deeply therapeutic process where warm medicated oils are poured rhythmically over the body for deep rejuvenation and nervous system support.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Kerala Ayurveda & Training Courses",
      description: "Globally certified, hands-on learning programs covering traditional massage techniques, therapeutic applications, and fundamental Ayurvedic principles.",
  ...
  const whyChooseUs = [
    {
      title: "39+ Years Clinical Wisdom",
      description: "Led by Dr. Sibi George (Dr. Siby), practicing traditional Kerala Ayurveda, pulse diagnosis, and holistic healing since 1986.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Authentic Kerala Lineage",
      description: "Bringing classical South Indian Kerala Ayurveda techniques, specialized herbal oils, and authentic therapeutic traditions to the Himalayas.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Beautiful Bhagsu Environment",
      description: "Our main center in Bhagsunag offers a serene, fresh mountain setting surrounded by lush pine forests and refreshing Himalayan air.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Personalized Pulse Diagnostic",
      description: "Every individual receives direct diagnostic pulse readings (Nadi Pariksha) from Dr. Siby to design a tailored therapy and diet program.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Multi-Center Experience",
      description: "Seamlessly access our healing programs in Dharamshala, our branch in Yol, or during winter at our Varkala Beach center in Kerala.",
      icon: <Globe className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Certified Training Programs",
      description: "Study and receive globally recognized certificates in traditional Ayurvedic massage, Panchakarma, and holistic bodywork.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
  ...
  useEffect(() => {
    document.title = "Dr. SIBY's Kerala Ayurveda & Panchakarma Center | Dharamshala Himachal";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Kerala Ayurvedic Panchakarma, therapeutic massages, and traditional healing in Dharamshala under Dr. Sibi George. Foundations since 1986.");
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Dr. SIBY's Kerala Ayurveda & Panchakarma Center Himachal
            </li>
          </ol>
        </div>
      </nav>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-lg">Dharamshala, Himachal Pradesh, India</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.7</span>
                  <span className="opacity-90">(40 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Dr. SIBY's Kerala Ayurveda & Panchakarma Center</strong>, an authentic alternative medicine sanctuary nestled in the serene forest hills of Dharamshala. Established by the highly experienced practitioner Dr. Sibi George (Dr. Siby), our center has been offering classical Ayurvedic therapies, specialized bodywork, and holistic wellness programs since 1986.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/himalayas-rishikesh-uttarakhand-north-east/Dr. SIBY's Ayurveda Center/secondary.jpg" 
                          alt="Dr. SIBY's Ayurveda Center gardens and view"
                  ...
                  <p>
                    Located on Bhagsunag Temple Road in a peaceful environment surrounded by towering pine trees and refreshing mountain air, the center serves as a perfect escape for deep restoration. We offer customized 7 to 45-day Panchakarma detoxification, specialized spine and joint care, rejuvenating herbal oil baths, and certified training programs.
                  </p>

                  <p>
                    Under the direct pulse analysis (Nadi Pariksha) and guidance of Dr. Siby, each individual receives a personalized package of treatments. To accommodate guests year-round, the center has branches in Bhagsunag and Yol (Dharamshala), and operates a winter location at Varkala Beach in Kerala from December to February.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/himalayas-rishikesh-uttarakhand-north-east/Dr. SIBY's Ayurveda Center/main.avif" 
                      alt="Dr. SIBY's Kerala Ayurveda & Panchakarma Center"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP centers/himalayas-rishikesh-uttarakhand-north-east/Dr. SIBY's Ayurveda Center/secondary.jpg" 
                        alt="Dr. SIBY's Center Therapy Space"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Dr. SIBY's Ayurveda Center today.
              </h3>
            </div>
          </div>
        </div>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/himalayas-rishikesh-uttarakhand-north-east/Dr. SIBY's Ayurveda Center/main.avif"
                  alt="Dr. SIBY's Ayurveda Center"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Dr. SIBY's Center?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Dr. SIBY's Center?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, retreats, and therapies at Dr. SIBY's Center.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-foreground/70 leading-relaxed space-y-2 text-sm md:text-base" style={{ color: "#7F543D" }}>
                      <p>Bhagsunag Temple Road, opposite UCO Bank, near McLeod Ganj, Dharamshala, Himachal Pradesh</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Approx. 18 km from Gaggal Airport</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Approx. 22 km from Kangra Railway Station</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15340491.82404948!2d65.86961643416534!3d20.165844402351755!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x391b56cde0cc124b%3A0x8535485aad0e9441!2sDr.%20SIBY&#39;S%20Ayurveda%20Center!5e0!3m2!1sen!2sin!4v1780495050209!5m2!1sen!2sin"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Dr. SIBY's Ayurveda Center Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or course program at Dr. SIBY's Ayurveda Center.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919736741726?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Dr.%20SIBY's%20Ayurveda%20Center."
              target="_blank"
              rel="noreferrer"
