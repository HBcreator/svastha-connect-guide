...
export default function AdyantAyurvedaJayanagar() {
  ...
  const programs = [
    {
      ...
      description: "Authentic, doctor-supervised detox procedures including Snehana, Swedana, and Shirodhara to deeply cleanse metabolic toxins.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Spine & Joint Care",
      description: "Targeted Ayurvedic management for arthritis, sciatica, and cervical spondylosis using specialized herbal oil therapies.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Women's Health & Gynaecology",
      description: "Natural holistic protocols for managing PCOD, menstrual irregularities, and comprehensive fertility support.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stress & Sleep Management",
      description: "Soothing therapies focused on reducing anxiety, managing stress, and resolving chronic insomnia naturally.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Hair Care",
      description: "Specialized treatments for chronic skin conditions like psoriasis, along with authentic Ayurvedic beauty rituals.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Pediatric Immunity",
      description: "Swarna Bindu Prashana and customized wellness programs to naturally boost children's immunity and development.",
  ...
  const whyChooseUs = [
    {
      title: "Personalized, Doctor-Led Care",
      description: "Every treatment plan is highly customized based on a thorough consultation and your unique body constitution.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Award-Winning Excellence",
      description: "Recognized with prestigious awards for outstanding Panchakarma treatments and commitment to holistic health.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Authentic & Safe Therapies",
      description: "Strict adherence to traditional Ayurvedic formulations, ensuring pure, safe, and effective healing.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Comprehensive Healing",
      description: "An integrative approach combining precise herbal medicine, customized diet plans, and lifestyle modifications.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Certified & Registered",
      description: "A KPME-licensed and ROHINI-registered clinic, maintaining the highest clinical standards and hygiene.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Tranquil Environment",
      description: "A calm, thoughtfully designed clinic atmosphere in Jayanagar that actively promotes relaxation and recovery.",
  ...
  const treatmentProcess = [
    {
      ...
      description: "In-depth evaluation by our expert Vaidyas to identify the root cause of your health concerns.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Personalized Protocol",
      description: "Creation of a customized treatment plan detailing specific therapies, dietary shifts, and herbal support.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Deep Cleansing",
      description: "Application of classical Panchakarma procedures to safely eliminate accumulated toxins from the body.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Targeted Therapies",
      description: "Execution of specialized treatments focused directly on alleviating your specific chronic or acute condition.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Rejuvenation",
      description: "Restorative Rasayana therapies designed to strengthen immunity, nourish tissues, and restore vitality.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Ongoing Guidance",
      description: "Continuous post-treatment support and lifestyle advice to ensure sustained health benefits over time.",
  ...
  const testimonials = [
    {
      ...
      review: "Traveled from the UK seeking a holistic alternative for my severe osteoarthritis. The doctors at Adyant were incredibly compassionate. After 14 days of authentic Janu Basti and Abhyanga, my mobility improved drastically.",
      name: "Michael T.",
      verified: true,
      location: "London, UK",
    ...
    {
      title: "Life-Changing Detox Journey",
      review: "I flew to Bangalore specifically for their Panchakarma detox. Dealing with chronic hormonal imbalance back home was frustrating, but their guided herbal protocol naturally restored my health. Truly life-changing experience!",
      name: "Sarah Jenkins",
      verified: true,
    ...
    {
      title: "Incredible Stress Relief",
      review: "The Shirodhara treatment for my chronic insomnia was magical. The Jayanagar clinic is exceptionally clean and the staff is so welcoming to international guests. My stress levels have completely vanished.",
      name: "Elena R.",
      verified: true,
    ...
    {
      title: "Authentic Healing Experience",
      review: "I came for a 21-day wellness retreat to address severe digestive issues and fatigue. Adyant Ayurveda provided a deeply authentic healing environment and precise dietary guidance that I couldn't find anywhere in Australia.",
      name: "David O'Connor",
      verified: true,
  ...
  const faqItems = [
    {
      ...
      answer: "Yes, we highly recommend booking an appointment in advance. Our treatments are doctor-led, and a prior appointment ensures you get adequate time for a thorough consultation."
    },
    {
      question: "What should I expect during my first consultation?",
      answer: "Your first visit involves a detailed Nadi Pariksha (pulse diagnosis) and discussion of your medical history, diet, and lifestyle. The doctor will determine your Prakriti (body constitution) and suggest a personalized treatment plan."
    },
    {
      question: "Are the medicines prescribed safe and authentic?",
      answer: "Absolutely. Adyant Ayurveda uses strict quality-controlled, authentic herbal formulations. All therapies adhere strictly to traditional Ayurvedic principles ensuring maximum safety and efficacy."
    },
    {
      question: "Do you offer residential Panchakarma treatments?",
      answer: "While we are a day-care clinic, we offer comprehensive Panchakarma therapies that you can undergo by visiting daily. Please contact us to discuss how we can accommodate your specific treatment schedule."
    },
    {
      question: "Is there parking available at the Jayanagar clinic?",
      answer: "Yes, there is dedicated parking available for our patients near the clinic in Jayanagar."
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Adyant Ayurveda – Jayanagar</h1>
                <p className="text-xl mb-4 opacity-90">Premier Ayurvedic Clinic Chain in Bengaluru</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="opacity-90">(2,000 reviews)</span>
                </div>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-lg md:text-xl leading-relaxed text-foreground/80 text-justify md:text-left" style={{ color: "#7F543D" }}>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/adyant-waiting.jpg.png" 
                          alt="Adyant Ayurveda Jayanagar Waiting Area"
                  ...
                  <p>
                    Our comprehensive approach goes beyond mere symptom management. Whether you are seeking deep detoxification through classical Panchakarma, specialized care for chronic conditions like joint pain, PCOD, and skin disorders, or rejuvenation therapies to counter modern-day stress, our expert Vaidyas curate tailored treatment protocols. By integrating authentic herbal formulations, dietary guidance, and therapeutic yoga, Adyant Ayurveda empowers you to restore your natural balance and achieve lasting well-being.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/adyant-therapy.jpg.png" 
                      alt="Adyant Ayurveda Jayanagar Therapy Room"
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at Adyant Ayurveda</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Adyant Ayurveda</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience authentic healing supported by modern clinical standards and compassionate care.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Your Healing Journey at Adyant Ayurveda</h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A structured, doctor-led approach to restore your natural balance.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  ...
                  alt="Adyant Ayurveda Hospital"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/3.jpg"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Adyant Ayurveda?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Adyant Ayurveda?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at Adyant Ayurveda.</p>
          </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1" style={{ color: "#7F543D" }}>
                      <li>• Approx. 40 km from Kempegowda International Airport (BLR)</li>
                      <li>• Approx. 8 km from KSR Bengaluru Railway Station</li>
                    </ul>
                  </div>
                </div>
              </div>
              
              <div className="h-[400px] bg-white p-2 rounded-2xl shadow-sm border border-[#2C4E5A]/5">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.7825327593046!2d77.57515057507564!3d12.9216940873891!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1540ac9cb0eb%3A0xe6abe59a27aeab34!2sAdyant%20Ayurveda%20Jayanagar%20%7C%20Best%20Ayurvedic%20clinic%20%26%20Panchakarma%20treatment%20center!5e0!3m2!1sen!2sin!4v1779438092414!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  ...
                  className="rounded-xl grayscale-[20%] contrast-125"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a free consultation. Our doctors will guide you towards the perfect treatment program at Adyant Ayurveda.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/918028432737?text=Hi%2C%20I%20want%20to%20book%20a%20free%20consultation%20with%20Adyant%20Ayurveda%20Jayanagar."
              target="_blank"
              rel="noreferrer"
