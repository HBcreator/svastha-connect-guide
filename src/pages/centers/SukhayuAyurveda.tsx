...
export default function SukhayuAyurveda() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "In-depth Nadi Pariksha (Pulse Diagnosis) and evaluation of your medical history by Dr. Sachin Jadhav and team.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Customized Treatment Blueprint",
      description: "Formulating a precise healing protocol utilizing classical Kerala Ayurveda techniques targeted to your specific ailment.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Preparation for Detoxification",
      description: "Initial body preparation with medicated ghee (Snehana) and herbal steam therapies (Swedana) to loosen deep-seated toxins.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Authentic Panchakarma Cleansing",
      description: "Executing core detox procedures like Vamana, Virechana, or Basti, facilitated by highly skilled therapists from Kerala.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Rejuvenation & Rasayana",
      description: "Post-detoxification strengthening using specialized Ayurvedic formulations and Rasayana therapies to rebuild vitality.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Lifestyle & Maintenance Plan",
      description: "Providing an ongoing dietary chart, customized yoga practices, and supportive medicines to prevent disease recurrence.",
  ...
  const testimonials = [
    {
      title: "Cervical Spondylosis Relief",
      review: "I had severe neck pain and stiffness due to cervical spondylosis. The Greeva Basti and Kati Basti therapies performed by the expert Kerala therapists here completely resolved my pain. Dr. Sachin Jadhav is brilliant and very attentive.",
    ...
    {
      title: "Exceptional Panchakarma Experience",
      review: "The Virechana process I underwent at Sukhayu was life-changing. The facility at Canada Corner is incredibly clean, and the staff is highly professional. My chronic acidity and stress levels have vanished.",
      name: "Sarah Jenkins",
      verified: true,
      location: "Sydney, Australia",
      condition: "Panchakarma Detox & Stress",
      rating: 5
    },
    {
      title: "Effective Knee Pain Treatment",
      review: "I visited Sukhayu Ayurveda for chronic knee joint pain. The Janu Basti treatment and the prescribed Ayurvedic medicines showed results within a week. I can now walk comfortably without painkillers.",
      name: "David Mueller",
      verified: true,
    ...
    {
      title: "Remarkable Eye Care (Netra Tarpan)",
      review: "Due to excessive screen time, my eyes were constantly dry and strained. The Netra Tarpan therapy recommended by Dr. Jadhav felt incredibly soothing and restored my vision clarity. Excellent clinic!",
      name: "Elena Rodriguez",
      verified: true,
      location: "Madrid, Spain",
      condition: "Eye Strain / Dry Eyes",
      rating: 5
    },
    {
      title: "Trustworthy & Authentic Healing",
      review: "From the accurate diagnosis to the final day of therapy, everything is systematic. The Kerala-trained therapists know their job well. It's the best place in Nashik for genuine Ayurvedic treatments.",
      name: "Robert Evans",
      verified: true,
  ...
  const faqItems = [
    {
      question: "Who is the chief physician at Sukhayu Ayurveda & Panchakarma Center?",
      answer: "The clinic is led by Dr. Sachin Jadhav, a highly experienced Ayurvedic General Surgeon and Panchakarma Specialist with over 14 years of clinical excellence in treating chronic ailments."
    },
    {
      question: "Are the therapists certified?",
      answer: "Yes, all our Panchakarma therapies are administered by highly trained and experienced therapists directly from Kerala, ensuring you receive the most authentic and effective Ayurvedic treatments."
    },
    {
      question: "What are the core specialties of the clinic?",
      answer: "We specialize in classical Panchakarma therapies, pain management (cervical spondylosis, knee pain, sciatica), eye disorders (Netra Tarpan), stress management, and comprehensive lifestyle disease reversal."
    },
    {
      question: "Do I need to book an appointment in advance?",
      answer: "Yes, to ensure personalized attention and minimal waiting time, we highly recommend booking your consultation in advance. You can easily schedule an appointment via phone or through our website."
    },
    {
      question: "Where exactly is the clinic located in Nashik?",
      answer: "Sukhayu Ayurveda & Panchakarma Center is centrally located at Canada Corner in Nashik, Maharashtra. It serves as the foundational pillar of the prestigious Sukhayu Hospital, offering state-of-the-art facilities."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Complete detoxification protocols including Vamana, Virechana, and Basti to deeply cleanse the body and mind.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Spine & Joint Wellness",
      description: "Targeted therapies like Kati Basti and Greeva Basti to permanently relieve back pain, sciatica, and cervical spondylosis.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Ayurvedic Eye Care",
      description: "Netra Tarpan and specialized treatments to combat digital eye strain, dryness, and protect vision health.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stress & Anxiety Relief",
      description: "Soothing Shirodhara and Abhyanga therapies designed to calm the nervous system and cure insomnia.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Metabolic Correction",
      description: "Personalized diet charts and Ayurvedic medicines targeting obesity, thyroid imbalances, and sluggish metabolism.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Rejuvenation Therapy",
      description: "Pinda Sweda and Rasayana treatments to boost immunity, restore energy levels, and delay the aging process.",
  ...
  const whyChooseUs = [
    {
      ...
      description: "Over a decade of successful clinical outcomes and thousands of healed patients across Maharashtra.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Kerala-Trained Therapists",
      description: "Authentic therapies administered strictly by skilled therapists bringing the pure essence of Kerala Ayurveda.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Expert Medical Direction",
      description: "Led by Dr. Sachin Jadhav, blending deep Ayurvedic wisdom with surgical precision and modern diagnostic understanding.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "State-of-the-Art Facility",
      description: "A pristine, serene, and highly hygienic hospital environment at Canada Corner ensuring complete peace of mind.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Customized Protocols",
      description: "No generic treatments; every medicine and therapy is meticulously tailored to your unique Prakriti (body constitution).",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "High Patient Satisfaction",
      description: "Boasting a stellar 4.9 rating with over 1,600+ Google reviews, reflecting our commitment to excellent patient care.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
  ...
  useEffect(() => {
    document.title = "Sukhayu Ayurveda & Panchakarma Center Nashik | Authentic Treatment";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Kerala Panchakarma and effective treatments for joint pain, spine issues, and stress at Sukhayu Ayurveda & Panchakarma Center, Nashik.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Sukhayu Ayurveda & Panchakarma Center Nashik
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Sukhayu Ayurveda <br /> & Panchakarma Center</h1>
                <p className="text-xl mb-4 opacity-90">Nashik's Premier Destination for Authentic Kerala Ayurveda</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Canada Corner, Nashik, Maharashtra, India</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.9</span>
                  <span className="opacity-90">(1,600+ Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Sukhayu Ayurveda & Panchakarma Center</strong>, Nashik's premier destination for authentic, clinical Kerala Ayurveda. Operating as the foundational pillar of the prestigious Sukhayu Hospital in Canada Corner, we bring the pure, unadulterated essence of Ayurveda to Maharashtra with over 14 years of clinical excellence. We embrace a patient-first approach, taking the time to conduct thorough consultations and advanced Nadi Parikshan (pulse diagnosis) to pinpoint the exact root causes of disease, ensuring that every treatment plan is as unique as the individual receiving it.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/Sukhayu Ayurveda & Panchakarma Centre/image 2.png" 
                          alt="Sukhayu Ayurveda therapy room"
                          className="w-full h-full object-cover"
                          onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/25.webp"; }}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <p>
                    Led by Dr. Sachin Jadhav, a noted Ayurvedic General Surgeon and Panchakarma Specialist, our team is dedicated to treating the root cause of chronic illnesses. We are particularly celebrated for effectively treating cervical spondylosis, knee pain, eye disorders, stress, and lifestyle imbalances in a highly discreet, state-of-the-art facility, delivering deeply transformative healing outcomes for our patients. By fusing ancient Vedic herbal protocols with meticulous, modern clinical standards, we offer a truly holistic and highly effective path to lifelong vitality, making us a trusted sanctuary for patients seeking profound, lasting health transformations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/Sukhayu Ayurveda & Panchakarma Centre/image 1.png" 
                      alt="Sukhayu Ayurveda main view"
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Sukhayu Ayurveda today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Sukhayu Ayurveda
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Sukhayu Ayurveda
              </h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience world-class traditional healthcare backed by clinical excellence, state-of-the-art facilities, and highly trained therapists from Kerala.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Sukhayu Ayurveda
            </h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/Sukhayu Ayurveda & Panchakarma Centre/image 2.png"
                  alt="Sukhayu Ayurveda view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/25.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Sukhayu Ayurveda?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Sukhayu Ayurveda?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and specialties at Sukhayu Ayurveda.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Sukhayu Ayurveda & Panchakarma Center<br />
                      Patil Lane, Canada Corner<br />
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Located at the prominent Canada Corner for easy accessibility in Nashik.</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Convenient parking and well-connected by local transit options.</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=Sukhayu+Hospital,+Canada+Corner,+Nashik&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Sukhayu Ayurveda Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or therapy program at Sukhayu Ayurveda.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919560113189?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Sukhayu%20Ayurveda."
              target="_blank"
              rel="noreferrer"
