...
export default function MadukkakuzhyAyurveda() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "An intensive diagnostic check-up and physical review led by an experienced 8th-generation Vaidya physician to identify your baseline physical constitution and core dosha imbalances.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Custom Healing Schedule",
      description: "Designing a highly customized daily therapeutic calendar, compiling specific organic herbal extracts, specialized meals, and guided restorative yoga exercises.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Purva Karma Warmups",
      description: "Administering warm synchronized massage (Abhyangam) and customized steam baths (Swedana) using in-house herbal oils to loosen cell toxicities and prepare bodily channels.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Classical Pradhana Karma",
      description: "Carefully administering traditional biological purification procedures (such as Virechana, Vasti, or Nasyam) under strict supervision to eliminate deep-seated metabolic wastes.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Samsarjana & Restorative Yoga",
      description: "Slowly rebuilding digestive fire through targeted dietary steps coupled with custom medical yoga overseen by Dr. Robin Jacob to nourish cellular tissues and build vital energy.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Dinacharya Home Care",
      description: "Prescribing a personalized daily dietary blueprint, lifestyle tips, breathing guidelines, and home-use organic supplements to sustain the benefits of your recovery long-term.",
  ...
  const testimonials = [
    {
      ...
      condition: "Arthritis & Joint Regeneration",
      rating: 5
    },
    {
      ...
      condition: "Fibromyalgia & Chronic Fatigue (Panchakarma)",
      rating: 5
    },
    {
      ...
      condition: "Digestive Disorders & Metabolic Reset",
      rating: 5
    },
    {
      ...
      condition: "Post-Natal Care & Rejuvenation",
      rating: 5
    },
    {
      ...
      condition: "Stress Burnout & Sleep Care",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "What makes Madukkakuzhy Ayurveda's legacy unique?",
      answer: "Madukkakuzhy Ayurveda carries forward an unbroken lineage of eight generations of traditional Ayurvedic Vaidya wisdom since 1938, founded by the visionary Vaidyakalanidhi M.C. Mathew. By blending long-standing family formulations with modern clinical scientific standards, we deliver authentic, highly individualized treatments."
    },
    {
      question: "What does the Green Leaf Certification signify?",
      answer: "The 'Green Leaf' Certification is the highest official accreditation awarded by the Kerala Tourism Department for Ayurvedic centers. It guarantees that our hospital maintains the strictest benchmarks in hygiene, therapeutic precision, certified clinical physicians, quality of authentic herbal medicines, and environmental eco-conservation."
    },
    {
      question: "Are your Ayurvedic herbal formulations prepared in-house?",
      answer: "Yes, a core strength of Madukkakuzhy Ayurveda is our in-house preparation of high-potency Ayurvedic medicines. We harvest wild, organic herbs and botanical roots from our own local gardens to prepare custom oils, pastes, and decocations tailored specifically to the biological needs of each patient."
    },
    {
      question: "How do your international branches and collaborations function?",
      answer: "We support a global community of healing through our established European clinical collaboration at Bad Bocklet, Germany, as well as operations in the Middle East. Guests can start their recovery in Kottayam, Kerala, and receive continued professional Ayurvedic oversight and check-ups closer to home in Europe."
    },
    {
      question: "Does Madukkakuzhy assist with international health insurance claims?",
      answer: "Yes, our medical administration office compiles exhaustive case files, signed clinical diagnostics sheets, detailed treatment receipts, and certified pharmacy logs. We provide full support to help guests submit their claims for private international or corporate health insurance reimbursements."
    }
  ];

  const programs = [
    {
      title: "Arthritis & Joint Regeneration",
      description: "Intensive, individualized therapies integrating synchronized oil massage, local Kizhi, and targeted therapies to soothe inflammation and restore mobility.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Fibromyalgia & Chronic Fatigue",
      description: "Specialized body purification and tissue-nourishing Panchakarma regimens designed to build systemic energy and strengthen immunity.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Digestive & Metabolic Reset",
      description: "Traditional clinical gut-cleansing protocols combined with physician-guided organic diet charts to manage metabolic and gastrointestinal concerns.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Psoriasis Recovery",
      description: "Pure blood-purifying botanical wraps and specialized herbal therapies designed to address eczema, psoriasis, and deep tissue toxicities.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Post-Natal & Rejuvenation",
      description: "Tailored therapeutic programs for post-pregnancy recovery, anti-aging cellular repair, and deep tissue nourishment.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Pre-Conception & Panchakarma",
      description: "3-week comprehensive physiological detoxification and body purification programs to restore systemic vital health.",
  ...
  const whyChooseUs = [
    {
      title: "8 Generations of Heritage",
      description: "An unbroken lineage of traditional Vaidya wisdom since 1938, founded by Vaidyakalanidhi M.C. Mathew.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Green Leaf Certified",
      description: "Awarded the highest government accreditation for hygiene, classical therapies, and eco-friendly wellness standards.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "In-House Organic Pharmacy",
      description: "Utilizes high-potency herbal remedies crafted from organic herbs grown in their own native gardens.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "European Collaboration",
      description: "Broad global footprint with an established clinical collaboration in Bad Bocklet, Germany, caring for international seekers.",
      icon: <Globe className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Customized Healing Food",
      description: "Pure, physician-guided organic meals prepared to balance individual doshas and support deep recovery.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Comprehensive Case Papers",
  ...
  useEffect(() => {
    document.title = "Madukkakuzhy Ayurveda | Authentic Panchakarma & 8 Generations Heritage in Kottayam";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Ayurvedic healing at Madukkakuzhy Ayurveda in Kanjirappally, Kottayam. Green Leaf Certified clinical Panchakarma, 8 generations of Vaidya lineage, and personalized doctor-guided therapy.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Madukkakuzhy Ayurveda</h1>
                <p className="text-xl mb-4 opacity-90">8 Generations of Traditional Vaidya Heritage & Green Leaf Certified Panchakarma</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Kanjirappally, Kottayam, Kerala, India</span>
                </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] leading-tight md:leading-[1.1] max-w-4xl mx-auto px-2">
                Eight Generations of Unbroken <br className="hidden lg:block" />
                Vaidya Healing at Madukkakuzhy
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-lg md:text-xl leading-relaxed text-foreground/80 text-justify md:text-left" style={{ color: "#7F543D" }}>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP cneters/kerela/Madukkakuzhy Ayurveda/secondary.jpg" 
                          alt="Madukkakuzhy Ayurveda homestay gardens"
                  ...
                  <p>
                    Rooted in traditional Ayurvedic values, the hospital specializes in treating complex, chronic health challenges like arthritis, fibromyalgia, metabolic reset, skin conditions, and geriatric longevity, alongside deeply purifying classical Panchakarma detoxes. Rejecting standard, automated protocols, each guest undergoes detailed daily consultation by the resident doctors who formulate custom therapies, freshly prepared organic herbal remedies from our local estate pharmacy, and individualized Ayurvedic vegetarian meals.
                  </p>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/kerela/Madukkakuzhy Ayurveda/main.webp" 
                      alt="Madukkakuzhy Ayurveda Exterior and Greenery"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP cneters/kerela/Madukkakuzhy Ayurveda/secondary.jpg" 
                        alt="Therapy Chamber at Madukkakuzhy Ayurveda"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Madukkakuzhy Ayurveda today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at Madukkakuzhy</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Madukkakuzhy</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience clinical precision combined with warm family hospitality, native remedies, and decades of healing legacy.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A meticulously structured scientific healing system carrying forward centuries of traditional clinical Kerala Vaidya experience.
            </p>
          </div>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP cneters/kerela/Madukkakuzhy Ayurveda/main.webp"
                  alt="Madukkakuzhy Ayurveda"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Madukkakuzhy Ayurveda?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Madukkakuzhy Ayurveda?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at Madukkakuzhy Ayurveda.</p>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Approx. 95 km from Cochin International Airport</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Approx. 38 km from Kottayam Railway Station</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  ...
                  title="Madukkakuzhy Ayurveda Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="/TOP cneters/kerela/Madukkakuzhy Ayurveda/main.webp"
            alt="Madukkakuzhy Ayurveda Homestay"
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment program at Madukkakuzhy Ayurveda.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919745209900?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Madukkakuzhy%20Ayurveda."
              target="_blank"
              rel="noreferrer"
