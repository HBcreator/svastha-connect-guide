...
export default function KeralaAyurvedaClinic() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "A thorough Prakriti and Dosha analysis by experienced Kerala-trained physicians to accurately diagnose the root cause of your ailment.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Personalized Protocol",
      description: "Designing a highly customized therapy schedule targeting your specific chronic conditions, using traditional Kerala Ayurvedic principles.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Purvakarma (Preparation)",
      description: "Preparing your body for deep detoxification through specialized Snehana (oleation) and Swedana (sudation) therapies.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Pradhana Karma",
      description: "Executing core classical Panchakarma procedures such as Vamana, Virechana, or Basti using authentic methods for systemic cleansing.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Targeted Kerala Therapies",
      description: "Integrating specialized local treatments like Pizhichil, Kizhi (Pottali), or Shirodhara for rapid relief from pain and stress.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Paschat Karma (Aftercare)",
      description: "Providing rejuvenating herbal medicines, specific dietary protocols, and lifestyle adjustments to sustain your healing and vitality.",
  ...
  const testimonials = [
    {
      ...
      review: "The authentic Keraleeya Panchakarma at this clinic is exactly what I was searching for. The doctors are incredibly knowledgeable and my chronic skin condition has improved drastically since the treatments.",
      name: "Emily R.",
      verified: true,
    ...
    },
    {
      ...
      review: "I highly recommend their traditional Abhyangam and Shirodhara for anyone suffering from severe stress. The therapists are genuinely trained from Kerala and bring an unmatched level of expertise.",
      name: "Oliver W.",
      verified: true,
      location: "London, UK",
      condition: "Severe Stress",
      rating: 5
    },
    {
      title: "Excellent Joint Rehabilitation",
      review: "Traveling to Mumbai for my musculoskeletal rehabilitation was totally worth it. The Pizhichil treatments significantly reduced my joint pain and improved my mobility within just two weeks.",
      name: "Sophia J.",
      verified: true,
    ...
    {
      title: "Transformative Gut Health",
      review: "The comprehensive digestive and metabolic protocols offered here are exceptional. I appreciate how deeply the physicians analyzed my Doshas before prescribing a highly personalized Basti Chikitsa.",
      name: "Lucas B.",
      verified: true,
    ...
    {
      title: "An Authentic Oasis",
      review: "An oasis of authentic Kerala healing in the middle of bustling Mumbai. The quality of the herbal oils and the meticulous attention to detail during my therapy sessions exceeded all my expectations.",
      name: "Mia K.",
      verified: true,
      location: "Toronto, Canada",
      condition: "Holistic Detox",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "What makes Kerala Ayurveda Multi Speciality Clinic different?",
      answer: "We bring the true essence of traditional Kerala Ayurveda to Mumbai, offering an extensive range of classical therapies performed by expert therapists trained strictly in Kerala."
    },
    {
      question: "Do you offer specialized Panchakarma programs?",
      answer: "Yes, we provide comprehensive, doctor-supervised Panchakarma detoxification protocols tailored to individual Prakriti for managing chronic illnesses and metabolic conditions."
    },
    {
      question: "Are your treatments effective for joint and muscle pain?",
      answer: "Absolutely. We offer specialized Kerala therapies like Pizhichil and Kizhi (Pottali treatments) which are highly effective for musculoskeletal rehabilitation and arthritis."
    },
    {
      question: "Where is the clinic located in Mumbai?",
      answer: "We have our premium multi-specialty clinics located in accessible areas like Andheri, equipped with modern amenities while retaining traditional healing atmospheres."
    },
    {
      question: "Do I need to book an appointment before visiting?",
      answer: "Yes, to ensure our physicians can dedicate ample time for a thorough consultation and customized treatment planning, prior appointments are highly recommended."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Authentic detoxification programs strictly following Kerala traditions to deeply cleanse the body of toxins and restore systemic health.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Musculoskeletal Care",
      description: "Targeted Ayurvedic pain management for arthritis, spondylosis, and sports injuries using specialized therapies like Kizhi and Pizhichil.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stress & Mental Health",
      description: "Deeply relaxing therapies including Shirodhara and traditional Abhyangam to alleviate chronic stress, anxiety, and insomnia.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Hair Disorders",
      description: "Comprehensive blood purification and external applications using premium Kerala herbs to treat eczema, psoriasis, and hair loss.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Digestive & Metabolic",
      description: "Effective natural protocols for managing chronic indigestion, acidity, IBS, diabetes, and restoring optimal gut health.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Rejuvenation (Rasayana)",
      description: "Premium wellness treatments designed to revive energy levels, boost immunity, and combat chronic fatigue naturally.",
  ...
  const whyChooseUs = [
    {
      title: "True Kerala Heritage",
      description: "We bring the unadulterated essence of traditional Kerala Ayurveda to Mumbai with specially sourced herbs and oils.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Expert Practitioners",
      description: "Our treatments are guided by highly experienced physicians and performed by therapists trained directly in Kerala.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Customized Protocols",
      description: "Every wellness journey begins with a meticulous Dosha assessment ensuring completely personalized therapies.",
      icon: <FileSearch className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Comprehensive Care",
      description: "From chronic illness management to holistic rejuvenation, we offer a full spectrum of classical treatments.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Premium Facilities",
      description: "Our clinics are designed to provide a pristine, serene, and deeply healing environment in the heart of the city.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Flawless Reputation",
      description: "Consistently rated 5.0 on Google, reflecting our unwavering commitment to exceptional patient outcomes.",
  ...
  useEffect(() => {
    document.title = "Kerala Ayurveda Multi Speciality Clinic | Authentic Care in Mumbai";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Kerala Ayurvedic treatments, Panchakarma, and specialized therapies at Kerala Ayurveda Multi Speciality Clinic in Mumbai.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Kerala Ayurveda Multi Speciality Clinic Mumbai
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Kerala Ayurveda <br className="hidden md:block" /> Multi Speciality Clinic</h1>
                <p className="text-xl mb-4 opacity-90">Mumbai's Premier Destination for Authentic Kerala Healing</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Andheri, Mumbai, Maharashtra, India</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">5.0</span>
                  <span className="opacity-90">(63 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Kerala Ayurveda Multi Speciality Clinic
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Kerala Ayurveda Multi Speciality Clinic</strong>, a premium wellness destination in Mumbai boasting a flawless 5.0 Google rating. Our clinic is dedicated to delivering authentic, classical Kerala therapies rooted deeply in the state's rich Ayurvedic heritage. We successfully bridge the gap between traditional Kerala healing methodologies and the specific health needs of modern patients residing in bustling urban environments.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/Kerala Ayurveda Multi Speciality Clinic/image 2.webp" 
                          alt="Kerala Ayurveda therapy room"
                          className="w-full h-full object-cover"
                          onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/17.webp"; }}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <p>
                    Led by experienced Kerala-trained physicians and therapists, the clinic offers a comprehensive range of traditional treatments including Shirodhara, Pizhichil, Pottali (Kizhi) therapies, Basti Chikitsa, and classical Abhyangam. We specialize in managing chronic conditions spanning skin and hair disorders, digestive and metabolic imbalances, musculoskeletal rehabilitation, and mental health support. Every treatment is customized using authentic medicated oils to guarantee unparalleled therapeutic outcomes.
                  </p>
                  
                  <p>
                    Our dedication to healing goes beyond symptom management. We focus on total body rejuvenation by incorporating strict dietary guidelines, specialized post-treatment care (Paschat Karma), and lifestyle counseling into every protocol. This comprehensive approach ensures that our patients experience sustainable long-term relief and profound transformation, making us the most trusted name in authentic Ayurvedic care in Mumbai.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/Kerala Ayurveda Multi Speciality Clinic/image 1.webp" 
                      alt="Kerala Ayurveda main view"
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Kerala Ayurveda Multi Speciality Clinic today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Kerala Ayurveda Multi Speciality Clinic
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Kerala Ayurveda Multi Speciality Clinic
              </h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience world-class traditional Kerala healthcare with a boutique approach, authentic medicines, and highly personalized care.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Kerala Ayurveda Multi Speciality Clinic
            </h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/Kerala Ayurveda Multi Speciality Clinic/image 1.webp"
                  alt="Kerala Ayurveda view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/17.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Kerala Ayurveda Multi Speciality Clinic?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Kerala Ayurveda Multi Speciality Clinic?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and specialties at Kerala Ayurveda Multi Speciality Clinic.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Kerala Ayurveda Multi Speciality Clinic<br />
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Centrally located clinic in Andheri for easy access.</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Easily accessible from major transit hubs in Mumbai.</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=Kerala+Ayurveda+Hub,+Powai,+Mumbai&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or therapy program at Kerala Ayurveda Multi Speciality Clinic.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/9198xxxxxxxx?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Kerala%20Ayurveda%20Multi%20Speciality%20Clinic."
              target="_blank"
              rel="noreferrer"
