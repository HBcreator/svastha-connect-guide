...
export default function HLCAyurvedaAndNatureCureHospital() {
  ...
  const treatmentProcess = [
    {
      number: 1,
      title: "Integrative Consultation",
      description: "Detailed assessments by our expert doctors, merging classical Ayurvedic examination with Naturopathic diagnostic tools.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Custom Therapeutic Design",
      description: "Formulating a personalized recovery protocol spanning diet, Yoga, Med Spa treatments, and custom herbal medicines.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Standardized Organic Remedies",
      description: "Prescribing high-quality, pure herbal preparations prepared under strict clinical supervision for maximum efficacy.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Detox & Naturopathic Cleansing",
      description: "Undergoing customized Panchakarma therapies or Naturopathic hydrotherapy to eliminate systemic metabolic wastes.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Acupuncture & Physical Rehab",
      description: "Utilizing specialized acupuncture, clinical physical therapy, or medical massage to restore mobility and relieve pain.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Rejuvenation & Aftercare",
      description: "Sustaining long-term vitality through lifestyle coaching, custom diet plans, and periodic wellness assessments.",
  ...
  const testimonials = [
    {
      title: "Life-Changing Diabetes Reversal",
      review: "I traveled from Germany for HLC's 10-day Diabetes Reversal Program. Dr. Jaya Prakash and the acupuncture team were outstanding. My fasting sugar levels dropped significantly, and the serene 2-acre cottage campus was incredibly healing.",
      name: "Lucas Wagner",
      verified: true,
    ...
    {
      title: "Incredible Postnatal Care",
      review: "After my second pregnancy, I underwent postnatal rejuvenation at HLC. The therapists are exceptionally skilled, using purely natural, aromatic medicated oils. The luxurious 12,000 sq ft spa felt so safe and professional.",
      name: "Charlotte Dubois",
      verified: true,
      location: "Lyon, France",
      condition: "Postnatal Rejuvenation",
      rating: 5
    },
    {
      title: "Excellent Joint Pain Relief",
      review: "Suffered from chronic knee arthritis for years. HLC's integration of classical Ayurveda and modern physical therapies did wonders. I stayed in their beautiful cottages, which are peaceful and highly hygienic. Excellent, empathetic care.",
      name: "Grace Campbell",
      verified: true,
    ...
    {
      title: "Scientific Skin and Hair Care",
      review: "I had severe chronic eczema. Dr. Krishnasree's treatment plan combined customized naturopathic detox diets with organic herbal remedies. My skin has finally healed, and I couldn't be more grateful. Highly professional doctors!",
      name: "Yuki Tanaka",
      verified: true,
    ...
    {
      title: "Brilliant Neurological Rehab",
      review: "My father underwent paralysis rehabilitation here post-stroke. Dr. Sateesha's molecular research background brought great scientific depth to the treatment. He has regained significant motor control. Highly recommend HLC hospital!",
      name: "Dmitri Ivanov",
      verified: true,
  ...
  const faqItems = [
    {
      question: "What sets HLC Ayurveda & Nature Cure Hospital apart?",
      answer: "Established in 2017, HLC is a premier wellness hospital set on a tranquil 2-acre campus in Electronic City, Bangalore. We specialize in 'Integrative Ayush', bridging classical Ayurveda and Naturopathy with standard modern diagnostics, specialized acupuncture, a 12,000 sq ft Med Spa, and 19 luxury cottages."
    },
    {
      question: "Do you offer programs for Diabetes and Weight Loss?",
      answer: "Yes, we specialize in a highly successful, holistic 10-day Diabetes Reversal Program, comprehensive Obesity Management, and natural weight loss treatments, tailored to address the root systemic causes."
    },
    {
      question: "Can I avail of health insurance for my treatments at HLC?",
      answer: "Yes, we provide the necessary clinical documentation, bills, and discharge summaries to enable patients to claim health insurance reimbursement for their AYUSH treatments, subject to your policy terms."
    },
    {
      question: "Who will manage my clinical treatment plan?",
      answer: "Your treatment will be overseen by our senior experts, including Dr. D. Jaya Prakash (BNYS, MD(Acu), NABH), Dr. C. Krishnasree (BAMS, MBA), and Dr. Sateesha (BAMS, MD), a researcher in molecular biology."
    },
    {
  ...
  const programs = [
    {
      ...
      description: "A specialized holistic care program combining Ayurveda, acupuncture, and custom Naturopathic diets to naturally reverse type 2 diabetes.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Obesity & Weight Management",
      description: "Therapeutic bio-cleansing, fat-burning massages, and custom nutritional plans to help achieve sustainable, healthy weight loss.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "HLC Med Spa Services",
      description: "Indulge in our premium 12,000 square feet spa space, offering 8 distinct classical styles and 50+ relaxing procedures.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Spine & Joint Care",
      description: "Relieve back pain, sciatica, and arthritis using targeted classical oils, acupuncture, and integrative physical therapy.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Women's Health & OBG",
      description: "Specialized, compassionate care for PCOD, thyroid imbalances, infertility, and comprehensive pre & postnatal recovery.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stroke & Neurological Rehab",
      description: "Intensive rehabilitation programs utilizing evidence-based Ayurveda therapies to restore motor functions and speech post-stroke.",
  ...
  const whyChooseUs = [
    {
      title: "NABH & Insurance-Friendly",
      description: "A highly trusted hospital structure where patients can easily obtain reimbursement for AYUSH treatments under standard insurance.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "2-Acre Health Resort",
      description: "Features 19 private luxury cottages set amidst lush green campus, offering a peaceful space for overnight inpatient healing.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "12,000 Sq Ft Med Spa",
      description: "A dedicated rejuvenation space offering over 50 authentic procedures and 8 classical styles under clinical supervision.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Stellar Medical Team",
      description: "Led by eminent specialists including Dr. D. Jaya Prakash (Naturopathy) and Dr. Sateesha (Ayurveda & Molecular Biology researcher).",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Integrative Medicine",
      description: "Harmoniously combines the ancient wisdom of classical Ayurveda, Naturopathy, clinical Yoga, and specialized acupuncture.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Curative & Preventive Range",
      description: "From chronic disease reversal (diabetes, paralysis) to preventive stress relief and postnatal care under one roof.",
  ...
  useEffect(() => {
    document.title = "HLC Ayurveda & Nature Cure Hospital | Best Ayurvedic Hospital in Bangalore";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Book a consultation at HLC Ayurveda & Nature Cure Hospital in Electronic City, Bangalore. Specializing in diabetes reversal, weight loss, and postnatal care.");
  ...
  return (
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>HLC Ayurveda & Nature Cure Hospital</h1>
                <p className="text-xl mb-4 opacity-90">Holistic Ayurveda and Naturopathy Center</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Bingipura, Electronic City Phase 1, Bengaluru</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.4</span>
                  <span className="opacity-90">(180)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] leading-tight md:leading-[1.1] max-w-4xl mx-auto px-2">
                Discover Authentic Healing <br className="hidden lg:block" />
                at HLC Ayurveda & Nature Cure Hospital
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-lg md:text-xl leading-relaxed text-foreground/80 text-justify md:text-left" style={{ color: "#7F543D" }}>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/12.JPG" 
                          alt="HLC Ayurveda & Nature Cure Hospital Exterior"
                          className="w-full h-full object-cover"
                          onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/12.JPG"; }}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <p>
                    Under the expert guidance of renowned specialists—including Dr. D. Jaya Prakash (BNYS, MD in Acupuncture, MBA in Health Administration), Dr. C. Krishnasree (BAMS, MBA), and Dr. Sateesha (BAMS, MD, Molecular Biology researcher)—HLC has successfully treated over 70,000 happy patients. With a fully equipped 12,000 square feet Med Spa offering 8 classical styles and 50+ restorative procedures, alongside 19 luxury cottages for overnight stays, our hospital specializes in holistic Diabetes Reversal, obesity management, postnatal care, and neuromusculoskeletal rehabilitation. Experience compassionate, research-backed therapies supported by AYUSH insurance reimbursement to restore your long-term health and vitality.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/HLCAyurvedaAndNatureCureHospital/main.webp" 
                      alt="HLC Ayurveda & Nature Cure Hospital Campus"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/HLCAyurvedaAndNatureCureHospital/secondary.webp" 
                        alt="HLC Med Spa Therapy Session"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/12.JPG"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with HLC Ayurveda & Nature Cure Hospital today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at HLC Ayurveda & Nature Cure Hospital</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose HLC Ayurveda & Nature Cure Hospital</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience natural, research-backed healing supported by dedicated medical professionals on a serene wellness resort.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Your Healing Journey at HLC</h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A structured, evidence-based approach integrating Ayurveda, Yoga, and Naturopathy to activate your body's self-healing.
            </p>
          </div>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/12.JPG"
                  alt="HLC Ayurveda & Nature Cure Hospital"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/12.JPG"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at HLC Ayurveda & Nature Cure Hospital?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at HLC Ayurveda & Nature Cure Hospital?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at HLC Ayurveda & Nature Cure Hospital.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      HLC Ayurveda & Nature Cure Hospital<br />
                      #228/4, S. Bingipura, Electronic City Phase 1<br />
                      Bengaluru, Karnataka
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1" style={{ color: "#7F543D" }}>
                      ...
                      <li>• Approx. 6 km from Heelalige Railway Station (HLE)</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62232.86289089537!2d77.58001887328061!3d12.872062333000734!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae6b7aec42a165%3A0x78ac0b15407b12be!2sHLC%20Ayurveda%20and%20Nature%20Cure%20Hospital!5e0!3m2!1sen!2sin!4v1779688931950!5m2!1sen!2sin"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="HLC Ayurveda and Nature Cure Hospital Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/HLCAyurvedaAndNatureCureHospital/main.webp"
            alt="Ayurvedic Therapy at HLC Ayurveda"
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a free consultation. Our doctors will guide you towards the perfect treatment program at HLC Ayurveda.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/918008897700?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20HLC%20Ayurveda."
              target="_blank"
              rel="noreferrer"
