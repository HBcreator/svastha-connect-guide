...
export default function JayadevMemorialRashtrotthanaHospitalAyurvedaDepartment() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Thorough evaluation by Dr. Venkatesh H.S. and team, integrating modern diagnostics with traditional Nadi Pariksha.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Integrative Care Plan",
      description: "A customized treatment regimen harmonizing Ayurvedic therapies, allopathic support (if needed), and dietary adjustments.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Root-Cause Interventions",
      description: "Implementation of specialized therapies like Panchakarma, Nasya, or Virechana for deep, systemic healing.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Multidisciplinary Support",
      description: "Access to a 162-bed hospital infrastructure, ensuring comprehensive care for conditions like Thyroid or Metabolic disorders.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Holistic Rehabilitation",
      description: "Recovery focused on cellular repair, immunity enhancement, and vitality using Rasayana protocols and Yoga.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Sustained Well-being",
      description: "Ongoing lifestyle tracking and regular follow-ups to support metabolic, digestive, and overall well-being.",
  ...
  const testimonials = [
    {
      title: "Comprehensive Care Setup",
      review: "Being treated in an Ayurveda department made me feel really reassured from the beginning. Dr. Venkatesh took the time to understand my metabolic and gut health issues in depth, and his approach felt both thoughtful and personalized.",
      name: "David Sterling",
      verified: true,
      location: "London, UK",
      condition: "Metabolic & Gut Health",
      rating: 5
    },
    {
      title: "Exceptional Postnatal Support",
      review: "The Mathrubhava program is truly a blessing. The holistic support for both me and my newborn was outstanding, bridging the best of modern maternity care with Ayurvedic recovery.",
      name: "Sarah Connors",
      verified: true,
      location: "Sydney, Australia",
      condition: "Postnatal Care (Mathrubhava)",
      rating: 5
    },
    {
      title: "Effective Thyroid Management",
      review: "I had been struggling with thyroid imbalances for years. The specialized regimens and dietary changes prescribed here have brought my levels back to normal without heavy medications.",
      name: "Emma Richards",
      verified: true,
    ...
    {
      title: "Life-changing Panchakarma",
      review: "The detox process was rigorous yet deeply healing. The facilities in RR Nagar are pristine, and the therapists are extremely knowledgeable. My arthritis pain has reduced significantly.",
      name: "Robert Hughes",
      verified: true,
      location: "Boston, USA",
    ...
    {
      title: "Fantastic Respiratory Relief",
      review: "The Nasya treatments for my chronic sinusitis were highly effective. The entire team, especially Dr. Kavya, provided compassionate care that targeted the root cause of my migraines.",
      name: "Michael Chen",
      verified: true,
      location: "San Francisco, USA",
      condition: "Sinusitis & Migraines",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "Is the Ayurveda Department part of the main Rashtrotthana Hospital?",
      answer: "Yes, our Ayurveda Department is fully integrated within the 162-bed multi-specialty Rashtrotthana Hospital, allowing patients access to modern diagnostics and comprehensive medical support alongside traditional therapies."
    },
    {
      question: "What is the Mathrubhava program?",
      answer: "Mathrubhava is our specialized holistic postnatal care program. It provides structured Ayurvedic regimens, dietary support, and therapeutic massages to aid the recovery of new mothers and ensure the well-being of their babies."
    },
    {
      question: "Do you offer authentic Panchakarma detoxification?",
      answer: "Yes, we offer comprehensive Panchakarma therapies. Our expert team administers targeted detox treatments like Virechana and Nasya in a highly hygienic, hospital-grade environment."
    },
    {
      question: "Can I consult for chronic lifestyle disorders like Thyroid or Metabolic issues?",
      answer: "Absolutely. We have dedicated programs for managing metabolic disorders, gut health issues, and thyroid imbalances through personalized Ayurvedic treatments, diet plans, and lifestyle modifications."
    },
    {
      question: "How do I book an appointment with Dr. Venkatesh H.S. or Dr. Kavya N.?",
      answer: "You can book an appointment with our expert Ayurvedic specialists by calling our reception or by scheduling a consultation through this website."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Authentic therapeutic detoxification programs designed to cleanse the body of accumulated toxins and restore systemic balance.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Mathrubhava (Postnatal Care)",
      description: "A holistic program dedicated to new mothers, offering tailored dietary advice, herbal therapies, and support for maternal recovery.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Thyroid & Hormonal Care",
      description: "Specialized Ayurvedic protocols aimed at managing thyroid disorders and hormonal imbalances through natural, root-cause interventions.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Metabolic & Gut Health",
      description: "Targeted treatments addressing metabolic syndrome, chronic digestive issues, and related skin and autoimmune conditions.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Respiratory Care (Nasya)",
      description: "Therapeutic nasal administrations specifically designed for managing sinusitis, chronic migraines, and respiratory allergies.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Spine & Joint Management",
      description: "Integrative therapies to alleviate arthritis, back pain, and musculoskeletal conditions, promoting mobility and structural health.",
  ...
  const whyChooseUs = [
    {
      ...
      description: "Access world-class infrastructure, modern diagnostics, and emergency care right alongside traditional Ayurvedic healing.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "True Integrative Medicine",
      description: "We seamlessly blend the wisdom of classical Ayurveda with modern allopathic expertise for superior patient outcomes.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Expert Ayurvedic Doctors",
      description: "Our department is led by highly qualified specialists like Dr. Venkatesh H.S. and Dr. Kavya N., ensuring authentic care.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Mathrubhava Program",
      description: "Our signature holistic postnatal care initiative offers unparalleled support for both mother and newborn.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Comprehensive Therapies",
      description: "From Panchakarma to specialized management of Thyroid and Metabolic disorders, we address the root cause of illnesses.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Prime RR Nagar Location",
      description: "Conveniently situated in Rajarajeshwari Nagar with state-of-the-art facilities and a healing, patient-centric environment.",
  ...
  useEffect(() => {
    document.title = "Jayadev Memorial Rashtrotthana Hospital Ayurveda | Top Ayurvedic Clinic in Bangalore";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Book an Ayurvedic consultation at Rashtrotthana Hospital in RR Nagar, Bangalore. Multi-specialty center offering Panchakarma, Thyroid Care, and Mathrubhava program.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Jayadev Memorial Rashtrotthana Hospital</h1>
                <p className="text-xl mb-4 opacity-90">Ayurvedic Treatment Department</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Rajarajeshwari Nagar, BEML 5th Stage, Bengaluru</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.7</span>
                  <span className="opacity-90">(1490 reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Jayadev Memorial Rashtrotthana Hospital
</h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                    ...
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          ...
                          alt="Jayadev Memorial Rashtrotthana Hospital Ayurveda"
                  ...
                  <p>
                    Known for comprehensive healing, our department specializes in rigorous Panchakarma detoxification, specialized Thyroid Care, the Mathrubhava postnatal program, and treatments for metabolic and gut health. Patients benefit from the supervision of highly experienced doctors like Dr. Venkatesh H.S. and Dr. Kavya N., alongside our supportive therapies like Yoga and Naturopathy. At Rashtrotthana Hospital, we provide an environment of absolute hygiene, compassion, and professional medical backing, making it a safe haven for profound rejuvenation and recovery.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Jayadev Memorial - Rashtrotthana Hospital Ayurveda Dept/main.webp" 
                      alt="Jayadev Memorial Rashtrotthana Hospital Exterior"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP centers/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Jayadev Memorial - Rashtrotthana Hospital Ayurveda Dept/secondary.webp" 
                        alt="Jayadev Memorial Rashtrotthana Hospital Treatment"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Rashtrotthana Hospital today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Jayadev Memorial Rashtrotthana Hospital
</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Jayadev Memorial Rashtrotthana Hospital
</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience authentic healing backed by the complete infrastructure of a modern multi-specialty hospital.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Jayadev Memorial Rashtrotthana Hospital
</h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"
                  alt="Jayadev Memorial Rashtrotthana Hospital"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Rashtrotthana Hospital?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Rashtrotthana Hospital?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at Rashtrotthana Hospital.</p>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Jayadev Memorial Rashtrotthana Hospital<br />
                      BEML 5th Stage, Rajarajeshwari Nagar (RR Nagar)<br />
                      Bengaluru
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1" style={{ color: "#7F543D" }}>
                      <li>• Approx. 44 km from Kempegowda International Airport (BLR)</li>
                      <li>• Approx. 11 km from KSR Bengaluru Railway Station</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  ...
                  title="Jayadev Memorial Rashtrotthana Hospital Location"
                ></iframe>
              </div>
            </div>
          </div>
