...
export default function KevaAyurvedaBMTLayout() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Thorough evaluation combining modern diagnostics and classical Ayurvedic principles by our expert physicians.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Integrative Treatment Plan",
      description: "A tailored protocol mapping out Ayurvedic therapies, diet, and lifestyle modifications.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Systemic Detoxification",
      description: "Authentic Panchakarma therapies administered in a controlled, hygienic environment.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Condition-Specific Care",
      description: "Targeted interventions like weight management or women's care customized to your precise needs.",
  ...
  const testimonials = [
    {
      title: "Incredible Rejuvenation",
      review: "The Tejomayi Therapy completely transformed my skin. The staff was incredibly welcoming, and the authentic Ayurvedic approach was truly a refreshing experience after a long flight.",
      name: "Emily Carter",
      verified: true,
      location: "New York, USA",
      condition: "Skin Care & Rejuvenation",
      rating: 5
    },
    {
      title: "Exceptional Joint Care",
      review: "I tried the Sandhirujahara Therapy for my chronic joint stiffness. The Choorna Swedam was fantastic, and I felt immediate relief. Highly recommend Keva Ayurveda to anyone visiting Bengaluru.",
    ...
    {
      title: "The Best Detox Experience",
      review: "As a frequent traveler, the Traveller's Detoxification package was exactly what I needed. The whole facility is pristine and the Shirodhara treatment melted all my stress away.",
      name: "Sarah Jenkins",
      verified: true,
      location: "London, UK",
      condition: "Traveller's Fatigue",
      rating: 5
    },
    {
      title: "True Holistic Healing",
      review: "Keva Ayurveda is a gem. I took part in their corporate wellness program to combat burnout. The personalized care and expert therapists helped me find my balance again.",
      name: "James Bennett",
      verified: true,
    ...
    {
      title: "Wonderful Maternity Care",
      review: "I underwent the Pre & Post Natal Care program here. The customized diet and herbal massages provided me with immense strength and relaxation during a crucial time. Highly grateful!",
      name: "Olivia Mitchell",
      verified: true,
      location: "Seattle, USA",
      condition: "Pre & Post Natal Care",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "What are the operating hours of Keva Ayurveda in BTM Layout?",
      answer: "Keva Ayurveda, BTM Layout is open seven days a week to ensure convenient access to Ayurvedic consultations and treatments. Our clinic operates daily from 8:00 AM to 8:00 PM. We recommend booking an appointment in advance for a smooth and hassle-free experience."
    },  
    {
      question: "Do you accept medical insurance for Ayurvedic treatments?",
      answer: "Yes, Keva Ayurveda accepts medical insurance for various treatments. Please consult our front desk with your policy details for cashless facilities or reimbursement processes."
    },
    {
      question: "Is Keva Ayurveda accredited?",
      answer: "Yes, Keva Ayurveda is an ISO and NABH accredited healthcare center, ensuring the highest standards of quality and safety in our treatments."
    },
    {
      question: "Do you offer specialized packages for IT professionals?",
      answer: "Absolutely. We offer specialized corporate wellness programs, stress management, and traveler's detox packages specifically designed for modern lifestyle issues."
    },
    {
      question: "What conditions do you specialize in?",
      answer: "We offer a wide spectrum of treatments including Weight Management, Panchakarma, Infertility, Paralysis, Women's Care, Acne/Pimples, Hair fall, and Spine & Joint care."
    }
  ];

  const programs = [
    {
      title: "Tejomayi Therapy",
      description: "A royal therapy combining Abhyangam, Lepam, and Snanam to improve complexion, remove dead skin, and make the skin glow.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Ayurvardhini Therapy",
      description: "Strengthens natural immunity, revitalises energy levels, and promotes balance between body and mind through Abhyangam and Shirodhara.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Sandhirujahara Therapy",
      description: "Specialized treatment utilizing Choorna Swedam and targeted massages to cure aches and stiffness of joints.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Pre & Post Natal Care",
      description: "Comprehensive care maintaining a woman's health during and after pregnancy with natural herbal medicines and special diet.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Corporate Wellness Programme",
      description: "De-stressing massages, Shiroabhyangam, and Swedam to help professionals combat stress and restore harmony.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Traveller's Detoxification",
      description: "A special detoxification treatment involving Basti and relaxing massages to refresh a tired, travel-weary body.",
  ...
  const whyChooseUs = [
    {
      title: "NABH & ISO Accredited",
      description: "Recognized for maintaining the highest standards of quality, safety, and hygiene in healthcare.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Insurance Accepted",
      description: "We make Ayurvedic healthcare accessible by accepting various medical insurance policies.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Expert Practitioners",
      description: "Our team is made up of seasoned Ayurvedic practitioners with extensive experience in holistic wellness.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Integrative Approach",
      description: "We uniquely integrate classical Ayurveda with Yoga and Naturopathy for complete wellness.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Specialized Programs",
      description: "From corporate wellness to geriatric care, our packages are tailored to modern lifestyle needs.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Convenient Location",
      description: "Situated in the heart of BTM Layout with flexible timings from 8 AM to 8 PM, all days a week.",
  ...
  useEffect(() => {
    document.title = "Keva Ayurveda - BTM Layout | Top Ayurvedic Clinic in Bangalore";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Book a consultation at Keva Ayurveda in BTM Layout, Bangalore. ISO & NABH accredited center offering Panchakarma, weight management, and women's care.");
  ...
  return (
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Keva Ayurveda - BTM Layout</h1>
                <p className="text-xl mb-4 opacity-90">Best Bangalore Ayurveda Clinic</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">KAS Officers Colony, BTM 2nd Stage, Bengaluru</span>
                </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-lg md:text-xl leading-relaxed text-foreground/80 text-justify md:text-left" style={{ color: "#7F543D" }}>
                  ...
                  <p>
                    Known for its patient-centered approach, Keva Ayurveda offers therapies for a variety of lifestyle and wellness concerns, including rejuvenation and detox programs. The center has earned recognition for its commitment to authentic Ayurvedic care and continues to make wellness treatments accessible in a comfortable and professional environment. With an emphasis on natural healing and long-term wellness, the clinic aims to create treatment experiences that feel both effective and comforting. Patients also benefit from a calm and supportive atmosphere designed to encourage relaxation, recovery, and overall wellness.
                  </p>
                </div>
              </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Keva Ayurveda today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at Keva Ayurveda</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Keva Ayurveda</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience authentic healing with certified professionals, complete transparency, and insurance support.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Your Healing Journey at Keva Ayurveda</h2>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  ...
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Keva Ayurveda?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Keva Ayurveda?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at Keva Ayurveda.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Keva Ayurveda<br />
                      28, 5th Cross, 35th Main, KAS Officers Colony<br />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1" style={{ color: "#7F543D" }}>
                      ...
                      <li>• Approx. 11 km from KSR Bengaluru City Railway Station</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.897893494202!2d77.61835409999999!3d12.914283699999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae14fa6e632447%3A0x55162671a7403972!2sKeva%20Ayurveda%20BTM%20-%20Best%20Ayurveda%20Clinic%20Bangalore!5e0!3m2!1sen!2sin!4v1779568947874!5m2!1sen!2sin" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Keva Ayurveda BTM Layout Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a free consultation. Our doctors will guide you towards the perfect treatment program at Keva Ayurveda.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/918050080058?text=Hi%2C%20I%20want%20to%20book%20a%20free%20consultation%20with%20Keva%20Ayurveda."
              target="_blank"
              rel="noreferrer"
