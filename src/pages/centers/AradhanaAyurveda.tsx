...
export default function AradhanaAyurveda() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Comprehensive pulse diagnosis and consultation to understand your unique body constitution and the root cause of ailments.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Individualized Treatment Plan",
      description: "Designing a highly personalized therapy schedule targeting chronic conditions like arthritis or hormonal imbalances.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Purvakarma Therapies",
      description: "Preparing your body for detoxification using authentic medicated oils, Abhyanga, and steam therapies to loosen deep-seated toxins.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Classical Panchakarma",
      description: "Executing deep cleansing procedures such as Basti, Virechana, or Nasya using traditional methods for systemic relief.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Specialized Local Therapies",
      description: "Integrating targeted treatments like Kati Basti for back pain or Shirodhara for stress and neurological conditions.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Post-Treatment Care",
      description: "Providing rejuvenating herbal medicines and a customized lifestyle and diet blueprint to sustain your recovery.",
  ...
  const testimonials = [
    {
      title: "Incredible Chronic Pain Relief",
      review: "The specialized Panchakarma therapies at Aradhana Ayurveda drastically improved my mobility. Traveling from London for their authentic Kati Basti was the best decision for my back pain.",
      name: "Lucas F.",
      verified: true,
      location: "London, UK",
      condition: "Arthritis & Back Pain",
      rating: 5
    },
    {
      title: "Hormonal Balance Restored",
      review: "The individualized approach to hormonal health here is exceptional. The expert Vaidyas and natural treatments helped me regain balance without relying on synthetic medications.",
      name: "Amelia H.",
      verified: true,
    ...
    {
      title: "Deep Digestive Healing",
      review: "I suffered from chronic digestive issues for years. The classical detoxification programs at Aradhana cleansed my system completely. Their personalized diet protocols are incredibly effective.",
      name: "Benjamin J.",
      verified: true,
    ...
    {
      title: "Complete Stress Management",
      review: "The Shirodhara and Abhyanga therapies provided profound relief from my chronic stress and insomnia. It is a true sanctuary of traditional healing with a perfect atmosphere.",
      name: "Charlotte O.",
      verified: true,
    ...
    {
      title: "Effective Natural Skin Care",
      review: "The blood purification therapies transformed my skin health. The doctors took the time to understand my Prakriti, offering treatments that finally resolved my persistent eczema.",
      name: "Henry G.",
      verified: true,
      location: "Dubai, UAE",
  ...
  const faqItems = [
    {
      question: "What specific conditions does Aradhana Ayurveda treat?",
      answer: "We specialize in treating joint and bone-related issues, digestive health, hormonal imbalances, infertility, skin conditions, stress, and obesity."
    },
    {
      question: "Are your Panchakarma therapies authentic?",
      answer: "Yes, we strictly follow classical Ayurvedic principles to deliver highly authentic and individualized Panchakarma programs, including Abhyanga, Shirodhara, Nasya, and Basti."
    },
    {
      question: "Where is the clinic located?",
      answer: "Aradhana Ayurveda Clinic & Panchakarma Center is a renowned clinic located in Mumbai."
    },
    {
      question: "Who will be designing my treatment plan?",
      answer: "Your personalized treatment plan will be designed by our trained and highly qualified Ayurvedic physicians after a comprehensive Prakriti-based consultation."
    },
    {
      question: "Do you offer targeted pain management?",
      answer: "Absolutely. We offer specialized local therapies like Kati Basti and Janu Basti, which are highly effective for managing chronic back, knee, and shoulder pain."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Targeted Ayurvedic pain management for arthritis, cervical spondylosis, and back pain using specialized therapies like Kati Basti.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Classical Panchakarma",
      description: "Individualized detoxification programs designed to cleanse the body of deep-seated toxins and restore natural metabolic balance.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Women's Health",
      description: "Holistic treatments to address hormonal imbalances, infertility, and gynecological issues through customized diet and therapies.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Digestive Wellness",
      description: "Effective natural protocols for managing chronic indigestion, acidity, IBS, and restoring optimal gut health.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stress & Mind Care",
      description: "Deeply relaxing therapies including Shirodhara and Abhyanga to combat chronic stress, anxiety, and sleep disorders.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Dermatology",
      description: "Comprehensive blood purification and external applications to naturally treat eczema, psoriasis, and recurrent allergies.",
  ...
  const whyChooseUs = [
    {
      title: "Prakriti-Based Care",
      description: "Every treatment plan is strictly individualized based on a thorough analysis of your unique body constitution.",
      icon: <FileSearch className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Classical Authenticity",
      description: "We are committed to delivering traditional Ayurvedic therapies without compromising on classical methods or ingredients.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Expert Physicians",
      description: "Our clinic is staffed by highly trained and experienced Ayurvedic doctors dedicated to treating chronic lifestyle ailments.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Specialized Pain Relief",
      description: "Renowned for our high success rates in managing complex joint, bone, and spine-related issues naturally.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Patient-Focused Approach",
      description: "We blend clinical expertise with the warmth of traditional healing, ensuring a comfortable and supportive environment.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "High Success Rate",
      description: "A standout choice for patients seeking genuine, deeply personalized Ayurvedic attention with exceptional therapeutic outcomes.",
  ...
  useEffect(() => {
    document.title = "Aradhana Ayurveda Clinic & Panchakarma Center | Authentic Care";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience personalized Ayurvedic treatments and Panchakarma at Aradhana Ayurveda Clinic & Panchakarma Center in Mumbai.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Aradhana Ayurveda Clinic & Panchakarma Center Mumbai
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Aradhana Ayurveda Clinic <br className="hidden md:block" /> & Panchakarma Center</h1>
                <p className="text-xl mb-4 opacity-90">Mumbai's Boutique Destination for Exceptional Ayurvedic Care</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="opacity-90">(13 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Aradhana Ayurveda Clinic & Panchakarma Center
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Aradhana Ayurveda Clinic & Panchakarma Center</strong>, a boutique and highly respected Ayurvedic sanctuary located in Mumbai. Our clinic offers personalized classical treatments tailored for chronic and lifestyle conditions. With a perfect 5.0 Google rating, we pride ourselves on exceptional patient care and delivering outstanding therapeutic outcomes in a serene, private environment.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/Aradhana Ayurveda Clinic & Panchakarma Center/image 2.webp" 
                          alt="Aradhana Ayurveda therapy room"
                          className="w-full h-full object-cover"
                          onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/15.webp"; }}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <p>
                    Our healing philosophy centers on deep, individualized attention. Led by qualified BAMS physicians, our center specializes in chronic pain, digestive health, skin conditions, infertility, and hormonal imbalances. We offer personalized Ayurvedic consultations, customized Panchakarma programs, herbal treatments, and holistic lifestyle guidance. It is a standout choice for patients seeking genuine, deeply personalized Ayurvedic care.
                  </p>
                  <p>
                    Every treatment at Aradhana Ayurveda is crafted using the finest, authentically sourced herbal ingredients, ensuring the highest standards of safety and efficacy. Our dedicated team is committed to creating a supportive, compassionate environment that nurtures your physical, mental, and spiritual well-being throughout your entire healing journey.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/Aradhana Ayurveda Clinic & Panchakarma Center/image 1.webp" 
                      alt="Aradhana Ayurveda main view"
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Aradhana Ayurveda today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Aradhana Ayurveda Clinic & Panchakarma Center
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Aradhana Ayurveda Clinic & Panchakarma Center
              </h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience world-class traditional healthcare with a boutique approach, authentic medicines, and highly personalized care.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Aradhana Ayurveda Clinic & Panchakarma Center
            </h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/Aradhana Ayurveda Clinic & Panchakarma Center/image 1.webp"
                  alt="Aradhana Ayurveda view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/15.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Aradhana Ayurveda?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Aradhana Ayurveda?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and specialties at Aradhana Ayurveda.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Aradhana Ayurveda Clinic & Panchakarma Center<br />
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Centrally located clinic for personalized care.</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Easily accessible from major transit hubs.</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=Aradhana+Ayurveda+Clinic,+Pune&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Aradhana Ayurveda Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or therapy program at Aradhana Ayurveda Clinic & Panchakarma Center.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/9198xxxxxxxx?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Aradhana%20Ayurveda."
              target="_blank"
              rel="noreferrer"
