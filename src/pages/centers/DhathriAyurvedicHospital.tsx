...
export default function DhathriAyurvedicHospital() {
  ...
  useEffect(() => {
    fetch("/Center Videos/Dhathri Ayurveda Resort/YT i frame testimonies.txt")
      .then((res) => res.text())
      .then((text) => {
      ...
      .catch((err) => console.error("Error loading Dhathri testimonials:", err));
  }, []);
  ...
  useEffect(() => {
    fetch("/Center Images/Dhathri Ayurveda Resort/Photo Gallery/Photo Gallery Links.txt")
      .then((res) => res.text())
      .then((text) => {
  ...
  useEffect(() => {
    fetch("/Center Videos/Dhathri Ayurveda Resort/video links.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim()).filter(Boolean);
        setVideos(lines);
      ...
      .catch((err) => console.error("Error loading Dhathri videos:", err));
  }, []);
    ...
    <div className="min-h-screen bg-background overflow-x-hidden font-poppins">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              DHATHRI AYURVEDA HOSPITAL KERALA
            </li>
          </ol>
        </div>
      </nav>
      ...
      <div id="gallery" className="container mx-auto px-3 md:px-4 pt-12 pb-2 max-w-full">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12" id="videos">
            <div className="text-center mb-10">
              <h2 className="text-2xl md:text-4xl font-bold text-primary mb-3">
                Video Gallery of Dhathri Ayurveda Resort
              </h2>
              <p className="text-base md:text-lg mx-auto px-4 max-w-4xl" style={{ color: "#7F543D" }}>
                Experience the serene atmosphere and holistic healing journey at Dhathri Ayurveda Resort through our video gallery.
              </p>
            </div>
          ...
          {/* Testimonials of Dhathri Ayurvedic Hospital - Video Section */}
          <div className="mb-12" id="testimonial-videos" ref={testimonialSectionRef}>
            <div className="text-center mb-8 md:mb-10 px-4">
              <h2 className="text-xl md:text-4xl font-extrabold text-primary mb-2 leading-tight tracking-tight">
                Testimonials of Dhathri Ayurvedic Hospital
              </h2>
                  ...
                  <div className="aspect-video w-full relative">
                    {testimonialVideos.length > 0 && (
                      <iframe
                        ...
                        title="Dhathri Testimonial Video"
          ...
          {/* Awards & Recognition */}
          <div id="awards" className="mb-16 md:mb-24 px-4 overflow-hidden">
            <div className="text-center mb-8 md:mb-12">
          ...
          {contactAddress.length > 0 && (
            <Card id="contact" className="mb-12 border-2 border-primary overflow-hidden">
              <CardContent className="p-8">
