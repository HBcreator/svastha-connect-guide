...
import { MapPin, Star, Calendar, ChevronLeft, ChevronRight, Images, Video, X, Users, Heart, TrendingUp, Droplet, Brain, Sparkles, Activity, HeartPulse, ShieldCheck, UserCheck, Stethoscope, Pill, Award, Hospital, Leaf, Home, FileSearch } from "lucide-react";
...
export default function DhathriAyurvedicHospital() {
  ...
  const medicalIconForTitle = (t: string) => {
    ...
    if (s.includes("arthritis") || s.includes("pain") || s.includes("joint") || s.includes("spondylosis") || s.includes("shoulder")) return <HeartPulse className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />;
    ...
    if (s.includes("lifestyle")) return <Activity className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />;
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12">
            <div className="text-center mb-10">
              <h2 className="text-xl md:text-4xl font-bold text-primary mb-3">Why Choose Dhathri Ayurveda Hospital for Your Healing Journey</h2>
