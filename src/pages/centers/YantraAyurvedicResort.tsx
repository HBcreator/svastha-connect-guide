...
export default function YantraAyurvedicResort() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "An initial in-depth check-up and physical evaluation by experienced Ayurvedic doctors to diagnose body constitution (prakriti) and specific dosha imbalances.",
  ...
  const testimonials = [
    ...
    },
    {
      ...
      condition: "Rejuvenation & Sleep Care",
      rating: 5
    },
    {
      ...
      condition: "Chronic Back Pain & Spine Care",
      rating: 5
    },
    {
    ...
    },
    {
      ...
      condition: "Eczema & Skin Rejuvenation",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "What makes Yantra Ayurvedic Resort in Nattika unique?",
      answer: "Yantra Ayurvedic Resort is a serene coastal wellness destination set directly on golden-sand Nattika Beach, Thrissur, Kerala. We blend authentic classical Ayurvedic treatments and experienced physician consultations with a relaxing beach holiday experience, featuring traditional cottages and sea-view organic dining."
    },
    {
      question: "How are the Ayurvedic treatments personalized for guests?",
      answer: "Every guest undergoes a detailed personal consultation with our panel of experienced Ayurvedic doctors upon arrival. The doctors evaluate your body constitution (prakriti), detect specific dosha imbalances, and design a customized therapy schedule, herbal medicines, and dietary plan."
    },
    {
      question: "What are the primary packages and treatments available?",
      answer: "We specialize in authentic Classical Panchakarma (body purification and detoxification), Coastal Rejuvenation (Rasayana), Stress Reset & Yoga, Weight Management (incorporating Udwarthanam and custom diets), and targeted treatments for Spine & Joint Wellness."
    },
    {
      question: "What type of accommodation and facilities are offered?",
      answer: "The resort offers traditional Kerala-style cottages and beachfront viewing huts set within a green coastal garden. Other amenities include a restaurant serving healthy Ayurvedic vegetarian cuisine, beach huts, regular yoga/meditation sessions, and doctor-on-call services."
    },
    {
  ...
  const programs = [
    ...
    },
    {
      ...
      description: "Medicated synchronized massages and herbal steam therapies designed to rebuild bodily tissues, slow aging, and strengthen natural immunity.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stress Reset & Yoga",
    ...
    },
    {
      ...
      description: "Targeted oil retention therapies (Kati Vasti, Janu Vasti) and synchronized massages to relieve lower back pain, chronic stiffness, and arthritis.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Preventive Skin Care",
      description: "Detoxifying botanical body wraps and traditional herbal therapies formulated to address chronic skin dryness, eczema, and psoriasis.",
  ...
  const whyChooseUs = [
    {
      title: "Golden Nattika Beach Location",
      description: "Set directly along the golden sands of Nattika Beach, offering a soothing marine breeze and beachfront huts for sunrise/sunset viewing.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Physician-Guided Programs",
      description: "Every treatment regimen is customized, monitored, and guided by experienced Ayurvedic doctors and executed by trained therapists.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Traditional Kerala Cottages",
      description: "Stay in comfortable, eco-friendly traditional cottages set within a quiet, green garden landscape to facilitate complete recovery.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Sea-View Organic Dining",
      description: "Freshly prepared vegetarian meals tailored strictly to your Ayurvedic diet plan, served with beautiful ocean views.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Seaside Yoga & Meditation",
      description: "Regular guided yoga sessions, deep breathing practices, and meditation on the beach to support complete mental and physical well-being.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
  ...
  useEffect(() => {
    document.title = "Yantra Ayurvedic Resort | Beachside Wellness & Panchakarma in Thrissur, Kerala";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Book a consultation at Yantra Ayurvedic Resort on Nattika Beach, Thrissur. Discover authentic, doctor-guided Panchakarma, stress reset, weight loss, and yoga programs.");
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Yantra Ayurvedic Resort</h1>
                <p className="text-xl mb-4 opacity-90">Beachside Wellness Haven & Authentic Panchakarma Centre</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Nattika Beach, Thrissur, Kerala, India</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.1</span>
                  <span className="opacity-90">(520 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-lg md:text-xl leading-relaxed text-foreground/80 text-justify md:text-left" style={{ color: "#7F543D" }}>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP cneters/kerela/Yantra Ayurvedic Resort/secondary.jpeg" 
                          alt="Yantra Ayurvedic Resort"
                  ...
                  <p>
                    Every healing program at Yantra begins with a comprehensive, in-depth consultation with our panel of experienced Ayurvedic physicians to diagnose your body constitution and specific dosha imbalances. The resort features comfortable traditional cottages, beachfront huts for sunrise and sunset viewing, an Ayurvedic restaurant serving fresh meals customized to your dietary needs, a seaside yoga pavilion, and comprehensive documentation to facilitate cashless or reimbursement claims for AYUSH health insurance.
                  </p>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/kerela/Yantra Ayurvedic Resort/main.jpeg" 
                      alt="Yantra Ayurvedic Resort Exterior"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP cneters/kerela/Yantra Ayurvedic Resort/secondary.jpeg" 
                        alt="Therapy Chamber at Yantra Ayurvedic Resort"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Yantra Ayurvedic Resort today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at Yantra</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Yantra</h2>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  ...
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Yantra Ayurvedic Resort?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Yantra Ayurvedic Resort?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at Yantra Ayurvedic Resort.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Yantra Ayurvedic Beach Resort<br />
                      Nattika Beach, Nattika P.O.<br />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1.5" style={{ color: "#7F543D" }}>
                      <li>• Approx. 55 km from Cochin International Airport</li>
                      <li>• Approx. 25 km from Thrissur Railway Station</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3924.1193545021424!2d76.08404707503676!3d10.412094289715368!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba7f352df192159%3A0x8d1960b9b1aad5b0!2sYantra%20Ayurvedic%20Beach%20Resort!5e0!3m2!1sen!2sin!4v1779863398583!5m2!1sen!2sin"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Yantra Ayurvedic Resort Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment program at Yantra Ayurvedic Resort.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919995125000?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Yantra%20Ayurvedic%20Resort."
              target="_blank"
              rel="noreferrer"
