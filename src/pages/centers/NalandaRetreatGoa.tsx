...
const iconForTitle = (t: string) => {
  ...
  if (s.includes("beach") || s.includes("ocean") || s.includes("sea")) return <MapPin className="h-6 w-6 text-primary group-hover:text-white transition-colors" />;
  if (s.includes("ayurveda") || s.includes("physician")) return <Stethoscope className="h-6 w-6 text-primary group-hover:text-white transition-colors" />;
  if (s.includes("yoga") || s.includes("school")) return <Star className="h-6 w-6 text-primary group-hover:text-white transition-colors" />;
  if (s.includes("personal") || s.includes("custom") || s.includes("journey")) return <HeartPulse className="h-6 w-6 text-primary group-hover:text-white transition-colors" />;
  if (s.includes("community") || s.includes("support")) return <Users className="h-6 w-6 text-primary group-hover:text-white transition-colors" />;
  if (s.includes("mind-body") || s.includes("holistic")) return <Brain className="h-6 w-6 text-primary group-hover:text-white transition-colors" />;
  if (s.includes("cuisine") || s.includes("sattvic") || s.includes("food")) return <Leaf className="h-6 w-6 text-primary group-hover:text-white transition-colors" />;
  if (s.includes("learning") || s.includes("education")) return <Sparkles className="h-6 w-6 text-primary group-hover:text-white transition-colors" />;
  if (s.includes("accommodation") || s.includes("rooms") || s.includes("cottages")) return <Home className="h-6 w-6 text-primary group-hover:text-white transition-colors" />;
  return <Heart className="h-6 w-6 text-primary group-hover:text-white transition-colors" />;
};

const treatmentIconForTitle = (t: string) => {
  const s = t.toLowerCase();
  if (s.includes("consultation") || s.includes("assessment") || s.includes("arrival")) return <ClipboardList className="h-5 w-5 md:h-6 md:w-6 text-primary" />;
  if (s.includes("plan") || s.includes("blueprint") || s.includes("protocol")) return <FileSearch className="h-5 w-5 md:h-6 md:w-6 text-primary" />;
  if (s.includes("therapy") || s.includes("treatment")) return <Pill className="h-5 w-5 md:h-6 md:w-6 text-primary" />;
  if (s.includes("cuisine") || s.includes("diet") || s.includes("meal")) return <Utensils className="h-5 w-5 md:h-6 md:w-6 text-primary" />;
  if (s.includes("yoga") || s.includes("review")) return <Activity className="h-5 w-5 md:h-6 md:w-6 text-primary" />;
  if (s.includes("departure") || s.includes("home") || s.includes("knowledge")) return <Home className="h-5 w-5 md:h-6 md:w-6 text-primary" />;
      ...
      : t.includes("room") || t.includes("accommodation") || t.includes("cottage") ? <Building2 className="h-7 w-7 text-white" />
        : t.includes("restaurant") || t.includes("dining") || t.includes("cuisine") ? <Utensils className="h-7 w-7 text-white" />
          : t.includes("pool") || t.includes("swimming") ? <Activity className="h-7 w-7 text-white" />
            : t.includes("beach") || t.includes("access") ? <MapPin className="h-7 w-7 text-white" />
              : t.includes("library") || t.includes("reading") ? <Globe className="h-7 w-7 text-white" />
                : t.includes("garden") || t.includes("tropical") ? <TreePine className="h-7 w-7 text-white" />
                  : t.includes("service") || t.includes("wifi") || t.includes("front desk") ? <ShieldCheck className="h-7 w-7 text-white" />
                    : <ShieldCheck className="h-7 w-7 text-white" />;
};

const renderInlineBlueBold = (text: string) => {
...
const wellnessIconForTitle = (t: string) => {
  const s = t.toLowerCase();
  if (s.includes("detox") || s.includes("cleanse") || s.includes("panchakarma")) {
    return <Sparkles className="h-4 w-4 md:h-5 md:w-5 text-green-600" />;
  }
  if (s.includes("stress") || s.includes("relax") || s.includes("calm") || s.includes("sleep")) {
    return <Heart className="h-4 w-4 md:h-5 md:w-5 text-green-600" />;
  }
  if (s.includes("yoga") || s.includes("meditation") || s.includes("mind")) {
    return <Sparkles className="h-4 w-4 md:h-5 md:w-5 text-green-600" />;
  }
  if (s.includes("immunity")) {
    return <ShieldCheck className="h-4 w-4 md:h-5 md:w-5 text-green-600" />;
  }
  if (s.includes("weight") || s.includes("fitness")) {
    return <Activity className="h-4 w-4 md:h-5 md:w-5 text-green-600" />;
  }
  if (s.includes("nature") || s.includes("garden") || s.includes("herbal")) {
...
const medicalIconForTitle = (t: string) => {
  const s = t.toLowerCase();
  if (s.includes("detox") || s.includes("panchakarma")) return <Sparkles className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />;
  if (s.includes("weight")) return <Activity className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />;
  if (s.includes("diabetes") || s.includes("hypertension") || s.includes("cholesterol")) {
    return <TrendingUp className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />;
  }
  if (s.includes("joint") || s.includes("pain") || s.includes("spinal") || s.includes("arthritis")) {
    return <HeartPulse className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />;
  }
  if (s.includes("stress") || s.includes("mental") || s.includes("sleep")) {
  ...
  if (s.includes("respiratory") || s.includes("allergy") || s.includes("asthma")) {
...
const NalandaRetreatGoa = () => {
  ...
  const founderImage = "/Center Images/Nalanda Retreat Goa/Founder/Founder.png";
  const teamImage = "/Center Images/Nalanda Retreat Goa/Founder/team.jpg";
  ...
  const awards = [
    {
      title: "Government of India Incorporation",
      description: "Certificates of incorporation in India are issued under the Registrar of Companies with a Government Seal.",
      image: "/Center Images/Nalanda Retreat Goa/Awards/award 2 (Government Recognized Diploma).png",
    },
    {
      title: "NABH Accredited",
      description: "NABH is India’s apex body for setting benchmarks in healthcare quality and patient safety.",
      image: "/Center Images/Nalanda Retreat Goa/Awards/Award 3 (NABH).png",
    },
    {
      title: "Tripadvisor Travelers’ Choice 2025",
      description: "Based on the quality and quantity of traveler reviews and ratings over a 12‑month period.",
      image: "/Center Images/Nalanda Retreat Goa/Awards/award 1 (tripadvisor travellor choice ).png",
    },
  ];
  ...
  const jumpSections = [
    ...
    { id: "why-choose", title: "Why Choose Nalanda" },
  ...
  useEffect(() => {
    ...
    loadList(
      "/Center Images/Nalanda Retreat Goa/Photo Gallery/Photo Gallery.txt",
      setImages
    );
    loadList(
      "/Center Videos/Nalanda Retreat Goa/Video Gallery.txt",
      setVideos
    );
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Nalanda Retreat Goa/Wellness & Rejuvenation Programs.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
      ...
      .catch((err) => console.error("Error loading Nalanda wellness content:", err));

    fetch("/content/Top Centers/Nalanda Retreat Goa/Medical Treatment Programs.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
      ...
      .catch((err) => console.error("Error loading Nalanda medical content:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Nalanda Retreat Goa/Why Choose Nalanda Retreat Goa.txt")
      .then((res) => res.text())
      .then((text) => {
        setWhyChooseData(parseCardSection(text));
      })
      .catch((err) => console.error("Error loading Nalanda why-choose content:", err));
  }, []);

  useEffect(() => {
    fetch("/Center Videos/Nalanda Retreat Goa/Testimonies/Testimonies.txt")
      .then((r) => r.text())
      .then((t) => {
        const urls = t
          .split("\n")
  ...
  useEffect(() => {
    fetch("/content/Top Centers/Nalanda Retreat Goa/Treatment Process & Patient Journey.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
      ...
      .catch((err) => console.error("Error loading Nalanda treatment process:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Nalanda Retreat Goa/Facilities & Amenities.txt")
      .then((res) => res.text())
      .then((text) => {
        setFacilitiesData(parseCardSection(text));
      })
      .catch((err) => console.error("Error loading Nalanda facilities content:", err));
  }, []);

  useEffect(() => {
    fetch("/Center Images/Nalanda Retreat Goa/Facilities/Facilities.txt")
      .then((res) => res.text())
      .then((text) => {
        const urls = text
          .split("\n")
      ...
      .catch((err) => console.error("Error loading Nalanda facilities images:", err));
  }, []);
  ...
  useEffect(() => {
    fetch("/content/Top Centers/Nalanda Retreat Goa/Founder & Team Info.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
        let section: "intro" | "founder" | "expertise" | "group" | "teams" = "intro";
        let name = "";
        let role = "";
        let fdesc = "";
        ...
        for (const line of lines) {
          ...
          if (line.startsWith("**") && line.endsWith("**")) {
            ...
            if (!name && section === "intro") { name = t; section = "founder"; continue; }
            if (/leadership & expertise/i.test(t)) { section = "expertise"; continue; }
            if (/our expert/i.test(t)) { if (currentGroup) groups.push(currentGroup); currentGroup = { title: t, description: "", items: [] }; section = "group"; continue; }
          ...
          if (section === "founder") {
            if (role === "" && line.length <= 40 && !line.includes(".")) { role = line; continue; }
      ...
      .catch((err) => console.error("Error loading Nalanda founder content:", err));
  }, []);
  ...
  useEffect(() => {
    fetch("/content/Top Centers/Nalanda Retreat Goa/Patient Stories & Reviews.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
      ...
      .catch((err) => console.error("Error loading Nalanda reviews:", err));
  }, []);
  ...
  useEffect(() => {
    if (!isAwardAutoPlaying || !isAwardsMobile) return;
    const id = setInterval(() => {
      setCurrentAward((prev) => (prev >= maxAwardIndex ? 0 : prev + 1));
    }, 5000);
    return () => clearInterval(id);
  }, [isAwardAutoPlaying, isAwardsMobile, maxAwardIndex]);
  ...
  useEffect(() => {
    fetch("/content/Top Centers/Nalanda Retreat Goa/Insurance & Payment Info.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
      ...
      .catch((err) => console.error("Error loading Nalanda insurance info:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Nalanda Retreat Goa/Frequently Asked Questions.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
      ...
      .catch((err) => console.error("Error loading Nalanda FAQ:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Nalanda Retreat Goa/Contact Information.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        const addr: string[] = [];
        ...
        for (const line of lines) {
          ...
          if (line.startsWith("*")) {
            const bullet = line.replace(/^\*+\s*/, "");
            if (section === "distance") dists.push(bullet);
            continue;
          }
          if (section === "address") {
            addr.push(line);
      ...
      .catch((err) => console.error("Error loading Nalanda contact info:", err));
  }, []);
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-lg md:text-xl mb-4 opacity-90">
                  A soulful beachside sanctuary blending yoga, Ayurveda, and holistic healing.
                </p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-base md:text-lg">Mandrem, North Goa, India</span>
                </div>
        ...
        <div className="max-w-6xl mx-auto">
                  ...
                  <div className="container mx-auto px-4 py-10" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                      {images.map((img, i) => (
                        ...
                        >
                          <img src={img} alt={`Nalanda ${i + 1}`} className="absolute inset-0 w-full h-full object-cover rounded-lg" />
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              {lightboxOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-[#EDE8D0]/80 backdrop-blur-sm">
                  ...
                  <div className="bg-background/90 rounded-xl shadow-2xl p-4 w-full max-w-5xl">
                    <div className="text-center text-primary text-2xl font-bold mb-3 leading-relaxed">Nalanda Retreat Goa</div>
                    <div className="relative rounded-lg overflow-hidden shadow-lg w-full" style={{ paddingBottom: "56.25%" }}>
                      <img
                        src={images[lightboxImage]}
                        alt={`Nalanda ${lightboxImage + 1}`}
          ...
          <Card className="mb-12">
            <CardContent className="px-4 md:px-8 py-6 md:py-8 prose md:prose-lg max-w-none prose-p:text-justify prose-p:leading-relaxed prose-p:text-base md:prose-p:text-lg">
              <MarkdownContent
                contentPath="/content/Top Centers/Nalanda Retreat Goa/Main content.txt"
          ...
          <div className="mb-12 rounded-3xl p-6 md:p-6 lg:p-12" style={{ backgroundColor: "#EDE8D0" }} id="wellness">
            <div className="grid grid-cols-3 gap-2 md:gap-6 max-w-3xl mx-auto mb-8 md:mb-10 overflow-hidden">
              ...
              <div className="text-center p-2.5 md:p-4 bg-white/60 rounded-xl">
                ...
                <div className="text-base md:text-3xl font-bold text-primary mb-1 whitespace-nowrap">Goa</div>
                <div className="text-xs md:text-sm" style={{ color: "#7F543D" }}>Coastal Escape</div>
              </div>
              <div className="text-center p-2.5 md:p-4 bg-white/60 rounded-xl">
                <div className="inline-flex items-center justify-center w-9 h-9 md:w-12 md:h-12 rounded-full bg-green-100 mb-2 md:mb-3">
                  <TrendingUp className="h-4 w-4 md:h-6 md:w-6 text-green-600" />
                </div>
                <div className="text-base md:text-3xl font-bold text-primary mb-1 whitespace-nowrap">Yoga</div>
                <div className="text-xs md:text-sm" style={{ color: "#7F543D" }}>Holistic Care</div>
              </div>
            </div>
            ...
            <Accordion type="single" collapsible className="space-y-3 md:space-y-4">
              {wellnessPrograms.map((p, idx) => (
                <AccordionItem key={idx} value={`wellness-${idx}`} className="border-2 border-green-200 rounded-lg px-4 md:px-6 data-[state=open]:border-green-500 transition-colors bg-white">
          ...
          <div className="mb-12" id="videos">
            <div className="text-center mb-10">
              <h2 className="text-2xl md:text-4xl font-bold text-primary mb-3">
                Video Gallery of Nalanda Retreat Goa
              </h2>
              <p className="text-base md:text-lg mx-auto px-4 max-w-4xl" style={{ color: "#7F543D" }}>
                Experience the coastal calm and mindful practices at Nalanda through our video gallery.
              </p>
            </div>
          ...
          <div className="mb-12" id="why-choose">
            <div className="text-center mb-10">
              <h2 className="text-2xl md:text-4xl font-bold text-primary mb-3">
                {whyChooseData?.title || "Why Choose Nalanda Retreat Goa"}
              </h2>
          ...
          <div className="mb-12" id="testimonial-videos">
            <div className="text-center mb-8 md:mb-10 px-4">
              <h2 className="text-xl md:text-4xl font-extrabold text-primary mb-2 leading-tight tracking-tight">
                Testimonials of Nalanda Retreat Goa
              </h2>
            ...
            <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#EDE8D0" }}>
              <div className="md:hidden">
                <div className="max-w-sm mx-auto bg-white/80 rounded-2xl p-4 shadow-lg border-2 border-primary/30">
                  <img
                    src="/Center Images/Nalanda Retreat Goa/CTA mid.jpg"
                    alt="Nalanda Retreat Goa"
              ...
              <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <Button size="lg" variant="outline" className="rounded-full px-6 border-2 border-[#2F5B63] text-[#2F5B63]" onClick={() => setQuoteModalOpen(true)}>
                      <MessageCircle className="mr-2 h-5 w-5" />
                      Chat With Us
                    </Button>
                  </div>
          ...
          <div className="mb-10 rounded-3xl p-4 md:p-10" style={{ backgroundColor: "#EDE8D0" }} id="team">
            ...
            <div className="grid md:grid-cols-2 gap-4 md:gap-8 mb-6 md:mb-12">
              <Card className="border-2 border-primary/20 hover:border-primary/50 transition-all hover:shadow-xl h-full">
                <CardContent className="p-4 md:p-8 h-full md:h-[480px]">
                ...
                <Card className="border-2 border-primary/20 hover:border-primary/50 transition-all hover:shadow-xl h-full">
                  <CardContent className="p-4 md:p-8 h-full md:h-[480px] md:overflow-y-auto">
                    <div className="flex items-start gap-3 md:gap-4 mb-4 md:mb-6">
                      ...
                      <div>
                        <h3 className="text-lg md:text-2xl font-bold text-primary mb-1 md:mb-2 leading-snug break-words whitespace-normal min-h-[2.5rem] flex items-center">
                          {teamGroups[currentTeamSlide]?.title || "Our Expert Healing Team"}
                        </h3>
                      </div>
                    </div>
                    ...
                    <ul className="space-y-2">
                      {(teamGroups[currentTeamSlide]?.items || []).map((it, idx) => (
                        <li key={idx} className="flex items-start gap-2 text-sm" style={{ color: "#7F543D" }}>
                          <span className="text-primary mt-1">&bull;</span>
                          <span>{renderInlineBlueBold(it)}</span>
                        </li>
                      ))}
                    </ul>
                  </CardContent>
              ...
              {testimonials.length > 0 && (
                <div className="mb-12" id="reviews">
                  <div className="text-center mb-6 md:mb-8">
                    <h2 className="text-2xl md:text-4xl font-bold text-primary mb-3">
                      <span className="text-[#2F5B63]">Patient</span> Stories & Reviews
                    </h2>
          ...
          <div className="mb-12" id="awards">
            <div className="text-center mb-6 md:mb-10">
              ...
              <p className="text-base md:text-lg px-4" style={{ color: "#7F543D" }}>
                Recognition of excellence in healing, hospitality, and guest care
              </p>
            </div>
            ...
            <div className="relative group max-w-5xl mx-auto">
              ...
              <button
                ...
                className="md:hidden absolute left-8 top-[57%] -translate-y-1/2 bg-white/90 hover:bg-primary hover:text-white text-primary p-2 rounded-full shadow-lg transition-all border-2 border-primary z-10"
              ...
              <button
                ...
                className="md:hidden absolute right-8 top-[57%] -translate-y-1/2 bg-white/90 hover:bg-primary hover:text-white text-primary p-2 rounded-full shadow-lg transition-all border-2 border-primary z-10"
              ...
              <Card className="mt-6 bg-primary/5 border-l-4 border-l-primary">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-primary mb-2">For International Guests</h4>
          ...
          {faqItems.length > 0 && (
            <div className="mb-12" id="faq">
              <div className="text-center mb-8">
                ...
                <p className="text-base md:text-lg mx-auto px-4" style={{ color: "#7F543D" }}>
                  Find answers to common questions about your stay and wellness journey
                </p>
              </div>
                    ...
                    <div className="rounded-2xl bg-white/70 p-1 shadow-lg border-2 border-primary/20 overflow-hidden">
                      <div className="rounded-xl overflow-hidden">
                        <div className="relative w-full aspect-[800/600]">
                          <iframe
                            title="Nalanda Retreat Goa Map"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3841.629328225601!2d73.71059057462065!3d15.664714950141104!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbfef90692eb44b%3A0x133aa1aeda311483!2sNalanda%20Retreat%2C%20Goa!5e0!3m2!1sen!2sin!4v1774630423743!5m2!1sen!2sin"
            ...
            <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#234A50" }}>
              <div className="md:hidden">
                <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                  <img
                    src="/Center Images/Nalanda Retreat Goa/CTA bottom.jpg"
                    alt="Nalanda Retreat Goa"
                    className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  />
                  <h2 className="text-xl font-bold text-white text-center mb-4">Begin Your Holistic Healing Journey at Nalanda Retreat Goa</h2>
                  <div className="space-y-3">
                    <Button
                      size="lg"
              ...
              <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <h2 className="text-2xl md:text-4xl font-bold text-white mb-3">Begin Your Holistic Healing Journey at Nalanda Retreat Goa</h2>
                  <div className="flex flex-wrap gap-3">
