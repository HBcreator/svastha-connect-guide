...
export default function MokshaHimalayaSpaResort() {
  ...
  const treatmentProcess = [
    {
      number: 1,
      title: "Welcoming Ascent",
      description: "Taking the scenic Timber Trail cable car up to the resort, leaving the bustle behind and entering a quiet mountaintop sanctuary.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Wellness Consultation",
      description: "Detailed evaluation with our wellness specialists to assess your physical constitution, stress levels, and set clear therapy goals.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Personalized Schedule",
      description: "Designing a custom package combining signature Ayurvedic therapies, international bodywork, or hydrotherapy treatments.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Therapeutic Healing",
      description: "Experiencing expert-guided bodywork sessions, soothing steam/jacuzzi treatments, or targeted international massages.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Mind-Body Harmonization",
      description: "Participating in daily morning yoga classes, guided meditation overlooking the valley, and revitalizing nature walks.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Sustained Vitality Guidance",
      description: "Equipping you with post-retreat lifestyle guidelines and nutritional recommendations to maintain balance in your regular routine.",
...
It was the perfect combination of professional therapeutic bodywork and serene alpine beauty.`,
      ...
      verified: true,
      location: "London, UK",
      condition: "Siam Symphony & Aromatherapy",
      rating: 5
    },
    {
...
The professional therapists and quiet surroundings make it a truly world-class resort.`,
      ...
      condition: "Abhyanga & Choornaswedana",
      rating: 5
    },
    {
...
I returned home feeling lighter, stronger, and with a deep sense of peace.`,
      ...
      condition: "Balinese & LaStone Therapy",
      rating: 5
    },
    {
...
The warm oil streaming on my forehead induced a state of deep, restorative sleep.`,
      ...
      condition: "Shirodhara & Padabhyanga",
      rating: 5
    },
    {
...
It worked out all the chronic knots in my back from the long flight.`,
      ...
      condition: "Hawaiian Lomi Lomi & Wellness Consult",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "How do guests access Moksha Himalaya Spa Resort?",
      answer: "The resort is situated on a scenic mountaintop and is exclusively accessible via a scenic cable car ride from the Timber Trail Resort base station in Parwanoo. The cable car operates daily from 9:00 AM to 5:30 PM (or 6:00 PM in summer), so guests must align their arrival times accordingly."
    },
    {
      question: "What types of spa treatments and therapies are available?",
      answer: "We offer a blend of traditional Ayurvedic treatments (like Abhyanga, Shirodhara, and Choornaswedana) and international therapies (such as Siam Symphony, Aromatherapy, Balinese LaStone, and Hawaiian Lomi Lomi with bamboo fusion), along with advanced hydrotherapy and skincare."
    },
    {
      question: "Are daily yoga and meditation sessions included?",
      answer: "Yes. Guests can participate in daily morning yoga and guided meditation sessions at our wellness center overlooking the Shivalik Ranges, which are designed to support mental clarity and physical flexibility."
    },
    {
      question: "What facilities are available in the thermal wellness suite?",
      answer: "Our spa facilities include detoxifying steam rooms, saunas, hot jacuzzis, and an outdoor temperature-controlled swimming pool surrounded by peaceful pine forests."
    },
    {
      question: "How far is the resort from the nearest airport and railway station?",
      answer: "Moksha Himalaya Spa Resort is approximately 43 km from Chandigarh International Airport (IXC) (about a 60-minute drive) and roughly 7 km from Kalka Railway Station (KLK) (about a 20-minute drive to the cable car base station). Chandigarh Railway Station is 34 km away."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Traditional therapies including Abhyanga, Shirodhara, Choornaswedana, and Padabhyanga tailored to restore biological equilibrium and eliminate systemic toxins.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "International Spa",
      description: "Signature world-class treatments like Siam Symphony, Balinese LaStone, Aromatherapy, and Hawaiian Lomi Lomi to release deep muscle tension.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Yoga & Meditation",
      description: "Daily morning yoga classes and valley-view meditation programs guided by certified instructors to cultivate mindfulness and inner peace.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Hydro & Thermal Wellness",
      description: "Detoxifying steam, sauna, hot jacuzzi, and a temperature-controlled outdoor swimming pool surrounded by tranquil Himalayan forests.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Wellness & Detox Packages",
      description: "Comprehensive purification programs combining health consultations, therapeutic massages, organic Saatvic meals, and herbal steam sessions.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Nature & Forest Walks",
      description: "Guided hikes, alpine trekking, and silent walks through the pristine pine forests of Parwanoo to ground and revitalize your energy.",
  ...
  const whyChooseUs = [
    {
      title: "Mountaintop Sanctuary",
      description: "Perched 5,000 feet above sea level in the Shivalik Ranges, offering fresh mountain air and stunning 360-degree valley views.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Cable-Car Access Only",
      description: "Exclusively accessible via a scenic Timber Trail cable car ride, providing a quiet environment isolated from city noise.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Global Spa Therapies",
      description: "An extensive menu combining authentic Indian Ayurveda and world-class international massage techniques under one roof.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Thermal Wellness Suite",
      description: "Luxury facilities featuring steam, sauna, jacuzzis, and an outdoor temperature-controlled pool nestled in the forest.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Nutritious Dining",
      description: "Fresh, healthy, and appetizing organic meals served to boost your metabolic health, energy, and digestive vitality.",
      icon: <Globe className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Experienced Therapists",
      description: "Highly trained professionals and certified wellness instructors offering dedicated attention and personalized care.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
  ...
  useEffect(() => {
    document.title = "Moksha Himalaya Spa Resort Parwanoo | Luxury Wellness & Spa Retreats";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Ayurvedic therapies, international spa treatments (Siam Symphony, Balinese LaStone, Aromatherapy, Lomi Lomi, KuNye), daily morning yoga, and cable-car accessible luxury wellness retreats in the Shivalik Ranges of Parwanoo, Himachal Pradesh.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Moksha Himalaya Spa Resort Parwanoo Himachal
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Moksha Himalaya Spa Resort</h1>
                <p className="text-xl mb-4 opacity-90">Luxury Spa & Wellness Retreat | Shivalik Ranges, Parwanoo</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Parwanoo, Himachal Pradesh, India</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.3</span>
                  <span className="opacity-90">(1090 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Moksha Himalaya Spa Resort</strong>, an exquisite mountaintop sanctuary perched 5,000 feet above sea level in the Shivalik Ranges of Parwanoo, Himachal Pradesh. Centered around the Sanskrit concept of "Moksha"—meaning liberation or release—our luxury retreat is dedicated to helping guests free themselves from physical stress and mental fatigue, restoring vital life energy in a pristine forest environment.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP cneters/himalayas-rishikesh-uttarakhand-north-east/Moksha Himalaya Spa Resort/secondary.webp" 
                          alt="Prana Spa massage treatment room view"
                  ...
                  <p>
                    The resort is situated on a scenic hilltop and is exclusively accessible via a breathtaking cable car ride from the Timber Trail Resort base station in Parwanoo. Please note that the cable car operates daily between 9:00 AM and 5:30 PM (or 6:00 PM during summer peak seasons); guests must plan their arrival to align with these operating hours, as the resort is isolated and does not provide alternative road transport if the cable car service is missed.
                  </p>

                  <p>
                    At Moksha, we combine authentic Ayurvedic care (such as Abhyanga and Shirodhara) with signature international therapies, including Balinese LaStone and Hawaiian Lomi Lomi massages. Complemented by daily morning yoga sessions, outdoor temperature-controlled pools, hot jacuzzis, and forest treks, we provide an unparalleled healing escape designed to ground, cleanse, and revitalize your entire being.
                  </p>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/himalayas-rishikesh-uttarakhand-north-east/Moksha Himalaya Spa Resort/main.webp" 
                      alt="Prana Spa reception lobby view"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP cneters/himalayas-rishikesh-uttarakhand-north-east/Moksha Himalaya Spa Resort/secondary.webp" 
                        alt="Prana Spa treatment room space"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Moksha Himalaya Spa Resort today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Moksha Himalaya Spa Resort
</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Moksha Himalaya Spa Resort
</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience mountaintop wellness, global spa techniques, and scenic cable car accessibility in the tranquil pine forests.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Moksha Himalaya Spa Resort
</h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP cneters/himalayas-rishikesh-uttarakhand-north-east/Moksha Himalaya Spa Resort/main.webp"
                  alt="Moksha Himalaya Spa Resort center"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Moksha Himalaya Spa Resort?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Moksha Himalaya Spa Resort?</h2>
              ...
              <div>
                <img
                  src="/TOP cneters/himalayas-rishikesh-uttarakhand-north-east/Moksha Himalaya Spa Resort/main.webp"
                  alt="Moksha Himalaya Spa Resort center view"
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments and training courses at Moksha Himalaya Spa Resort.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-foreground/70 leading-relaxed space-y-2 text-sm md:text-base" style={{ color: "#7F543D" }}>
                      <p>Near Village Banasar, Parwanoo, Almora District Road, Parwanoo, Himachal Pradesh</p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="min-w-0">
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Approx. 43 km from Chandigarh International Airport (IXC)</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Approx. 7 km from Kalka Railway Station (KLK)</span>
                      </li>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3426.3977367816365!2d76.9902565!3d30.819519599999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390f8fa111a0e78b%3A0xd207a912a4493768!2sMoksha%20Himalaya%20Spa%20Resort%20Himachal%20Pradesh%20-%20Parwanoo!5e0!3m2!1sen!2sin!4v1780563627618!5m2!1sen!2sin"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Moksha Himalaya Spa Resort Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="/TOP cneters/himalayas-rishikesh-uttarakhand-north-east/Moksha Himalaya Spa Resort/main.webp"
            alt="Moksha Himalaya Spa Resort background"
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated wellness therapists will guide you towards the perfect treatment or spa program at Moksha Himalaya Spa Resort.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919218532341?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Moksha%20Himalaya%20Spa%20Resort."
              target="_blank"
              rel="noreferrer"
