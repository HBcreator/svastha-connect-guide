...
export default function SwarayuAyurveda() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Thorough pulse diagnosis and Prakriti (body constitution) analysis by Dr. Smita Gaikwad to understand the root cause.",
    ...
    },
    {
      ...
      description: "Providing rejuvenating medicines sourced from Kerala and a complete lifestyle blueprint to sustain your recovery.",
  ...
  const testimonials = [
    {
      title: "Life-Changing Shirodhara",
      review: "The Shirodhara treatment for my chronic stress and insomnia was incredible. Dr. Gaikwad’s personalized approach and the authentic oils made a huge difference. I sleep perfectly now.",
      name: "Emma Thompson",
      verified: true,
      location: "London, UK",
    ...
    },
    {
      ...
      review: "I completed a 14-day Panchakarma program to address my digestive issues. The Nadi Parikshan was incredibly accurate, and the results of the detox exceeded my expectations.",
      name: "James Wilson",
      verified: true,
    ...
    {
      title: "Profound Sciatica Relief",
      review: "My sciatica pain was severe before visiting Swarayu. Through their specialized Kati Basti and authentic Kerala herbal medicines, my mobility has been completely restored without surgery.",
      name: "Sophia Rossi",
      verified: true,
      location: "Rome, Italy",
      condition: "Sciatica",
    ...
    {
      title: "Effective Migraine Management",
      review: "After years of suffering from migraines, the therapies here finally provided relief. The clinic is pristine, and the expertise of Dr. Smita Gaikwad is truly world-class.",
      name: "Oliver Smith",
      verified: true,
    ...
    {
      title: "Holistic Psoriasis Care",
      review: "I traveled specifically for their skin disorder treatments. The customized diet, internal cleansing, and external applications significantly cleared my psoriasis. A highly recommended clinic.",
      name: "Lucas Muller",
      verified: true,
  ...
  const faqItems = [
    {
      question: "Who leads the medical team at Swarayu Ayurveda?",
      answer: "Swarayu Ayurveda is founded and led by Dr. Smita Gaikwad, a highly esteemed and board-certified Ayurvedic physician holding an MD and PhD in Panchakarma, with over 17 years of clinical experience."
    },
    {
      question: "What conditions do you specialize in treating?",
      answer: "We specialize in the Ayurvedic management of asthma, arthritis, sinusitis, sciatica, migraines, stress, obesity, and chronic skin conditions like eczema and psoriasis."
    },
    {
      question: "Are your medicines and oils authentic?",
      answer: "Yes, to ensure the highest quality and therapeutic efficacy, all our Ayurvedic medicines and medicated oils are authentically sourced directly from Kerala."
    },
    {
      question: "How long are the Panchakarma programs?",
      answer: "Our comprehensive Panchakarma detoxification programs are deeply customized based on your Prakriti and condition, typically ranging from 5 to 21 days."
    },
    {
      question: "Where is the clinic located?",
      answer: "The clinic is centrally located in Vile Parle East, Mumbai, making it easily accessible for both local residents and international patients seeking traditional Ayurvedic care."
    }
  ];
  ...
  const programs = [
    ...
    },
    {
      ...
      description: "Signature Shirodhara programs with a 92% satisfaction rate for managing stress, anxiety, and insomnia.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Joint & Spine Care",
      description: "Specialized pain management therapies targeting sciatica, arthritis, and chronic back pain using Kerala oils.",
  ...
  const whyChooseUs = [
    {
      ...
      description: "Led by Dr. Smita Gaikwad, bringing profound academic and clinical expertise in Panchakarma.",
    ...
    {
      title: "Authentic Kerala Sourcing",
      description: "Ensuring uncompromising quality by sourcing all therapeutic oils and medicines directly from Kerala.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "High Success Rates",
      description: "Achieving a remarkable 92% patient satisfaction rate, especially in specialized programs like Shirodhara.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
    ...
    },
    {
      ...
      description: "Conveniently situated in Vile Parle East, offering a highly accessible, peaceful healing environment.",
  ...
  useEffect(() => {
    document.title = "Swarayu Ayurveda Clinic & Panchakarma Center Mumbai | Authentic Care";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience personalized Ayurvedic treatments and Panchakarma led by Dr. Smita Gaikwad at Swarayu Ayurveda Clinic in Vile Parle East, Mumbai.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Swarayu Ayurveda Clinic & Panchakarma Center Mumbai
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Swarayu Ayurveda Clinic <br /> & Panchakarma Center</h1>
                <p className="text-xl mb-4 opacity-90">Mumbai's Trusted Destination for Authentic Ayurveda & Panchakarma</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Vile Parle East, Mumbai, Maharashtra, India</span>
                </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Swarayu Ayurveda Clinic & Panchakarma Center</strong>, a highly trusted and result-driven Ayurvedic sanctuary located in Vile Parle East, Mumbai. Founded and led by Dr. Smita Gaikwad, a board-certified Ayurvedic physician holding an MD and PhD in Panchakarma, we bring over 17 years of profound clinical experience to our patients. Recognizing that no two bodies are alike, we pride ourselves on delivering highly tailored, uncompromisingly authentic Ayurvedic care that seamlessly blends deep traditional wisdom with modern clinical efficacy and safety standards.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/Swarayu Ayurveda Clinic & Panchakarma Centre/image 2.webp" 
                          alt="Swarayu Ayurveda therapy room"
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/Swarayu Ayurveda Clinic & Panchakarma Centre/image 1.webp" 
                      alt="Swarayu Ayurveda main view"
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Swarayu Ayurveda today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Swarayu Ayurveda Clinic
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Swarayu Ayurveda Clinic
              </h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience world-class traditional healthcare backed by over 17 years of expertise, authentic medicines, and highly personalized care.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Swarayu Ayurveda Clinic
            </h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/Swarayu Ayurveda Clinic & Panchakarma Centre/image 2.webp"
                  alt="Swarayu Ayurveda view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/1.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Swarayu Ayurveda?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Swarayu Ayurveda?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and specialties at Swarayu Ayurveda.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Swarayu Ayurveda Clinic & Panchakarma Center<br />
                      Vile Parle East<br />
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Located centrally in Vile Parle East for excellent connectivity in Mumbai.</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Very close to Vile Parle railway station and the airport.</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=Swarayu+Ayurveda+Clinic,+Vile+Parle+East,+Mumbai&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Swarayu Ayurveda Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or therapy program at Swarayu Ayurveda Clinic.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919560113189?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Swarayu%20Ayurveda."
              target="_blank"
              rel="noreferrer"
