...
export default function AatreyaAyurvedClinic() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "A deep, one-on-one consultation with Dr. Swati or Dr. Rajesh Nalage to thoroughly identify the underlying cause of your health concerns.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Customized Protocol",
      description: "Designing a highly personalized treatment plan encompassing classical Panchakarma therapies, specific dietary charts, and herbal medicines.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Targeted Therapies",
      description: "Executing specialized Ayurvedic procedures designed specifically for infertility, joint pain, or hormonal imbalances with utmost care.",
      icon: <Heart className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Core Panchakarma",
      description: "Administering full-spectrum detoxification and systemic cleansing programs to restore your body's natural metabolic balance.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Emotional Support",
      description: "Providing compassionate counseling and emotional support throughout your healing journey, especially for chronic and fertility issues.",
      icon: <Users className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Lifestyle Rejuvenation",
      description: "Delivering detailed post-treatment lifestyle guidance to ensure your recovery is sustained and your overall vitality is enhanced.",
  ...
  const testimonials = [
    {
      title: "A Miracle for Our Family",
      review: "The customized infertility treatment protocols at Aatreya Ayurved are nothing short of miraculous. After years of failed conventional treatments, Dr. Swati’s deep understanding of classical Ayurveda and compassionate emotional support finally helped us conceive. The entire clinic radiates a serene, genuinely caring atmosphere that makes you feel completely safe.",
      name: "Eleanor T.",
      verified: true,
      location: "London, UK",
    ...
    },
    {
      ...
      review: "I traveled from Australia to treat a severe, chronic back pain issue that had severely limited my mobility for years. The intensive Panchakarma detox combined with specialized Kati Basti treatments here completely eradicated the pain. The doctors take immense time to explain the root cause and provide invaluable lifestyle guidance for lasting relief.",
      name: "Julian W.",
      verified: true,
    ...
    {
      title: "Life-Changing Hormonal Balance",
      review: "The holistic approach at Aatreya for managing my severe PCOD and hormonal imbalances was incredibly thorough and life-changing. From the meticulously customized diet plan to the highly effective Ayurvedic medicines, every step was precisely tailored to my unique constitution. I have never felt so truly heard by any medical professional.",
      name: "Matilda R.",
      verified: true,
    ...
    {
      title: "Profound Detoxification",
      review: "A genuinely authentic Ayurvedic healing center right in the heart of Pune. I underwent a comprehensive 14-day Panchakarma detox program to address persistent digestive disorders and chronic fatigue. The results have been phenomenal, completely restoring my energy levels and transforming my overall daily metabolic health.",
      name: "Sebastian H.",
      verified: true,
    ...
    {
      title: "Exceptional Integrative Care",
      review: "We initially consulted Dr. Rajesh for male fertility concerns and were deeply impressed by his clinical expertise and the incredibly supportive environment. Their integrative approach, utilizing pure herbal remedies and profound classical techniques, is simply exceptional. We highly recommend Aatreya to anyone seeking true, deep-rooted Ayurvedic healing.",
      name: "Chloe L.",
      verified: true,
  ...
  const faqItems = [
    {
      question: "What are your main areas of specialization?",
      answer: "We specialize deeply in Ayurvedic infertility treatments, complex gynecological disorders (like PCOD and endometriosis), classical Panchakarma detox programs, and chronic pain management."
    },
    {
      question: "Do you offer prenatal and pediatric Ayurvedic care?",
      answer: "Yes, we offer highly specialized Garbhsanskar therapy for comprehensive pregnancy wellness and traditional Swarnaprashan to naturally boost children's immunity."
    },
    {
      question: "How long has Aatreya Ayurved Clinic been operating?",
      answer: "Our primary Hadapsar branch was established in December 2008, providing over a decade and a half of trusted, authentic Ayurvedic healing to the community."
    },
    {
      question: "What makes your consultation process unique?",
      answer: "We are known for our deep, one-on-one diagnostic consultations where we take the time to identify the root cause of your ailment and provide emotional support alongside medical care."
    },
    {
      question: "Are your Panchakarma treatments customized?",
      answer: "Absolutely. Every Panchakarma detoxification and rejuvenation program is meticulously tailored to your specific body constitution, current imbalances, and long-term health goals."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Highly specialized Ayurvedic protocols addressing the root causes of both male and female infertility to naturally support conception.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Women's Health & PCOD",
      description: "Comprehensive management of gynecological issues including PCOD, endometriosis, and menstrual irregularities using traditional therapies.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Classical Panchakarma",
      description: "Full-spectrum detoxification programs designed to deeply cleanse the body, remove rooted toxins, and restore optimal metabolic function.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Joint & Spine Care",
      description: "Targeted Ayurvedic pain management employing specialized localized therapies like Kati Basti and medicated oils for chronic relief.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Garbhsanskar Therapy",
      description: "Specialized prenatal Ayurvedic care and lifestyle guidance designed to ensure absolute physical and mental wellness during pregnancy.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Pediatric Immunity",
      description: "Traditional Swarnaprashan administration and pediatric Ayurvedic care to naturally enhance your child's immunity and overall development.",
  ...
  const whyChooseUs = [
    {
      ...
      description: "Celebrated for outstanding outcomes in complex Ayurvedic infertility treatments.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Root-Cause Approach",
      description: "Dedicated to identifying and treating the underlying cause, not just the symptoms.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Experienced Doctors",
      description: "Led by the highly respected and experienced duo, Dr. Swati and Dr. Rajesh Nalage.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Compassionate Care",
      description: "Known for deep one-on-one consultations and profound emotional support.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Holistic Specialties",
      description: "Offering unique services like Garbhsanskar and Swarnaprashan alongside Panchakarma.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Trusted Heritage",
      description: "A highly trusted institution established in 2008 with a stellar 4.8 Google rating.",
      icon: <Star className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
  ...
  useEffect(() => {
    document.title = "Aatreya Ayurved & Panchakarma Clinic | Authentic Care in Pune";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Ayurvedic treatments, infertility care, and complete Panchakarma at Aatreya Ayurved & Panchakarma Clinic in Pune.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Aatreya Ayurved & Panchakarma Clinic Pune
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Aatreya Ayurved & <br className="hidden md:block" /> Panchakarma Clinic</h1>
                <p className="text-xl mb-4 opacity-90">Pune's Trusted Center for Holistic Health & Fertility</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Hadapsar, Pune, Maharashtra, India</span>
                </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Aatreya Ayurved & Panchakarma Clinic
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Aatreya Ayurved & Panchakarma Clinic</strong>, a deeply trusted sanctuary for holistic healing in Pune, proudly holding a 4.8 Google rating from over 600 satisfied patients. Established in December 2008 in Hadapsar, the clinic is celebrated for its authentic approach to Ayurveda, focusing on identifying and treating the root cause of illnesses rather than merely managing symptoms.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/Aatreya Ayurved & Panchakarma Clinic/image 2.webp" 
                          alt="Aatreya Ayurved therapy room"
                          className="w-full h-full object-cover"
                          onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/21.webp"; }}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <p>
                    Led by the highly respected husband-wife duo, Dr. Swati Nalage and Dr. Rajesh Nalage, Aatreya is renowned across Maharashtra for its exceptional success rates in Ayurvedic infertility treatments, complex gynecological conditions like PCOD and endometriosis, and male fertility issues. They also offer highly specialized Garbhsanskar therapy for pregnancy wellness and Swarnaprashan for boosting children's natural immunity.
                  </p>
                  
                  <p>
                    Beyond reproductive health, the clinic provides comprehensive classical Panchakarma detoxification programs and highly effective chronic disease management for severe joint pain, back pain, and stubborn skin conditions. Patients universally praise the clinic not just for its medical excellence, but for its deep one-on-one consultations, emotional support, and the genuine, compassionate healing atmosphere where every individual feels truly heard and cared for.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/Aatreya Ayurved & Panchakarma Clinic/image 1.webp" 
                      alt="Aatreya Ayurved main view"
                      className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                      onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/21.jpg"; }}
                    />
                  </div>
                </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Aatreya Ayurved & Panchakarma Clinic today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Aatreya Ayurved & Panchakarma Clinic
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Aatreya Ayurved & Panchakarma Clinic
              </h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience deeply personalized healthcare renowned for its expertise in fertility, root-cause diagnosis, and compassionate emotional support.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Aatreya Ayurved & Panchakarma Clinic
            </h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A deeply personalized pathway of profound diagnosis, tailored therapies, and comprehensive emotional support designed for lasting wellness.
            </p>
          </div>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/Aatreya Ayurved & Panchakarma Clinic/image 1.webp"
                  alt="Aatreya Ayurved view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/21.jpg"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Aatreya Ayurved & Panchakarma Clinic?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Aatreya Ayurved & Panchakarma Clinic?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and specialties at Aatreya Ayurved & Panchakarma Clinic.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Aatreya Ayurved & Panchakarma Clinic<br />
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Centrally located clinic in Hadapsar, Pune.</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Easily accessible from major transit hubs in Pune.</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15647767.451975958!2d66.5392373232389!3d16.76394808071627!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2c30ab1b10e77%3A0x3781e6ff53749462!2sAatreya%20Ayurved%20Panchkarma%20%26%20Infertility%20Clinic%20in%20Hadapsar%20Pune!5e0!3m2!1sen!2sus!4v1781537146802!5m2!1sen!2sus"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Aatreya Ayurved Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or therapy program at Aatreya Ayurved & Panchakarma Clinic.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/9198xxxxxxxx?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Aatreya%20Ayurved%20%26%20Panchakarma%20Clinic."
              target="_blank"
              rel="noreferrer"
