...
export default function DivyamrutAyurcare() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Comprehensive pulse diagnosis and consultation by expert physicians to understand your unique body constitution and the root cause of ailments.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Individualized Treatment Plan",
      description: "Designing a highly personalized therapy schedule targeting your specific chronic conditions, stress levels, or wellness goals.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Purvakarma Therapies",
      description: "Preparing your body for detoxification using authentic Kerala medicated oils, Abhyanga, and steam therapies to loosen deep-seated toxins.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Classical Panchakarma",
      description: "Executing deep cleansing procedures such as Basti, Virechana, or Nasya using traditional Kerala methods for systemic relief.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Specialized Local Therapies",
      description: "Integrating targeted treatments like Pizhichil, Udvarthanam, or Shirodhara for neurological conditions and profound stress relief.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Post-Treatment Care",
      description: "Providing rejuvenating herbal medicines and a customized lifestyle and diet blueprint to sustain your recovery and holistic wellness.",
  ...
  const testimonials = [
    {
      title: "Exceptional Four-Hand Massage",
      review: "The four-hand synchronized Abhyanga massage at Divyamrut Ayurcare is truly world-class. Having visited many clinics, this authentic Kerala therapy provided unmatched relief from my chronic fatigue.",
      name: "Alexander M.",
      verified: true,
      location: "London, UK",
    ...
    {
      title: "Profound Pain Relief",
      review: "I traveled to Mumbai specifically for their specialized Panchakarma treatments. The expert physicians accurately diagnosed my Dosha imbalance and completely resolved my severe musculoskeletal pain.",
      name: "Isabella V.",
      verified: true,
      location: "Rome, Italy",
    ...
    {
      title: "A Peaceful Sanctuary",
      review: "Their approach to stress management through Shirodhara and classical therapies is phenomenal. The luxurious and peaceful environment they maintain in the heart of Mumbai is highly commendable.",
      name: "Daniel K.",
      verified: true,
    ...
    {
      title: "Transformative Detoxification",
      review: "The customized detoxification program totally transformed my digestive health. Their use of genuine Kerala herbs and meticulous attention to every detail of my diet protocol was incredibly impressive.",
      name: "Sophie L.",
      verified: true,
    ...
    {
      title: "Deep Sleep Restored",
      review: "Exceptional care from highly trained therapists with years of experience. The personalized approach and authentic Pizhichil therapy successfully managed my persistent sleep disorders naturally.",
      name: "Christopher T.",
      verified: true,
  ...
  const faqItems = [
    {
      question: "What makes Divyamrut Ayurcare unique in Mumbai?",
      answer: "We specialize in authentic Kerala Ayurvedic therapies, including our renowned four-hand synchronized Abhyanga, performed by highly experienced therapists in a luxurious environment."
    },
    {
      question: "Do you offer complete Panchakarma programs?",
      answer: "Yes, we provide comprehensive, personalized Panchakarma detoxification protocols including Shirodhara, Pizhichil, Nasya, and Basti, tailored to your specific Prakriti."
    },
    {
      question: "Are the treatments suitable for chronic pain?",
      answer: "Absolutely. We excel in managing musculoskeletal pain, joint disorders, and chronic fatigue using targeted classical Ayurvedic interventions and specialized oils."
    },
    {
      question: "Where is Divyamrut Ayurcare located?",
      answer: "Our modern and spacious wellness center is centrally located on N. Bharucha Marg, near the Grant Road Post Office in Mumbai."
    },
    {
      question: "Do I need to book an appointment in advance?",
      answer: "Yes, to ensure personalized attention and adequate time for comprehensive consultation and therapies, we highly recommend booking your appointment in advance."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Authentic detoxification programs designed to cleanse the body of deep-seated toxins and restore natural metabolic balance using traditional methods.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stress & Anxiety Relief",
      description: "Deeply relaxing therapies including Shirodhara and specialized head massages to combat chronic stress, anxiety, and sleep disorders.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Musculoskeletal Care",
      description: "Targeted Ayurvedic pain management for arthritis, spondylosis, and back pain using specialized Kerala therapies like Pizhichil.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Digestive Wellness",
      description: "Effective natural protocols for managing chronic indigestion, acidity, IBS, and restoring optimal gut health and robust metabolism.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Hair Care",
      description: "Comprehensive blood purification and external applications to naturally treat dermatological conditions and promote healthy hair growth.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Rejuvenation Therapy",
      description: "Premium wellness treatments focusing on our signature synchronized Abhyanga to revive energy levels and combat chronic fatigue.",
  ...
  const whyChooseUs = [
    {
      ...
      description: "We bring the true essence of traditional Kerala Ayurveda to Mumbai with specially sourced herbs and medicated oils.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Expert Therapists",
      description: "Our treatments are performed by highly skilled Kerala-trained therapists with decades of hands-on experience.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Personalized Consultations",
      description: "Every wellness journey begins with a meticulous Dosha assessment by our qualified Ayurvedic physicians.",
      icon: <FileSearch className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Signature Therapies",
      description: "Renowned for unique offerings like our four-hand synchronized Abhyanga that delivers unparalleled relaxation.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Luxurious Environment",
      description: "A modern, spacious, and deeply serene facility designed to provide a perfect sanctuary in the heart of the city.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "High Success Rate",
      description: "Consistently rated 4.9 by our patients for delivering genuine, deeply effective therapeutic outcomes.",
  ...
  useEffect(() => {
    document.title = "Divyamrut Ayurcare | Authentic Kerala Ayurveda in Mumbai";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Kerala Ayurvedic treatments, Panchakarma, and specialized therapies at Divyamrut Ayurcare in Grant Road, Mumbai.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Divyamrut Ayurcare</h1>
                <p className="text-xl mb-4 opacity-90">Mumbai's Premium Destination for Authentic Kerala Healing</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Grant Road, Mumbai, Maharashtra, India</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.9</span>
                  <span className="opacity-90">(157 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Divyamrut Ayurcare</strong>, a celebrated Ayurvedic wellness clinic located in the heart of Mumbai. Renowned for its specialized four-hand synchronized Abhyanga massage performed by Kerala-trained therapists, our center delivers a deeply healing and transformative experience. With an outstanding 4.9 Google rating, we bridge the gap between authentic Kerala heritage and the sophisticated wellness needs of modern patients.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/Divyamrut Ayurcare/image 2.webp" 
                          alt="Divyamrut Ayurcare therapy room"
                          className="w-full h-full object-cover"
                          onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/16.webp"; }}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <p>
                    Every wellness journey at Divyamrut Ayurcare is preceded by a personalized Dosha assessment by our expert Ayurvedic doctors, ensuring that all treatments—including Shirodhara, Pizhichil, Nasya, and full Panchakarma programs—are meticulously tailored to your body. We excel in providing deep detoxification, stress relief, and targeted care for musculoskeletal pain in a luxurious, serene environment. Our commitment is to restore your natural balance, vitality, and overall holistic well-being.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/Divyamrut Ayurcare/image 1.webp" 
                      alt="Divyamrut Ayurcare main view"
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Divyamrut Ayurcare today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Divyamrut Ayurcare
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Divyamrut Ayurcare
              </h2>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Divyamrut Ayurcare
            </h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/Divyamrut Ayurcare/image 1.webp"
                  alt="Divyamrut Ayurcare view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/16.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Divyamrut Ayurcare?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Divyamrut Ayurcare?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and specialties at Divyamrut Ayurcare.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Centrally located near Grant Road Post Office.</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=Divyamrut+Ayurcare,+Grant+Road,+Mumbai&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Divyamrut Ayurcare Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or therapy program at Divyamrut Ayurcare.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/9198xxxxxxxx?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Divyamrut%20Ayurcare."
              target="_blank"
              rel="noreferrer"
