...
export default function AyushaktiAyurved() {
  ...
  const treatmentProcess = [
    {
      number: 1,
      title: "Advanced Nadi Pariksha",
      description: "Our signature, highly accurate pulse reading to detect root imbalances and dosha issues deep within the body.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Diet & Lifestyle Roadmap",
      description: "A customized food plan that aligns with your specific condition, removing inflammatory triggers and boosting recovery.",
      icon: <Leaf className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Herbal Supplements",
      description: "Proprietary, potent herbal formulations globally exported and clinically proven to accelerate the healing process.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Deep Detox (Panchkarma)",
      description: "Signature detoxification programs to flush out deep-rooted toxins (Aama) and restore cellular intelligence.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Specialized Marma Chikitsa",
      description: "Targeted stimulation of vital energy points to relieve chronic pain and improve energy flow across the body.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Rejuvenation (Rasayana)",
      description: "Post-detox strengthening therapies to rebuild immunity, prevent recurrence, and ensure long-term vitality.",
  ...
  const testimonials = [
    {
      title: "Accurate Diagnosis & Relief",
      review: "The Nadi Pariksha was incredibly accurate. The doctors immediately identified my digestive issues, and the detox program completely transformed my energy levels within weeks.",
      name: "Eleanor Hughes",
      verified: true,
      location: "London, UK",
    ...
    {
      title: "Arthritis Pain Vanished",
      review: "I flew to Mumbai specifically for my severe arthritis. Ayushakti's herbal treatments and specialized joint therapies gave me my mobility back when nothing else worked.",
    ...
    {
      title: "Exceptional Asthma Care",
      review: "My chronic asthma was significantly debilitating. The respiratory detox protocols and their proprietary herbal formulations helped me breathe freely without heavy dependency on inhalers.",
      name: "David Mueller",
      verified: true,
    ...
    {
      title: "Incredible Psoriasis Transformation",
      review: "The holistic approach here is unmatched. By changing my diet and undergoing deep blood purification (Virechan), my severe psoriasis cleared up remarkably after 10 years of struggle.",
      name: "Sophie Bennett",
      verified: true,
    ...
    },
    {
      ...
      review: "From the Swadshakti restaurant to the expert therapies, everything is ISO certified and highly professional. A truly global standard Ayurvedic hospital.",
      name: "Ahmad Al-Farsi",
      verified: true,
      location: "Dubai, UAE",
      condition: "Wellness & Detox",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "What is Ayushakti's global presence?",
      answer: "Founded in 1987 by Vaidya Smita Naram, Ayushakti is a pioneering global institution that has helped over 1.5 million people from 108 countries. Our herbal supplements are exported globally, including to the USA, Europe, and Australia."
    },
    {
      question: "What makes Ayushakti's diagnosis unique?",
      answer: "We are pioneers in Nadi Pariksha (Pulse Reading). This ancient technique allows our expert Vaidyas to accurately diagnose deep-rooted dosha imbalances and blockages without relying solely on modern diagnostic tests."
    },
    {
      question: "What conditions are best treated at Ayushakti?",
      answer: "Our specialized Detox programs are highly effective for chronic conditions such as asthma, diabetes, severe arthritis, psoriasis, infertility, digestive disorders, and obesity."
    },
    {
      question: "Are there facilities for international patients?",
      answer: "Yes, our ISO 9001-certified, 15,000 sq. ft. headquarters in Malad West features full residential stay options, an OPD, world-class Panchakarma rooms, and the Swadshakti restaurant serving customized healing cuisine."
    },
    {
      question: "Are your herbal supplements safe?",
      answer: "Absolutely. All Ayushakti herbal food supplements undergo rigorous quality testing and meet stringent international safety standards, having been safely exported and consumed globally for over 25 years."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Comprehensive Panchakarma protocols to flush out systemic toxins and reset cellular metabolism.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Joint & Arthritis Care",
      description: "Targeted Ayurvedic pain management to reduce inflammation, improve mobility, and rebuild cartilage.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Respiratory & Asthma",
      description: "Specialized therapies to clear lung congestion, strengthen respiratory immunity, and manage asthma naturally.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Psoriasis",
      description: "Deep blood purification and targeted internal herbal support for chronic dermatological conditions.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Metabolic Wellness",
      description: "Holistic reversal protocols for type-2 diabetes, obesity, and thyroid imbalances through diet and detox.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Fertility & Women's Health",
      description: "Expert hormonal balancing and reproductive health treatments to support natural conception and ease PCOD.",
  ...
  const whyChooseUs = [
    {
      title: "Global Legacy Since 1987",
      description: "Pioneered by Vaidya Smita Naram, positively impacting over 1.5 million lives across 108 countries.",
      icon: <Globe className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Mastery in Nadi Pariksha",
      description: "Unparalleled expertise in ancient pulse reading for highly accurate root-cause diagnosis.",
      icon: <FileSearch className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "ISO 9001-Certified Hub",
      description: "Our 15,000 sq. ft. headquarters features state-of-the-art OPD, Panchakarma, and residential facilities.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Internationally Approved Herbs",
      description: "Proprietary herbal formulations rigorously tested and exported to the USA, Europe, and Australia for 25+ years.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Swadshakti Healing Cuisine",
      description: "An exclusive in-house Ayurvedic restaurant providing customized, delicious dietary support during treatments.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Comprehensive Care",
      description: "Seamlessly combining doctor consultations, treatments, therapies, and medicines all under one massive roof.",
  ...
  useEffect(() => {
    document.title = "Ayushakti Ayurved Health Center Mumbai | Global Healing";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Discover Ayushakti Ayurved Health Center in Mumbai. Founded by Vaidya Smita Naram, offering world-class Panchakarma, Nadi Pariksha, and proven herbal detox programs.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Ayushakti Ayurved Health Center Mumbai
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Ayushakti Ayurved Health Center</h1>
                <p className="text-xl mb-4 opacity-90">A Pioneering Global Ayurveda Institution Since 1987</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Kandivali West, Mumbai, Maharashtra, India</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.7</span>
                  <span className="opacity-90">(1,000+ Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Ayushakti Ayurved Health Center
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Founded in 1987 by the late <strong className="font-bold text-[#2C4E5A]">Vaidya Smita Naram</strong>, Ayushakti Ayurved Health Center stands as a pioneering global Ayurveda institution. With a legacy of over three decades, Ayushakti has positively impacted the lives of more than 1.5 million people across 108 countries, earning a reputation as one of the world's most trusted hubs for authentic Ayurvedic healing. By strictly adhering to the classical ancient texts while utilizing modern medical validations, our highly trained practitioners deliver an unparalleled standard of care that addresses the absolute root cause of chronic illnesses rather than merely suppressing the symptoms.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/Ayushakti Ayurved Health Centre/image 2.png" 
                          alt="Ayushakti Ayurved therapy and medicine"
                          className="w-full h-full object-cover"
                          onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/3.webp"; }}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <p>
                    Our ISO 9001-certified headquarters in Mumbai is a massive 15,000 sq. ft. multi-facility center equipped with state-of-the-art OPDs, traditional Panchakarma rooms, and residential stays for international guests. We are global leaders in Nadi Pariksha (pulse reading) and highly specialized detox programs targeting chronic issues like asthma, arthritis, psoriasis, and diabetes. Our clinically proven herbal supplements have been exported to the USA, Europe, and Australia for over 25 years. Beyond clinical excellence, our facility features the unique Swadshakti Ayurvedic cuisine restaurant, ensuring that our patients' dietary regimes perfectly complement their customized holistic healing programs.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/Ayushakti Ayurved Health Centre/image 1.png" 
                      alt="Ayushakti Ayurved facility"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP centers/mumbai pune nashik/Ayushakti Ayurved Health Centre/image 2.png" 
                        alt="Ayushakti Ayurved treatments"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/3.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Ayushakti today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Ayushakti Ayurved Health Center
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Ayushakti Ayurved Health Center
              </h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience world-class traditional healthcare backed by a global legacy, international standard herbs, and highly personalized care.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Ayushakti Ayurved Health Center
            </h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A comprehensive pathway of precise pulse diagnosis, powerful herbs, and deep healing designed specifically for your unique body constitution.
            </p>
          </div>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/Ayushakti Ayurved Health Centre/image 2.png"
                  alt="Ayushakti Ayurved view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/3.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Ayushakti?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Ayushakti?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and specialties at Ayushakti.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Ayushakti Ayurved Health Center (HQ)<br />
                      Kandivali West / Malad West<br />
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Located conveniently in Kandivali/Malad West, easily accessible from central Mumbai.</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Well-connected for international patients arriving from Chhatrapati Shivaji Airport.</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=Ayushakti+Ayurved+Health+Centre+Malad+Mumbai&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Ayushakti Ayurved Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Join over 1.5 million people worldwide who have discovered authentic healing with Ayushakti.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919560113189?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Ayushakti%20Ayurved."
              target="_blank"
              rel="noreferrer"
