...
export default function MaharishiAyurvedaHospital() {
  ...
  const treatmentProcess = [
    {
      number: 1,
      title: "Detailed Pulse Diagnosis",
      description: "A precise Nadi Vigyaan check-up to identify Dosha imbalances and define your metabolic constitution.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Tailored Program Design",
      description: "Creating your customized schedule of Panchakarma therapies, herbal remedies, diet, and yoga exercises.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Preparatory Treatments",
      description: "Warm herbal oil applications and steam therapies to loosen accumulated metabolic wastes (Ama).",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Panchakarma Detoxification",
      description: "Administering core purification procedures (like Vaman, Virechan, or Basti) under strict medical supervision.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Restoration & TM Practice",
      description: "Integrating organic Saatvic meals, rest, gentle yoga, and Transcendental Meditation to restore strength.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Long-Term Wellness Guide",
      description: "Receiving a customized lifestyle and nutrition blueprint to sustain energy and prevent future imbalances.",
...
After 14 days of customized Panchakarma detox, oil pooling (Kati Basti), and yoga exercises, I felt a complete release.`,
      ...
      verified: true,
      location: "London, UK",
      condition: "Joint Pain & Back Care",
      rating: 5
    },
    {
...
specialized herbs, and a strict Saatvic diet.`,
      ...
      condition: "Diabetes & Metabolic Reset",
      rating: 5
    },
    {
...
I left feeling completely refreshed, energized, and clear-headed.`,
      ...
      condition: "Rejuvenation & Anti-Aging",
      rating: 5
    },
    {
...
were completely customized.`,
  ...
  const faqItems = [
    {
      question: "What is the medical philosophy of Maharishi Ayurveda Hospital?",
      answer: "We combine authentic traditional Ayurvedic healing with modern clinical hygiene and eco-friendly infrastructure. Our treatments are guided by detailed pulse diagnosis (Nadi Vigyaan) to treat the root cause of chronic conditions rather than just managing symptoms."
    },
    {
      question: "What makes the accommodations at the hospital unique?",
      answer: "Our rooms are designed using eco-friendly materials like sustainable bamboo and natural fibers. They incorporate natural light wells and free-flowing ventilation to support physical healing and mental calm."
    },
    {
      question: "What facilities are available at Maharishi Ayurveda Hospital?",
      answer: "The hospital features private consultation chambers, specialized Panchakarma therapy suites, a dedicated yoga and meditation hall, eco-friendly inpatient rooms (Luxury, Deluxe, and Standard), and a specialized kitchen preparing custom Saatvic meals."
    },
    {
      question: "What chronic conditions do you specialize in treating?",
      answer: "We specialize in musculoskeletal disorders (arthritis, spondylitis, backache, sciatica), metabolic conditions (type II diabetes, hypertension, obesity), chronic digestive complaints (IBS, liver concerns), as well as stress, insomnia, asthma, and skin conditions."
    },
    {
      question: "How far is the hospital from the nearest transit points?",
      answer: "Maharishi Ayurveda Hospital is located in Shalimar Bagh (West), New Delhi. It is approximately 22 km from Indira Gandhi International (IGI) Airport, about 16 km from New Delhi Railway Station (NDLS), and is in close proximity to the Shalimar Bagh Metro Station (Pink Line)."
    }
  ];

  const programs = [
    {
      title: "Ayurveda & Panchakarma Detox",
      description: "Tailored Vaman, Virechan, Basti, Nasya, and Raktamokshan therapies guided by pulse analysis.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Chronic Disease Management",
      description: "Custom protocols targeting arthritis, back pain, sciatica, diabetes, hypertension, and digestive disorders.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Pulse Diagnosis & Nadi Vigyaan",
      description: "In-depth constitutional assessment to detect physical and mental imbalances before they manifest as diseases.",
      icon: <FileSearch className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stress & Mental Wellness",
      description: "Soothing Shirodhara, head treatments, therapeutic pranayama, and Transcendental Meditation for mental clarity.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Eco-Conscious Health Stays",
      description: "Holistic treatment stays including organic Saatvic dining, daily yoga, and rooms built with sustainable materials.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Rejuvenation & Rasayana",
      description: "Age-reversing herbal therapies and bodywork designed to elevate immune strength and restore youthfulness.",
  ...
  const whyChooseUs = [
    {
      title: "Root-Cause Consultations",
      description: "In-depth pulse analysis (Nadi Vigyaan) to trace conditions back to their energetic and metabolic root causes.",
      icon: <FileSearch className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Senior BAMS/MD Physicians",
      description: "All therapies designed and monitored by highly experienced physicians including CMO Dr. Amit Arora.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Eco-Friendly Architecture",
      description: "Eco-conscious accommodations utilizing bamboo, natural fibers, and Vastu design to enhance healing.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Comprehensive Panchakarma",
      description: "Full range of traditional purification and toxin-clearing therapies in clinical hygiene standards.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Transcendental Meditation",
      description: "Integrating Maharishi Mahesh Yogi's renowned Transcendental Meditation and yoga for complete mental balance.",
      icon: <Globe className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Custom Saatvic Nutrition",
      description: "Fresh, organic, and individualized vegetarian meals prepared specifically to complement your recovery.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
  ...
  useEffect(() => {
    document.title = "Maharishi Ayurveda Hospital Delhi | Panchakarma & Chronic Disease Care";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Panchakarma detoxification, pulse diagnosis (Nadi Vigyaan), and personalized Ayurveda treatments for chronic diseases at Maharishi Ayurveda Hospital in Shalimar Bagh, New Delhi.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="opacity-90">(860 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Maharishi Ayurveda Hospital
</h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to the <strong className="font-bold text-[#2C4E5A]">Maharishi Ayurveda Hospital</strong>, a premier alternative healthcare destination located in Shalimar Bagh (West), New Delhi. Built on the timeless principles of Vedic wellness, our hospital is dedicated to offering authentic Panchakarma treatments, root-cause consultations, and specialized chronic disease management. Under the clinical leadership of Chief Medical Officer <strong className="font-bold text-[#2C4E5A]">Dr. Amit Arora</strong>, we utilize precise pulse diagnosis (<em className="italic">Nadi Vigyaan</em>) to assess your unique constitution (<em className="italic">Deha Prakriti</em>) and current energy imbalances (<em className="italic">Doshas</em>).
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP cneters/delhi/Maharishi Ayurveda Hospital/secondary.webp" 
                          alt="Maharishi Ayurveda Hospital accommodation"
                  ...
                  <p>
                    Our inpatient facility features eco-friendly accommodations, offering Luxury, Deluxe, and Standard rooms constructed with sustainable materials like bamboo and natural fibers. Designed in accordance with natural health architecture principles, the rooms provide free-flowing ventilation and warm light wells to support recovery. Your wellness journey at Maharishi Ayurveda Hospital is supported by custom-prepared Saatvic meals, juices, therapeutic yoga, pranayama breathing exercises, and Transcendental Meditation (TM) techniques.
                  </p>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/delhi/Maharishi Ayurveda Hospital/main.avif" 
                      alt="Maharishi Ayurveda Hospital main view"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP cneters/delhi/Maharishi Ayurveda Hospital/secondary.webp" 
                        alt="Maharishi Ayurveda Hospital therapy room"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Maharishi Ayurveda Hospital today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Maharishi Ayurveda Hospital
</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Maharishi Ayurveda Hospital
</h2>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Maharishi Ayurveda Hospital
</h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP cneters/delhi/Maharishi Ayurveda Hospital/main.avif"
                  alt="Maharishi Ayurveda Hospital view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Maharishi Ayurveda Hospital?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Maharishi Ayurveda Hospital?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and therapies at Maharishi Ayurveda Hospital.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Approx. 22 km from Indira Gandhi International (IGI) Airport</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Approx. 16 km from New Delhi Railway Station (NDLS)</span>
                      </li>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3499.39309501363!2d77.15419899999999!3d28.7077961!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d01fade6cc887%3A0x519f6d55ee45274b!2sMaharishi%20Ayurveda%20Hospital!5e0!3m2!1sen!2sin!4v1780628427401!5m2!1sen!2sin"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Maharishi Ayurveda Hospital Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="/TOP cneters/delhi/Maharishi Ayurveda Hospital/main.avif"
            alt="Maharishi Ayurveda Hospital"
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or retreat program at Maharishi Ayurveda Hospital.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919310866852?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Maharishi%20Ayurveda%20Hospital."
              target="_blank"
              rel="noreferrer"
