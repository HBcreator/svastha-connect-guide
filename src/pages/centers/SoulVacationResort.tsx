...
const SoulVacationResort = () => {
  ...
  const [treatmentSteps, setTreatmentSteps] = useState<
    { number: number; title: string; description: string; bullets: string[] }[]
  >([]);
  ...
  const awards = [
    {
      title: "Outlook Traveller Feature",
      description: "Featured for offering a distinctive blend of luxury comfort and authentic Ayurvedic wellness experiences in South Goa.",
      image: "/Center Images/Soul Vacation Resort and Spa/Awards/Award 1 (outlook traveller).jpg",
    },
    {
      title: "Luxury Wellness Recognition",
      description: "Recognized for elevated resort hospitality that complements personalized wellness and rejuvenation programs.",
      image: "/Center Images/Soul Vacation Resort and Spa/Awards/Award 2 (luxury, ).png",
    },
    {
      title: "Trusted Wellness Destination",
      description: "Celebrated as a trusted destination for holistic healing journeys guided by experienced wellness professionals.",
      image: "/Center Images/Soul Vacation Resort and Spa/Awards/Award 3 (trust).webp",
    },
  ];
  ...
  const soulVacationMapSrc =
    "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3848.809294121204!2d73.91245947416303!3d15.278192360130452!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbfb418d5585ed9%3A0xd9cb728d729f237c!2sSoul%20Vacation!5e0!3m2!1sen!2sin!4v1770201850603!5m2!1sen!2sin";

  const founderImage = "/Center Images/Soul Vacation Resort and Spa/Founder/founder.jpg";
  const teamImage = "/Center Images/Soul Vacation Resort and Spa/Founder/Team.jpg";

  useEffect(() => {
    fetch("/Center Images/Soul Vacation Resort and Spa/Photo Gallery/Photo Links.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text
          .split("\n")
      ...
      .catch((err) => console.error("Error loading Soul Vacation photo links:", err));

    fetch("/Center Videos/Soul Vacation Resort and Spa/Video links.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text
          .split("\n")
      ...
      .catch((err) => console.error("Error loading Soul Vacation video links:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Soul Vacation Resort and Spa/Patient Stories & Reviews.txt")
      .then((res) => res.text())
      .then((text) => {
      ...
      .catch((err) => console.error("Error loading Soul Vacation reviews:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Soul Vacation Resort and Spa/Insurance & Payment Info.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
      ...
      .catch((err) => console.error("Error loading Soul Vacation insurance content:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Soul Vacation Resort and Spa/Frequently Asked Questions About Soul Vacation.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
      ...
      .catch((err) => console.error("Error loading Soul Vacation FAQs:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Soul Vacation Resort and Spa/Contact Information.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
      ...
      .catch((err) => console.error("Error loading Soul Vacation contact info:", err));
  }, []);
  ...
  useEffect(() => {
    fetch("/content/Top Centers/Soul Vacation Resort and Spa/Wellness Programs.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
      ...
      .catch((err) => console.error("Error loading Soul Vacation wellness content:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Soul Vacation Resort and Spa/Medical Programs.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
      ...
      .catch((err) => console.error("Error loading Soul Vacation medical content:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Soul Vacation Resort and Spa/Why Choose Soul Vacation.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
      ...
      .catch((err) => console.error("Error loading Soul Vacation why-choose content:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Soul Vacation Resort and Spa/Treatment Process & Patient Journey.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
      ...
      .catch((err) => console.error("Error loading Soul Vacation treatment process content:", err));
  }, []);

  useEffect(() => {
    fetch("/Center Images/Soul Vacation Resort and Spa/Facilities/Facilities Links.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text
          .split("\n")
      ...
      .catch((err) => console.error("Error loading Soul Vacation facilities image links:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Soul Vacation Resort and Spa/Facilities & Amenities.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n");
      ...
      .catch((err) => console.error("Error loading Soul Vacation facilities content:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Soul Vacation Resort and Spa/Vision & Team Info.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
        ...
        let section: "intro" | "vision" | "expertise" | "team" = "intro";
        let teamTitle = "";
        const teamDesc: string[] = [];
        ...
        for (const line of lines) {
          ...
          if (line.startsWith("**") && line.endsWith("**")) {
            ...
            if (/leadership/i.test(t)) {
              section = "expertise";
              continue;
            }
            if (/expert wellness team/i.test(t)) {
              section = "team";
              teamTitle = t;
              continue;
            }
        ...
        if (teamTitle) {
          groups.push({
            title: teamTitle,
            description: teamDesc.join(" "),
            items: teamItems,
          });
        }

        setTeamIntro(intro);
        setVisionText(visionParts.join(" "));
        setFounderExpertise(expertise);
        setTeamGroups(groups);
      })
      .catch((err) => console.error("Error loading Soul Vacation vision/team content:", err));
  }, []);
  ...
  const whyIconForTitle = (t: string) => {
    ...
    if (s.includes("goa") || s.includes("beach") || s.includes("sanctuary") || s.includes("location")) return <MapPin className={cls} />;
    if (s.includes("kare") || s.includes("powered") || s.includes("physician") || s.includes("care")) return <Hospital className={cls} />;
    if (s.includes("media") || s.includes("praised") || s.includes("featured")) return <Award className={cls} />;
    if (s.includes("yoga") || s.includes("therapeutic")) return <HeartPulse className={cls} />;
    if (s.includes("cuisine") || s.includes("food") || s.includes("sattvic")) return <Home className={cls} />;
    if (s.includes("ayurveda") || s.includes("wellness") || s.includes("wisdom")) return <Stethoscope className={cls} />;
    if (s.includes("detox") || s.includes("panchakarma")) return <Droplet className={cls} />;
    if (s.includes("nature") || s.includes("serene") || s.includes("tranquil")) return <Leaf className={cls} />;
    if (s.includes("award")) return <Award className={cls} />;
    return <Heart className={cls} />;
  };

  const treatmentIconForTitle = (t: string) => {
    const s = t.toLowerCase();
    if (s.includes("consultation") || s.includes("analysis") || s.includes("assessment")) {
    ...
    if (s.includes("cuisine") || s.includes("nutrition") || s.includes("meals") || s.includes("diet")) {
      return <Utensils className="h-5 w-5 md:h-6 md:w-6 text-primary" />;
    }
    if (s.includes("beach") || s.includes("mindful") || s.includes("living") || s.includes("wellness") || s.includes("relaxation") || s.includes("activities")) {
        ...
        : t.includes("room") || t.includes("suite") || t.includes("accommodation") ? <Building2 className="h-7 w-7 text-white" />
          : t.includes("restaurant") || t.includes("dining") || t.includes("meal") || t.includes("cuisine") ? <Utensils className="h-7 w-7 text-white" />
            : t.includes("pool") || t.includes("swimming") ? <Activity className="h-7 w-7 text-white" />
              : t.includes("beach") || t.includes("location") ? <MapPin className="h-7 w-7 text-white" />
                : t.includes("hospitality") || t.includes("service") ? <Sparkles className="h-7 w-7 text-white" />
                  : t.includes("nature") || t.includes("garden") ? <TreePine className="h-7 w-7 text-white" />
                    : t.includes("award") || t.includes("ambiance") ? <Globe className="h-7 w-7 text-white" />
  ...
  const jumpSections = [
    ...
    { id: "why", title: "Why Choose Soul Vacation" },
    { id: "process", title: "Process & Journey" },
    { id: "cta-mid", title: "Ready to Start" },
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              SOUL VACATION RESORT & WELLNESS CENTER GOA
            </li>
          </ol>
        </div>
      </nav>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="opacity-90">(Highly rated)</span>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
                ...
                {images.length > 0 && (
                  <div className="relative mb-8 rounded-lg overflow-hidden shadow-lg w-full h-[200px] md:h-[500px] lg:h-[400px] group">
                    <img
                      ...
                      alt={`Soul Vacation ${selectedImage + 1}`}
                  ...
                  >
                    <div className="container mx-auto px-4 py-10" onClick={(e) => e.stopPropagation()}>
                      <div className="relative flex items-center justify-center mb-4 pl-16 md:pl-0">
                        ...
                        <div className="text-center text-primary font-bold leading-relaxed whitespace-nowrap text-lg md:text-2xl">Soul Vacation Gallery</div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                        {images.map((img, i) => (
                          ...
                          >
                            <img src={img} alt={`Soul Vacation ${i + 1}`} className="absolute inset-0 w-full h-full object-cover rounded-lg" />
                          </div>
                        ))}
                      </div>
                    </div>
                ...
                {lightboxOpen && (
                  ...
                  >
                    ...
                    <div className="bg-background/90 rounded-xl shadow-2xl p-4 w-full max-w-5xl" onClick={(e) => e.stopPropagation()}>
                      <div className="text-center text-primary text-2xl font-bold mb-3 leading-relaxed">Soul Vacation Resort</div>
                      <div className="relative rounded-lg overflow-hidden w-full" style={{ paddingBottom: "56.25%" }}>
                        {images[lightboxImage] && (
                          <img src={images[lightboxImage]} alt={`Soul Vacation ${lightboxImage + 1}`} className="absolute inset-0 w-full h-full object-cover" />
                        )}
                        <button
                          onClick={() => setLightboxOpen(false)}
          ...
          <Card className="mb-12" id="content">
            <CardContent className="px-4 md:px-8 py-6 md:py-8 prose md:prose-lg max-w-none prose-p:text-justify prose-p:leading-relaxed prose-p:text-base md:prose-p:text-lg">
              <MarkdownContent
                contentPath="/content/Top Centers/Soul Vacation Resort and Spa/main content.txt"
          ...
          <div className="mb-12" id="videos">
            <div className="text-center mb-10">
              <h2 className="text-2xl md:text-4xl font-bold text-primary mb-3">Video Gallery of Soul Vacation</h2>
              <p className="text-base md:text-lg mx-auto px-4 max-w-4xl" style={{ color: "#7F543D" }}>
                Experience the serene atmosphere and holistic healing journey at Soul Vacation through our video gallery.
              </p>
            </div>
          ...
          <div className="mb-12" id="why">
            <div className="text-center mb-10">
              <h2 className="text-xl md:text-4xl font-bold text-primary mb-3">Why Choose Soul Vacation for Your Healing Journey</h2>
            ...
            <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#EDE8D0" }}>
              <div className="md:hidden">
                <div className="max-w-sm mx-auto bg-white/80 rounded-2xl p-4 shadow-lg border-2 border-primary/30">
                  <img
                    src="/Center Images/Soul Vacation Resort and Spa/CTA mid.jpg"
                    alt="Soul Vacation Resort"
          ...
          <div className="mb-12" id="awards">
            <div className="text-center mb-6 md:mb-10">
              ...
              <p className="text-base md:text-lg px-4" style={{ color: "#7F543D" }}>
                Recognition of our excellence in luxury wellness, trusted care, and transformative guest experiences
              </p>
            </div>
                    ...
                    <div className="rounded-2xl bg-white/70 p-1 shadow-lg border-2 border-primary/20 overflow-hidden">
                      <div className="rounded-xl overflow-hidden">
                        <div className="relative w-full aspect-[800/600]">
                          <iframe
                            title="Soul Vacation Map"
                            src={soulVacationMapSrc}
            ...
            <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: '#234A50' }}>
              <div className="md:hidden">
                <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                  <img
                    src="/Center Images/Soul Vacation Resort and Spa/CTA bottom.jpg"
                    alt="Soul Vacation"
                    className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  />
                  <h2 className="text-xl font-bold text-white text-center mb-4">Begin Your Holistic Healing Journey at Soul Vacation</h2>
                  <div className="space-y-3">
                    <Button
                      size="lg"
              ...
              <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <h2 className="text-2xl md:text-4xl font-bold text-white mb-3">Begin Your Holistic Healing Journey at Soul Vacation</h2>
                  <div className="flex flex-wrap gap-3">
...
export default SoulVacationResort;
