...
export default function PranaSpaAyurveda() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Evaluating your physical condition, muscle tension, and individual wellness goals to recommend the ideal therapy or training path.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Technique & Stroke Alignment",
      description: "Customizing massage strokes, pressure intensity, and therapeutic oil selections based on your target areas or chosen course syllabus.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Healing Bodywork",
      description: "Experiencing traditional Ayurvedic therapies, localized massages, or guided hands-on practice sessions under expert supervision.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Anatomical Integration",
      description: "Learning or experiencing how muscle structures, pressure points, and energy lines align during bodywork for effective tension release.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Skin & Face Rejuvenation",
      description: "Nourishing your skin with organic ingredients, steaming, and customized masks to promote cellular repair and complete relaxation.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Post-Session Guidance & Certification",
      description: "Providing lifestyle tips for maintaining well-being, or presenting your official course certificate upon successful completion of training.",
...
They didn't just teach the strokes; they explained energy flow and anatomy.`,
      ...
      condition: "5-Day Massage Training Course",
      rating: 5
    },
    {
...
The therapists were extremely skilled, professional, and had highly healing hands.`,
      ...
      condition: "Shirodhara & Abhyanga Treatment",
      rating: 5
    },
    {
...
The training is very hands-on, encouraging, and personalized for every student.`,
      ...
      condition: "10-Day Massage Certification Course",
      rating: 5
    },
    {
...
It was pure heaven and highly recommended to anyone visiting the local area.`,
      ...
      condition: "45 Minute Delight Massage",
      rating: 5
    },
    {
...
The space is clean, cozy, and perfect for getting away from the busy streets.`,
      ...
      condition: "Swedish & Deep Tissue Massage",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "What types of massage training courses does Prana Spa offer?",
      answer: "We offer professional certification courses structured over 3, 5, 7, and 10 days. These courses cover basic strokes, Swedish and Deep Tissue methodologies, client consultations, and structural anatomy."
    },
    {
      question: "Where is Prana Spa & Ayurveda located in Rishikesh?",
      answer: "Prana Spa is situated on Laxman Jhula Road, opposite the Little Buddha Cafe, Laxman Jhula, Rishikesh, Uttarakhand 249302. It is a highly central and convenient location."
    },
    {
      question: "What wellness treatments and massages are available?",
      answer: "We specialize in traditional Ayurvedic therapies (such as Shirodhara, Abhyanga, and Marma therapy), holistic massages (including Swedish, Deep Tissue, and target sessions like the 35 Minute Bliss and 45 Minute Delight), and organic facial care."
    },
    {
      question: "Do I need prior experience to join the massage courses?",
      answer: "No. Our 3-day and 5-day courses are specifically designed for beginners who want to learn core techniques, while our 7-day and 10-day programs cover advanced methodologies suitable for intermediate and professional practitioners."
    },
    {
      question: "How can I reach Prana Spa and what are the travel distances?",
      answer: "Prana Spa is highly accessible, located approximately 22 km from Jolly Grant Airport (DED) in Dehradun and roughly 10 km from Yog Nagri Rishikesh Railway Station. Haridwar Railway Station is approximately 33 km away."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "A wide variety of massages including Swedish, Deep Tissue, and specialized sessions like the 35 Minute Bliss and 45 Minute Delight to soothe muscle tension.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Ayurvedic Treatments",
      description: "Traditional therapies including Shirodhara, Abhyanga massage, and localized Marma therapy to balance systemic energies and promote healing.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Massage Certification",
      description: "Highly structured training programs spanning 3, 5, 7, or 10 days, covering core strokes, anatomy, client consultation, and practical bodywork.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Yoga & Retreats",
      description: "Customized yoga classes and meditation programs suitable for all levels, guided by certified instructors to cultivate physical ease and mental clarity.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Facial Care",
      description: "Deep cleansing and nourishing skin therapies incorporating gentle steaming, organic exfoliation, customized masks, and rich moisturization.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Holistic Detoxification",
      description: "Combining classical Ayurvedic bodywork, cleansing herbal oils, and custom dietary guidelines to systematically release physical stress and toxins.",
  ...
  const whyChooseUs = [
    {
      ...
      description: "Learn from highly experienced wellness teachers who provide personalized hands-on guidance and structural feedback.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Comprehensive Training",
      description: "Certification courses range from 3-day introductory techniques to comprehensive 10-day therapeutic programs.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Rooted in Prana",
      description: "All treatments are centered around nurturing the universal life force (Prana) to restore physical vitality and peace.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Traditional Ayurvedic Care",
      description: "Authentic therapies like Shirodhara and Abhyanga designed to systematically relieve anxiety and ease muscle stiffness.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Heart of Laxman Jhula",
      description: "Ideally located on Laxman Jhula Road, opposite Little Buddha Cafe, close to local cafes, shops, and spiritual centers.",
      icon: <Globe className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Clean & Professional Space",
      description: "Providing a hygienic, warm, and highly calming sanctuary that is perfectly suited for learning and deep rejuvenation.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
  ...
  useEffect(() => {
    document.title = "Prana Spa & Ayurveda Rishikesh | Holistic Massages & Certification Courses";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Ayurvedic therapies, holistic massages, and professional massage training courses (3-day, 5-day, 7-day, 10-day) at Laxman Jhula, Rishikesh.");
  ...
  return (
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Prana Spa & Ayurveda</h1>
                <p className="text-xl mb-4 opacity-90">Holistic Massages, Ayurvedic Treatments & Certification Courses | Laxman Jhula, Rishikesh</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="opacity-90">(2610 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] leading-tight md:leading-[1.1] max-w-4xl mx-auto px-2">
                Holistic Healing & Massage <br className="hidden lg:block" />
                Certification in Rishikesh
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Prana Spa & Ayurveda</strong>, a tranquil sanctuary located in the heart of Laxman Jhula, Rishikesh. Grounded in the concept of "Prana"—the universal life force that flows through all living beings—our center is dedicated to nurturing this vital energy. We integrate traditional Ayurvedic therapies, holistic massages, and comprehensive training courses to help you achieve a state of complete physical harmony and mental balance.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP cneters/himalayas-rishikesh-uttarakhand-north-east/Prana Spa & Ayurveda (Holy Prana)/secondary.webp" 
                  ...
                  <p>
                    Whether you are seeking deep relaxation through our Swedish and Deep Tissue massages or looking to learn the art of healing bodywork, we offer tailored services for your needs. Our professional massage certification courses (ranging from 3 to 10 days) cover core techniques, practical strokes, and structural anatomy, making them ideal for both beginners and experienced practitioners.
                  </p>

                  <p>
                    Located in a vibrant spiritual hub along Laxman Jhula Road, opposite the Little Buddha Cafe, Prana Spa offers a hygienic and welcoming environment. Our expert therapists and certified instructors provide dedicated personal attention, ensuring you gain either deep physical rejuvenation or the skills and confidence to practice healing massage back home.
                  </p>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/himalayas-rishikesh-uttarakhand-north-east/Prana Spa & Ayurveda (Holy Prana)/main.webp" 
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Prana Spa & Ayurveda today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages in Prana Spa & Ayurveda</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Prana Spa & Ayurveda</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience expert-guided massage training, authentic Ayurvedic therapies, and holistic relaxation in a hygienic and professional sanctuary.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Your Healing Journey in Prana Spa & Ayurveda</h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP cneters/himalayas-rishikesh-uttarakhand-north-east/Prana Spa & Ayurveda (Holy Prana)/main.webp"
                  alt="Prana Spa & Ayurveda center"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Prana Spa & Ayurveda?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Prana Spa & Ayurveda?</h2>
              ...
              <div>
                <img
                  src="/TOP cneters/himalayas-rishikesh-uttarakhand-north-east/Prana Spa & Ayurveda (Holy Prana)/main.webp"
                  alt="Prana Spa & Ayurveda center view"
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments and training courses at Prana Spa & Ayurveda.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-foreground/70 leading-relaxed space-y-2 text-sm md:text-base" style={{ color: "#7F543D" }}>
                      <p>Laxman Jhula Rd, opposite Little Buddha Cafe, Laxman Jhula, Rishikesh, Uttarakhand</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1.5" style={{ color: "#7F543D" }}>
                      ...
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Approx. 10 km from Yog Nagri Rishikesh Railway Station</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3450.970668382687!2d78.3293611!3d30.1236528!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3909165c81a9c37b%3A0xb1be7c3c29226105!2sPrana%20Spa%20%26%20Ayurveda!5e0!3m2!1sen!2sin!4v1780562471339!5m2!1sen!2sin"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Prana Spa & Ayurveda Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="/TOP cneters/himalayas-rishikesh-uttarakhand-north-east/Prana Spa & Ayurveda (Holy Prana)/main.webp"
            alt="Prana Spa & Ayurveda background"
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated wellness therapists will guide you towards the perfect treatment or massage training course at Prana Spa & Ayurveda.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919760115254?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Prana%20Spa%20%26%20Ayurveda."
              target="_blank"
              rel="noreferrer"
