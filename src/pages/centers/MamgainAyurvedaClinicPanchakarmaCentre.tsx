...
export default function MamgainAyurvedaClinicPanchakarmaCentre() {
  ...
  const testimonials = [
    {
      title: "Proficient Panchakarma & Stress Reset",
      review: "I came to Rishikesh feeling completely depleted. Drs. R.K. and Pratibha Mamgain designed a customized 14-day Panchakarma protocol that brought me back to life. Their warmth, clinical precision, and patient-first approach are unmatched.",
      name: "Maryon Maass",
      verified: true,
      location: "USA",
      condition: "Stress Relief & Joint Care",
      rating: 5
    },
    {
      title: "Deeply Spiritual & Meticulous Healing Journey",
      review: "As a yoga teacher visiting Rishikesh, I wanted a traditional Panchakarma detox. The doctors' deep understanding of traditional Ayurveda, combined with daily prayers and therapeutic Abhyanga, completely restored my digestive health. It was a deeply spiritual and clinical journey.",
      name: "Monika Bert",
      verified: true,
      location: "Budapest, Hungary",
      condition: "Chronic Digestion & Yoga Detox",
      rating: 5
    },
    {
      title: "Invaluable Treatment for Joint Stiffness",
      review: "This was my sixth visit to Mamgain's clinic. I have suffered from painful joint stiffness for years, but the warm oil therapies (Kati Basti) and herbal potli massages under the doctors' supervision work wonders every time. It feels like a second home.",
      name: "Agnes Laan",
      verified: true,
      location: "Utrecht, Netherlands",
      condition: "Arthritis & Spinal Care",
      rating: 5
    },
    {
      title: "Highly Compassionate & Effective Care",
      review: "After falling ill during my travels in India, a colleague referred me to Dr. Ravindra and Dr. Pratibha Mamgain. Their diagnosis of my severe skin allergy and the custom herbal cleanses they administered resolved my issues within days. Truly compassionate Vaidyas.",
      name: "Geri Pieri",
      verified: true,
      location: "Chicago, USA",
      condition: "Skin Allergy & Detox",
      rating: 5
    },
    {
      title: "Excellent Asthma & Respiratory Management",
      review: "I chose Mamgain Clinic for their 35 years of clinical expertise. The treatments for my chronic bronchial asthma—using specialized steam inhalations, chest massages, and pure herbal preparations—significantly improved my lung capacity. Highly professional medical care.",
      name: "Hans Weber",
      verified: true,
      location: "Berlin, Germany",
      condition: "Respiratory Asthma Care",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "What are the medical credentials of the consulting doctors at Mamgain's Clinic?",
      answer: "Our senior consultants, Dr. R.K. Mamgain (Dr. Ravindra Kumar Mamgain) and Dr. Pratibha Mamgain, both hold B.A.M.S., M.D., and Ph.D. degrees in Ayurvedic Medicine from the Institute of Medical Sciences, Banaras Hindu University (IMS BHU). They bring over 35 years of clinical, teaching, and research experience to their practice."
    },
    {
      question: "Are the treatments at the clinic conducted under doctor supervision?",
      answer: "Yes, absolutely. All Panchakarma therapies, specialized joint oil treatments, and clinical detox regimes are administered by trained therapists under the strict direct supervision of Dr. R.K. Mamgain and Dr. Pratibha Mamgain."
    },
    {
      question: "What conditions are specialized in at Mamgain's Clinic?",
      answer: "We specialize in classical Panchakarma detoxification, chronic arthritis, joint pain, spinal stiffness, skin disorders (psoriasis, eczema, and allergies), asthma, respiratory ailments, digestive reset, and women's gynecological health."
    },
    {
      question: "Is prior booking required for a consultation?",
      answer: "Yes. In order to ensure dedicated attention and proper clinical evaluation, consultation at our Pashulok clinic is by prior appointment only."
    },
    {
      question: "How far is the clinic from Jolly Grant Airport and Rishikesh railway station?",
      answer: "The clinic is located in Aam Bagh, Pashulok, which is approximately 25 km from Jolly Grant Airport in Dehradun (around 45 minutes by taxi). The Yog Nagari Rishikesh Railway Station is just 5 km away (15 minutes by car/auto)."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "A complete five-fold biological detoxification program including Vamana, Virechana, and Basti supervised by our senior IMS BHU doctors.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Joint & Arthritis Care",
      description: "Targeted clinical protocols for rheumatoid arthritis, sciatica, gout, and spinal disorders utilizing warm herbal oil pools and potli massage.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Rejuvenation & Stress Relief",
      description: "Restorative Rasayana and calmative therapies like Shirodhara and synchronized Abhyangam to balance the nervous system and immunity.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Women's Gynecological Wellness",
      description: "Holistic consultation for hormonal imbalances, prenatal care, and postnatal health, led by gynecologist Dr. Pratibha Mamgain.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Chronic Disease Management",
      description: "Comprehensive care for persistent skin issues (psoriasis, eczema), digestive resets, and chronic metabolic imbalances.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Himalayan Tradition Yoga",
      description: "Spiritual and yogic practices under Swami Veda Bharati's lineage (Swami Rama's disciple) integrated with active healing plans.",
  ...
  const whyChooseUs = [
    {
      title: "35+ Years of Clinical Expertise",
      description: "Academic and clinical background of over 35 years, providing highly trusted, research-backed Ayurvedic treatments.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Double BHU PhD Vaidyas",
      description: "Led by former professors Dr. R.K. Mamgain and Dr. Pratibha Mamgain, both BAMS, MD, and PhD from the prestigious IMS BHU.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Himalayan Tradition Lineage",
      description: "Trained in spiritual and meditation traditions by Swami Veda Bharati, disciple of H.H. Swami Rama.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Calm Pashulok Location",
      description: "Situated in the tranquil Aam Bagh (Pashulok) region of Rishikesh, close to AIIMS Rishikesh and Seema Dental College.",
      icon: <Globe className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Strict Doctor Supervision",
      description: "All therapies and herbal administrations are supervised directly by the doctors, ensuring absolute safety and precision.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Safe & Affordable Care",
      description: "Committed to providing authentic, genuine traditional Ayurvedic and Panchakarma therapies at highly accessible rates.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="opacity-90">(30 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] leading-tight md:leading-[1.1] max-w-4xl mx-auto px-2">
                Genuine Traditional Healing & <br className="hidden lg:block" />
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  ...
                  <p>
                    Our clinic is specialized in genuine clinical treatments, including classical Panchakarma detoxification (Vamana, Virechana, Basti), Potli massages (Patra Pinda Sweda), and localized oil treatments like Kati Basti and Janu Basti. Under the strict supervision of our expert Vaidyas and a team of well-trained therapists, patients receive customized programs to manage chronic arthritis, spinal stiffness, sciatica, respiratory asthma, skin allergies, metabolic diseases, and women's health concerns.
                  </p>
                </div>
              </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Mamgain's Ayurveda Clinic today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at Mamgain's Clinic</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Mamgain's Clinic</h2>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  ...
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Mamgain's Ayurveda Clinic?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Mamgain's Ayurveda Clinic?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at Mamgain's Clinic.</p>
          </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  ...
                  title="Mamgain's Ayurveda Clinic Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment program at Mamgain's Ayurveda Clinic.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919837291005?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Mamgain's%20Ayurveda%20Clinic."
              target="_blank"
              rel="noreferrer"
