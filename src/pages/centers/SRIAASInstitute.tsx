...
export default function SRIAASInstitute() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "A comprehensive review of your medical reports, including kidney function tests, GFR levels, and a thorough analysis of physical symptoms.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Prakriti & Pulse Diagnosis",
      description: "Traditional Ayurvedic Nadi Parikshan (pulse reading) to accurately determine your innate body constitution and current doshic imbalances.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Personalized Herbal Medicine",
      description: "Prescription of highly potent, research-backed herbal formulations designed to repair cellular damage and optimize organ function.",
      icon: <Leaf className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Specialized Renal & Hepatic Diet",
      description: "A meticulously tailored nutritional plan focusing on managing protein, sodium, and potassium intake while naturally supporting healing.",
      icon: <Heart className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Gentle Therapeutic Detox",
      description: "Non-invasive Ayurvedic therapies designed to gently cleanse toxins from the blood without placing additional stress on compromised organs.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Continuous Progress Tracking",
      description: "Regular consultations and monitoring of pathology reports to track improvements and carefully adjust treatment protocols over time.",
  ...
  const testimonials = [
    {
      title: "Remarkable Drop in Creatinine",
      review: "My father's creatinine levels were dangerously high and doctors suggested immediate dialysis. Within two months of SRIAAS's treatment and strict diet, his creatinine dropped significantly, and he regained his energy. Dr. Puru Dhawan's approach is incredible.",
      name: "Sanjay Verma",
      verified: true,
    ...
    {
      title: "Avoided Dialysis Successfully",
      review: "I was terrified when diagnosed with CKD stage 4. The herbal medicines provided here, combined with their excellent dietary counseling, stabilized my GFR. I feel much healthier and have successfully managed to avoid dialysis.",
      name: "Meena Patel",
      verified: true,
      location: "Pune, India",
    ...
    {
      title: "Excellent Relief from Nephrotic Syndrome",
      review: "The severe swelling in my legs and protein loss in urine reduced dramatically after following the SRIAAS protocol for 3 months. The doctors are highly professional, empathetic, and focus on the root cause rather than just symptoms.",
      name: "Rajesh Kumar",
      verified: true,
    ...
    },
    {
      ...
      review: "The liver detox program effectively reversed my early-stage fatty liver and improved my digestion entirely. Their Ayurvedic medicines are purely herbal and highly effective without causing any heavy side effects.",
      name: "Amit Desai",
      verified: true,
    ...
    {
      title: "Trusted Ayurvedic Expertise",
      review: "I have consulted many clinics for my chronic kidney issues, but the scientific approach and clarity provided by the doctors here stand out. My dependence on allopathic medications has decreased and my overall vitality has returned.",
      name: "Sneha Joshi",
      verified: true,
  ...
  const faqItems = [
    {
      question: "What is SRIAAS known for?",
      answer: "SRIAAS (SR Institute of Advanced Ayurvedic Sciences), guided by Dr. Puru Dhawan, is globally recognized for its highly specialized, research-driven Ayurvedic treatments for chronic kidney diseases, aiming to reduce dependency on dialysis through natural means."
    },
    {
      question: "Can Ayurveda effectively treat Chronic Kidney Disease?",
      answer: "Yes, SRIAAS uses potent, clinically researched herbal formulations and strict dietary protocols designed to repair cellular damage, reduce creatinine levels, and improve the Glomerular Filtration Rate (GFR) naturally without surgical interventions."
    },
    {
      question: "Who leads the medical team at SRIAAS?",
      answer: "The institute is led by Dr. Puru Dhawan, a globally renowned Ayurvedic physician who has pioneered evidence-based approaches to renal care, blending classical Ayurvedic wisdom with modern scientific parameters."
    },
    {
      question: "Do you offer treatments for conditions other than kidney disease?",
      answer: "Yes, while globally acclaimed for nephrology, SRIAAS also provides comprehensive, highly effective treatments for liver disorders, chronic respiratory conditions, autoimmune diseases, and complex metabolic syndromes."
    },
    {
      question: "Where is the clinic located in Mumbai?",
      answer: "The clinic is conveniently located in Andheri West, Mumbai, providing a highly professional and hygienic environment for both local and international patients seeking advanced Ayurvedic care."
    }
  ];

  const programs = [
    {
      title: "Advanced Kidney Care (CKD)",
      description: "Scientifically formulated herbal protocols focused on improving GFR, lowering high creatinine, and managing the progression of CKD.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Dialysis Avoidance Protocols",
      description: "Intensive Ayurvedic management designed to naturally restore renal function and reduce the frequency of or need for dialysis.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Liver Disorder Management",
      description: "Potent detoxifying herbal regimens targeting fatty liver, hepatitis, early cirrhosis, and overall hepatic rejuvenation.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Metabolic Syndrome Care",
      description: "Holistic care for severe diabetes and hypertension to prevent their secondary, damaging impact on vital organs like the kidneys.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Nephrotic Syndrome Relief",
      description: "Targeted Ayurvedic interventions to stop protein leakage in urine and significantly reduce body swelling (edema).",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Autoimmune & Immunity Support",
      description: "Advanced Rasayana therapies designed to deeply modulate the immune system and manage chronic autoimmune disorders.",
  ...
  const whyChooseUs = [
    {
      title: "Pioneers in Ayurvedic Nephrology",
      description: "Globally recognized for successfully managing severe renal conditions and improving patient quality of life without invasive procedures.",
      icon: <Globe className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Led by Dr. Puru Dhawan",
      description: "Operating under the visionary guidance of one of India's most celebrated and clinically successful Ayurvedic kidney specialists.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Evidence-Based Protocols",
      description: "We rigorously track patient progress using modern pathology reports alongside traditional Ayurvedic diagnostic methods.",
      icon: <FileSearch className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Potent Botanical Extracts",
      description: "Utilizing highly researched, pure extracts of life-saving Ayurvedic herbs proven to support organ regeneration and repair.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Comprehensive Dietary Guidance",
      description: "Providing meticulous, highly personalized diet charts that form the crucial foundation for the success of renal and hepatic recovery.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Patient-Centric Care",
      description: "A highly dedicated team providing continuous support, follow-ups, and education to ensure long-term, sustainable healing.",
  ...
  useEffect(() => {
    document.title = "SRIAAS | SR Institute of Advanced Ayurvedic Sciences Mumbai";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience advanced Ayurvedic care for chronic kidney and liver diseases at SRIAAS in Andheri West, Mumbai, led by Dr. Puru Dhawan.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              SRIAAS – SR Institute of Advanced Ayurvedic Sciences Mumbai
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>SRIAAS – SR Institute of Advanced Ayurvedic Sciences</h1>
                <p className="text-xl mb-4 opacity-90">Advanced, Research-Driven Ayurvedic Care Specializing in Kidney & Chronic Conditions</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="opacity-90">(289+ Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">SRIAAS (SR Institute of Advanced Ayurvedic Sciences)</strong>, a pioneering and highly reputed institution dedicated to treating severe chronic illnesses through evidence-based Ayurveda. Guided by the visionary expertise of Dr. Puru Dhawan, our center has emerged as a global beacon of hope, particularly for patients battling advanced kidney diseases and complex liver disorders. By strictly adhering to deep-rooted Ayurvedic traditions while continuously evolving our methodologies to meet the stringent demands of modern healthcare, SRIAAS stands out as an unparalleled center for natural, restorative healing.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/SRIAAS – SR Institute of Advanced Ayurvedic Sciences/image 2.webp" 
                          alt="SRIAAS clinic interior"
                  ...
                  <p>
                    Our facility in Andheri West, Mumbai, brings world-class Ayurvedic expertise directly to the western region. Globally renowned for successfully managing Chronic Kidney Disease (CKD) and drastically reducing the immediate need for dialysis or transplants, SRIAAS employs highly potent, customized herbal formulations backed by rigorous clinical data. We provide highly individualized dietary counseling, specialized herbal therapies, and continuous patient education to ensure that healing is not just a temporary medical intervention, but a lifelong, sustainable transformation towards absolute vitality.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/SRIAAS – SR Institute of Advanced Ayurvedic Sciences/image 1.webp" 
                      alt="SRIAAS facility"
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with SRIAAS today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> SRIAAS
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> SRIAAS
              </h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Discover the difference of evidence-based Ayurvedic nephrology and chronic care, backed by advanced scientific research.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> SRIAAS
            </h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A structured, evidence-based approach combining classical Ayurvedic diagnosis with modern pathological insights to revive organ function.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  ...
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/7.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at SRIAAS?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at SRIAAS?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, diagnosis, and specialties at SRIAAS.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      SR Institute of Advanced Ayurvedic Sciences<br />
                      Andheri West<br />
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Located conveniently in Andheri West, easily accessible from central Mumbai.</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Well-connected for out-of-town patients arriving from Chhatrapati Shivaji Airport.</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=SRIAAS+Andheri+West+Mumbai&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Join thousands of patients who have discovered true renal and holistic healing with SRIAAS.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919560113189?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20SRIAAS."
              target="_blank"
              rel="noreferrer"
