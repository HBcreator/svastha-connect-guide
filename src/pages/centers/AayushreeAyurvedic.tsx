...
export default function AayushreeAyurvedic() {
  ...
  const testimonials = [
    {
      title: "Excellent Panchakarma",
      review: "The Panchakarma therapy at Aayushree Ayurvedic was transformative. I travelled from Dubai for their authentic treatments, and the results for my back pain have been remarkable.",
      name: "Michael R.",
      verified: true,
      location: "Dubai, UAE",
      condition: "Back Pain",
    ...
    {
      title: "Great Care for Joints",
      review: "I visited from London specifically for knee pain. The Vaidyas here are exceptionally knowledgeable. Their Kati Basti treatment provided the relief I had been seeking for years.",
      name: "Emma W.",
      verified: true,
      location: "London, UK",
    ...
    },
    {
      ...
      review: "The Shirodhara sessions completely resolved my chronic stress. A beautiful, authentic Ayurvedic clinic in the heart of Mumbai. Highly recommended to international travelers.",
      name: "John S.",
      verified: true,
    ...
    {
      title: "Holistic Skin Treatment",
      review: "After years of struggling with skin issues in Canada, the deep blood purification protocols at Aayushree finally gave me clear skin. The personalized approach is unmatched.",
      name: "Chloe D.",
      verified: true,
    ...
    },
    {
      ...
      review: "The Udvartana and dietary corrections recommended by the expert team helped me manage my weight naturally and sustainably. The clinic environment is incredibly supportive.",
      name: "Sarah C.",
      verified: true,
  ...
  const faqItems = [
    {
      question: "Who leads the medical team at Aayushree Ayurvedic?",
      answer: "Aayushree Ayurvedic is led by highly qualified and board-certified BAMS physicians with extensive clinical experience in authentic Panchakarma treatments."
    },
    {
      question: "What conditions do you specialize in treating?",
      answer: "We specialize in treating joint pain (knee, back, shoulder), sciatica, chronic skin conditions, diabetes, obesity, and stress management."
    },
    {
      question: "Are your Panchakarma therapies authentic?",
      answer: "Yes, we strictly follow classical Ayurvedic protocols, offering full Panchakarma programs including Vaman, Virechana, Basti, Nasya, and Raktamokshana."
    },
    {
      question: "Where is the clinic located?",
      answer: "We are centrally located in Borivali West, Mumbai, near the Link View Hotel, making us easily accessible for both local residents and international patients."
    },
    {
      question: "What are your operating hours?",
      answer: "We are typically open from Monday to Saturday, 8:00 AM to 9:00 PM. We recommend booking an appointment in advance for a thorough consultation."
    }
  ];
  ...
  const whyChooseUs = [
    {
      ...
      description: "Led by Expert Vaidyas, bringing profound academic and clinical expertise in Panchakarma.",
    ...
    },
    {
      ...
      description: "Achieving a remarkable patient satisfaction rate, especially in specialized programs like Shirodhara.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
    ...
    },
    {
      ...
      description: "Conveniently situated in Borivali West, offering a highly accessible, peaceful healing environment.",
  ...
  useEffect(() => {
    document.title = "Aayushree Ayurvedic – Polyclinic & Panchakarma Center | Authentic Care";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience personalized Ayurvedic treatments and Panchakarma led by Expert Vaidyas at Aayushree Ayurvedic in Borivali West, Mumbai.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Aayushree Ayurvedic – Polyclinic & Panchakarma Center Mumbai
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Aayushree Ayurvedic <br className="hidden md:block" /> – Polyclinic & Panchakarma Center</h1>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Aayushree Ayurvedic – Polyclinic & Panchakarma Center</strong>, a highly trusted and result-driven Ayurvedic sanctuary located in Borivali West, Mumbai. Founded and led by Expert Vaidyas, a board-certified Ayurvedic physician, we bring profound clinical experience to our patients. Recognizing that no two bodies are alike, we pride ourselves on delivering highly tailored, uncompromisingly authentic Ayurvedic care that seamlessly blends deep traditional wisdom with modern clinical efficacy and safety standards.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/Aayushree Ayurvedic – Polyclinic & Panchakarma Center/image 2.jpg" 
                          alt="Aayushree Ayurvedic therapy room"
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/Aayushree Ayurvedic – Polyclinic & Panchakarma Center/image 1.jpg" 
                      alt="Aayushree Ayurvedic main view"
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Aayushree Ayurvedic today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Aayushree Ayurvedic
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Aayushree Ayurvedic
              </h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience world-class traditional healthcare backed by extensive expertise, authentic medicines, and highly personalized care.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Aayushree Ayurvedic
            </h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/Aayushree Ayurvedic – Polyclinic & Panchakarma Center/image 2.jpg"
                  alt="Aayushree Ayurvedic view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/1.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Aayushree Ayurvedic?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Aayushree Ayurvedic?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and specialties at Aayushree Ayurvedic.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Aayushree Ayurvedic – Polyclinic & Panchakarma Center<br />
                      Borivali West<br />
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Located centrally in Borivali West for excellent connectivity in Mumbai.</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=Aayushree+Ayurvedic+Polyclinic+&+Panchakarma+Centre,+Borivali+West,+Mumbai&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Aayushree Ayurvedic Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or therapy program at Aayushree Ayurvedic.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/9198xxxxxxxx?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Aayushree%20Ayurvedic."
              target="_blank"
              rel="noreferrer"
