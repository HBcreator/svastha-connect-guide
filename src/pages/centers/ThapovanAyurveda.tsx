...
export default function ThapovanAyurveda() {
  ...
  const treatmentProcess = [
    {
      number: 1,
      title: "In-Depth Kerala Diagnosis",
      description: "A comprehensive traditional consultation with our experienced BAMS doctors to evaluate your Prakriti (body constitution) and Vikriti (imbalances).",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Customized Therapy Planning",
      description: "Developing a tailored protocol using specific Kerala Ayurvedic therapies like Podikizhi or Udwarthanam depending on your health goals.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Purvakarma & Preparation",
      description: "Preparing the body for deep healing through authentic external oleation (Snehana) and herbal steam fomentation (Swedana).",
      icon: <Leaf className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Core Panchakarma execution",
      description: "Administering the primary detoxification or pain management therapies in our hygienic, serene, and well-equipped treatment rooms.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Rejuvenating Marma Therapy",
      description: "Expert application of pressure on vital energy points (Marma) by our highly skilled therapists to release deep-seated tension and pain.",
      icon: <Heart className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Diet & Lifestyle Integration",
      description: "Providing you with personalized dietary guidelines and lifestyle adjustments to maintain the benefits of the therapies long-term.",
  ...
  const testimonials = [
    {
      title: "Incredible Relief from Back Pain",
      review: "I had severe lower back pain for months. The specialized Kati Basti and Podikizhi treatments here worked wonders. The therapists are extremely skilled and professional. Highly recommend Thapovan to anyone in pain.",
      name: "Vikram Sharma",
      verified: true,
    ...
    },
    {
      ...
      review: "Finding genuine Kerala Ayurveda in Mumbai is tough, but Thapovan delivers exactly that. The Shirodhara session was deeply relaxing, and the clinic's hygiene and peaceful ambience immediately put you at ease.",
      name: "Priya Desai",
      verified: true,
    ...
    },
    {
      ...
      review: "I couldn't lift my arm due to a frozen shoulder. After a 14-day intensive Ayurvedic therapy course guided by the doctors here, my mobility is almost 100% back without any painkillers or injections.",
      name: "Rahul Mehta",
      verified: true,
    ...
    {
      title: "Excellent Weight Management",
      review: "The Udwarthanam (herbal powder massage) package really helped me shed stubborn fat and feel incredibly light. The doctors monitor your progress closely and provide an excellent, easy-to-follow diet chart.",
      name: "Sneha Nair",
      verified: true,
    ...
    },
    {
      ...
      review: "From the front desk to the doctors and the therapists, everyone at Thapovan is incredibly caring. They take the time to explain every step of the Panchakarma process. Truly the best Ayurvedic center in Powai.",
  ...
  const faqItems = [
    {
      question: "Where is Thapovan Ayurveda located?",
      answer: "Thapovan Ayurveda is conveniently located in Galleria Shopping Mall, Hiranandani Gardens, Powai, Mumbai. We provide a peaceful and authentic healing sanctuary right in the heart of the city."
    },
    {
      question: "Are your therapists trained in Kerala Ayurveda?",
      answer: "Yes, all our therapists are highly experienced and specifically trained in authentic Kerala Ayurvedic techniques, ensuring you receive the highest standard of classical treatments."
    },
    {
      question: "What types of conditions do you specialize in?",
      answer: "We specialize in pain management (including knee pain, back pain, and frozen shoulder), stress relief, comprehensive Panchakarma detoxification, and specialized weight management therapies like Udwarthanam."
    },
    {
      question: "Is prior consultation with a doctor necessary before a massage?",
      answer: "Yes, to ensure maximum benefit and safety, we strongly recommend a consultation with our experienced BAMS doctors who will assess your body constitution (Prakriti) and prescribe the most appropriate medicated oils and therapies."
    },
    {
      question: "Do you offer full Panchakarma programs?",
      answer: "Absolutely. We offer complete, classical Panchakarma detoxification programs customized to your specific health requirements, ranging from 7 to 21 days depending on the clinical assessment."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Highly effective treatments like Kati Basti and Podikizhi aimed at relieving chronic back, knee, neck, and joint pain.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Classical Panchakarma",
      description: "Deep cellular detoxification programs designed to cleanse the body of accumulated toxins and restore metabolic harmony.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Udwarthanam Weight Loss",
      description: "Specialized deep tissue herbal powder massages that break down subcutaneous fat and stimulate lymphatic drainage.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stress & Anxiety Relief",
      description: "Deeply calming therapies including authentic Shirodhara and Abhyanga to soothe the nervous system and promote deep sleep.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Musculoskeletal Rehab",
      description: "Focused therapies using warm medicated oils (Pizhichil) to treat frozen shoulder, arthritis, and sports injuries.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Rejuvenation Therapy",
      description: "Rasayana therapies designed to boost immunity, improve vitality, and promote healthy aging through classical Kerala protocols.",
  ...
  const whyChooseUs = [
    {
      ...
      description: "We bring the pure, unadulterated traditions of classical Kerala Ayurveda directly to the heart of Mumbai.",
      icon: <Globe className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Highly Skilled Therapists",
      description: "Our dedicated therapists have years of hands-on experience and rigorous training in specialized traditional techniques.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Exceptional Hygiene",
      description: "We maintain the highest standards of cleanliness and hygiene in all our therapy rooms to ensure a safe, relaxing experience.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Expert BAMS Doctors",
      description: "All treatments are strictly prescribed and monitored by our highly qualified and experienced Ayurvedic physicians.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Genuine Herbal Oils",
      description: "We use only premium, authentic medicated oils and herbal preparations sourced directly from traditional pharmacies.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Premium Powai Location",
      description: "Easily accessible in Hiranandani Gardens, our clinic provides a serene escape from the bustling city outside.",
  ...
  useEffect(() => {
    document.title = "Thapovan Ayurveda Powai | Premium Kerala Ayurvedic Treatments";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Kerala Ayurveda at Thapovan Ayurveda in Powai, Mumbai. Specializing in Panchakarma, pain management, and holistic wellness.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Thapovan Ayurveda</h1>
                <p className="text-xl mb-4 opacity-90">Premium Authentic Kerala Ayurveda Treatment Centre in Mumbai</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Powai, Mumbai, Maharashtra, India</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.8</span>
                  <span className="opacity-90">(273+ Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Thapovan Ayurveda</strong>, a premium destination for authentic Kerala Ayurvedic healing nestled in the heart of Powai, Mumbai. With a stellar reputation and an outstanding Google rating, Thapovan is highly regarded for bringing the unadulterated, classical traditions of Ayurvedic medicine directly to the city. We explicitly distinguish ourselves from commercial spa centers by focusing entirely on deep, clinical, and genuine therapeutic outcomes designed to address the root causes of disease.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/Thapovan Ayurveda/image 2.webp" 
                          alt="Thapovan Ayurveda clinic interior"
                  ...
                  <p>
                    Led by highly experienced BAMS doctors and supported by a team of rigorously trained therapists from Kerala, we offer an extensive range of specialized treatments. From highly effective pain management protocols for chronic conditions like arthritis, sciatica, and frozen shoulder, to complete Panchakarma detoxification programs and stress relief therapies like Shirodhara, every treatment is customized. At Thapovan Ayurveda, you will experience the perfect synergy of exceptional hygiene, professional care, and profound ancient wisdom, ensuring your path to recovery is both serene and highly effective.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/Thapovan Ayurveda/image 1.webp" 
                      alt="Thapovan Ayurveda facility"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP centers/mumbai pune nashik/Thapovan Ayurveda/image 2.webp" 
                        alt="Thapovan Ayurveda consultation"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/7.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Thapovan Ayurveda today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Thapovan Ayurveda
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Thapovan Ayurveda
              </h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Discover the difference of authentic Kerala Ayurveda, combining classical therapies with highly skilled execution.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Thapovan Ayurveda
            </h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A structured and deeply personalized approach to restore your body's natural balance and vitality.
            </p>
          </div>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/Thapovan Ayurveda/image 2.webp"
                  alt="Thapovan Ayurveda view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/7.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Thapovan Ayurveda?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Thapovan Ayurveda?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, diagnosis, and specialties at Thapovan Ayurveda.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Thapovan Ayurveda<br />
                      A 405, Galleria Shopping Mall, 4th Floor<br />
                      Hiranandani Gardens, Powai, Mumbai 400076<br />
                      Maharashtra, India
                    </p>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Located prominently inside the Galleria Mall in Hiranandani Gardens, Powai.</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Convenient access via Eastern Express Highway or JVLR.</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=Thapovan+Ayurveda+Powai+Mumbai&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Thapovan Ayurveda Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Discover genuine Kerala Ayurvedic healing at Thapovan Ayurveda in Powai.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919930528007?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Thapovan%20Ayurveda."
              target="_blank"
              rel="noreferrer"
