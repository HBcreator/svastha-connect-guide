            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-lg md:text-xl leading-relaxed text-foreground/80 text-justify md:text-left" style={{ color: "#7F543D" }}>
                  ...
                  <p>
                    Directed by a senior panel of highly qualified BAMS and MD practitioners, including <strong className="font-bold">Dr. M. Harikrishnan</strong> (MD Ayurveda), <strong className="font-bold">Dr. V. Indumathi</strong> (MD Ayurveda), <strong className="font-bold">Dr. Vinodini Varma</strong> (BAMS), and <strong className="font-bold">Dr. S. Karpagam</strong> (BAMS), the clinic offers highly customized wellness roadmaps. Every healing journey begins with a traditional diagnostic assessment. The clinic features premium, hygienic therapy suites adhering strictly to NABH standards, a fully stocked pharmacy of genuine Kottakkal formulations, and comprehensive support for health insurance reimbursement.
                  </p>
                </div>
              </div>
