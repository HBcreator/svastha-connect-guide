...
export default function KottakkalAryaVaidyaSala() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Thorough physical diagnostic assessment and medical history review guided by classical Ayurvedic principles.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Customized Remedial Mapping",
      description: "Designing a highly personalized therapeutic blueprint specifying exact botanical formulations, target therapies, and strict dietary guidelines.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Preparatory Mobilization (Purvakarma)",
      description: "Administering synchronic Abhyangam and herbal steam baths (Swedana) to loosen deep somatic impurities.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Classical Purifying Detox",
      description: "Executing precise, clinically monitored physiological cleansing procedures tailored specifically to eliminate metabolic wastes.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Targeted Localized Procedures",
      description: "Administering targeted external oil pools (such as Kati Vasti or Greeva Vasti) and specialized therapies to target localized spinal or joint pain.",
  ...
  const testimonials = [
    ...
    },
    {
      ...
      condition: "Severe Insomnia & Burnout",
      rating: 5
    },
    {
  ...
  const faqItems = [
    {
      question: "What makes the Mahalingapuram Kottakkal branch unique in Chennai?",
      answer: "Our Mahalingapuram center is a directly authorized franchise clinic of the legendary Arya Vaidya Sala (AVS) Kottakkal. We bring their 120-year-old healing legacy, authentic AVS-manufactured medicines, highly qualified senior Vaidyahs, and skilled Keralite therapists to deliver genuine Kerala Ayurvedic healthcare in Chennai."
    },
    {
      question: "Who are the consulting doctors at the Mahalingapuram center?",
      answer: "The clinic features an eminent panel of senior physicians, including Dr. M. Harikrishnan, Dr. V. Indumathi, Dr. Vinodini Varma, and Dr. S. Karpagam. They offer detailed consultations, pulse diagnosis, and personalized treatment mapping for chronic diseases and pain management."
    },
    {
      question: "What treatments are offered for joint stiffness and orthopedic issues?",
      answer: "We offer specialized non-surgical rehabilitation for joint and spinal conditions. Therapies like Pizhichil (warm oil bath), Elakizhi (herbal leaf poultice), Janu Vasti, and Kati Vasti are combined with authentic Kottakkal formulations to reduce nerve compression, lubricate joints, and soothe inflammation."
    },
    {
      question: "Do you sell genuine Kottakkal Ayurvedic medicines at the clinic?",
      answer: "Yes, our clinic features a fully stocked authentic Kottakkal Arya Vaidya Sala pharmacy. We dispense the complete range of genuine AVS-manufactured oils, Kashayams, Lehyams, Arishtams, and single-herb formulations directly to patients."
    },
    {
      question: "Is health insurance claim assistance available at this branch?",
      answer: "Yes, we provide all required clinical case sheets, medical certificates, and diagnostic logs to facilitate hassle-free private and corporate health insurance reimbursement claims."
    }
  ];

  const programs = [
    {
      title: "Classical Panchakarma Purifications",
      description: "Meticulously administered 5-fold detoxification therapies (Vamana, Virechana, Vasti, Nasya, Raktamokshana) to systematically purge deep-seated cell toxins and restore dosha balance.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Spine & Joint Restoration",
      description: "Targeted clinical care addressing herniated discs, chronic lower back pain, sciatica, cervical spondylosis, and severe osteoarthritic joint pain without surgical intervention.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Genuine Kerala Restoratives",
      description: "Synchronic body treatments such as Abhyangam (herbal oil massage), Pizhichil (warm oil bath), and herbal poultice massage (Elakizhi) to enhance joint lubrication and soothe inflammation.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stress & Neurological Care",
      description: "Deeply relaxing therapies like Shirodhara (warm medicated oil pouring) and specialized head packs (Talapodichil) to soothe chronic fatigue, anxiety, insomnia, and nervous exhaustion.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Specialized Chronic Disease Support",
      description: "Comprehensive, physician-supervised care plans targeting lifestyle illnesses like diabetes, metabolic sluggishness, obesity, and cardiovascular wellness.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Respiratory & Skin Care Regimens",
      description: "Guided therapeutic Nasya (nasal therapy), botanical steam baths, and freshly prepared herbal formulations to address chronic sinusitis, migraines, allergies, eczema, and psoriasis.",
  ...
  const whyChooseUs = [
    {
      title: "Century-Old Healing Heritage",
      description: "Backed by the rich legacy of Arya Vaidya Sala (AVS) Kottakkal, India's most respected Ayurvedic institution founded in 1902 by Vaidyaratnam P.S. Varier.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Eminent Doctor Panel",
      description: "Consult with senior BAMS and MD practitioners, including Dr. M. Harikrishnan, Dr. V. Indumathi, Dr. Vinodini Varma, and Dr. S. Karpagam.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "NABH Quality Compliance",
      description: "Operating under strict quality control standards, ensuring complete clinical sanitization, patient safety, and operational excellence.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Highly Trained Keralite Therapists",
    ...
    {
      title: "Authentic Kottakkal Formulations",
      description: "Direct, single-source access to genuine, high-potency AVS Kottakkal-manufactured Oushadhis, Kashayams, oils, and Single-Herb extracts.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Health Insurance Claim Assistance",
  ...
  useEffect(() => {
    document.title = "Kottakkal Arya Vaidya Sala - Mahalingapuram | Best Ayurvedic Clinic in Chennai";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Book consultations at Kottakkal Arya Vaidya Sala Clinic in Mahalingapuram, Chennai. Experience authentic Kerala Ayurveda, classical Panchakarma, and genuine Kottakkal medicines from highly qualified senior doctors.");
  ...
  return (
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Kottakkal Arya Vaidya Sala – Mahalingapuram</h1>
                <p className="text-xl mb-4 opacity-90">Authorized Franchise Center & Legendary Kerala Ayurveda Heritage</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Mahalingapuram, Chennai, Tamil Nadu</span>
                </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] leading-tight md:leading-[1.1] max-w-4xl mx-auto px-2">
                NABH-Compliant Kerala Ayurveda <br className="hidden lg:block" />
                at Kottakkal Arya Vaidya Sala
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-lg md:text-xl leading-relaxed text-foreground/80 text-justify md:text-left" style={{ color: "#7F543D" }}>
                    ...
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          ...
                          alt="Kottakkal Arya Vaidya Sala Mahalingapuram Exterior"
                  ...
                  <p>
                    Directed by a senior panel of highly qualified BAMS and MD practitioners, including <strong className="font-bold text-[#2C4E5A]">Dr. M. Harikrishnan</strong> (MD Ayurveda), <strong className="font-bold text-[#2C4E5A]">Dr. V. Indumathi</strong> (MD Ayurveda), <strong className="font-bold text-[#2C4E5A]">Dr. Vinodini Varma</strong> (BAMS), and <strong className="font-bold text-[#2C4E5A]">Dr. S. Karpagam</strong> (BAMS), the clinic offers highly customized wellness roadmaps. Every healing journey begins with a traditional diagnostic assessment. The clinic features premium, hygienic therapy suites adhering strictly to NABH standards, a fully stocked pharmacy of genuine Kottakkal formulations, and comprehensive support for health insurance reimbursement.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                       src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Kottakkal Arya Vaidya Sala - Mahalingapuram/main.webp" 
                       alt="Kottakkal Arya Vaidya Sala Mahalingapuram Center"
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        ...
                        alt="Therapy chamber at Kottakkal Arya Vaidya Sala Mahalingapuram"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Kottakkal Arya Vaidya Sala Mahalingapuram today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at Kottakkal Arya Vaidya Sala</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Kottakkal Arya Vaidya Sala</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Discover a premier clinical environment combining a 120-year Ayurvedic heritage, specialty therapies, and dedicated patient care.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Your Healing Journey at Kottakkal Arya Vaidya Sala</h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A structured, integrated recovery pathway directed entirely by senior physicians, from traditional diagnostic assessment to customized continuing care.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  ...
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/9.JPG"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Kottakkal Arya Vaidya Sala?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Kottakkal Arya Vaidya Sala?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at Kottakkal Arya Vaidya Sala.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Kottakkal Arya Vaidya Sala - Mahalingapuram<br />
                      No. 53, New No. 2/2, Madhavan Nair Road<br />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1" style={{ color: "#7F543D" }}>
                      <li>• Approx. 13 km from Chennai International Airport (MAA)</li>
                      <li>• Approx. 7.5 km from Chennai Central Railway Station (MAS)</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3886.6583187929477!2d80.22969567507795!3d13.057407587265896!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5267b1cb75b833%3A0x7fd7c419055cbfc3!2sKotakal%20Arya%20Vadya%20Sala%20Mahaligapuram%20Chennai!5e0!3m2!1sen!2sin!4v1779755096515!5m2!1sen!2sin"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Kottakkal Arya Vaidya Sala Mahalingapuram Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Kottakkal Arya Vaidya Sala - Mahalingapuram/main.webp"
            alt="Ayurvedic Therapy at Kottakkal Arya Vaidya Sala"
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment program at Kottakkal Arya Vaidya Sala Mahalingapuram.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/917358063902?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Kottakkal%20Arya%20Vaidya%20Sala%20Mahalingapuram."
              target="_blank"
              rel="noreferrer"
