...
export default function AdivaidyamAyurvedaHospital() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Thorough evaluation by Dr. Savitha Sagar and her team to understand your complete medical history.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Root Cause Analysis",
      description: "Diagnosing the root cause of disorders using traditional Ayurvedic methods to ensure targeted treatments.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Natural Organic Medications",
      description: "Prescribing 100% natural, preservative-free medications tailored to your unique dosha and condition.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Authentic Therapies",
      description: "Implementation of specialized therapies like Panchakarma and Kerala treatments using 100% pure oils.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Yoga & Lifestyle",
      description: "Integrating Yoga practices and dietary adjustments to support metabolic, digestive, and overall well-being.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Holistic Recovery",
      description: "Ongoing tracking and follow-ups to ensure a complete transition to a healthier, disease-free life.",
  ...
  const testimonials = [
    {
      title: "Profound Panchakarma Detox",
      review: "I traveled from Ireland specifically to undergo a 14-day Panchakarma detox. Dr. Savitha's approach was incredibly thorough. The use of 100% pure oils made a huge difference, and I left feeling completely revitalized.",
      name: "Liam O'Connor",
      verified: true,
    ...
    {
      title: "Authentic Kerala Treatments",
      review: "Struggling with chronic lower back pain, I tried their authentic Kerala treatments. The integration of traditional Ayurveda and daily Yoga sessions significantly improved my mobility. It’s a very hygienic and peaceful clinic.",
    ...
    {
      title: "Deeply Relaxing Body Massage",
      review: "I booked an Ayurvedic body massage to relieve severe work stress. The therapists were highly skilled, and the preservative-free herbal oils melted away my muscle tension. A truly authentic experience in Bangalore.",
      name: "Mateo Silva",
      verified: true,
    ...
    {
      title: "Amazing Skin and Beauty Care",
      review: "I opted for their natural beauty therapies for my sensitive skin. They use strictly organic, chemical-free herbal preparations. My skin has never felt healthier or looked more radiant. Highly recommend!",
      name: "Elena Costa",
      verified: true,
    ...
    },
    {
      ...
      review: "What makes Adivaidyam special is how they combine Ayurveda with Yoga. Dr. Savitha correctly diagnosed my gut issues and provided natural medications that actually worked. Exceptional patient care.",
  ...
  const faqItems = [
    {
      question: "What types of Ayurvedic treatments do you specialize in?",
      answer: "We specialize in a comprehensive range of therapies including Panchakarma detoxification, authentic Kerala treatments, Ayurvedic body massages, and specialized skin and hair care using purely natural ingredients."
    },
    {
      question: "Are your medications and oils completely natural?",
      answer: "Yes, absolutely. We strictly adhere to authentic Ayurvedic practices by utilizing 100% pure oil medications and prescribing organic herbal medicines that are completely free of artificial preservatives."
    },
    {
      question: "Who will be guiding my treatment plan?",
      answer: "Your treatment will be personally overseen by Dr. Savitha Sagar, our Managing Director. She holds an MS and BAMS from GAMC Bangalore, bringing over 18 years of clinical expertise in treating chronic disorders."
    },
    {
      question: "Do you integrate Yoga into your Ayurveda treatments?",
      answer: "Yes, Adivaidyam is uniquely positioned as a holistic center that seamlessly combines classical Ayurveda with Yoga. We offer integrated Yoga classes to support physical and mental recovery alongside your treatments."
    },
    {
  ...
  const programs = [
    {
      ...
      description: "A holistic detox and rejuvenation therapy customizing cleansing treatments to remove toxins, restore balance, and promote well-being.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Ayurvedic Body Massage",
      description: "Uses herbal oils to relax, detox, and rejuvenate, fostering overall health and vitality through a holistic approach.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Kerala Treatments",
      description: "Discover authentic Kerala Ayurveda treatments, rooted in centuries of wisdom, restoring balance and vitality.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Beauty Therapies",
      description: "Ayurvedic beauty therapies use natural methods and herbal ingredients to enhance inner and outer radiance.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin And Hair Care",
      description: "Natural, holistic solutions using herbs and traditional practices to address skin and hair health.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Yoga Classes",
      description: "Integrative yoga practices to support your physical and mental well-being in tandem with Ayurvedic healing.",
  ...
  const whyChooseUs = [
    {
      ...
      description: "We strictly adhere to traditional Ayurvedic practices, utilizing 100% pure oil medications for all our therapies.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Experienced Doctor",
      description: "Led by Dr. Savitha Sagar, bringing 18 years of expertise in treating numerous chronic disorders.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Natural Medications",
      description: "We prescribe natural, organic medications that are completely free of preservatives, showcasing Ayurveda's uniqueness.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Comprehensive Range",
      description: "From Panchakarma to Kerala treatments and beauty therapies, we offer holistic healing under one roof.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Ayurveda & Yoga",
      description: "We are a unique Ayurveda hospital that seamlessly combines both Ayurveda and Yoga for a comprehensive wellness solution.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Patient-Focused Approach",
      description: "Patient comfort and convenience are paramount. Our dedicated team ensures a seamless experience from start to finish.",
  ...
  useEffect(() => {
    document.title = "Adivaidyam Ayurvedic Hospital | Top Ayurvedic Clinic in Bangalore";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Book an Ayurvedic consultation at Adivaidyam Ayurvedic Hospital in Banashankari, Bangalore. Offering Panchakarma, Yoga, and natural therapies by Dr. Savitha Sagar.");
  ...
  return (
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Adivaidyam Ayurvedic Hospital</h1>
                <p className="text-xl mb-4 opacity-90">Holistic Healing and Wellness Clinic</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Banashankari 3rd Stage, Bengaluru</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.9</span>
                  <span className="opacity-90">(380)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-lg md:text-xl leading-relaxed text-foreground/80 text-justify md:text-left" style={{ color: "#7F543D" }}>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/10.JPG" 
                          alt="Adivaidyam Hospital Ayurveda"
                  ...
                  <p>
                    Under the visionary leadership of Dr. Savitha Sagar (BAMS, MS, YIC, AGOC, PKTC)—a renowned Ayurvedic doctor with 18+ years of clinical excellence—the hospital strictly utilizes 100% pure, preservative-free herbal formulations. Whether you are seeking rigorous Panchakarma detox programs, authentic Kerala Ayurvedic therapies, or specialized natural beauty and skincare treatments, Adivaidyam guarantees genuine methodologies using unadulterated medicated oils. Discover a sanctuary where traditional wellness meets modern reliability for your ultimate health rejuvenation.
                    We prioritize a compassionate, supportive environment that empowers every patient on their unique path to lasting wellness and vitality.
                  </p>
                </div>
              </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Adivaidyam Hospital today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at Adivaidyam Hospital</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Adivaidyam Hospital</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience authentic healing backed by experienced practitioners and a patient-first approach.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Your Healing Journey at Adivaidyam</h2>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  ...
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/10.JPG"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Adivaidyam Hospital?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Adivaidyam Hospital?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at Adivaidyam Hospital.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Adivaidyam Ayurvedic Hospital<br />
                      1475, 17th Main, Muneshwara Block, Banashankari 3rd Stage<br />
                      Bengaluru
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1" style={{ color: "#7F543D" }}>
                      <li>• Approx. 43 km from Kempegowda International Airport (BLR)</li>
                      <li>• Approx. 5 km from Nayandahalli Railway Station</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.4446603149054!2d77.54599927507597!3d12.943373887369386!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae3f2c034c8f41%3A0x3e98142ce771e7cb!2sAdivaidyam%20Ayurveda%20Hospital!5e0!3m2!1sen!2sin!4v1779608192252!5m2!1sen!2sin" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Adivaidyam Ayurvedic Hospital Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a free consultation. Our doctors will guide you towards the perfect treatment program at Adivaidyam Ayurveda.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/918884581202?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Adivaidyam%20Ayurvedic."
              target="_blank"
              rel="noreferrer"
