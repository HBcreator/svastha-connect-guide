...
export default function DharaAyurGlow() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Your visit opens with an unhurried Ayurvedic consultation that maps your natural constitution, current imbalances, digestion pattern, sleep quality, and daily routine.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Therapy Plan & Oil Selection",
      description: "Based on your assessment, the team selects specific medicated oils, herbal decoctions, and a session sequence matched to your body type and health goal.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Abhyanga & Herbal Steam",
      description: "Warm oil applied through rhythmic Kerala-style strokes loosens stiffness and mobilises accumulated toxins, followed by herbal steam that opens the channels.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Signature Dhara & Kizhi Therapy",
      description: "Continuous warm oil poured over the forehead (Shirodhara) calms an overworked nervous system, while heated herbal poultices target deep muscular pain.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Cleansing & Nasyam",
      description: "Where indicated, gentle Panchakarma steps and nasal detox therapy clear the head region, easing sinus congestion, migraine tendency, and mental fog.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Home Routine & Follow-Up",
      description: "You leave with a written dinacharya plan, food guidance suited to your dosha, and herbal support so the benefits of your sessions continue at home.",
  ...
  const testimonials = [
    {
      title: "Shirodhara Ended Months of Broken Sleep",
      review: "I arrived in Morjim running on four hours of sleep a night. Three Shirodhara sessions later I was sleeping through until morning. The therapist explained every step before starting, which made me feel completely at ease.",
    ...
    {
      title: "Kizhi Relieved My Chronic Shoulder Pain",
      review: "Years of desk work had locked up my shoulders and upper back. The warm herbal poultice treatment here did more in five sessions than months of physiotherapy back home. Genuinely skilled hands.",
      name: "Marc Delacroix",
      verified: true,
      location: "Lyon, France",
      condition: "Elakizhi & Abhyanga",
      rating: 5
    },
    {
      title: "Honest Advice, No Upselling",
      review: "What stood out was the honesty. I was told which therapies I actually needed and which I could skip. That kind of straightforward guidance is rare and it earned my complete trust.",
      name: "Priya Raghunathan",
      verified: true,
      location: "Bengaluru, India",
      condition: "Ayurvedic Consultation",
      rating: 5
    },
    {
      title: "A Quiet Escape Minutes from Morjim Beach",
      review: "The setting is calm and spotlessly clean, tucked away from the beach crowds but close enough to walk. Warm oils, herbal aromas and unhurried therapists made every session feel restorative.",
      name: "Sofia Marchetti",
      verified: true,
      location: "Milan, Italy",
      condition: "Rejuvenation Package",
      rating: 5
    },
    {
      title: "Noticeable Change in Skin and Energy",
      review: "I booked a two-week detox alongside their Ayurvedic facial treatments. My skin cleared, my digestion settled, and I went home with a food plan I still follow. Well worth the visit.",
      name: "Hannah Brookfield",
      verified: true,
      location: "Manchester, UK",
      condition: "Detox & Beauty Therapy",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "What is Dhara AyurGlow and where exactly is it located?",
      answer: "Dhara AyurGlow is an authentic Kerala Ayurveda treatment centre and spa in North Goa, operating as part of the AyurGlow group of wellness centres. It is located at H.No 700, E Maradiwada, opposite Saffron Supermarket, Pernem, Morjim, in the Mapusa region of North Goa, within easy reach of Morjim, Ashwem and Mandrem beaches."
    },
    {
      question: "Which therapies can I book at the centre?",
      answer: "The centre offers Kerala-tradition Abhyanga full body massage, Shirodhara, Elakizhi and Podikizhi herbal poultice therapy, Nasyam nasal detox, Ayurvedic herbal steam, Panchakarma cleansing programmes, Ayurvedic facials and beauty therapies, targeted area-specific massage, weight management support, and doctor-guided consultations with herbal medicines."
    },
    {
      question: "How long does a typical session take and what does it cost?",
      answer: "Most single therapies run between 45 and 90 minutes depending on the treatment chosen. A standard 60-minute Shirodhara session is offered at approximately ₹3,000, while multi-day detox and Panchakarma packages are priced according to the duration and therapies included. Current rates are confirmed at the time of booking."
    },
    {
      question: "Do I need a consultation before starting treatment?",
      answer: "Yes, and it is recommended. Every guest begins with an Ayurvedic assessment of body constitution and current imbalances so that oils, herbs and therapy sequence can be matched to individual needs rather than applied from a fixed menu."
    },
    {
      question: "What are the opening hours and how do I reach the centre?",
      answer: "The centre operates seven days a week, from 9:30 AM to 8:00 PM. It sits roughly 20 km from Manohar International Airport at Mopa and around 22 km from Thivim Railway Station, with taxi and two-wheeler access available directly to the door."
    }
  ];

  const programs = [
    {
      title: "Signature Shirodhara",
      description: "A steady stream of warm medicated oil over the forehead that settles an overstimulated nervous system, easing anxiety, insomnia and persistent mental fatigue.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Kerala Abhyanga Massage",
      description: "Synchronised warm oil massage using classical Kerala strokes to improve circulation, release muscular tension and support lymphatic drainage across the whole body.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Kizhi Poultice Therapy",
      description: "Heated herbal boluses pressed rhythmically over stiff joints and tight muscles, widely chosen for back pain, frozen shoulder, arthritis and sports recovery.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Panchakarma Detox",
      description: "Structured multi-day biological cleansing with preparatory oleation, steam and elimination therapies, planned and supervised according to your constitution.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Nasyam Head Detox",
      description: "Medicated oil administered through the nasal passage to clear the head and sinus region, supporting relief from congestion, headaches and breathing difficulty.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Ayurvedic Beauty & Skin Care",
      description: "Herbal facials, natural scrubs and Ayurvedic skin protocols using plant-based preparations to restore clarity, tone and a healthy natural glow.",
  ...
  const whyChooseUs = [
    {
      title: "Rated 4.9 by Guests",
      description: "Consistently high ratings across hundreds of verified reviews, with visitors repeatedly praising therapist skill, cleanliness and genuine care.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Trained Kerala Therapists",
      description: "Therapies are delivered in the classical Kerala tradition by practitioners trained in authentic technique, oil selection and correct treatment sequence.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Part of the AyurGlow Group",
      description: "Backed by the established AyurGlow network of Ayurvedic centres across North Goa, sharing the same standards, sourcing and clinical protocols.",
      icon: <Globe className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Herbal Oils, Never Synthetic",
      description: "Treatments use traditionally prepared medicated oils, powders and poultices rather than commercial spa products with artificial fragrance.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Plans Built Around You",
      description: "Nothing is applied from a fixed menu. Oils, duration and therapy order are chosen after assessing your dosha, symptoms and treatment history.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Minutes from Morjim Beach",
      description: "A calm, easily reached location in Pernem taluka, close to Morjim, Ashwem and Mandrem, ideal for guests combining therapy with a North Goa stay.",
  ...
  useEffect(() => {
    document.title = "Dhara AyurGlow Morjim, Goa | Kerala Panchakarma, Shirodhara & Ayurvedic Massage";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Dhara AyurGlow is an authentic Kerala Ayurveda centre in Morjim, Mapusa, North Goa offering Shirodhara, Abhyanga, Kizhi, Nasyam, Panchakarma detox and Ayurvedic beauty therapies with personalised dosha-based consultations. Open daily 9:30 AM to 8:00 PM.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Dhara AyurGlow</h1>
                <p className="text-xl mb-4 opacity-90">Authentic Kerala Ayurveda Centre for Panchakarma, Shirodhara & Herbal Therapies</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Mapusa, Goa, India</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.4</span>
                  <span className="opacity-90">(290 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    <strong className="font-bold text-[#2C4E5A]">Dhara AyurGlow</strong> is a dedicated Kerala Ayurveda treatment centre in <strong className="font-bold text-[#2C4E5A]">Morjim, Pernem</strong>, within the Mapusa region of North Goa. Part of the established <strong className="font-bold text-[#2C4E5A]">AyurGlow</strong> group of wellness centres, it was created for guests who want genuine classical therapy rather than a generic spa hour. Every treatment here follows the Kerala lineage, with traditionally prepared medicated oils, herbal powders and freshly bound poultices selected specifically for the person on the table. Set a short distance from Morjim, Ashwem and Mandrem beaches, the centre has built a reputation among Indian and international visitors for skilled therapists, spotless treatment rooms and honest, unhurried advice.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img
                          src="/Anchor pages/Goa centers/Dhara AyurGlow/image 2.jpg"
                          alt="Traditional Kerala herbal poultices and medicated oil used at Dhara AyurGlow Goa"
                          className="w-full h-full object-cover"
                          onError={(e) => { e.currentTarget.src = "/Anchor pages/Goa centers/images/13.jpg"; }}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <p>
                    Treatment always begins with an Ayurvedic assessment of your constitution, digestion, sleep and current complaints, so the therapy plan is shaped around your body rather than a fixed package. From there guests may follow a single restorative session or a structured multi-day programme built around <strong className="font-bold text-[#2C4E5A]">Shirodhara, Abhyanga, Kizhi, Nasyam and Panchakarma cleansing</strong>. The centre is open every day from 9:30 AM to 8:00 PM, making it practical for both short beach stays and longer detox visits in North Goa.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img
                      src="/Anchor pages/Goa centers/Dhara AyurGlow/image 1.jpg"
                      alt="Ayurvedic head and neck therapy session at Dhara AyurGlow, Morjim, North Goa"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img
                        src="/Anchor pages/Goa centers/Dhara AyurGlow/image 2.jpg"
                        alt="Kizhi herbal poultice therapy preparation at Dhara AyurGlow Ayurveda centre in Goa"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/Goa centers/images/13.jpg"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Dhara AyurGlow today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Dhara AyurGlow
</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Dhara AyurGlow
</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Classical Kerala technique, traditionally prepared herbal oils, and therapy plans shaped around your own constitution.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Dhara AyurGlow
</h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A step-by-step Kerala Ayurveda pathway that moves from assessment through oil therapy, cleansing, and a routine you can keep at home.
            </p>
          </div>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/Anchor pages/Goa centers/Dhara AyurGlow/image 1.jpg"
                  alt="Dhara AyurGlow Ayurveda centre in Morjim, North Goa"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/Goa centers/images/13.jpg"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Dhara AyurGlow?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Dhara AyurGlow?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at Dhara AyurGlow.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Dhara AyurGlow<br />
                      H.No 700, E Maradiwada, opposite Saffron Supermarket<br />
                      Pernem, Morjim, Mapusa, Goa 403512
                    </p>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Approx. 20 km from Manohar International Airport, Mopa</span>
                      </li>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe
                  src="https://www.google.com/maps?q=Dhara+Spa+%26+Kerala+Ayurveda,+H.No+700,+E+Maradiwada,+Pernem,+Morjim,+Mapusa,+Goa+403512&output=embed"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="/Anchor pages/Goa centers/Dhara AyurGlow/image 1.jpg"
            alt="Dhara AyurGlow Ayurveda sanctuary in Morjim, Goa"
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment program at Dhara AyurGlow.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919372227461?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Dhara%20AyurGlow."
              target="_blank"
              rel="noreferrer"
