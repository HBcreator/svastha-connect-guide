...
export default function AprasuAyurvedicHospital() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Detailed analysis of your Prakriti, pulse, and health history by senior consultants Dr. Sameer Arora or Dr. Reema Arora.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Insurance & Cashless Verification",
      description: "Empanelment documentation check for CGHS, ECHS, CAPF, or private cashless TPA mediclaim setup to facilitate cashless admissions.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Purvakarma Preparation",
      description: "Preparing the body with Snehan internal/external oiling and Swedan herbal steam to soften and loosen toxins.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Panchakarma or Parasurgical Procedure",
      description: "Administering customized detox therapies (Basti, Virechana) or specialized minimally invasive Kshar Sutra para-surgery.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "In-Patient Care & Custom Diet",
      description: "Observation by doctors with nourishing organic meals tailored to your treatment for maximum tissue recovery.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Post-Discharge Restoration Plan",
      description: "Providing custom diet charts, exercises, and lifestyle guidelines to ensure long-term health and prevent recurrence.",
  ...
  const testimonials = [
    {
      title: "Avascular Necrosis (AVN) Reversal",
      review: "I was diagnosed with early-stage AVN of the hip and was terrified of joint replacement surgery. The specialized Panchakarma therapies and specific exercises under Dr. Sameer Arora's supervision saved my mobility. I'm back to walking without a limp.",
      name: "Oliver Bennett",
      verified: true,
      location: "Melbourne, Australia",
      condition: "Avascular Necrosis (AVN) Reversal",
      rating: 5
    },
    {
      title: "Chronic Fistula & Kshar Sutra",
      review: "After two failed surgeries for fistula-in-ano back home, I travelled to Delhi for Kshar Sutra Chikitsa under Dr. Reema Arora. The healing was gradual but complete. It has been two years and I have had no recurrence.",
      name: "Sia Kowalski",
      verified: true,
      location: "Chicago, USA",
      condition: "Chronic Fistula & Kshar Sutra",
      rating: 5
    },
    {
      title: "Psoriasis & Skin Detox",
      review: "My stubborn plaque psoriasis was causing severe itching and skin shedding. The custom Virechana detox and herbal formulas at Aprasu cleared my skin remarkably. Highly recommend their professional staff.",
      name: "Klaus Lindner",
      verified: true,
      location: "Hamburg, Germany",
      condition: "Psoriasis & Skin Detox",
      rating: 5
    },
    {
      title: "Chronic Sciatica & Spine Care",
      review: "Years of desk work left me with severe sciatica that radiated down my leg. A 14-day Panchakarma session involving Kati Basti and specialized herbal oils completely relieved the nerve compression.",
      name: "Isabella Rossi",
      verified: true,
    ...
    {
      title: "IBS & Gut Reset",
      review: "Chronic acidity, bloating, and unpredictable bowel habits made it hard to travel. The personalized dietary guidelines and mild cleansing therapies at Aprasu balanced my digestion.",
      name: "Ethan de Groot",
      verified: true,
      location: "Amsterdam, Netherlands",
      condition: "IBS & Gut Reset",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "Is Aprasu Ayurveda Hospital accredited and empanelled?",
      answer: "Yes. Aprasu Ayurveda Hospital is NABH accredited, which ensures high quality and safety standards. We are also empanelled with major government healthcare schemes including CGHS, ECHS, CAPF, and Ayushman Bharat (PM-JAY)."
    },
    {
      question: "Do you offer cashless treatments for insurance policies?",
      answer: "Yes. Aprasu Ayurveda is a pioneer in cashless Ayurvedic treatments. We support cashless TPA services for major private health insurance companies and empanelled government cards, allowing hassle-free admissions."
    },
    {
      question: "Who are the lead doctors at the Rohini hospital?",
      answer: "Our medical team is led by senior consultants Dr. Sameer Arora (BAMS, carrying forward the Humraz Clinic legacy since 1970) and Dr. Reema Arora (BAMS, M.D. in Panchakarma, specialized Panchakarma & anorectal parasurgery expert)."
    },
    {
      question: "What specialized treatments are you known for?",
      answer: "We are highly recognized for our comprehensive non-surgical Avascular Necrosis (AVN) Reversal program, Kshar Sutra parasurgical treatments for piles, fissures, and fistula, and classical customized Panchakarma detox."
    },
    {
      question: "How far is the hospital from key transit points?",
      answer: "Our hospital is located at B-1087-88, Avantika Chowk, Rohini Sector-1, Delhi. It is approximately 22-25 km from Indira Gandhi International (IGI) Airport (Terminal 3), 18-20 km from New Delhi Railway Station (NDLS), 6-8 km from Shakur Basti Railway Station (SSB), and 2-3 km from Rohini West and Rithala Metro Stations."
    }
  ];

  const programs = [
    {
      title: "AVN Reversal Program",
      description: "Comprehensive, non-surgical reversal program combining specialized Panchakarma, customized exercises, and blood-flow-enhancing herbal formulations.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Kshar Sutra Chikitsa",
      description: "Time-tested, minimally invasive parasurgical treatment for piles, fistula-in-ano, and fissures with exceptionally low recurrence rates.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Customized Panchakarma",
      description: "Fully tailored Vamana, Virechana, Nasya, Basti, and Raktamokshana treatments determined after deep body constitution analysis.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Orthopedic & Spine Care",
      description: "Targeted treatments (Kati Basti, Janu Basti, Potli Sweda) to relieve sciatica, slip disc, osteoarthritis, and joint stiffness.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Allergy Management",
      description: "Steroid-free clinical therapies addressing chronic psoriasis, stubborn eczema, urticaria, and severe food allergies.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Metabolic & Gynecological Health",
      description: "Tailored detox and dietary correction to regulate obesity, PCOS/PCOD, diabetes, and thyroid function.",
  ...
  const whyChooseUs = [
    {
      ...
      description: "Operating under strict national healthcare quality, hygiene, and patient safety standards.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Pioneering Cashless Facility",
      description: "Easy cashless mediclaim/TPA settlement options with major private health insurance providers.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "CGHS & ECHS Empanelled",
      description: "Full cashless treatment coverage for eligible central government and ex-servicemen cardholders.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Senior Doctor Expertise",
      description: "Led by Dr. Sameer Arora and Dr. Reema Arora (M.D. in Panchakarma) with extensive clinical experience.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Comfortable IPD Admissions",
      description: "Hygienic in-patient facilities with private AC rooms, customized diet charts, and disabled-friendly lift access.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Ayurveda Training Academy",
      description: "A recognized institute offering certified diploma and training courses in traditional Ayurveda.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
  ...
  useEffect(() => {
    document.title = "Aprasu Ayurveda Hospital Delhi | Cashless Panchakarma & AVN Treatment";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic, NABH-accredited Ayurvedic treatments, Kshar Sutra para-surgery, and Avascular Necrosis (AVN) reversal at Aprasu Ayurveda Hospital in Rohini, Delhi. CGHS, ECHS, and cashless insurance facilities available.");
  ...
  return (
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Aprasu Ayurveda Hospital Rohini North Delhi
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Aprasu Ayurveda Hospital</h1>
                <p className="text-xl mb-4 opacity-90">NABH Accredited Clinical Center | Unit of Humraz Clinic (Since 1970)</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Rohini, North Delhi, India</span>
                </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] leading-tight md:leading-[1.1] max-w-4xl mx-auto px-2">
                Authentic Ayurvedic Healing & <br className="hidden lg:block" />
                Panchakarma in Rohini
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Aprasu Ayurveda Hospital</strong>, North Delhi's premier destination for authentic, NABH-accredited Ayurvedic clinical care and root-cause healing. Operating as a proud unit of the historic <strong className="font-bold text-[#2C4E5A]">Humraz Clinic</strong> (serving patients since 1970), we carry forward a multi-generational legacy of healing. The name 'Aprasu' is derived from the Guru Granth Sahib and signifies 'God', reflecting our dedication to serving patients with divine compassion. Conveniently located near Avantika Chowk in Rohini Sector-1, our hospital is led by senior consultant Dr. Sameer Arora (BAMS) and specialized Panchakarma expert Dr. Reema Arora (BAMS, M.D. in Panchakarma).
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP cneters/delhi/Aprasu Ayurvedic Hospital/secondary.jpg" 
                          alt="Aprasu Ayurveda Hospital accommodation"
                  ...
                  <p>
                    As a NABH-accredited hospital empanelled with CGHS, ECHS, and CAPF, we maintain the highest standards of safety, quality, and clinical excellence. We are proud to be one of the pioneering Ayurvedic hospitals in Delhi to offer cashless mediclaim/TPA treatment facilities for hassle-free admissions. Our doctors specialize in treating complex chronic disorders, particularly Avascular Necrosis (AVN) of the bone, anorectal conditions (using specialized Kshar Sutra para-surgery), orthopedic joint pain, sciatica, and metabolic disorders.
                  </p>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/delhi/Aprasu Ayurvedic Hospital/main.webp" 
                      alt="Aprasu Ayurveda Hospital main view"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP cneters/delhi/Aprasu Ayurvedic Hospital/secondary.jpg" 
                        alt="Aprasu Ayurveda Hospital therapy room"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Aprasu Ayurveda Hospital today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages in Aprasu Ayurveda Hospital</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Aprasu Ayurveda Hospital</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience NABH-accredited quality standards, expert diagnostics, and cashless CGHS/ECHS/TPA healthcare services in a modern inpatient facility.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Your Healing Journey in Aprasu Ayurveda Hospital</h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP cneters/delhi/Aprasu Ayurvedic Hospital/main.webp"
                  alt="Aprasu Ayurveda Hospital view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Aprasu Ayurveda Hospital?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Aprasu Ayurveda Hospital?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, consultations, and transit options at Aprasu Ayurveda Hospital.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Aprasu Ayurveda Hospital<br />
                      B-1087-88, Avantika Chowk, Rohini, Sector-1<br />
                      Delhi, India
                    </p>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Approx. 22-25 km from Indira Gandhi International (IGI) Airport (Terminal 3)</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Approx. 18-20 km from New Delhi Railway Station (NDLS)</span>
                      </li>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3499.5764291326514!2d77.0977734!3d28.702314599999998!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d04023c469cd1%3A0x896f0d771f62f9f5!2sAprasu%20ayurvedic%20Hospital%20Panchkarma%2C%20kshar%20sutra%20%26%20AVN%20(on%20panel%20CGHS%2C%20ECHS)!5e0!3m2!1sen!2sin!4v1780637611722!5m2!1sen!2sin"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Aprasu Ayurveda Hospital Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or therapy program at Aprasu Ayurveda Hospital.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919899066055?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Aprasu%20Ayurveda%20Hospital."
              target="_blank"
              rel="noreferrer"
