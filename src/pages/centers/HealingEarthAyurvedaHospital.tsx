...
export default function HealingEarthAyurvedaHospital() {
  ...
  const treatmentProcess = [
    {
      number: 1,
      title: "Comprehensive Prakriti Analysis",
      description: "Our experienced Ayurvedic practitioners begin by assessing your unique body constitution (Prakriti) and dosha imbalances to form a clear baseline for healing.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Personalized Treatment Roadmap",
      description: "Based on your assessment and lab diagnostics, we formulate a tailored care plan integrating traditional Kerala therapies, precise diet charts, and herbal prescriptions.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Panchakarma Therapy",
      description: "We administer targeted detoxification procedures such as Virechana, Nasya, or Basti in our highly hygienic, specialized therapy rooms to eliminate deep-seated toxins.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "In-house Herbal Medications",
      description: "Our treatments are supported by authentic, in-house prepared Ayurvedic medicines ensuring the highest purity and therapeutic efficacy for faster recovery.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Holistic Rehabilitation",
      description: "Recovery is accelerated through integrated Yoga, Naturopathy, and specialized dietary guidelines designed to rejuvenate cellular health and boost immunity.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Sustainable Wellness Support",
      description: "We provide ongoing lifestyle counseling and follow-up consultations to help you maintain balance, manage chronic conditions, and prevent future illnesses.",
  ...
  const testimonials = [
    {
      title: "Life-changing Detox Experience",
      review: "I flew to India for a 14-day Panchakarma detox. The medical team was incredibly professional and attentive. By the end, I felt completely rejuvenated. Highly recommend this NABH accredited facility.",
    ...
    {
      title: "Outstanding Joint Pain Management",
      review: "The Janubasti treatments transformed my mobility. I struggled with severe knee osteoarthritis, but Healing Earth reduced my inflammation drastically without surgery. I'm extremely grateful to their expert specialists.",
      name: "Isabella Rossi",
      verified: true,
      location: "Rome, Italy",
    ...
    {
      title: "Effective Respiratory Relief",
      review: "Struggling with chronic asthma, I turned to Healing Earth. Their targeted therapies and custom-compounded herbal medicines provided me with relief that conventional medicine couldn't.",
      name: "Kenji Tanaka",
      verified: true,
      location: "Tokyo, Japan",
      condition: "Asthma & Respiratory Care",
      rating: 5
    },
    {
      title: "Holistic Skin and Beauty Care",
      review: "I opted for their Mukha Lepanam package. The results were visibly stunning! Their approach goes beyond the surface, using purely natural, in-house prepared herbs to address internal balance.",
      name: "Sophie Martin",
      verified: true,
      location: "Paris, France",
      condition: "Skin Health & Rejuvenation",
      rating: 5
    },
    {
      title: "Exceptional Hypertension Management",
      review: "The serene environment at Healing Earth Ayurveda Hospital aided my recovery from severe hypertension. The doctors patiently explained my treatment plan involving Ksheera Dhara and Yoga. Exceptional patient care.",
      name: "Michael Schmidt",
      verified: true,
      location: "Berlin, Germany",
      condition: "Hypertension & Stress Management",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "Is Healing Earth Ayurveda Hospital accredited?",
      answer: "Yes, Healing Earth is a fully NABH (National Accreditation Board for Hospitals & Healthcare Providers) accredited facility, ensuring stringent quality controls, exceptional hygiene standards, and patient-centric healthcare delivery."
    },
    {
      question: "Can I use my health insurance for Ayurvedic treatments at Healing Earth?",
      answer: "Absolutely. We are recognized by the Central Government Health Scheme (CGHS) and are empanelled with major IRDAI-approved insurance providers, allowing eligible patients to avail cashless or reimbursement facilities for their inpatient treatments."
    },
    {
      question: "What types of conditions are treated at your HSR Layout facility?",
      answer: "We offer comprehensive management for a wide array of chronic conditions including Asthma, Hypertension, Joint Pain, Myopia, and skin disorders. We also provide specialized Panchakarma detox, geriatric care, and postnatal support."
    },
    {
      question: "Does Healing Earth Ayurveda Hospital have in-patient (IPD) facilities?",
      answer: "Yes, we operate a fully-equipped hospital. Our facility includes specialized wards, a dedicated operation theatre for non-invasive and ano-rectal procedures, and highly hygienic therapy rooms for traditional Kerala karmas."
    },
    {
      question: "Are the Ayurvedic medicines prescribed prepared in-house?",
      answer: "To guarantee purity and maximum therapeutic efficacy, many of the classical Ayurvedic formulations and herbal preparations prescribed by our expert doctors are carefully compounded and prepared in our in-house facility."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Experience profound systemic cleansing through authentic Panchakarma therapies designed to flush out deep-seated toxins and restore your body's natural metabolic balance.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Joint & Spine Care",
      description: "Targeted pain management uses specialized medicated oil therapies to help lubricate joints, reduce inflammation, and ease stiffness for improved mobility.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Beauty Care",
      description: "Holistic aesthetic treatments employing natural herbal pastes to address acne, pigmentation, and promote a radiant, healthy complexion from within.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stress & Rejuvenation",
      description: "Soothing therapies involving rhythmic pouring of medicated liquids over the body to alleviate stress, cool the system, and cure nervous disorders.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Muscle Strengthening",
      description: "A nourishing therapy using medicinal rice boluses to rejuvenate degenerated tissues, strengthen muscles, and combat neuro-muscular conditions.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Respiratory & Eye Health",
      description: "Specialized Ayurvedic interventions tailored to manage chronic conditions like Asthma, Allergic Rhinitis, and vision-related disorders such as Myopia.",
  ...
  const whyChooseUs = [
    {
      ...
      description: "Our healthcare services follow the highest national standards for quality care and clinical hygiene, ensuring trusted and reliable treatment across all departments.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Hospital Infrastructure",
      description: "Our center features specialized inpatient wards, modern diagnostics, and an exclusive operation theatre for minor Ayurvedic surgeries.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "CGHS & Insurance Empanelled",
      description: "Accessible healthcare is a priority. We support major health insurance claims and are a recognized provider under the CGHS scheme.",
      icon: <FileSearch className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Authentic Kerala Therapies",
      description: "Experience genuine, uncompromised classical Ayurvedic treatments and Panchakarma therapies administered by skilled traditional therapists.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "In-house Medicine Preparation",
      description: "Ensuring unadulterated healing, we custom compound our herbal prescriptions and prepare classical medicines right in our facility.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Expert Multidisciplinary Team",
      description: "Receive patient-centric care led by seasoned Ayurvedic physicians, supported by dedicated Yoga instructors and Naturopathy experts.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
  ...
  useEffect(() => {
    document.title = "Healing Earth Ayurveda Hospital | Top Ayurveda Clinic in HSR Layout, Bengaluru";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Book an Ayurvedic consultation at Healing Earth Ayurveda Hospital in HSR Layout, Bengaluru. NABH accredited center offering traditional Panchakarma, specialized wards, and in-house herbal medicines.");
  ...
  return (
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Healing Earth Ayurveda Hospital</h1>
                <p className="text-xl mb-4 opacity-90">Authentic Ayurveda & Panchakarma Department</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">No. 149, 5th Sector, HSR Layout, Bengaluru</span>
                </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] leading-tight md:leading-[1.1] max-w-4xl mx-auto px-2">
                Authentic Ayurveda <br className="hidden lg:block" />
                at Healing Earth Ayurveda Hospital
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-lg md:text-xl leading-relaxed text-foreground/80 text-justify md:text-left" style={{ color: "#7F543D" }}>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Healing Earth Ayurveda Hospital/main.jpg" 
                          alt="Rashtrotthana Hospital Ayurveda"
                  ...
                  <p>
                    The hospital specializes in Panchakarma therapies and classical Ayurvedic treatments for conditions such as asthma, hypertension, joint pain, and skin disorders. It provides in-house diagnostic services, custom-compounded herbal medicines, and a dedicated operation theatre for minor Ayurvedic procedures. Healing Earth Ayurveda Hospital focuses on root-cause healing, detoxification, and long-term rejuvenation under the guidance of experienced Ayurvedic doctors.
                  </p>
                  <p>
                    Every patient receives a customized wellness plan meticulously designed to restore harmony to the body, mind, and spirit. From therapeutic yoga sessions to specialized dietary recommendations.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Healing Earth Ayurveda Hospital/main.webp" 
                      alt="Rashtrotthana Hospital Exterior"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Healing Earth Ayurveda Hospital/secondary.webp" 
                        alt="Rashtrotthana Hospital Treatment"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Healing Earth Ayurveda Hospital today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at Healing Earth Ayurveda Hospital</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Healing Earth Ayurveda Hospital</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience authentic healing backed by the complete infrastructure of an NABH-accredited Ayurveda hospital.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Your Healing Journey at Healing Earth Ayurveda Hospital</h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A structured, holistic approach integrating Ayurveda, Yoga, and Naturopathy to restore your natural balance.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  ...
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Healing Earth Ayurveda Hospital?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Healing Earth Ayurveda Hospital?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at Healing Earth Ayurveda Hospital.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Healing Earth Ayurveda Hospital<br />
                      No. 149, 5th Sector, HSR Layout, HSR Ring Road<br />
                      Bengaluru - 560034
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1" style={{ color: "#7F543D" }}>
                      <li>• Approx. 42 km from Kempegowda International Airport (BLR)</li>
                      <li>• Approx. 8 km from Carmelaram Railway Station (CRLM)</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.8642916708322!2d77.63625800000001!3d12.9164426!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae148c3ea15fc1%3A0xd96af77be11210f!2sHealing%20Earth%20Ayurveda%20Hospital%20Bangalore%2C%20Prithvi%20Health%20Care%20PVT%20LTD.!5e0!3m2!1sen!2sin!4v1779604196739!5m2!1sen!2sin" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Healing Earth Ayurveda Hospital Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a free consultation. Our doctors will guide you towards the perfect treatment program at Healing Earth Ayurveda.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/917899903943?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Healing%20Earth."
              target="_blank"
              rel="noreferrer"
