...
export default function Ayurillam() {
  ...
  const treatmentProcess = [
    {
      number: 1,
      title: "Naadi Diagnosis & Profiling",
      description: "In-depth baseline diagnostic assessment to identify dosha imbalances and compile a comprehensive clinical case history.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Customized Remedial Blueprint",
      description: "Developing an individualized therapeutic roadmap specifying specialized botanical formulations, exact dietary schedules, and target treatments.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Preparatory Warm Mobilization",
      description: "Administering synchronized Abhyangam and herbal steam baths (Swedana) to loosen deep-seated systemic impurities.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Classical Panchakarma Purification",
      description: "Executing precise, clinically supervised physiological purification treatments tailored specifically to eliminate metabolic waste.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Specialized Localized Retainers",
      description: "Utilizing targeted external treatments like Kati Vasti, Janu Vasti, or Shirodhara to soothe localized joint or neural inflammation.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Continuing Health Preservation",
      description: "Long-term lifestyle stability supported by practical home diet charts, therapeutic exercises, and scheduled follow-up assessments.",
  ...
  const testimonials = [
    {
      title: "Neck Pain & Stiffness Relieved!",
      review: "Sitting at my laptop all day had left me with severe cervical spondylosis and near-constant neck pain. I sought help at Ayurillam in Velachery. Dr. Jayalakshmi's detailed consultation was very reassuring. The course of Greeva Vasti and synchronized Abhyangam massage completely eliminated the localized muscle stiffness and restored full movement. The Keralite therapists are truly exceptionally skilled.",
      name: "Signe Olofsson",
      verified: true,
    ...
    {
      title: "Fantastic Relief from Sciatica",
      review: "A severe disc bulge had caused shooting pain down my left leg, making it difficult to walk or stand. The specialized Kati Vasti treatments and warm oil pooling here worked wonders. The clinic operates under strict clinical hygiene protocols, and the doctors monitored my improvements daily. Within two weeks, the nerve compression subsided entirely.",
      name: "Matteo Rossini",
      verified: true,
      location: "Milan, Italy",
      condition: "Lumbar Disc Bulge & Sciatica",
      rating: 5
    },
    {
      title: "Profound Sleep and Stress Recovery",
      review: "Corporate burnout and chronic stress had given me persistent insomnia. Ayurillam’s serene therapy environment immediately put me at ease. The rhythmic warm oil stream of Shirodhara completely quieted my mind and reset my nervous system. I am sleeping deeply again and feel completely recharged. Excellent authentic Keralite care!",
      name: "Alix Fournier",
      verified: true,
      location: "Geneva, Switzerland",
      condition: "Chronic Insomnia & Burnout",
      rating: 5
    },
    {
      title: "Superb Digestive & Metabolic Balance",
      review: "I suffered from chronic digestive sluggishness and fatigue for years. The consulting doctors did an extremely thorough Prakriti diagnosis of my body. A customized, mild Panchakarma detox combined with authentic herbal Oushadhis completely rebalanced my metabolism. I feel light, healthy, and highly energetic again.",
      name: "Keiko Mori",
      verified: true,
    ...
    {
      title: "Chronic Sinusitis & Migraines Resolved",
      review: "Sinus pressure and terrible migraines used to ruin my weeks. The targeted Nasyam (nasal oil therapy) and herbal steam treatments here cleared out my deep congestion at the root. I haven't had a single migraine episode since, and I can breathe freely again. The staff here is wonderfully kind and compassionate.",
      name: "Callum Macleod",
      verified: true,
      location: "Edinburgh, Scotland",
      condition: "Chronic Sinusitis & Migraines",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "What makes Ayurillam Chennai unique for authentic Kerala Ayurveda?",
      answer: "Ayurillam is a premier Ayurvedic therapy chain founded by Mr. Vikas V. R., dedicated to authentic Kerala Ayurvedic treatments. We combine classical Panchakarma detox, highly qualified senior Vaidyahs, and Keralite therapists to provide genuine, clinically directed recovery in Chennai."
    },
    {
      question: "Who are the leading consulting doctors at the Velachery clinic?",
      answer: "Our Velachery branch features detailed consultations with senior, highly qualified physicians including Dr. Jayalakshmi. They specialize in classical Ayurvedic diagnosis, pulse profiling, and personalized chronic disease management."
    },
    {
      question: "Which therapies are offered for joint stiffness and orthopedic issues?",
      answer: "We offer non-surgical spinal and joint rehabilitation combining authentic Kerala therapies such as Pizhichil (synchronized oil bath), warm Elakizhi leaf poultices, specialized oil poolings (Kati Vasti, Greeva Vasti, Janu Vasti), and genuine herbal formulations to reduce joint inflammation and restore mobility."
    },
    {
      question: "Are genuine Kerala Ayurvedic medicines available at the clinic?",
      answer: "Yes, our clinic features a fully stocked pharmacy dispensing the complete range of authentic, high-potency Ayurvedic Kashayams, oils, Lehyams, and single-herb formulations to support your home recovery."
    },
    {
      question: "Does Ayurillam provide insurance reimbursement assistance?",
      answer: "Yes, our administrative team provides all necessary clinical case sheets, medical certificates, and diagnostic logs to facilitate private or corporate AYUSH health insurance claims."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Systematically purging cellular toxins and restoring biological dosha balance through classical Vamana, Virechana, and Vasti.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Spinal & Joint Rehabilitation",
      description: "Targeted therapies for neck stiffness, sciatica, lumbar spondylosis, and severe joint arthritis without surgical intervention.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Kerala Restorative Therapies",
      description: "Rhythmic Abhyangam massage, herbal leaf poultice massages (Elakizhi), and hot oil synchronic baths (Pizhichil) to soothe sore muscles and lubricate joints.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stress & Neurological Rejuvenation",
      description: "Medicated head oil retention (Shirovasthi) and soothing warm oil stream pours (Shirodhara) to quiet chronic anxiety, insomnia, and burnout.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Lifestyle & Metabolic Care",
      description: "Physician-guided programs to reverse diabetes sluggishness, high cholesterol, obesity, and cardiovascular fatigue.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Respiratory Regimens",
      description: "Botanical steam chambers, nasal therapy (Nasyam), and organic herb application to address chronic sinusitis, asthma, eczema, and psoriasis.",
  ...
  const whyChooseUs = [
    {
      title: "Eminent Kerala-Rooted Leadership",
      description: "Established in 2014 by Mr. Vikas V. R., bringing rich family folklore and traditional Kerala Ayurvedic heritage.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Professional Consulting Physicians",
      description: "Thorough diagnostic assessments led by qualified practitioners like Dr. Jayalakshmi and senior medical Vaidyahs.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "NABH Quality Protocols",
      description: "Operating under rigorous clinical safety, complete sanitization, and premium patient care guidelines.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Highly Trained Kerala Therapists",
      description: "All therapeutic procedures are administered by highly experienced, professionally trained male and female therapists from Kerala.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Authentic AVS Pharmacy",
      description: "Direct, single-source access to genuine, high-potency Kerala Ayurvedic oils, Kashayams, Lehyams, and single-herb extracts.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Health Insurance Claim Support",
      description: "Providing comprehensive medical documentations and diagnostic logs to facilitate private and corporate health insurance reimbursement.",
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Ayurillam – Home of Ayurvedic Therapy Center
</h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                    ...
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          ...
                          alt="Ayurillam Velachery Chennai Exterior"
                  ...
                  <p>
                  Directed by a senior panel of highly qualified BAMS practitioners, including chief consulting physician <strong className="font-bold text-[#2c4e5a]">Dr. Jayalakshmi</strong>, the clinic offers highly customized wellness roadmaps. Every healing journey begins with a traditional physical pulse and constitutional diagnosis. The clinic features premium, hygienic therapy suites adhering strictly to NABH standard guidelines, a fully stocked pharmacy of genuine Kerala formulations, and comprehensive support for health insurance reimbursement.
                    With custom wellness diets, daily lifestyle counseling, and dedicated support for post-treatment preservation, our team ensures that every patient receives compassionate.
                  </p>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                       src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Ayurillam/main.jpeg" 
                       alt="Ayurillam Velachery Chennai Center"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Kottakkal Arya Vaidya Sala - Mahalingapuram/secondary.webp" 
                        alt="Therapy chamber at Ayurillam Velachery Chennai"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Ayurillam – Home of Ayurvedic Therapy Center
</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Ayurillam – Home of Ayurvedic Therapy Center
</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Discover a premier clinical environment combining traditional Kerala therapeutic legacy, senior BAMS physicians, and authentic formulations.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Ayurillam – Home of Ayurvedic Therapy Center
</h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A structured, integrated recovery pathway directed entirely by senior physicians, from traditional Naadi diagnostics to customized continuing care.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  ...
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/9.JPG"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Ayurillam?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Ayurillam?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at Ayurillam.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1" style={{ color: "#7F543D" }}>
                      <li>• Approx. 10.5 km from Chennai International Airport</li>
                      <li>• Approx. 16 km from Chennai Central Railway Station</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=Ayurillam%20Velachery%20Chennai&amp;t=&amp;z=15&amp;ie=UTF8&amp;iwloc=&amp;output=embed"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Ayurillam Velachery Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Ayurillam/main.jpeg"
            alt="Ayurvedic Therapy at Ayurillam"
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment program at Ayurillam.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/917667603603?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Ayurillam%20Velachery."
              target="_blank"
              rel="noreferrer"
