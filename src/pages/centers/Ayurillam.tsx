            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-lg md:text-xl leading-relaxed text-foreground/80 text-justify md:text-left" style={{ color: "#7F543D" }}>
                  ...
                  <p>
                    Directed by a senior panel of highly qualified BAMS practitioners, including chief consulting physician <strong className="font-bold">Dr. Jayalakshmi</strong>, the clinic offers highly customized wellness roadmaps. Every healing journey begins with a traditional physical pulse and constitutional diagnosis. The clinic features premium, hygienic therapy suites adhering strictly to NABH standard guidelines, a fully stocked pharmacy of genuine Kerala formulations, and comprehensive support for health insurance reimbursement.
