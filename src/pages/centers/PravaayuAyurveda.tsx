...
export default function PravaayuAyurveda() {
  ...
  const testimonials = [
    {
      title: "Incredible Arthritis Relief",
      review: "The specialized Panchakarma therapies at Pravaayu Ayurveda drastically improved my joint mobility. Traveling from Canada for their authentic Kati Basti was the best decision for my back pain.",
      name: "Ethan M.",
      verified: true,
    ...
    },
    {
      ...
      review: "The individualized approach to PCOD at Pravaayu is exceptional. The expert Vaidyas and natural treatments helped me regain my hormonal balance without relying on synthetic medications.",
      name: "Isabella P.",
      verified: true,
      location: "Sydney, Australia",
      condition: "PCOD & Hormones",
      rating: 5
    },
    {
      title: "Deep Digestive Healing",
      review: "I suffered from chronic digestive issues for years. The classical detoxification programs here cleansed my system completely. The personalized diet and herbal protocols are incredibly effective.",
      name: "Liam K.",
      verified: true,
      location: "London, UK",
    ...
    },
    {
      ...
      review: "The Shirodhara and Abhyanga therapies at Pravaayu provided profound relief from my chronic stress and insomnia. It is a true sanctuary of traditional healing in the heart of Mumbai.",
      name: "Mia R.",
      verified: true,
    ...
    },
    {
      ...
      review: "The blood purification therapies transformed my skin health. The doctors at Pravaayu took the time to understand my Prakriti, offering treatments that finally resolved my persistent eczema.",
      name: "Noah S.",
      verified: true,
      location: "Dubai, UAE",
  ...
  const faqItems = [
    {
      question: "What specific conditions does Pravaayu Ayurveda treat?",
      answer: "We specialize in treating joint and bone-related issues (arthritis, back pain, cervical pain), digestive disorders, hormonal imbalances (like PCOD), skin conditions, stress, and obesity."
    },
    {
    ...
    },
    {
      ...
      answer: "Pravaayu Ayurveda & Panchkarma Clinic is conveniently located at A-101, Suchita Enclave, Maharashtra Nagar in Borivali West, Mumbai."
    },
    {
  ...
  const programs = [
    ...
    },
    {
      ...
      description: "Holistic treatments to address hormonal imbalances, PCOD, and gynecological issues through customized diet and therapies.",
  ...
  const whyChooseUs = [
    ...
    },
    {
      ...
      description: "Easily accessible in the heart of Borivali West, Mumbai, providing a reliable neighborhood destination for authentic care.",
  ...
  useEffect(() => {
    document.title = "Pravaayu Ayurveda & Panchkarma Clinic | Authentic Care";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience personalized Ayurvedic treatments and Panchakarma at Pravaayu Ayurveda & Panchkarma Clinic in Borivali West, Mumbai.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Pravaayu Ayurveda & Panchkarma Clinic Mumbai
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Pravaayu Ayurveda <br className="hidden md:block" /> & Panchkarma Clinic</h1>
                <p className="text-xl mb-4 opacity-90">Mumbai's Trusted Destination for Authentic Ayurveda & Panchakarma</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Borivali West, Mumbai, Maharashtra, India</span>
                </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Pravaayu Ayurveda & Panchkarma Clinic
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Pravaayu Ayurveda & Panchkarma Clinic</strong>, a dedicated and highly respected Ayurvedic sanctuary located in Borivali West, Mumbai. Our clinic offers personalized classical treatments tailored for chronic and lifestyle conditions. Recognizing that true healing requires more than just symptom management, we pride ourselves on delivering highly individualized care that seamlessly blends deep traditional Ayurvedic wisdom with clinical efficacy and a patient-focused approach.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/Pravaayu Ayurveda & Panchkarma Clinic/image 2.webp" 
                          alt="Pravaayu Ayurveda therapy room"
                  ...
                  <p>
                    Our healing philosophy centers on Prakriti-based consultations. Before initiating any therapy, our trained Ayurvedic physicians perform a detailed analysis of your unique body constitution. We specialize in providing effective natural solutions for complex joint and bone-related issues, back pain, digestive disorders, hormonal imbalances like PCOD, skin conditions, stress, and obesity. Our comprehensive Panchakarma programs, including Abhyanga, Shirodhara, Nasya, Basti, and Pizhichil, ensure that our patients experience profound, restorative, and long-lasting healing in the heart of Mumbai.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/Pravaayu Ayurveda & Panchkarma Clinic/image 1.webp" 
                      alt="Pravaayu Ayurveda main view"
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Pravaayu Ayurveda today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Pravaayu Ayurveda & Panchkarma Clinic
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Pravaayu Ayurveda & Panchkarma Clinic
              </h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience world-class traditional healthcare with a patient-focused approach, authentic medicines, and highly personalized care.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Pravaayu Ayurveda & Panchkarma Clinic
            </h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/Pravaayu Ayurveda & Panchkarma Clinic/image 2.webp"
                  alt="Pravaayu Ayurveda view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/1.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Pravaayu Ayurveda?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Pravaayu Ayurveda?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and specialties at Pravaayu Ayurveda.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Pravaayu Ayurveda & Panchkarma Clinic<br />
                      A-101, 1st Floor, Suchita Enclave, Maharashtra Nagar<br />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <div>Contact through My Vaidyam for appointments.</div>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Located conveniently in Maharashtra Nagar, Borivali West.</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Easily accessible from Borivali Railway Station.</span>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=Pravaayu+Ayurveda+%26+Panchkarma+Clinic+Borivali+Mumbai&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Pravaayu Ayurveda Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or therapy program at Pravaayu Ayurveda & Panchkarma Clinic.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/9198xxxxxxxx?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Pravaayu%20Ayurveda."
              target="_blank"
              rel="noreferrer"
