...
export default function AyushAyurvedPanchakarmaCenter() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "A thorough evaluation by our qualified Ayurvedic doctors to accurately diagnose your condition and understand your unique body constitution.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Personalized Protocol",
      description: "Designing a highly customized Panchakarma and internal medicine schedule targeting your specific chronic conditions.",
    ...
    },
    {
      ...
      description: "Integrating specialized local treatments for rapid relief from joint pain, skin disorders, and hormonal imbalances.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Paschat Karma & Lifestyle",
      description: "Providing rejuvenating herbal medicines, specific dietary protocols, and lifestyle counseling to sustain your healing and vitality.",
  ...
  const testimonials = [
    {
      title: "Incredible Digestive Relief",
      review: "The Panchakarma detox at Ayush Ayurved was incredibly thorough. My chronic digestive issues, which plagued me for years, have completely resolved. The doctors here are exceptional, taking the time to explain every step of the process. I highly recommend their facility to anyone seeking genuine healing and a balanced life.",
      name: "Charlotte H.",
      verified: true,
      location: "London, UK",
    ...
    {
      title: "Transformative Joint Care",
      review: "I came from Canada specifically for severe joint pain and the personalized Basti treatment worked wonders. The center is impeccably clean, and the therapists are highly skilled in classical methods. Within just three weeks, my mobility has drastically improved and I am no longer dependent on daily painkillers.",
      name: "Noah J.",
      verified: true,
    ...
    {
      title: "Life-Changing Balance",
      review: "Outstanding care for my hormonal imbalances and chronic fatigue. The combination of targeted therapies and authentic internal medicines prescribed here changed my life completely. The physicians conducted a deeply detailed Dosha analysis on my first day, which formed the foundation of my entire successful recovery journey.",
      name: "Isabella M.",
      verified: true,
    ...
    },
    {
      ...
      review: "The Vamana and Virechana procedures were conducted with absolute professionalism and profound care. I feel completely rejuvenated from the inside out, and my persistent skin condition has entirely cleared up. I am truly grateful for the dedication and expertise of the entire medical staff at this remarkable center.",
      name: "William K.",
      verified: true,
    ...
    {
      title: "True Authentic Care",
      review: "A truly genuine Ayurvedic center hidden in the heart of Mumbai. Their holistic approach, which seamlessly integrated comprehensive lifestyle counseling with authentic detox treatments, exceeded all my expectations. The quality of the medicated oils and the serene healing environment make this place an absolute sanctuary.",
      name: "Emma S.",
      verified: true,
  ...
  const faqItems = [
    {
      question: "What Panchakarma treatments do you offer at the Center?",
      answer: "We offer the complete spectrum of classical Panchakarma including Vamana, Virechana, Basti, Nasya, and Raktamokshan."
    },
    {
      question: "Are your Ayurvedic medicines authentic?",
      answer: "Yes, we exclusively use high-quality, authentic Ayurvedic medicines sourced from the most reputable traditional pharmacies."
    },
    {
      question: "Can Ayurveda help with chronic joint pain?",
      answer: "Absolutely. We specialize in treating chronic joint disorders using targeted therapies, specialized oils, and internal medications."
    },
    {
      question: "Do I need to follow a specific diet during treatment?",
      answer: "Yes, our doctors provide personalized dietary and lifestyle consultations that are crucial for the success of your Panchakarma treatment."
    },
    {
      question: "Is it necessary to book an appointment beforehand?",
      answer: "Yes, to ensure our doctors can dedicate the appropriate time for your detailed consultation, we highly recommend booking in advance."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Comprehensive detoxification procedures including Vamana, Virechana, and Basti to deeply cleanse the body of rooted toxins.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Joint & Spine Care",
      description: "Targeted Ayurvedic pain management for arthritis and spondylosis using specialized therapies and medicated oils.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Hair Wellness",
      description: "Effective blood purification therapies and external applications to treat chronic eczema, psoriasis, and severe hair loss.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Digestive Restoration",
      description: "Natural protocols for managing chronic indigestion, acidity, IBS, and restoring optimal gut health and metabolic balance.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Hormonal Balance",
      description: "Specialized Ayurvedic treatments designed to regulate hormonal fluctuations and support overall endocrine health naturally.",
  ...
  const whyChooseUs = [
    {
      ...
      description: "We are equipped to provide the entire spectrum of classical Panchakarma therapies.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Qualified Doctors",
      description: "Our treatments are guided by highly experienced and qualified Ayurvedic physicians.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Trained Therapists",
      description: "Every therapy is administered by extensively trained and skilled Ayurvedic therapists.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Authentic Medicines",
      description: "We exclusively use premium quality Ayurvedic medicines sourced from trusted pharmacies.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Holistic Lifestyle Guidance",
      description: "We provide comprehensive lifestyle and dietary consultations for sustainable wellness.",
      icon: <FileSearch className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Trusted Community",
      description: "Rated 4.7 on Google with over 214 reviews, trusted by a loyal patient community.",
  ...
  useEffect(() => {
    document.title = "Ayush Ayurved Panchakarma Center | Authentic Care in Mumbai";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Ayurvedic treatments and complete Panchakarma at Ayush Ayurved Panchakarma Center in Mumbai.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Ayush Ayurved Panchakarma Center Mumbai
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Ayush Ayurved <br className="hidden md:block" /> Panchakarma Center</h1>
                <p className="text-xl mb-4 opacity-90">Mumbai's Trusted Destination for Complete Panchakarma</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Santacruz, Mumbai, Maharashtra, India</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.7</span>
                  <span className="opacity-90">(214 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Ayush Ayurved Panchakarma Center
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Ayush Ayurved Panchakarma Center</strong>, a trusted sanctuary for authentic Ayurvedic healing in Mumbai with a stellar 4.7 Google rating. We offer complete classical Panchakarma procedures—including Vamana, Virechana, Basti, Nasya, and Raktamokshan—meticulously designed to detoxify the body and restore your natural metabolic balance.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/Ayush Ayurved Panchakarma Center/image 2.webp" 
                          alt="Ayush Ayurved therapy room"
                          className="w-full h-full object-cover"
                          onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/18.webp"; }}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <p>
                    Led by highly qualified doctors and administered by extensively trained therapists, we take immense pride in delivering consistent therapeutic outcomes. We exclusively use premium quality Ayurvedic medicines sourced directly from trusted, authentic traditional pharmacies to ensure the highest standard of care and safety for every patient visiting our Center.
                  </p>
                  
                  <p>
                    Whether you are dealing with chronic skin conditions, severe joint disorders, persistent digestive ailments, or complex hormonal imbalances, our Center provides a personalized healing approach. Our commitment goes beyond mere symptom management; we offer comprehensive lifestyle consultations and herbal internal medicines to support your long-term wellness and enduring vitality.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/Ayush Ayurved Panchakarma Center/image 1.jpeg" 
                      alt="Ayush Ayurved main view"
                      className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                      onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/18.jpg"; }}
                    />
                  </div>
                </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Ayush Ayurved Panchakarma Center today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Ayush Ayurved Panchakarma Center
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Ayush Ayurved Panchakarma Center
              </h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience comprehensive traditional healthcare with qualified doctors, trained therapists, and authentic medicines.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Ayush Ayurved Panchakarma Center
            </h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/Ayush Ayurved Panchakarma Center/image 1.jpeg"
                  alt="Ayush Ayurved view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/18.jpg"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Ayush Ayurved Panchakarma Center?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Ayush Ayurved Panchakarma Center?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and specialties at Ayush Ayurved Panchakarma Center.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Ayush Ayurved Panchakarma Center<br />
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Centrally located clinic in Santacruz for easy access.</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=Ayush+Ayurvedic+And+Panchakarma+Clinic,+Santacruz+East,+Mumbai&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or therapy program at Ayush Ayurved Panchakarma Center.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/9198xxxxxxxx?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Ayush%20Ayurved%20Panchakarma%20Center."
              target="_blank"
              rel="noreferrer"
