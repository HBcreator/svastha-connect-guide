...
export default function DhanwanthralayaAyurvedaSpecialityHospital() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "In-depth physical baseline evaluation and constitutional pulse profiling to determine specific dosha imbalances and build a meticulous clinical history.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Customized Clinical Prescriptions",
      description: "Developing a customized treatment plan including precise, high-potency internal remedies and designated daily localized external therapies.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Preparatory Purva Karma",
      description: "Administering synchronized warm oil massage (Abhyangam) and custom organic steam baths (Swedana) to loosen deep metabolic impurities.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Physiological Panchakarma Cleansing",
      description: "Executing classical, medically supervised cellular purification treatments (Virechana, Vasti, or Vamana) tailored specifically to clear deep toxins.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Targeted Localized Retention",
      description: "Applying highly specialized external therapies like Kati Vasti, Janu Vasti, or Greeva Vasti to soothe nerve compression and restore spinal mobility.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Long-Term Continuing Care",
      description: "Preserving therapeutic results through structured post-treatment guidelines, wellness diet charts, dynamic exercises, and scheduled evaluations.",
  ...
  const testimonials = [
    ...
    },
    {
      ...
      condition: "Severe Chronic Psoriasis",
      rating: 5
    },
    {
      ...
      condition: "Complex Anal Fistula",
      rating: 5
    },
    {
  ...
  const faqItems = [
    {
      question: "What makes Dhanwanthralaya Ayurveda Speciality Hospital a leading center in Chennai?",
      answer: "Dhanwanthralaya is a premier 30-bed Ayurvedic hospital in West Tambaram, Chennai. Founded in 2001 by Dr. Vanitha R. Muralikumar, a pioneer in the field, we integrate authentic classical Ayurveda with modern clinical diagnostics, private inpatient suites, a specialized operation theater, and 24/7 emergency support."
    },
    {
      question: "Who are the leading consulting specialists at the hospital?",
      answer: "Our consulting panel is led by founder Dr. Vanitha R. Muralikumar (MD in General Medicine), along with specialists like Dr. R. Ashok Kumar (MS Shalya - Surgery), Dr. K. Siva Balaji (MS Shalakya - Ophthalmology/ENT), Dr. S. Sriman Narayanan (MD Psychiatry), and Dr. Krithika Narayanan (Obstetrics & Gynecology)."
    },
    {
      question: "What facilities are available for in-patients and chronic treatments?",
      answer: "The hospital is a full-capacity 30-bed healthcare facility offering comfortable private and general wards, specialized Panchakarma suites, an operational theater, an in-house pharmacy, a radiology department, and a pathology lab."
    },
    {
      question: "How are the fresh herbal decoctions prepared at the hospital?",
      answer: "Yes, the hospital operates a unique 'Wet Pharmacy' where fresh herbal decoctions (Kashayams) are prepared daily under the supervision of pharmacologists using organically sourced herbs to guarantee highest therapeutic efficacy."
    },
    {
      question: "Does Dhanwanthralaya support corporate or private health insurance?",
      answer: "Yes, Dhanwanthralaya provides comprehensive medical documentation, clinical logs, and case sheets to assist patients in claiming AYUSH health insurance reimbursement."
    }
  ];

  const programs = [
    {
      title: "Non-Surgical Spine & Joint Care",
      description: "Targeted care for cervical/lumbar spondylosis, herniated discs, sciatica, and joint arthritis using specialized oil poolings (Kati Vasti, Greeva Vasti).",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Classical Panchakarma Detox",
      description: "Systematically purging cellular toxins and restoring metabolic balance through classical Vamana, Virechana, and Vasti under senior Vaidya supervision.",
    ...
    {
      title: "Prasuti Tantra",
      description: "Specialized obstetrics, gynecological care, prenatal/postnatal maternity support, and biological fertility optimization led by experienced practitioners.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Manasa Roga & Neuro-Psychiatry",
      description: "Deep soothing therapies like Shirodhara, Shirovasthi, and specialized herbs to resolve chronic insomnia, stress, anxiety, and depression.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Shalakya Tantra & Dermatology",
      description: "Dedicated treatments for eye/ENT care, chronic migraines, sinusitis, and complex skin conditions like psoriasis, eczema, and hair loss.",
  ...
  const whyChooseUs = [
    {
      title: "Distinguished Medical Leadership",
      description: "Spearheaded by Dr. Vanitha R. Muralikumar (eminent scholar, former President of CCIM) and a veteran consulting panel.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "30-Bed Speciality Hospital",
      description: "Comprehensive in-patient care, operational theater, and round-the-clock emergency support.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "In-House Fresh 'Wet Pharmacy'",
      description: "Direct preparation of fresh herbal decoctions (Kashayams) daily for peak organic potency.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Comprehensive Pathology & Diagnostics",
      description: "Apollo Diagnostics tie-up and radiography services for precise, integrated diagnostic checks.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Highly Trained Therapists",
      description: "Authentic procedures administered under strict medical supervision by highly skilled therapists.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "AYUSH Insurance Support",
      description: "Transparent documentation, clinical logs, and case sheets to facilitate insurance reimbursement claims.",
  ...
  useEffect(() => {
    document.title = "Dhanwanthralaya Ayurveda Speciality Hospital | Best Ayurvedic Hospital in Chennai";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Book consultations at Dhanwanthralaya Ayurveda Speciality Hospital in West Tambaram, Chennai. A premier 30-bed hospital founded by Dr. Vanitha R. Muralikumar, specializing in non-surgical spine/joint care, Kshara Sutra therapy, and classical Panchakarma.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Dhanwanthralaya Ayurveda Speciality Hospital</h1>
                <p className="text-xl mb-4 opacity-90">Non-Surgical Joint Rehabilitation Center</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">West Tambaram, Chennai, Tamil Nadu</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.5</span>
                  <span className="opacity-90">(250 reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Dhanwanthralaya Ayurveda Speciality Hospital
</h2>
            </div>
                    ...
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          ...
                          alt="Dhanwanthralaya Ayurveda Speciality Hospital West Tambaram Chennai Exterior"
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                       src="/TOP centers/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Dhanwanthralaya Ayurveda Speciality Hospital/main.jpg" 
                       alt="Dhanwanthralaya Ayurveda Speciality Hospital Chennai Center"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP centers/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Dhanwanthralaya Ayurveda Speciality Hospital/secondary.webp" 
                        alt="Therapy chamber at Dhanwanthralaya Ayurveda Speciality Hospital"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Dhanwanthralaya Ayurveda Speciality Hospital today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Dhanwanthralaya Ayurveda Speciality Hospital
</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Dhanwanthralaya Ayurveda Speciality Hospital
</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Discover a premier 30-bed speciality hospital combining classical Ayurveda, clinical diagnostics, and eminent medical leadership.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Dhanwanthralaya Ayurveda Speciality Hospital
</h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A structured, integrated recovery pathway directed entirely by senior specialists, from traditional diagnostics to custom continuing care.
            </p>
          </div>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/9.JPG"
                  alt="Dhanwanthralaya Ayurveda Speciality Hospital Center"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/9.JPG"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Dhanwanthralaya?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Dhanwanthralaya?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at Dhanwanthralaya.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Dhanwanthralaya Ayurveda Speciality Hospital<br />
                      No: 25, 26 A & B, Old State Bank Colony, First Main Road<br />
                      Behind Tambaram RTO Office, West Tambaram, Chennai
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1.5" style={{ color: "#7F543D" }}>
                      <li>• Approx. 12 km from Chennai International Airport</li>
                      <li>• Approx. 2 km from Tambaram Railway Station</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d124412.23101544922!2d80.09236659368626!3d12.97938433142324!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a525f73a6288cc9%3A0x3e9b4835fd046fb7!2sDhanwanthralaya%20Ayurveda%20Speciality%20Hospital%20%7C%20Ayurvedic%20Hospital%20in%20Chennai!5e0!3m2!1sen!2sin!4v1779757614675!5m2!1sen!2sin"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Dhanwanthralaya Ayurveda Speciality Hospital Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="/TOP centers/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Dhanwanthralaya Ayurveda Speciality Hospital/main.jpg"
            alt="Ayurvedic Therapy at Dhanwanthralaya"
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment program at Dhanwanthralaya.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919176677751?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Dhanwanthralaya%20Ayurveda%20Speciality%20Hospital."
              target="_blank"
              rel="noreferrer"
