...
export default function PraanaVaidyaAyurvedicHospital() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Thorough root-cause analysis combining classical Ayurvedic systems of examination with modern scientific laboratory profiling to establish a baseline.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Personalized Healing Map",
      description: "Our team of senior doctors constructs a detailed personal treatment pathway combining specific internal medications, dietary regimes, and physical therapies.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Purifying Panchakarma",
      description: "Undergoing clinically supervised detoxification therapies designed specifically to flush out deep-seated toxins and clear metabolic congestion.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Precision Parasurgical Care",
      description: "Executing targeted Shalya Tantra and parasurgical procedures like the highly effective Kshara Sutra for permanent resolution of complex anorectal issues.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Guided Herbal Restoratives",
      description: "Formulating and administering highly potent, 100% natural herbal preparations tailored to balance cellular intelligence and rejuvenate organ systems.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Sustained Vitality Integration",
      description: "Empowering your long-term health journey with clinical Yoga practices, custom dietary adjustments, and a seamless remote check-up calendar.",
  ...
  const testimonials = [
    {
      ...
      condition: "Severe Varicose Veins",
      rating: 5
    },
    {
      ...
      condition: "Chronic Psoriasis & Eczema",
      rating: 5
    },
    {
      ...
      verified: true,
      location: "Austin, USA",
      condition: "Anal Fistula (Shalya Tantra)",
      rating: 5
    },
    {
      ...
      condition: "Thyroid & PCOS Imbalance",
      rating: 5
    },
    {
  ...
  const faqItems = [
    {
      question: "What is the core clinical philosophy of PraanaVaidya?",
      answer: "PraanaVaidya stands out for its strictly physician-led, doctor-directed treatment model. We reject standard 'spa-based' general wellness and instead focus entirely on therapeutic root-cause diagnostics and clinical protocols for complex, chronic, and lifestyle conditions."
    },
    {
      question: "Who designs and oversees the medical treatments?",
      answer: "All clinical protocols are designed and supervised by our eminent medical leadership, led by Founder & Medical Director Dr. Chethan Upadhyaya (BAMS, MS in Shalya Tantra, expert Ayurvedic surgeon with 10+ years experience) and Dr. Swasthika Upadhyaya (BAMS, MD in Ayurveda, FAGE, specialist in women's endocrinology, fertility, and autoimmune conditions)."
    },
    {
      question: "What unique Shalya Tantra procedures are performed here?",
      answer: "We specialize in highly successful Ayurvedic parasurgical procedures, most notably the Kshara Sutra treatment for chronic anorectal disorders such as piles, fissures, and fistulas. This technique offers an extremely low recurrence rate and minimal discomfort compared to conventional invasive surgeries."
    },
    {
      question: "Can patients claim insurance reimbursement for treatments at PraanaVaidya?",
      answer: "Yes. PraanaVaidya operates under strict NABH accreditation guidelines. We provide all necessary standard diagnostic reports, itemized medical bills, prescriptions, and discharge summaries required by major insurers to process standard AYUSH insurance claims."
    },
    {
      question: "Do you offer remote consultations or home-care supervision?",
      answer: "Yes, we recognize that recovery continues at home. PraanaVaidya provides comprehensive virtual doctor-supervised consultation options, app-based Panchakarma monitoring, and home care protocols to support you throughout your entire healing journey."
    }
  ];

  const programs = [
    {
      title: "Anorectal & Kshara Sutra Care",
      description: "Advanced Shalya Tantra parasurgical protocols providing highly effective, low-recurrence solutions for piles, fissure, fistula, and pilonidal sinus.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Metabolic & Diabetes Reversal",
      description: "Doctor-guided cell-level rejuvenation therapies, metabolic screening, and structured nutritional plans designed to reverse insulin resistance.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Spine & Joint Restoration",
      description: "Comprehensive care for sciatica, cervical spondylosis, herniated discs, and osteoarthritis, combining target oils with modern diagnostics.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Hormonal & Women's Health",
      description: "Specialized, compassionate care for PCOS/PCOD, thyroid imbalances, infertility, and chronic menstrual issues managed under expert gynecological Ayurveda.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin & Autoimmune Recovery",
      description: "Scientific detoxification, deep blood purification, and target herbal applications to soothe and heal severe psoriasis, eczema, and skin allergies.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Stroke & Neurological Rehab",
      description: "Intensive physician-supervised rehabilitation integrating classic therapies to stimulate motor function, restore speech, and rebuild strength.",
  ...
  const whyChooseUs = [
    {
      ...
      description: "Assuring patients of high-quality therapeutic practices, strict hygiene protocols, standardized medications, and medical safety.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Strictly Physician-Led",
      description: "Rejecting generalized massage spas in favor of structured, doctor-directed diagnostic methods and clinical care.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Advanced Surgical Expertise",
      description: "Led by Shalya Tantra specialist Dr. Chethan Upadhyaya, offering highly successful, non-invasive Kshara Sutra treatments.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Eminent Medical Panel",
      description: "Featuring a dedicated team of 50+ registered medical practitioners with decades of combined Shalya and Kayachikitsa experience.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Massive Recovery Legacy",
      description: "Trusted by over 45,000+ happy patients, with a clinical history of 5,000+ successful surgeries and 13,000+ completed therapies.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Smooth Insurance Support",
      description: "Providing detailed clinical histories and paperwork to facilitate hassle-free cashless or reimbursement AYUSH claims.",
  ...
  useEffect(() => {
    document.title = "PraanaVaidya Ayurvedic Hospital | Best Shalya & Kayachikitsa Center in Bangalore";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Book consultations and treatments at PraanaVaidya Ayurvedic Hospital in Rajajinagar, Bangalore. Renowned for physician-led care in anorectal diseases, metabolic reversal, and joint health.");
  ...
  return (
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>PraanaVaidya Ayurvedic Hospital</h1>
                <p className="text-xl mb-4 opacity-90">Eminent Physician-Led Shalya & Kayachikitsa Care</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Rajajinagar, Bengaluru, Karnataka</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.8</span>
                  <span className="opacity-90">(170 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] leading-tight md:leading-[1.1] max-w-4xl mx-auto px-2">
               Physician-Led Healing <br className="hidden lg:block" />
                at PraanaVaidya Ayurvedic Hospital
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-lg md:text-xl leading-relaxed text-foreground/80 text-justify md:text-left" style={{ color: "#7F543D" }}>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/13.jpg" 
                          alt="PraanaVaidya Ayurvedic Hospital Rajajinagar Clinic"
                          className="w-full h-full object-cover"
                          onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/13.jpg"; }}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <p>
                    Under the stellar leadership of Founder & Medical Director <strong className="font-bold text-[#2C4E5A]">Dr. Chethan Upadhyaya</strong> (BAMS, MS in Ayurveda, Shalya Tantra surgeon) and senior endocrinology specialist <strong className="font-bold text-[#2C4E5A]">Dr. Swasthika Upadhyaya</strong> (BAMS, MD, FAGE), PraanaVaidya has established a phenomenal recovery legacy. Across our network of over 50 registered doctors, we have successfully completed more than 5,000 Shalya surgeries, administered 13,000+ advanced therapies, and clinically guided 45,000+ patients to long-term health.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Praana Vaidya Ayurvedic Hospital/main.jpg" 
                      alt="PraanaVaidya Ayurvedic Hospital Rajajinagar Campus"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Praana Vaidya Ayurvedic Hospital/secondary.webp" 
                        alt="Ayurvedic Therapy Room at PraanaVaidya"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with PraanaVaidya Ayurvedic Hospital today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at PraanaVaidya Ayurvedic Hospital</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose PraanaVaidya Ayurvedic Hospital</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience registered, doctor-led clinical treatments designed to target the systemic root-causes of chronic illnesses.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Your Healing Journey at PraanaVaidya</h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/13.jpg"
                  alt="PraanaVaidya Ayurvedic Hospital"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/13.jpg"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at PraanaVaidya Ayurvedic Hospital?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at PraanaVaidya Ayurvedic Hospital?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at PraanaVaidya Ayurvedic Hospital.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      PraanaVaidya Ayurvedic Hospital<br />
                      No. 69, Perikal Metro Hub, Service Road<br />
                      West of Chord Road, 2nd Stage, Near Rajajinagar Metro Station<br />
                      Bengaluru, Karnataka
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1" style={{ color: "#7F543D" }}>
                      <li>• Approx. 35 km from Kempegowda International Airport</li>
                      <li>• Approx. 4.5 km from KSR Bengaluru City Railway Station</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.5525489560523!2d77.54684107507698!3d13.000445987317562!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae17281badc1b7%3A0xe032b073c3c8070d!2sPraanaVaidya%20Ayurvedic%20Hospital%20-%20Rajajinagar!5e0!3m2!1sen!2sin!4v1779690491802!5m2!1sen!2sin"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="PraanaVaidya Ayurvedic Hospital Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Praana Vaidya Ayurvedic Hospital/main.jpg"
            alt="Ayurvedic Therapy at PraanaVaidya"
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a free consultation. Our doctors will guide you towards the perfect treatment program at PraanaVaidya.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919611773811?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20PraanaVaidya%20Ayurvedic%20Hospital."
              target="_blank"
              rel="noreferrer"
