...
export default function ShreeAyurvedHospital() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "A comprehensive clinical and Ayurvedic evaluation by Dr. Prashant Daundkar Patil and his expert team to identify the root cause of your ailments.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Integrated Treatment Plan",
      description: "Designing a robust healing protocol that seamlessly integrates classical Panchakarma, physiotherapy, and dietary modifications.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "In-Patient Admission",
      description: "Comfortable admission into our fully equipped 15-bed facility ensuring 24/7 medical supervision and strict dietary adherence.",
      icon: <Building2 className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Core Panchakarma execution",
      description: "Performing targeted detox therapies ranging from 7 to 28 days using authentic medicines for deep, systemic healing.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Specialized Interventions",
      description: "Applying targeted procedures such as Ksharsutra or physiotherapy specifically tailored to your orthopedic or chronic condition.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Post-Treatment Support",
      description: "Providing detailed post-discharge lifestyle guidelines, rasayana (rejuvenation) herbs, and ongoing follow-up care.",
  ...
  const testimonials = [
    {
      ...
      review: "The 21-day Panchakarma program at Shree Ayurved completely changed my life. My chronic arthritis pain has vanished, and the integration of traditional Ayurveda with modern hospital facilities made me feel incredibly safe and well-cared for. Dr. Prashant and his team are phenomenal.",
      name: "Oliver B.",
      verified: true,
      location: "London, UK",
      condition: "Arthritis",
    ...
    },
    {
      ...
      review: "I traveled from Australia to treat my severe spondylosis and the results exceeded my wildest expectations. The hospital’s specialized Ksharsutra and Panchakarma therapies provided the relief that years of conventional medicine could not. The hygiene and professionalism here are outstanding.",
      name: "Sophia C.",
      verified: true,
    ...
    {
      title: "Complete Metabolic Restoration",
      review: "Finding a comprehensive Ayurvedic hospital with an ICU and such deep traditional knowledge is rare. My personalized diabetes management plan, which included targeted Panchakarma and strict dietary guidance, has restored my metabolic balance completely. I highly recommend this facility.",
      name: "Elias M.",
      verified: true,
    ...
    {
      title: "Exceptional Holistic Care",
      review: "The customized infertility treatment protocols at this hospital are rooted in deep classical wisdom yet delivered with modern clinical precision. The daily therapies, the compassionate nursing staff, and the post-treatment lifestyle counseling were exceptional and profoundly effective.",
      name: "Amelia J.",
      verified: true,
    ...
    {
      title: "Unparalleled Healing",
      review: "An unparalleled healing experience in Pune. The dedicated 14-day detoxification program cleared my persistent skin disorders entirely. The doctors took the time to meticulously explain my body constitution, ensuring every herbal medicine and therapy aligned perfectly with my recovery needs.",
      name: "Lucas R.",
      verified: true,
  ...
  const faqItems = [
    {
      question: "What makes Shree Ayurved Hospital unique in Pune?",
      answer: "We are the first recognized private Ayurvedic hospital in Pune that combines classical Ayurveda, Panchakarma, Physiotherapy, and an ICU under one roof for complete patient care."
    },
    {
      question: "How long are your Panchakarma programs?",
      answer: "Our customized Panchakarma detoxification and rejuvenation programs typically range from 7 to 28 days, depending on the severity of your condition and specific health goals."
    },
    {
      question: "Do you offer cashless mediclaim facilities?",
      answer: "Yes, as a recognized hospital, we support cashless mediclaim facilities for eligible insurance policies to make your healing journey stress-free."
    },
    {
      question: "What chronic conditions do you specialize in treating?",
      answer: "We specialize in effectively treating arthritis, spondylosis, paralysis, diabetes, infertility, kidney stones, and complex skin disorders."
    },
    {
      question: "Is accommodation provided during the long-term treatments?",
      answer: "Yes, we are a fully equipped 15-bed hospital providing comfortable in-patient care, strict Ayurvedic diets, and 24/7 medical supervision during your stay."
    }
  ];

  const programs = [
    {
      title: "Intensive Panchakarma",
      description: "7 to 28-day classical detoxification protocols designed to cleanse deep-seated toxins and completely reset the body's metabolic functions.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Orthopedic & Spine Care",
      description: "Integrative therapies combining traditional Ayurvedic pain management and modern physiotherapy for arthritis and spondylosis.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Ksharsutra Surgery",
      description: "Specialized, minimally invasive Ayurvedic surgical interventions for specific conditions, ensuring faster recovery and healing.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Metabolic & Diabetes Care",
      description: "Comprehensive management plans including specialized diet regimens, internal medicines, and therapies to regulate blood sugar.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Infertility & Gynecology",
      description: "Holistic, classical Ayurvedic protocols designed to address root causes of infertility and complex gynecological disorders.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Skin Disorder Management",
      description: "Targeted blood purification treatments to effectively manage and heal chronic skin conditions like psoriasis and severe eczema.",
  ...
  const whyChooseUs = [
    {
      title: "Full Hospital Facility",
      description: "A recognized 15-bed hospital offering complete in-patient care and a fully functional ICU.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Integrative Approach",
      description: "We seamlessly combine classical Ayurveda, Panchakarma, and modern Physiotherapy.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Expert Leadership",
      description: "Led by Dr. Prashant Daundkar Patil and a highly skilled team of specialists.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Cashless Mediclaim",
      description: "Supporting cashless mediclaim facilities to make your holistic treatments accessible.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Long-Term Programs",
      description: "Offering immersive 7 to 28-day Panchakarma protocols tailored for deep healing.",
      icon: <FileSearch className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Exceptional Reputation",
      description: "Proudly holding a 4.5 rating from over 700+ satisfied patients worldwide.",
  ...
  useEffect(() => {
    document.title = "Shree Ayurved & Panchakarma Hospital | Authentic Care in Pune";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Ayurvedic treatments and complete Panchakarma at Shree Ayurved & Panchakarma Hospital in Pune.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Shree Ayurved & Panchakarma Hospital Pune
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Shree Ayurved & <br className="hidden md:block" /> Panchakarma Hospital</h1>
                <p className="text-xl mb-4 opacity-90">Pune's Premier Hospital for Integrative Ayurvedic Care</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Chandan Nagar, Pune, Maharashtra, India</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.5</span>
                  <span className="opacity-90">(700+ Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Shree Ayurved & Panchakarma Hospital
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to <strong className="font-bold text-[#2C4E5A]">Shree Ayurved & Panchakarma Hospital</strong>, Pune's recognized, premier Ayurveda and Panchakarma hospital with an impressive 4.5 Google rating from over 700+ reviews. Founded in 2005 and upgraded to a full hospital in 2018, it stands as the only Ayurvedic hospital in Pune offering a comprehensive suite of services including Ayurveda, Panchakarma, Physiotherapy, Ksharsutra Surgery, and an ICU all under one roof.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/Shree Ayurved & Panchakarma Hospital/image 2.webp" 
                          alt="Shree Ayurved therapy room"
                          className="w-full h-full object-cover"
                          onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/20.webp"; }}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <p>
                    Led by the highly experienced Dr. Prashant Daundkar Patil, the hospital effectively treats a wide array of chronic conditions ranging from arthritis, spondylosis, and paralysis to diabetes, infertility, and severe skin disorders. Our medical facility is uniquely designed to integrate traditional Ayurvedic practices with modern medical insights, ensuring uncompromising safety, hygiene, and profound therapeutic outcomes.
                  </p>
                  
                  <p>
                    We offer specialized in-patient Panchakarma programs ranging from 7 to 28 days, tailored meticulously to your specific health requirements and body constitution. Beyond the intensive treatments, our dedicated medical team provides personalized dietary regimens, strict post-treatment lifestyle guidance, and premium herbal medicines to guarantee sustained wellness and a completely rejuvenated life.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/Shree Ayurved & Panchakarma Hospital/image 1.webp" 
                      alt="Shree Ayurved main view"
                      className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                      onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/20.jpg"; }}
                    />
                  </div>
                </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Shree Ayurved & Panchakarma Hospital today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Shree Ayurved & Panchakarma Hospital
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Shree Ayurved & Panchakarma Hospital
              </h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience comprehensive healthcare with a unique blend of classical Ayurveda, modern medical amenities, and an in-house ICU.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Shree Ayurved & Panchakarma Hospital
            </h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A comprehensive clinical pathway of precise diagnosis, integrated therapies, and supervised in-patient healing designed for your unique condition.
            </p>
          </div>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/Shree Ayurved & Panchakarma Hospital/image 1.webp"
                  alt="Shree Ayurved view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/20.jpg"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Shree Ayurved & Panchakarma Hospital?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Shree Ayurved & Panchakarma Hospital?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and specialties at Shree Ayurved & Panchakarma Hospital.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Shree Ayurved & Panchakarma Hospital<br />
                      Chandan Nagar, Pune, Maharashtra, India
                    </p>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Centrally located hospital in Chandan Nagar, Pune.</span>
                      </li>
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=Shree+Ayurved+Hospital,+Chandan+Nagar,+Pune&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Shree Ayurved Hospital Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or therapy program at Shree Ayurved & Panchakarma Hospital.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/9198xxxxxxxx?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Shree%20Ayurved%20%26%20Panchakarma%20Hospital."
              target="_blank"
              rel="noreferrer"
