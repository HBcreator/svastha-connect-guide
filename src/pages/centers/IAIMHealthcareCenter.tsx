...
export default function IAIMHealthcareCenter() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "A thorough baseline assessment combining traditional Ayurvedic pulse diagnosis (Nadi Pariksha) with standard modern diagnostic protocols.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Personalized Treatment Plan",
      description: "Designing a customized therapeutic blueprint that integrates authentic Ayurvedic treatments, nutritional guidance, physiotherapy, and daily lifestyle adjustments.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Pure Medicated Formulations",
      description: "Administering highly potent, standardized, and quality-controlled herbal medications designed specifically to combat the underlying disease.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Authentic Panchakarma",
      description: "Undergoing classical bio-cleansing and detoxification protocols, closely monitored by senior physicians and administered by trained therapists.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Prevention & Rehabilitation",
      description: "Integrating dynamic ancillary modalities such as medical Yoga, clinical physiotherapy, or acupuncture to speed up holistic recovery.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Long-Term Wellness",
      description: "Providing scheduled post-treatment check-ups, follow-ups, and customized wellness guidelines to prevent recurrence and maintain vitality.",
  ...
  const testimonials = [
    {
      title: "Outstanding Integrative Rehab",
      review: "I spent 12 days at IAIM for severe lower back pain and sciatica. The combination of classical Panchakarma with modern physiotherapy was incredibly effective. The 100-bed facility is peaceful, clean, and the staff are amazingly professional.",
      name: "Oliver Hansen",
      verified: true,
      location: "Oslo, Norway",
      condition: "Sciatica & Back Pain",
      rating: 5
    },
    {
      title: "Incredible Support for Joint Pain",
      review: "As an elderly traveler, I was looking for gentle geriatric care. The doctors at IAIM constructed a personalized plan that greatly improved my knee mobility. Being NABH-accredited made the billing and documentation seamless.",
      name: "Sienna Ricci",
      verified: true,
      location: "Florence, Italy",
      condition: "Geriatric Knee Arthritis",
      rating: 5
    },
    {
      title: "Highly Professional Wellness Detox",
      review: "Established behind the green hills of Yelahanka, this center is a serene haven. Underwent a full 14-day detox. The transdisciplinary approach and research-backed methods gave me great confidence. Outstanding experience.",
      name: "Aria Thorne",
      verified: true,
      location: "London, UK",
    ...
    },
    {
      ...
      review: "We visited Bangalore seeking natural options for our child's recurring respiratory allergies. Dr. Prasan Shankar and the pediatrics team were exceptionally gentle. The natural formulations have vastly improved his immunity.",
      name: "Amélie Laurent",
      verified: true,
      location: "Paris, France",
      condition: "Pediatric Allergy & Immunity",
      rating: 5
    },
    {
      title: "Life-Changing Chronic Care",
      review: "Struggling with chronic IBS and stress, IAIM offered an integrative healing program combining Ayurveda, Yoga, and acupuncture. The values of empathy and excellence truly shine through the entire team. Highly recommend!",
      name: "Finn Gallagher",
      verified: true,
  ...
  const faqItems = [
    {
      question: "What makes IAIM Healthcare Center unique?",
      answer: "Launched in 2011 with seed-funding from the Tata Trusts, IAIM is a leading 100-bed, NABH-accredited hospital in Bangalore pioneering 'integrative care'. We blend classical Ayurveda with modern diagnostics, acupuncture, physiotherapy, and medical Yoga to offer a research-backed, evidence-based healing process."
    },
    {
      question: "Is IAIM Healthcare Center NABH-accredited? Can I claim insurance?",
      answer: "Yes, our hospital holds prestigious NABH accreditation. This standard ensures that patients can leverage standard health insurance policies for cashless billing or reimbursement for their Ayurvedic treatments, based on policy details."
    },
    {
      question: "What medical conditions do you specialize in?",
      answer: "We run highly specialized clinical departments focusing on Neuromusculoskeletal conditions (Vata Vyadhi), Child health (Koumarabhritya), Senior care (Jara Chikitsa), Gynecology & Obstetrics (OBG), surgical support (Shalya), Ophthalmology & ENT (Shalakya), and classical Panchakarma."
    },
    {
      question: "How does IAIM ensure the quality of its treatments?",
      answer: "We maintain rigorous, evidence-based standards matching ancient classical texts. Our clinical methods are reinforced by laboratory research in partnership with the Bio-Genomics and Plant Sciences wings of TDU, utilizing quality-checked herbal formulations."
    },
    {
      question: "How do I book an appointment or get a consultation?",
      answer: "You can schedule a consultation with our doctors by calling our desk at +91 7204377000, or by filling out the consultation and callback request form directly on this website."
    }
  ];

  const programs = [
    {
      title: "Integrative Panchakarma",
      description: "Scientific, classical bio-purification protocols customized to eliminate deep-seated metabolic toxins and realign systemic physiological balance.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Neuromusculoskeletal Care",
      description: "Targeted clinical regimens combining classical treatments with specialized modern physical therapy for spine, joint, and muscular ailments.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Preventive Wellness Programs",
      description: "Full-spectrum health evaluations integrating Ayurveda, clinical Yoga, and customized daily regimens to prevent the onset of lifestyle disorders.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Women's Health (OBG)",
      description: "Comprehensive care focusing on reproductive wellness, postpartum recovery, and hormonal equilibrium using safe, classical formulations.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Geriatric Care & Rehabilitation",
      description: "Gentle, specialized protocols designed to enhance physical mobility, strengthen immune responses, and elevate the daily quality of life in seniors.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Pediatric Ayurveda (Koumarabhritya)",
      description: "Dedicated care for infants and children focusing on healthy development, immune strength, and cognitive growth using natural remedies.",
  ...
  const whyChooseUs = [
    {
      title: "Tata Trusts Seed-Funded",
      description: "Launched in 2011 with seed funding and infrastructural backing from the Tata Trusts, establishing a world-class standard of clinical care.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "NABH Accredited & Insurance",
      description: "A fully NABH-accredited, 100-bed hospital that enables hassle-free medical insurance coverage and cashless benefits for patients.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Integrative Medicine",
      description: "A pioneering paradigm that harmoniously bridges the wisdom of classical Ayurveda with modern diagnostic criteria and medical science.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Transdisciplinary Research",
      description: "Fostering evidence-based clinical practices through active transdisciplinary research partnerships with TDU and global scientific bodies.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "HEED Values & Care",
      description: "Anchored in our foundational code of Honesty, Excellence, Empathy, and Dependability (HEED) to ensure a compassionate patient journey.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Highly Experienced Vaidyas",
      description: "Managed by a stellar medical collective of over 20 veteran Vaidyas, integrative clinicians, and specialized nursing staff.",
  ...
  useEffect(() => {
    document.title = "IAIM Healthcare Center | Top Ayurveda Hospital in Bangalore";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Book a consultation at IAIM Healthcare Center in Bengaluru. Tata Trusts seed-funded, NABH-accredited 100-bed hospital blending Ayurveda and modern diagnostics.");
  ...
  return (
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>IAIM Healthcare Center</h1>
                <p className="text-xl mb-4 opacity-90">NABH-Accredited Integrative Ayurveda Hospital</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Behind CRPF Camp, Attur Post, Yelahanka, Bengaluru</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.7</span>
                  <span className="opacity-90">(1,140)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] leading-tight md:leading-[1.1] max-w-4xl mx-auto px-2">
                Pioneering Integrative Ayurveda <br className="hidden lg:block" />
                at IAIM Healthcare Center
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-lg md:text-xl leading-relaxed text-foreground/80 text-justify md:text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Nestled in the tranquil, green surroundings of Attur, Yelahanka in North Bangalore, <strong className="font-bold text-[#2C4E5A]">IAIM Healthcare Center</strong> represents a benchmark in integrative clinical care. Founded in 2011 through crucial seed funding and robust infrastructural backing from the Tata Trusts, this esteemed 100-bed, NABH-accredited hospital stands as a beacon of traditional healing. Rather than merely managing temporary symptoms, our expert team utilizes a transdisciplinary medical framework, blending classical Ayurvedic therapies with modern diagnostic sciences to identify and treat the fundamental root causes of complex, chronic conditions.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/11.jpg" 
                          alt="IAIM Healthcare Center Ayurveda Hospital"
                  ...
                  <p>
                    Operating in close synergy with the Bio-Genomics and Plant Sciences divisions at the adjacent Transdisciplinary University (TDU), our facility specializes in evidence-based clinical programs. These include authentic Panchakarma detoxification, pediatric wellness, geriatric care, and comprehensive neuromusculoskeletal rehabilitation. Our medical team—consisting of over 20 veteran Vaidyas and integrative health specialists—utilizes exclusively quality-tested, unadulterated herbal preparations to facilitate dependable recovery.
                  </p>
                </div>
              </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with IAIM Healthcare Center today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at IAIM Healthcare Center</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose IAIM Healthcare Center</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience research-backed healing supported by modern diagnostics and a dedicated transdisciplinary team.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Your Healing Journey at IAIM</h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A structured, evidence-based approach integrating Ayurveda, Yoga, and supportive modern diagnostics to restore your health.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  ...
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/11.jpg"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at IAIM Healthcare Center?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at IAIM Healthcare Center?</h2>
              ...
              <CardContent className="p-6 md:p-12 relative">
                <div className="text-[#2C4E5A]/20 mb-4 md:mb-6">
                  <svg className="w-10 h-10 md:w-12 md:h-12" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M6 17h3l2-4V7H5v6h3zm8 0h3l2-4V7H5v6h3zm8 0h3l2-4V7h-6v6h3z" />
                  </svg>
                </div>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at IAIM Healthcare Center.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      IAIM Healthcare Center<br />
                      74/2, Jarakabande Kaval, Behind CRPF Camp, Attur Post<br />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>+91 7204377000</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1" style={{ color: "#7F543D" }}>
                      <li>• Approx. 22 km from Kempegowda International Airport</li>
                      <li>• Approx. 6 km from Yelahanka Junction Railway Station</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3885.5819747994924!2d77.54668389999999!3d13.1256475!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae221305f258a7%3A0x4b557e8c07d53c78!2sIAIM%20Healthcare%20Center!5e0!3m2!1sen!2sin!4v1761548880182!5m2!1sen!2sin" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="IAIM Healthcare Center Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/11.jpg"
            alt="Ayurvedic Therapy at IAIM Healthcare"
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a free consultation. Our doctors will guide you towards the perfect treatment program at IAIM Healthcare Center.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/917204377000?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20IAIM%20Healthcare%20Center."
              target="_blank"
              rel="noreferrer"
