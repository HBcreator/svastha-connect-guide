...
export default function KAREHealth() {
  ...
  const treatmentProcess = [
    {
      number: 1,
      title: "Physician Prakriti Check",
      description: "A detailed clinical consultation with resident Ayurvedic doctors evaluating your body constitution (Prakriti), imbalances (Vikriti), and modern physical health markers.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Custom Therapy Scripting",
      description: "Formulating a targeted healing blueprint detailing physician-prescribed Keralite treatments, saatvic diet rules, and custom Iyengar Yoga postures.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Swedana & Snehana preparation",
      description: "Preparatory warm oil therapies (Abhyangam, custom herbal scrubs) to soften body channels and mobilize deep systemic toxins.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Supervised Panchakarma Cleansing",
      description: "Authentic Keralite biological purification therapies (Vamana, Virechana, Basti, Nasya) carefully administered under close doctor supervision.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Iyengar Yoga Alignment",
      description: "Postural medical yoga sessions utilizing specialized props (belts, ropes, blocks, benches) to correct spinal alignment and target chronic skeletal stress.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Home Lifestyle Blueprint",
      description: "Receiving customized long-term daily regimes, post-detox saatvic eating rules, and supportive herbal supplements to maintain your vitality at home.",
  ...
  const testimonials = [
    {
      title: "Profound Sciatica & Posture Recovery",
      review: "Decades of severe posture pain and sciatica vanished after doing props-based Iyengar Yoga here. The integration of Keralite warm oil massages and medically supervised yoga was life-changing.",
      name: "Emma Vance",
      verified: true,
      location: "Sydney, Australia",
      condition: "Iyengar Medical Yoga",
      rating: 5
    },
    {
      title: "Deep Rejuvenating Panchakarma Detox",
      review: "Underwent a full 14-day classical detox program. The clinical rigor under their resident doctors was superb. My digestion is fully restored, and I lost weight naturally.",
      name: "Hugo Stern",
      verified: true,
      location: "Hamburg, Germany",
      condition: "Shuddhi Panchakarma",
      rating: 5
    },
    {
      title: "Ultimate Sanctuary near Colva Beach",
      review: "The quiet sanctuary at Soul Vacation, just minutes from Colva Beach, is the ultimate retreat. The personalized saatvic meals and classical Keralite oils left me feeling completely rebuilt.",
      name: "Nora Cole",
      verified: true,
      location: "Frankfurt, Germany",
      condition: "Saukhya Rejuvenation",
      rating: 5
    },
    {
      title: "Excellent Stress & Metabolic Correction",
      review: "I visited KARE to address chronic stress and sluggish metabolism. Their structured medical supervision and custom herbal steam baths worked miracles. I feel light and full of energy.",
      name: "Leon Finch",
      verified: true,
      location: "Dublin, Ireland",
      condition: "Ailment Specific Recovery",
      rating: 5
    },
    {
      title: "Premium Medical Wellness Retreat",
      review: "Fascinated by their scientific approach combining Western medical understanding with traditional Keralite Ayurveda. The therapists are outstanding. A truly premium clinical retreat.",
      name: "Clara Ward",
      verified: true,
      location: "London, UK",
      condition: "Samya General Wellness",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    {
      question: "Who leads KARE Ayurveda at Soul Vacation and what is their approach?",
      answer: "KARE was founded in 1999 by Dr. Prakash Kalmadi, a distinguished physician of modern medicine who integrated Western scientific diagnostics with classical Kerala Ayurveda, Iyengar Medical Yoga, and meditation. In Goa, KARE operates a dedicated clinical retreat at the beautiful Soul Vacation Resort in Colva Beach."
    },
    {
      question: "What main clinical programs do you offer?",
      answer: "We offer six primary packages: Samya (General Wellness), Saukhya (Rejuvenation), Urja (Gentle Detox), Shuddhi (Classical Panchakarma), Iyengar Medical Yoga, and Ailment-Specific recovery programs (for obesity, joint stiffness, and stress)."
    },
    {
      question: "Where is KARE situated in Goa?",
      answer: "In Goa, KARE is situated within the peaceful, boutique gardens of Soul Vacation Resort, just a short walk from the white sands of Colva Beach in South Goa."
    },
    {
      question: "What is special about the yoga taught at KARE?",
      answer: "We specialize in Iyengar Medical Yoga, studying under the lineage of B.K.S. Iyengar. It utilizes specialized props (belts, ropes, blocks, and wooden benches) to allow individuals with chronic pain, stiffness, or injuries to perform therapeutic postures safely."
    },
    {
      question: "Do you coordinate airport pick-up services?",
      answer: "Yes. KARE coordinates private, reliable airport taxi pick-up and drop-off services for guests from Dabolim Airport (approx. 40 minutes) and Manohar International Airport at Mopa (approx. 1.5 to 2 hours) at an additional cost."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Custom physician consultations, deep physiological relaxation therapies, and targeted saativic diet schedules to restore bodily equilibrium.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Rejuvenation",
      description: "Nourishing Keralite synchronized warm oil poolings, organic herbal poultices, and cellular rasayana tonics to slow down aging.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Gentle Detox",
      description: "Mild biological purification processes, customized metabolic screening, organic steam baths, and light dietary cleanses.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Classical Panchakarma",
      description: "Full medically-prescribed, doctor-supervised biological cleansing (Vamana, Virechana, Basti, Nasya) to purge deep toxins.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Iyengar Medical Yoga",
      description: "Postural medical yoga therapies utilizing specialized props to release joint pressure, correct posture, and heal skeletal issues.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Ailment Specific Programs",
      description: "Targeted clinical protocols designed to address chronic joint paint, arthritis, obesity, diabetes, and lifestyle metabolic illnesses.",
  ...
  const whyChooseUs = [
    {
      title: "Founded by a Medical Doctor",
      description: "Established by modern physician Dr. Prakash Kalmadi, ensuring scientific precision and clinical safety in all treatments.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Iyengar Yoga Integration",
      description: "Props-based therapeutic medical yoga designed to assist guests with chronic skeletal pain, stiffness, or injuries.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Colva Beach Resort Setting",
      description: "Situated in a scenic, highly tranquil garden setting at Soul Vacation Resort near Colva Beach, South Goa.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "24-Hour Resident Support",
      description: "Constant wellness monitoring, professional therapy supervision, and support available on-site.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Vedic Saatvic Nutrition",
      description: "Ayurvedic food combinations tailored to your body constitution, supporting excellent digestion and metabolic balance.",
      icon: <Globe className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Kerala Academy Partnership",
      description: "Developed in direct collaboration with Dr. Srinivasan Nair and the renowned CNS Chikitsalayam in Kerala.",
  ...
  useEffect(() => {
    document.title = "KARE Ayurveda & Yoga Retreat | Medical Panchakarma & Iyengar Yoga in Colva Beach, Goa";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience medically-prescribed Ayurvedic healing and Iyengar Yoga at KARE Ayurveda & Yoga Retreat at Soul Vacation near Colva Beach, South Goa. Founded in 1999 by Dr. Prakash Kalmadi, offering authentic Panchakarma and saatvic nutrition.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="opacity-90">(680 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] leading-tight md:leading-[1.1] max-w-4xl mx-auto px-2">
                Medically-Prescribed Kerala Ayurveda & Iyengar Yoga <br className="hidden lg:block" />
                at KARE Ayurveda & Yoga Retreat
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-lg md:text-xl leading-relaxed text-foreground/80 text-justify md:text-left" style={{ color: "#7F543D" }}>
                    ...
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          ...
                          alt="KARE Ayurveda Retreat diagnostic setups"
                  ...
                  <p>
                    KARE Ayurveda at Soul Vacation is widely recognized for combining precise clinical diagnostics with authentic traditional treatments. Developed in direct partnership with Dr. Srinivasan Nair and the renowned <strong className="font-bold text-[#2C4E5A]">CNS Chikitsalayam</strong> in Kerala, our Goa branch delivers highly scientific Panchakarma detoxification, physical rejuvenation, and customized health recovery. Under expert supervision, our resident doctors formulate tailored wellness programs incorporating in-house prepared classical oils, customized steam baths, sound healing, and specialized saatvic nutritional guidance designed to restore metabolic harmony. Guests stay in boutique resort rooms surrounded by lush tropical gardens, enjoying a deeply peaceful, holistic environment that maximizes cellular recovery and mental peace.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/goa/KARE Health - Goa/main.jpg" 
                      alt="KARE Ayurveda & Yoga Retreat Exterior"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP cneters/goa/KARE Health - Goa/secondary.jpg" 
                        alt="Clinical Therapy Room at KARE Ayurveda & Yoga Retreat"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with KARE Ayurveda & Yoga Retreat today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at KARE Ayurveda Retreat</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose KARE Ayurveda Retreat</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Experience expert medical direction, classical Panchakarma precision, and customized Iyengar therapeutic yoga.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A highly structured scientific healing system combining authentic Keralite Panchakarma with medically-prescribed Iyengar Yoga.
            </p>
          </div>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"
                  alt="KARE Ayurveda & Yoga Retreat"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at KARE Ayurveda Retreat?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at KARE Ayurveda Retreat?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at KARE Ayurveda & Yoga Retreat.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      KARE Ayurveda & Yoga Retreat<br />
                      at Soul Vacation Resort & Spa, 4th Ward<br />
                      Colva Beach, Salcete, South Goa, Goa
                    </p>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-2.5" style={{ color: "#7F543D" }}>
                      <li className="flex items-start gap-1">
                        ...
                        <span>Approx. 22 km from Dabolim Airport</span>
                      </li>
                      
                      <li className="flex items-start gap-1">
                        <span className="text-[#2C4E5A]">•</span>
                        <span>Approx. 8 km from Madgaon Railway Station</span>
                      </li>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d61581.84306187357!2d73.8961321849282!3d15.27514578536066!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bbfb5412a7a5285%3A0xf3c522ace4de41d7!2sKARE%20Ayurveda%20Wellness%20Retreat%20Goa!5e0!3m2!1sen!2sin!4v1779912410150!5m2!1sen!2sin"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="KARE Ayurveda & Yoga Retreat Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="/TOP cneters/goa/KARE Health - Goa/main.jpg"
            alt="KARE Ayurveda & Yoga Retreat Sanctuary"
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment program at KARE Ayurveda & Yoga Retreat.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919372227461?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20KARE%20Ayurveda%20%26%20Yoga%20Retreat."
              target="_blank"
              rel="noreferrer"
