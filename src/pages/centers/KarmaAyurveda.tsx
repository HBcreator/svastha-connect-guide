...
export default function KarmaAyurveda() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "A thorough review of your medical history, GFR levels, creatinine, and physical symptoms to understand the exact stage of your condition.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Prakriti & Dosha Analysis",
      description: "An Ayurvedic pulse and physical examination to map your unique body constitution (Prakriti) and current doshic imbalances.",
      icon: <Leaf className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Customized Herbal Formulations",
      description: "Prescription of potent, clinically researched herbs like Punarnava, Varuna, and Gokshura designed specifically for cellular repair.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Specialized Renal Diet Plan",
      description: "A strictly tailored diet plan focused on managing potassium, sodium, and protein intake while naturally supporting kidney function.",
      icon: <Heart className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Therapeutic Detox (Panchkarma)",
      description: "Gentle, non-invasive Ayurvedic therapies designed to reduce toxin buildup and lessen the functional load on vital organs.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Continuous Monitoring & Adjustments",
      description: "Regular follow-ups and tracking of pathology reports to ensure consistent improvement and adjust protocols as you heal.",
  ...
  const testimonials = [
    {
      ...
      review: "After being told dialysis was inevitable, we reached out to Karma Ayurveda. Within three months of their herbal regimen and strict diet, my father's creatinine levels dropped significantly, and his energy returned.",
      name: "James Wilson",
      verified: true,
    ...
    {
      title: "Avoided Dialysis Effectively",
      review: "The combination of Punarnava and Gokshura prescribed by Dr. Puneet's team worked wonders. My GFR improved, and I managed to avoid starting dialysis, which was a huge relief for my entire family.",
    ...
    {
      title: "Excellent Liver Care Protocol",
      review: "The holistic liver detox program reversed my early-stage cirrhosis markers. The doctors are incredibly knowledgeable and the diet plans they provide are meticulous and highly effective.",
    ...
    },
    {
      ...
      review: "Traveling from Australia for Ayurvedic kidney treatment was daunting, but the clinic in Andheri West was professional, supportive, and provided clear, actionable medical advice that genuinely worked.",
      name: "Liam O'Connor",
      verified: true,
    ...
    },
    {
      ...
      review: "While my condition is chronic, the Ayurvedic herbs completely eliminated my severe swelling and nausea. I feel much healthier, and my dependence on heavy allopathic medications has reduced dramatically.",
      name: "Klaus Weber",
      verified: true,
  ...
  const faqItems = [
    {
      question: "Can Ayurveda really help with Chronic Kidney Disease?",
      answer: "Yes, Karma Ayurveda specializes in managing CKD using a 5th-generation legacy of herbal medicine. By utilizing potent herbs like Punarnava and Varuna, combined with strict dietary changes, many patients have successfully managed their symptoms, improved GFR, and delayed or avoided dialysis."
    },
    {
      question: "Who is Dr. Puneet Dhawan?",
      answer: "Dr. Puneet Dhawan is a globally recognized Ayurvedic physician and the driving force behind Karma Ayurveda. He represents the 5th generation of this healing legacy and has been instrumental in modernizing Ayurvedic nephrology protocols."
    },
    {
      question: "Do you only treat kidney diseases?",
      answer: "While globally renowned for kidney care, the Mumbai clinic also provides exceptional, clinically proven protocols for liver disorders, lung conditions, chronic lifestyle ailments, and metabolic disorders."
    },
    {
      question: "Are your herbal medicines safe to take with allopathy?",
      answer: "Our Vaidyas carefully review your current medications before prescribing any Ayurvedic formulations. When managed properly, our herbal protocols can be integrated safely to support overall organ function."
    },
    {
      question: "Where is the clinic located in Mumbai?",
      answer: "The Mumbai branch of Karma Ayurveda is conveniently located in Andheri West, making it easily accessible for both local residents and international patients arriving from the airport."
    }
  ];
  ...
  const programs = [
    {
      ...
      description: "Globally recognized herbal protocols to improve GFR, lower creatinine, and manage CKD stages effectively.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Dialysis Reversal Protocols",
      description: "Specialized, intensive Ayurvedic management aimed at reducing the frequency of or naturally transitioning away from dialysis.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Liver Disorder Management",
      description: "Potent detoxifying herbal formulations for fatty liver, early cirrhosis, and overall hepatic rejuvenation.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Lung & Respiratory Health",
      description: "Ayurvedic interventions to strengthen lung capacity, clear chronic congestion, and manage respiratory ailments.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Metabolic & Lifestyle Disorders",
      description: "Holistic care for diabetes and hypertension to prevent their secondary impact on vital organs like the kidneys.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Ayurvedic Detoxification",
      description: "Gentle internal cleansing therapies designed to remove cellular waste without taxing compromised organs.",
  ...
  const whyChooseUs = [
    {
      title: "5th Generation Legacy",
      description: "Built on a profound medical heritage dating back to 1937, offering deeply trusted and refined Ayurvedic wisdom.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Global Kidney Care Authority",
      description: "Internationally recognized for successfully managing severe renal conditions and improving patient quality of life.",
      icon: <Globe className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Led by Dr. Puneet Dhawan",
      description: "Under the guidance of one of India's most celebrated and clinically successful Ayurvedic physicians.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Potent Herbal Formulations",
      description: "Utilizing highly researched, pure extracts of life-saving herbs like Punarnava, Varuna, and Gokshura.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Evidence-Based Ayurveda",
      description: "We track progress continuously using modern pathology reports alongside traditional Ayurvedic assessments.",
      icon: <FileSearch className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Comprehensive Dietary Support",
      description: "Providing meticulous, personalized diet charts that are crucial for the success of renal and hepatic recovery.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
  ...
  useEffect(() => {
    document.title = "Karma Ayurveda Clinic Mumbai | Kidney Care Specialists";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Discover Karma Ayurveda Mumbai in Andheri West. Led by Dr. Puneet Dhawan, specializing in Chronic Kidney Disease (CKD) and Ayurvedic organ rejuvenation.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Karma Ayurveda Clinic Mumbai</h1>
                <p className="text-xl mb-4 opacity-90">India's Most Recognized Ayurvedic Kidney Treatment Hospital</p>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Karma Ayurveda Clinic Mumbai
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Established in 1937, Karma Ayurveda is India's most recognized Ayurvedic institution for kidney and organ care. Driven by a remarkable <strong className="font-bold text-[#2C4E5A]">5th-generation legacy</strong> and led by the globally acclaimed Dr. Puneet Dhawan, the brand has revolutionized how chronic conditions are managed through natural sciences. By steadfastly adhering to deeply rooted Ayurvedic traditions while continuously evolving to meet the complex demands of modern healthcare, Karma Ayurveda stands as a beacon of hope for patients who have exhausted conventional medical avenues.
                  </p>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/karma ayurveda mumbai/image 2.webp" 
                          alt="Karma Ayurveda clinic interior"
                          className="w-full h-full object-cover"
                          onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/6.webp"; }}
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <p>
                    The Mumbai branch, located in Andheri West, brings this world-class expertise to the western region. Globally renowned for treating Chronic Kidney Disease (CKD) without the immediate need for dialysis or transplant, Karma Ayurveda has served over 1,50,000 patients worldwide. Utilizing potent herbal formulations like Varuna, Punarnava, and Gokshura, the clinic provides clinically proven protocols not only for renal care but also for liver disorders, lung conditions, and chronic lifestyle ailments. Through highly individualized dietary counseling, specialized herbal therapies, and continuous patient education, we ensure that healing is not just an intervention, but a lifelong, sustainable transformation.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/karma ayurveda mumbai/image 1.webp" 
                      alt="Karma Ayurveda facility"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP centers/mumbai pune nashik/karma ayurveda mumbai/image 2.webp" 
                        alt="Karma Ayurveda consultation"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/6.webp"; }}
                      />
                    </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Karma Ayurveda today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Karma Ayurveda Clinic Mumbai
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Karma Ayurveda Clinic Mumbai
              </h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Discover the difference of evidence-based Ayurvedic nephrology, backed by an unparalleled 5th-generation healing legacy.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Karma Ayurveda Clinic Mumbai
            </h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/karma ayurveda mumbai/image 2.webp"
                  alt="Karma Ayurveda view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/6.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Karma Ayurveda?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Karma Ayurveda?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and specialties at Karma Ayurveda.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=Karma+Ayurveda+Mumbai&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Join over 1,50,000 patients who have discovered renal and holistic healing with Karma Ayurveda.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919560113189?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Karma%20Ayurveda."
              target="_blank"
              rel="noreferrer"
