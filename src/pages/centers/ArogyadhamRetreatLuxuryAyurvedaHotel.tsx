...
export default function ArogyadhamRetreatLuxuryAyurvedaHotel() {
  ...
  const treatmentProcess = [
    {
      number: 1,
      title: "Detailed Doctor Consultation",
      description: "Thorough clinical check-up to assess your unique constitution (Prakriti) and current imbalances (Vikriti).",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Customized Plan Design",
      description: "Formulating a personalized routine specifying your daily therapies, herbs, diet, and yoga exercises.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Preparatory Massages (Purva Karma)",
      description: "Full-body oil applications (Abhyangam) and steam baths to loosen toxins and open body channels.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Cleansing Therapies (Pradhana Karma)",
      description: "Administering core Panchakarma purification steps under the close monitoring of Ayurvedic doctors.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Nourishing Rest & Hydration",
      description: "Specialized organic vegetarian meals, wellness teas, and rooftop pool relaxation to rebuild vitality.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Conscious Lifestyle Blueprint",
      description: "Receiving a personalized take-home guide detailing seasonal diets, herbs, and yoga routines for long-term health.",
...
The customized therapies and Saatvic menu successfully reset my entire digestive system.`,
      ...
      condition: "Panchakarma & Digestive Reset",
      rating: 5
    },
    {
...
My knees feel completely comfortable now, and I have resumed running daily.`,
      ...
      condition: "Pain Management & Ortho Care",
      rating: 5
    },
    {
...
Daily morning sessions, pranayama, and rooftop pool time helped me find deep peace.`,
      ...
      condition: "Yoga & Stress Management",
      rating: 5
    },
    {
...
I feel fully purified, mentally alert, and my general health has improved.`,
      ...
      condition: "Holistic Detoxification",
      rating: 5
    }
  ];
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "We offer three classes of well-furnished retreat rooms: Classic Retreat Rooms, Premium Retreat Rooms, and Executive Retreat Rooms, providing a comfortable and positive environment for your stay."
    },
    {
      question: "What kind of dining options are provided?",
      answer: "We serve 100% natural, organic vegetarian Saatvic meals prepared fresh in-house, customized to support your detoxification and healing objectives."
    },
    {
      question: "What facilities does the retreat feature?",
      answer: "The retreat is equipped with wellness consultation rooms, a dedicated yoga hall, a rooftop swimming pool with scenic views, and a large hall that can accommodate small wellness gatherings or events."
    },
    {
      question: "How far is the retreat from the nearest airport and railway station?",
      answer: "Arogyadham Retreat Luxury Ayurveda Hotel is located in Tapovan, approximately 22 km from Jolly Grant Airport (Dehradun Airport - DED) and about 5 km from Rishikesh Railway Station."
    }
  ];

  const programs = [
    {
      title: "Ayurveda Retreat & Panchakarma",
      description: "Personalized Tridosha analysis, deep biological cleansing, and customized Ayurvedic oil and steam therapies.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "De-Stress & Mental Wellness",
      description: "Targeted relaxation programs combining Shirodhara, breathing exercises, and meditation to calm the nervous system.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Anti-Aging & Cellular Rejuvenation",
      description: "Specialized therapies and organic Saatvic diets designed to restore tissue vitality and boost immunity.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Targeted Pain Management",
      description: "Focused therapies and herbal compresses addressing joint pain, muscle stiffness, backache, and sciatica.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Holistic Detoxification",
      description: "A comprehensive toxin clearance schedule utilizing customized herbal remedies and dietary guidance.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Yoga & Meditation Retreat",
      description: "Daily traditional classes covering Hatha, Ashtanga, pranayama, and concentration methods in a positive environment.",
  ...
  const whyChooseUs = [
    {
      title: "All-in-One Retreat",
      description: "A complete wellness destination integrating Ayurvedic consultations, therapeutic spa, and yoga under one roof.",
      icon: <ShieldCheck className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "In-House Ayurvedic Doctors",
      description: "Consultations and therapies guided by experienced BAMS/MD Ayurvedic physicians to target root causes.",
      icon: <Award className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Serene Tapovan Location",
      description: "Located in Aamkhala, Tapovan, the peaceful hotspot of Rishikesh, offering a positive, tranquil environment.",
      icon: <TreePine className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "100% Organic Saatvic Dining",
      description: "Freshly prepared natural vegetarian meals customized to support your body's purification process.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Rooftop Pool & Spa",
      description: "Relax and rejuvenate with our modern rooftop swimming pool overlooking the beautiful mountain ranges.",
      icon: <Globe className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Vastu-Designed Positivity",
      description: "The entire property is designed to foster a positive energy flow, peace, and spiritual growth.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    }
  ];
  ...
  useEffect(() => {
    document.title = "Arogyadham Retreat Luxury Ayurveda Hotel Rishikesh | Luxury Ayurveda & Yoga Wellness Resort";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Ayurvedic therapies, Panchakarma detoxification, yoga, meditation, and customized wellness retreats at Arogyadham Retreat Luxury Ayurveda Hotel in Tapovan, Rishikesh, Uttarakhand.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol ref={breadcrumbRef} className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              Arogyadham Retreat Luxury Ayurveda Hotel Rishikesh Uttarakhand
            </li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Arogyadham Retreat Luxury Ayurveda Hotel</h1>
                <p className="text-xl mb-4 opacity-90">Ayurvedic Spa & Luxury Wellness Resort</p>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="opacity-90">(980 Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Arogyadham Retreat Luxury Ayurveda Hotel
</h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                  <p>
                    Welcome to the <strong className="font-bold text-[#2C4E5A]">Arogyadham Retreat Luxury Ayurveda Hotel</strong>, the premier Ayurvedic health retreat located in Aamkhala, Tapovan—the vibrant hotspot of Rishikesh, Uttarakhand. Surrounded by the tranquil beauty of the Himalayan foothills, our center is a dedicated sanctuary where ancient Indian wellness sciences are combined with modern comfort. We specialize in Tridosha assessment (Vata, Pitta, Kapha) and customized wellness paths to target metabolic, emotional, and physical imbalances.
                  </p>
                  ...
                  <p>
                    Our team of experienced Ayurvedic doctors conducts in-depth health consultations to determine your unique body constitution. Based on your health goals, we design personalized treatments, organic diets, yoga exercises, and therapeutic routines. Arogyadham features premium facilities including well-appointed retreat rooms (Classic, Premium, and Executive), a rooftop swimming pool with scenic valley views, a specialized Ayurveda center, and a Vastu-designed positive atmosphere.
                  </p>

                  <p>
                    To ensure a pure healing experience, our kitchen serves 100% organic vegetarian Saatvic meals customized to support your purification.
                  </p>
                </div>
              </div>
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Arogyadham Retreat Luxury Ayurveda Hotel today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Arogyadham Retreat Luxury Ayurveda Hotel
</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Arogyadham Retreat Luxury Ayurveda Hotel
</h2>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Arogyadham Retreat Luxury Ayurveda Hotel
</h2>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  ...
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/5.webp"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Arogyadham Retreat Luxury Ayurveda Hotel?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Arogyadham Retreat Luxury Ayurveda Hotel?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about courses, retreats, and therapies at Arogyadham Retreat Luxury Ayurveda Hotel.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3450.7094007032993!2d78.3256665!3d30.1311279!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39093dfe46415cc7%3A0xea5dde41370c04f1!2sArogyadham%20Retreat%20%7C%20Luxury%20Hotel%20In%20Rishikesh!5e0!3m2!1sen!2sin!4v1780624479619!5m2!1sen!2sin"
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Arogyadham Retreat Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or retreat program at Arogyadham Retreat Luxury Ayurveda Hotel.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/919058240929?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Arogyadham%20Retreat."
              target="_blank"
              rel="noreferrer"
