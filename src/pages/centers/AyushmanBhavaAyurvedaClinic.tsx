...
export default function AyushmanBhavaAyurvedaClinic() {
  ...
  const testimonials = [
    {
      ...
      review: "I traveled from the UK specifically to see Dr. Yogesh Chavan for my severe joint pain and arthritis. The traditional Keraliya Panchakarma therapies, especially the Janu Basti, provided me with long-lasting relief that modern medicine failed to give. A truly authentic experience.",
      name: "Marcus T.",
      verified: true,
      location: "London, UK",
    ...
    },
    {
      ...
      review: "I visited Ayushman Bhava Clinic during my trip to India after trying everything back home for my severe hair fall. Dr. Chavan diagnosed the root cause correctly and the Ayurvedic oils stopped my hair fall within a month. Highly recommended for international patients!",
      name: "Sophia L.",
      verified: true,
    ...
    },
    {
      ...
      review: "My chronic migraines were completely disrupting my life in Canada. The Shirodhara and Nasya treatments I received here during my 14-day retreat were deeply relaxing and have significantly reduced the frequency of my headaches. A deeply healing environment.",
      name: "Isabella M.",
      verified: true,
    ...
    },
    {
      ...
      review: "I was suffering from IBS and chronic acidity for years. The personalized diet chart and deep detoxification via Virechana at this clinic completely reset my digestive system. The staff is very professional, speaks great English, and the hygiene is top-notch.",
      name: "David K.",
      verified: true,
    ...
    },
    {
      ...
      review: "Dr. Yogesh provided exceptional care for my PCOD. Instead of relying on hormones, his holistic Ayurvedic approach regulated my cycles naturally. I cannot thank the Ayushman Bhava team enough for their supportive guidance during my stay in Nashik.",
      name: "Elena R.",
      verified: true,
  ...
  useEffect(() => {
    document.title = "Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic Nashik | NABH Accredited Ayurvedic Care";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Keraliya Panchakarma and expert Ayurvedic consultations with Dr. Yogesh Chavan at Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic, Nashik.");
    ...
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic</h1>
                <p className="text-xl mb-4 opacity-90">Authentic Keraliya Panchakarma & Advanced Ayurvedic Care</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Old Gangapur Naka, Nashik, Maharashtra, India</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.9</span>
                  <span className="opacity-90">(480+ Reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                ...
                at Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic
              </h2>
            </div>
                  ...
                  <div className="lg:hidden py-4">
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          src="/TOP centers/mumbai pune nashik/Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic/image 2.jpg" 
                          alt="Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic therapy room"
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP centers/mumbai pune nashik/Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic/image 1.jpg" 
                      alt="Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic main view"
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Top Ayurveda Programs in <br className="hidden lg:block" /> Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic
            </h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
                Why Choose <br className="hidden lg:block" /> Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic
              </h2>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] max-w-4xl mx-auto px-2 mb-4" style={{ lineHeight: '1.2' }}>
              Your Healing Journey at <br className="hidden lg:block" /> Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic
            </h2>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/TOP centers/mumbai pune nashik/Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic/image 2.jpg"
                  alt="Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic view"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/mumbai/images/19.jpg"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments, accommodations, and specialties at Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic<br />
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                  src="https://maps.google.com/maps?q=Ayushman+Bhava+Ayurveda+%26+Keraliya+Panchakarma+Clinic,+Nashik&t=&z=15&ie=UTF8&iwloc=&output=embed"
                  width="100%"
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="/TOP centers/mumbai pune nashik/Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic/image 1.jpg"
            alt="Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic"
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a consultation. Our dedicated practitioners will guide you towards the perfect treatment or therapy program at Ayushman Bhava Ayurveda & Keraliya Panchakarma Clinic.
          </p>
