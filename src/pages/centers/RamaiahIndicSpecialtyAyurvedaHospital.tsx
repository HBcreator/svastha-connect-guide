...
export default function RamaiahIndicSpecialtyAyurvedaHospital() {
  ...
  const treatmentProcess = [
    {
      ...
      description: "Thorough Ayurvedic diagnostic profiling integrated with modern pathology, biochemistry panel review, and standard imaging diagnostics.",
      icon: <FileSearch className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 2,
      title: "Custom Recovery Roadmap",
      description: "Our panel of experienced doctors formulates a custom therapeutic roadmap combining internal medicines, tailored diet charts, and specific therapies.",
      icon: <ClipboardList className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 3,
      title: "Clinically Supervised Detoxification",
      description: "Undergoing safe, highly personalized Panchakarma bio-purification procedures monitored daily by senior specialists and trained therapists.",
      icon: <Droplet className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 4,
      title: "Targeted Organ Rejuvenation",
      description: "Applying advanced sensory organ care (Shalakya Tantra) or structural musculoskeletal deep-tissue treatments to alleviate deep pain.",
      icon: <Activity className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 5,
      title: "Standardized Classic Formulations",
      description: "Administering 100% natural, highly standardized Ayurvedic formulations sourced from certified, scientifically monitored botanical suppliers.",
      icon: <Sparkles className="h-8 w-8 text-[#2C4E5A]" />
    },
    {
      number: 6,
      title: "Integrative Continuum of Care",
      description: "Maintaining long-term recovery with physical rehabilitation, remote doctor-led follow-ups, and modern outpatient coordination.",
  ...
  const testimonials = [
    ...
    },
    {
      ...
      condition: "Chronic Dry Eye & Sinusitis",
      rating: 5
    },
    {
      ...
      condition: "Type 2 Diabetes & Weight",
      rating: 5
    },
    {
  ...
  const faqItems = [
    {
      question: "What makes Ramaiah Indic Specialty Ayurveda Hospital unique?",
      answer: "Ramaiah Indic Specialty Ayurveda (RISA) stands out as a premier integrative academic hospital. Backed by the prominent Ramaiah Group, we combine classical Ayurvedic sciences with modern medical research, diagnostic pathology, and evidence-based clinical trials."
    },
    {
      question: "Who designs and oversees the clinical protocols?",
      answer: "Our medical and research protocols are directed by the globally renowned Ayurvedacharya Dr. G. G. Gangadharan (PhD, Director of RISA) and experienced Medical Superintendent Dr. Krishna J., alongside a dedicated panel of registered academic physicians."
    },
    {
      question: "How does the hospital coordinate with modern medical systems?",
      answer: "Located adjacent to the 700-bed multi-specialty Ramaiah Memorial Hospital, we offer seamless coordination for emergency services, ICU support, radiology, laboratory diagnostics, and modern physical therapy department systems."
    },
    {
      question: "Is Ramaiah Indic Specialty Ayurveda Hospital NABH accredited?",
      answer: "Yes, we are one of the earliest academic Ayurvedic hospitals to achieve full NABH accreditation. This guarantees our patients the highest standards of safety, sanitized clinical facilities, and strictly monitored classical oil preparations."
    },
    {
      question: "Can I avail of health insurance for my AYUSH treatments here?",
      answer: "Yes, we provide comprehensive cashless facilities and detailed standard clinical documentations, bills, and discharge summaries to enable quick, hassle-free insurance reimbursement under all major insurers."
    }
  ];

  const programs = [
    {
      title: "Integrative Panchakarma & Detox",
      description: "Scientifically structured bio-cleansing therapies to safely eliminate physiological wastes, clear body channels, and restore cellular vitality.",
      icon: <Droplet className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Women's Health & Prasuti Tantra",
      description: "Specialized care for PCOS, thyroid irregularities, fertility optimization, and comprehensive pre & postnatal recovery under senior female specialists.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Kaumarbhritya & Pediatrics",
      description: "Gentle, compassionate developmental and sensory therapies designed to naturalize child immunity, cognitive patterns, and growth.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Shalakya Tantra Eye & ENT Care",
      description: "Targeted Ayurvedic ophthalmology and ENT treatments addressing severe dry eye syndrome, myopia, chronic sinusitis, and sensory decline.",
      icon: <Sparkles className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Metabolic & Diabetes Management",
      description: "Evidence-backed therapeutic protocols combining clinical dietary plans, yoga alignment, and specific remedies to reverse insulin resistance.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />,
    },
    {
      title: "Integrative Palliative Support",
      description: "Compassionate, multi-disciplinary therapies providing pain relief, physical strength, and immune support during oncology recovery and geriatric care.",
  ...
  const whyChooseUs = [
    {
      title: "Integrative Medical Group",
      description: "Backed by the legendary Ramaiah Group, giving patients access to extensive multi-disciplinary expertise and modern diagnostics.",
      icon: <Building2 className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "NABH Accredited Safety",
      description: "Early academic Ayurvedic hospital to secure NABH accreditation, assuring exceptional hygiene, patient care, and formulation safety.",
      icon: <Leaf className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Legendary Clinical Guidance",
      description: "Guided by eminent Ayurvedacharya Dr. G. G. Gangadharan (PhD, Director) and experienced Medical Superintendent Dr. Krishna J.",
      icon: <Users className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Tertiary Hospital Support",
      description: "Located adjacent to the 700-bed Ramaiah Memorial Hospital, allowing rapid access to emergency, ICU, and physical therapy systems.",
      icon: <Heart className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Evidence-Based Research",
      description: "Combines deep classical Ayurvedic documentation with modern scientific medical research standards and clinical trials.",
      icon: <Activity className="h-6 w-6 text-[#2C4E5A]" />
    },
    {
      title: "Smooth Insurance Coverage",
      description: "Excellent cashless and reimbursement support for all major health insurers under AYUSH guidelines.",
  ...
  useEffect(() => {
    document.title = "Ramaiah Indic Specialty Ayurveda Hospital | Integrative Academic Care in Bangalore";
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute("content", "Book consultations and treatments at Ramaiah Indic Specialty Ayurveda Hospital in Mathikere, Bangalore. Experience NABH-accredited academic Ayurvedic care.");
  ...
  return (
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
        ...
        <div className="container mx-auto px-3 md:px-4 max-w-full">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h1 className="text-4xl md:text-5xl font-bold mb-4" style={{ lineHeight: '1.3' }}>Ramaiah Indic Specialty Ayurveda Hospital</h1>
                <p className="text-xl mb-4 opacity-90">Integrative Academic Center of Excellence</p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-lg">Mathikere, Bengaluru, Karnataka</span>
                </div>
                <div className="flex items-center gap-2">
                  <Star className="h-5 w-5 fill-yellow-400 text-yellow-400" />
                  <span className="text-lg font-semibold">4.8</span>
                  <span className="opacity-90">(450 reviews)</span>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] leading-tight md:leading-[1.1] max-w-4xl mx-auto px-2">
                Natural Excellence <br className="hidden lg:block" />
                at Ramaiah Indic Specialty Ayurveda Hospital
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-base md:text-xl leading-relaxed text-foreground/80 text-left" style={{ color: "#7F543D" }}>
                    ...
                    <div className="relative group">
                      ...
                      <div className="relative rounded-[1.5rem] overflow-hidden shadow-xl border-4 border-white/50 aspect-[16/10]">
                        <img 
                          ...
                          alt="Ramaiah Indic Specialty Ayurveda Hospital Mathikere Campus"
                  ...
                  <p>
                    Under the visionary direction of eminent Ayurvedacharya <strong className="font-bold text-[#2C4E5A]">Dr. G. G. Gangadharan</strong> (PhD, Director of RISA) and experienced Medical Superintendent <strong className="font-bold text-[#2C4E5A]">Dr. Krishna J.</strong>, RISA provides patients with a highly scientific healing continuum. Our clinical structure is uniquely positioned adjacent to the **700-bed tertiary Ramaiah Memorial Hospital**, allowing immediate access to modern emergency systems, biochemistry laboratory testing, advanced radiology, ICU support, and physical rehabilitation. We specialize in evidence-backed general medicine, sensory organ care, pediatric developmental programs, chronic pain management, and highly compassionate supportive palliative therapies.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-8 order-first lg:order-last">
                <div className="relative group">
                  ...
                  <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                    <img 
                      src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Ramaiah Indic Specialty Ayurveda Hospital/main.webp" 
                      alt="Ramaiah Indic Specialty Ayurveda Hospital Campus"
                ...
                <div className="hidden lg:block">
                  <div className="relative group">
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 aspect-[16/10]">
                      <img 
                        src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Ramaiah Indic Specialty Ayurveda Hospital/secondary.webp" 
                        alt="Ayurvedic Therapy Room at Ramaiah Ayurveda"
                        className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
            ...
            <div className="pt-10 text-center border-t border-[#2C4E5A]/10 mt-12">
              <h3 className="text-xl md:text-2xl font-semibold text-[#2C4E5A] leading-relaxed">
                ...
                My Vaidyam to connect with Ramaiah Indic Specialty Ayurveda Hospital today.
              </h3>
            </div>
          </div>
        </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at Ramaiah Indic Specialty Ayurveda Hospital</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Ramaiah Indic Specialty Ayurveda Hospital</h2>
              <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
                Benefit from an academic medical powerhouse that perfectly merges ancient Ayurvedic wisdom with modern clinical research.
              </p>
            </div>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Your Healing Journey at Ramaiah</h2>
            <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
              A highly structured, evidence-guided recovery protocol overseen by specialist physicians from diagnostic consultation to complete home integration.
            </p>
          </div>
          ...
          <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#2C4E5A" }}>
            <div className="md:hidden">
              <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                <img
                  src="/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/14.jpg"
                  alt="Ramaiah Indic Specialty Ayurveda Hospital"
                  className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                  onError={(e) => { e.currentTarget.src = "/Anchor pages/bangalore-hyderabad-chennai-south-india/Images/14.jpg"; }}
                />
                <h2 className="text-xl font-bold text-white text-center mb-4">Ready to Start Your Wellness Journey at Ramaiah Indic Specialty Ayurveda Hospital?</h2>
            ...
            <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold text-white mb-8">Ready to Start Your Wellness Journey at Ramaiah Indic Specialty Ayurveda Hospital?</h2>
      ...
      <section id="faq" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-10 md:mb-16">
            ...
            <p className="text-lg text-foreground/70">Find answers to common queries about treatments at Ramaiah Indic Specialty Ayurveda Hospital.</p>
          </div>
          ...
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 shadow-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed" style={{ color: "#7F543D" }}>
                      Ramaiah Indic Specialty Ayurveda Hospital<br />
                      Gnanagangothri Campus, New BEL Road<br />
                      M S Ramaiah Nagar, Mathikere<br />
                      Bengaluru, Karnataka
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-foreground/70 leading-relaxed space-y-1" style={{ color: "#7F543D" }}>
                      <li>• Approx. 30 km from Kempegowda International Airport</li>
                      <li>• Approx. 3.5 km from Yesvantpur Junction Railway Station</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="h-full min-h-[300px] rounded-2xl overflow-hidden shadow-lg border-4 border-white/50">
                <iframe 
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.1193393136273!2d77.56625257507747!3d13.028071587292525!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae17dbf5931141%3A0xcb3e2463f1d2a822!2sRamaiah%20Ayurveda%20Hospital%20-%20Mathikere!5e0!3m2!1sen!2sin!4v1779692153505!5m2!1sen!2sin" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
                  ...
                  title="Ramaiah Indic Specialty Ayurveda Hospital Location"
                ></iframe>
              </div>
            </div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden bg-[#2C4E5A] text-white">
        <div className="absolute inset-0 z-0">
          <img
            src="/TOP cneters/bangalore-hyderabad-chennai-south-india-ayurvedic-centers/Ramaiah Indic Specialty Ayurveda Hospital/main.webp"
            alt="Ayurvedic Therapy at Ramaiah Indic Specialty Ayurveda"
        ...
        <div className="container relative z-10 mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/90 mb-10 max-w-2xl mx-auto">
            Contact us today for a free consultation. Our doctors will guide you towards the perfect treatment program at Ramaiah Indic Specialty Ayurveda.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              href="https://wa.me/917090533000?text=Hi%2C%20I%20want%20to%20book%20a%20consultation%20with%20Ramaiah%20Indic%20Specialty%20Ayurveda%20Hospital."
              target="_blank"
              rel="noreferrer"
