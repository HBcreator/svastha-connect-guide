...
const wellnessIconForTitle = (t: string) => {
  ...
  if (s.includes("detox") || s.includes("cleanse") || s.includes("digital")) {
    return <Wind className="h-4 w-4 md:h-5 md:w-5 text-green-600" />;
  }
  if (s.includes("holiday") || s.includes("weekend")) {
    return <Sun className="h-4 w-4 md:h-5 md:w-5 text-green-600" />;
  }
  if (s.includes("200-hour") || s.includes("300-hour") || s.includes("training") || s.includes("teacher")) {
    return <Award className="h-4 w-4 md:h-5 md:w-5 text-green-600" />;
  }
  if (s.includes("immersion") || s.includes("retreat") || s.includes("foundation")) {
    return <Leaf className="h-4 w-4 md:h-5 md:w-5 text-green-600" />;
  }
  if (s.includes("spa") || s.includes("bodywork") || s.includes("massage")) {
    return <HeartPulse className="h-4 w-4 md:h-5 md:w-5 text-green-600" />;
  }
  if (s.includes("couple") || s.includes("connect") || s.includes("care") || s.includes("women")) {
    return <Heart className="h-4 w-4 md:h-5 md:w-5 text-green-600" />;
  }
  if (s.includes("meditation") || s.includes("mind") || s.includes("calm") || s.includes("sleep")) {
    return <Moon className="h-4 w-4 md:h-5 md:w-5 text-green-600" />;
  }
  if (s.includes("creative") || s.includes("fusion") || s.includes("arts")) {
    return <Flame className="h-4 w-4 md:h-5 md:w-5 text-green-600" />;
  }
  if (s.includes("ayurveda") || s.includes("panchakarma")) {
    return <Droplet className="h-4 w-4 md:h-5 md:w-5 text-green-600" />;
  }
  if (s.includes("stress") || s.includes("relax")) {
...
const medicalIconForTitle = (t: string) => {
  const s = t.toLowerCase();
  if (s.includes("stress") || s.includes("mental") || s.includes("sleep") || s.includes("silent")) {
    return <Moon className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />;
  }
  if (s.includes("emotional") || s.includes("grief") || s.includes("loss") || s.includes("heart")) {
    return <Heart className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />;
  }
  if (s.includes("postural") || s.includes("alignment") || s.includes("pain") || s.includes("somatic")) {
    return <Activity className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />;
  }
  if (s.includes("transitions") || s.includes("clarity")) {
    return <TrendingUp className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />;
  }
  if (s.includes("pranic") || s.includes("breath") || s.includes("prana")) {
    return <Wind className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />;
  }
  if (s.includes("chakra") || s.includes("energy") || s.includes("dimensions") || s.includes("yin")) {
    return <Sparkles className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />;
  }
  if (s.includes("body positivity") || s.includes("embod")) {
    return <HeartPulse className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />;
  }
  if (s.includes("creative")) {
    return <Flame className="h-4 w-4 md:h-5 md:w-5 text-blue-600" />;
  }
...
const whyIconForTitle = (t: string) => {
  ...
  if (s.includes("home") || s.includes("soul")) return <Heart className={cls} />;
  if (s.includes("beach") || s.includes("river") || s.includes("setting")) return <MapPin className={cls} />;
  if (s.includes("yoga") || s.includes("teacher") || s.includes("training")) return <Sparkles className={cls} />;
  if (s.includes("eco") || s.includes("nature") || s.includes("garden")) return <Leaf className={cls} />;
  if (s.includes("community") || s.includes("family")) return <Users className={cls} />;
  if (s.includes("food") || s.includes("organic")) return <Star className={cls} />;
  if (s.includes("freedom") || s.includes("journey")) return <ShieldCheck className={cls} />;
  if (s.includes("holistic") || s.includes("sanctuary") || s.includes("healing")) return <HeartPulse className={cls} />;
  if (s.includes("accommodation") || s.includes("stay")) return <Stethoscope className={cls} />;
...
const getFacilityIcon = (title: string) => {
  ...
  return t.includes("ayurveda") || t.includes("treatment") ? <Droplet className="h-7 w-7 text-white" />
    : t.includes("doctor") || t.includes("therap") ? <Stethoscope className="h-7 w-7 text-white" />
      : t.includes("room") || t.includes("accommodation") || t.includes("villa") ? <Building2 className="h-7 w-7 text-white" />
        : t.includes("restaurant") || t.includes("dining") || t.includes("cafe") || t.includes("meal") ? <Utensils className="h-7 w-7 text-white" />
          : t.includes("pool") || t.includes("swimming") ? <Activity className="h-7 w-7 text-white" />
            : t.includes("beach") || t.includes("river") || t.includes("access") ? <MapPin className="h-7 w-7 text-white" />
              : t.includes("garden") || t.includes("nature") ? <TreePine className="h-7 w-7 text-white" />
                : t.includes("steam") || t.includes("spa") || t.includes("hammam") ? <Droplet className="h-7 w-7 text-white" />
                  : t.includes("boutique") || t.includes("shop") ? <Globe className="h-7 w-7 text-white" />
...
const AshiyanaYogaRetreat = () => {
  ...
  const founderImage = "/Center Images/Ashiyana Yoga Retreat/Founder/Founder.jfif";
  const teamImage = "/Center Images/Ashiyana Yoga Retreat/Founder/team.jpg";
  ...
  const awards = [
    {
      ...
      description: "Recognizes favorites based on the quality and quantity of traveler reviews and ratings gathered over 12 months.",
      image: "/Center Images/Ashiyana Yoga Retreat/Awards/award 1 (tripadvisor travellor choice).png",
    },
    {
      title: "Condé Nast Traveler Readers’ Choice Awards",
      description: "Annual awards determined by reader voting across hotels, resorts, cities, and more.",
      image: "/Center Images/Ashiyana Yoga Retreat/Awards/Award 2 (Condé Nast Traveller Recognition).jpg",
    },
    {
      title: "Travel + Leisure World’s Best Awards",
      description: "Reader‑voted survey spanning hotels, resorts, destinations, spas, and other travel categories.",
      image: "/Center Images/Ashiyana Yoga Retreat/Awards/award 3 (Travel plus Leisure).webp",
    },
    {
      title: "TripSavvy Featured Travel Source",
      description: "A travel site written by real experts, known for practical guidance and curated recommendations.",
      image: "/Center Images/Ashiyana Yoga Retreat/Awards/award 4 (tripsavy symbol logo).png",
    },
    {
      title: "NABH Accredited",
      description: "NABH is India’s apex body setting benchmarks for healthcare quality and patient safety.",
      image: "/Center Images/Ashiyana Yoga Retreat/Awards/Award 5 (NABH).png",
    },
  ];
  ...
  useEffect(() => {
    ...
    loadList(
      "/Center Images/Ashiyana Yoga Retreat/Photo Gallery/Photo Gallery.txt",
      setImages
    );
    loadList(
      "/Center Videos/Ashiyana Yoga Retreat/Video Gallery Links.txt",
      setVideos
    );
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Ashiyana Yoga Retreat/Wellness & Rejuvenation Programs.txt")
      .then((res) => res.text())
      .then((text) => {
      ...
      .catch((err) => console.error("Error loading Ashiyana wellness content:", err));

    fetch("/content/Top Centers/Ashiyana Yoga Retreat/Medical Programs.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
      ...
      .catch((err) => console.error("Error loading Ashiyana medical content:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Ashiyana Yoga Retreat/Why Choose Ashiyana Yoga Retreat.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
      ...
      .catch((err) => console.error("Error loading Ashiyana why-choose content:", err));
  }, []);

  useEffect(() => {
    const items = [
      "/Center Videos/Ashiyana Yoga Retreat/Testimonies/Testimonies 1.mp4",
      "/Center Videos/Ashiyana Yoga Retreat/Testimonies/Testimonies 2.mp4",
      "/Center Videos/Ashiyana Yoga Retreat/Testimonies/Testimonies 3.mp4",
    ];
  ...
  useEffect(() => {
    fetch("/content/Top Centers/Ashiyana Yoga Retreat/Treatment Process & Patient Journey.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
      ...
      .catch((err) => console.error("Error loading Ashiyana treatment process:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Ashiyana Yoga Retreat/Facilities & Amenities.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n");
      ...
      .catch((err) => console.error("Error loading Ashiyana facilities content:", err));
  }, []);

  useEffect(() => {
    fetch("/Center Images/Ashiyana Yoga Retreat/Facilities/Facilities.txt")
      .then((res) => res.text())
      .then((text) => {
        const urls = text
          .split("\n")
      ...
      .catch((err) => console.error("Error loading Ashiyana facilities images:", err));
  }, []);
  ...
  useEffect(() => {
    fetch("/content/Top Centers/Ashiyana Yoga Retreat/Our Founder & Expert.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
        ...
        for (const line of lines) {
          ...
          if (line.startsWith("### ")) {
            ...
            if (/dedicated teaching/i.test(t)) { if (currentGroup) groups.push(currentGroup); currentGroup = null; section = "teams"; continue; }
            if (!name && section === "founder") { name = t; continue; }
          }
          if (line.startsWith("**") && line.endsWith("**")) {
            const t = line.slice(2, -2);
            if (/core expertise/i.test(t)) { section = "expertise"; continue; }
            if (/our founder|expert teaching team/i.test(t)) { continue; }
          ...
          if (section === "founder") {
            if ((/Founder|Coach|Author|Director|Teacher/i.test(line) && line.length <= 70) && role === "") { role = line; continue; }
      ...
      .catch((err) => console.error("Error loading Ashiyana founder content:", err));
  }, []);
  ...
  useEffect(() => {
    fetch("/content/Top Centers/Ashiyana Yoga Retreat/Patient Stories & Reviews.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
      ...
      .catch((err) => console.error("Error loading Ashiyana reviews:", err));
  }, []);
  ...
  const jumpSections = [
    ...
    { id: "why-choose", title: "Why Choose Ashiyana" },
  ...
  useEffect(() => {
    fetch("/content/Top Centers/Ashiyana Yoga Retreat/Insurance & Payment Info.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        let intro = "";
      ...
      .catch((err) => console.error("Error loading Ashiyana insurance info:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Ashiyana Yoga Retreat/Frequently Asked Questions.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
      ...
      .catch((err) => console.error("Error loading Ashiyana FAQ:", err));
  }, []);

  useEffect(() => {
    fetch("/content/Top Centers/Ashiyana Yoga Retreat/Contact Information.txt")
      .then((res) => res.text())
      .then((text) => {
        const lines = text.split("\n").map((l) => l.trim());
        const addr: string[] = [];
      ...
      .catch((err) => console.error("Error loading Ashiyana contact info:", err));
  }, []);
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <ol className="flex items-center gap-2 text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] overflow-x-auto whitespace-nowrap pb-1 -mb-1 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <li className="text-primary/90 font-black shrink-0">
              ASHIYANA YOGA RETREAT CENTER GOA
            </li>
          </ol>
        </div>
      </nav>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-lg md:text-xl mb-4 opacity-90">
                  A serene haven for yoga, meditation, and holistic wellbeing on Mandrem Beach.
                </p>
                <div className="flex items-center gap-2 mb-4">
                  <MapPin className="h-5 w-5" />
                  <span className="text-base md:text-lg">Mandrem Beach, Goa, India</span>
                </div>
        ...
        <div className="max-w-6xl mx-auto">
                  ...
                  <div className="container mx-auto px-4 py-10" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                      {images.map((img, i) => (
                        ...
                        >
                          <img src={img} alt={`Ashiyana ${i + 1}`} className="absolute inset-0 w-full h-full object-cover rounded-lg" />
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              {lightboxOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-[#EDE8D0]/80 backdrop-blur-sm">
                  ...
                  <div className="bg-background/90 rounded-xl shadow-2xl p-4 w-full max-w-5xl">
                    <div className="text-center text-primary text-2xl font-bold mb-3 leading-relaxed">Ashiyana Yoga Retreat</div>
                    <div className="relative rounded-lg overflow-hidden shadow-lg w-full" style={{ paddingBottom: "56.25%" }}>
                      <img
                        src={images[lightboxImage]}
                        alt={`Ashiyana ${lightboxImage + 1}`}
          ...
          <Card className="mb-12">
            <CardContent className="px-4 md:px-8 py-6 md:py-8 prose md:prose-lg max-w-none prose-p:text-justify prose-p:leading-relaxed prose-p:text-base md:prose-p:text-lg">
              <MarkdownContent
                contentPath="/content/Top Centers/Ashiyana Yoga Retreat/Main content.txt"
          ...
          <div className="mb-12" id="videos">
            <div className="text-center mb-10">
              <h2 className="text-2xl md:text-4xl font-bold text-primary mb-3">
                Video Gallery of Ashiyana Yoga Retreat
              </h2>
              <p className="text-base md:text-lg mx-auto px-4 max-w-4xl" style={{ color: "#7F543D" }}>
                Experience the serene atmosphere and mindful practices at Ashiyana through our video gallery.
              </p>
            </div>
            ...
            <div className="mb-12" id="why-choose">
              <div className="text-center mb-10">
                <h2 className="text-xl md:text-4xl font-bold text-primary mb-3">
                  Why Choose Ashiyana Yoga Retreat for Your Healing Journey
                </h2>
                <p className="text-base md:text-lg mx-auto px-4 max-w-4xl" style={{ color: "#7F543D" }}>
                  {whyIntro}
                </p>
            ...
            <div className="mb-12" id="testimonial-videos">
              <div className="text-center mb-8 md:mb-10 px-4">
                <h2 className="text-xl md:text-4xl font-extrabold text-primary mb-2 leading-tight tracking-tight">
                  Testimonials of Ashiyana Yoga Retreat
                </h2>
                ...
                <p className="text-sm md:text-lg mx-auto max-w-none leading-relaxed italic" style={{ color: "#7F543D" }}>
                  Hear heartfelt stories from guests who discovered balance, peace, and renewal at Ashiyana.
                </p>
              </div>
                    ...
                    >
                      <video
                        ...
                        className={`w-full h-auto max-h-[70vh] object-contain ${
                          selectedTestimonialVideo === 2 ? "md:h-full md:object-cover" : ""
                        }`}
                        controls
                        playsInline
                      />
            ...
            <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#EDE8D0" }}>
              <div className="md:hidden">
                <div className="max-w-sm mx-auto bg-white/80 rounded-2xl p-4 shadow-lg border-2 border-primary/30">
                  <img
                    src="/Center Images/Ashiyana Yoga Retreat/CTA mid.jpg"
                    alt="Ashiyana Yoga Retreat"
            ...
            <div className="max-w-6xl mx-auto mt-6">
                    ...
                    <CardContent className="p-4 md:p-8 h-full md:h-[480px] flex flex-col">
                      ...
                      {founderExpertise.length > 0 && (
                        <div className="pt-3 md:pt-4 border-t border-primary/10">
                          <p className="text-xs font-semibold text-primary mb-2">Core Expertise</p>
              ...
              <div className="mb-12" id="awards">
                <div className="text-center mb-6 md:mb-10">
                  ...
                  <p className="text-base md:text-lg px-4" style={{ color: "#7F543D" }}>
                    Recognition across leading travel and wellness platforms
                  </p>
                </div>
                ...
                <div className="rounded-3xl p-6 md:p-10" style={{ backgroundColor: "#234A50" }}>
                  <div className="md:hidden">
                    <div className="max-w-sm mx-auto bg-black/30 rounded-2xl p-4 shadow-lg border-2 border-white/20">
                      <img
                        src="/Center Images/Ashiyana Yoga Retreat/CTA bottom.jpg"
                        alt="Ashiyana Yoga Retreat"
                        className="w-full h-auto rounded-xl mb-4 object-cover transition-transform duration-700 ease-out hover:scale-105"
                      />
                      <h2 className="text-xl font-bold text-white text-center mb-4">Begin Your Holistic Healing Journey at Ashiyana Yoga Retreat</h2>
                      <div className="space-y-3">
                        <Button
                          size="lg"
                  ...
                  <div className="hidden md:grid md:grid-cols-2 gap-8 items-center">
                    <div>
                      <h2 className="text-2xl md:text-4xl font-bold text-white mb-3">Begin Your Holistic Healing Journey at Ashiyana Yoga Retreat</h2>
                      <div className="flex flex-wrap gap-3">
