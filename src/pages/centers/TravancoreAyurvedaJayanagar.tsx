  ...
  return (
    <div className="min-h-screen bg-background font-poppins selection:bg-[#2C4E5A]/20">
          ...
          <div className="bg-white rounded-3xl p-6 md:p-12 shadow-sm border border-[#2C4E5A]/5">
            <div className="text-center mb-8 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] leading-tight md:leading-[1.1] max-w-4xl mx-auto px-2">
                NABH-Standard Kerala Ayurveda <br className="hidden lg:block" />
                at Travancore Ayurveda
              </h2>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-start">
              <div className="text-left space-y-8">
                <div className="space-y-6 text-lg md:text-xl leading-relaxed text-foreground/80 text-justify md:text-left" style={{ color: "#7F543D" }}>
                  ...
                  <p>
                    Directed by a senior panel of highly qualified BAMS practitioners, including <strong className="font-bold">Dr. Smita Katti Gotur</strong> (Head of Practice & Governance), <strong className="font-bold">Dr. Anjali Sivadas</strong> (Head of Practice & Bangalore), and <strong className="font-bold">Dr. Reeshma</strong> (Center Head, Jayanagar), the clinic offers highly customized wellness roadmaps. Every healing journey begins with a traditional pulse diagnosis (<strong className="font-bold">Naadi Pariksha</strong>). The clinic features premium, hygienic therapy suites adhering strictly to NABH standards, a fully stocked pharmacy of genuine Kerala formulations, and comprehensive support for health insurance reimbursement.
                  </p>
                </div>
              </div>
      ...
      <section id="programs" className="pt-4 md:pt-6 pb-8 md:pb-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A]">Top Ayurveda Packages at Travancore Ayurveda</h2>
          </div>
      ...
      <section id="why-choose" className="py-4 md:py-6">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="bg-[#EDE8D0] rounded-3xl p-8 md:p-12 lg:p-16 shadow-sm">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Why Choose Travancore Ayurveda</h2>
      ...
      <section id="process" className="py-8 md:py-12 bg-background">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-[26px] md:text-4xl lg:text-5xl font-black text-[#2C4E5A] mb-4">Your Healing Journey at Travancore Ayurveda</h2>
