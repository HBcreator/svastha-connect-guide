...
const VaricoseUlcer = () => {
  ...
  useEffect(() => {
    fetch("/content/Treatments/Varicose Veins Treatment.txt")
      .then((res) => res.text())
    ...
    <Layout>
      <section className="bg-gradient-to-r from-primary to-primary/80 text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-0">Varicose Ulcer Treatment</h1>
          <p className="text-lg text-white/90">Holistic Path to Healthy Circulation and Healing</p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <Card className="p-6 sm:p-8 md:p-10 shadow-lg mb-8 md:mb-12 bg-gradient-to-br from-primary/5 to-secondary/5">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-primary mb-0">Begin Your Journey to Healthy Veins</h2>
            <p className="text-foreground mb-6 max-w-2xl mx-auto">
              Experience the power of authentic Ayurvedic treatment with specialized therapies like Leech Therapy and blood purification for lasting relief.
            </p>
            <Button size="lg" className="font-semibold">Start Your Treatment</Button>
          </div>
        </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-0">Blood Purification</h3>
            <p className="text-muted-foreground">
              Rakta Mokshana and Virechana therapies purify blood, reduce inflammation, and improve circulation
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">🌿</div>
            <h3 className="text-xl font-semibold mb-0">Leech Therapy</h3>
            <p className="text-muted-foreground">
              Authentic Jalaukavacharana removes stagnant blood, relieves pressure, and promotes natural healing
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">💪</div>
            <h3 className="text-xl font-semibold mb-0">Vascular Strength</h3>
            <p className="text-muted-foreground">
              Herbal medicines and lifestyle modifications strengthen veins and prevent recurrence
            </p>
          </Card>
        </div>
      </section>
