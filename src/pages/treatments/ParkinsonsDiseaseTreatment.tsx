    ...
    <Layout>
      <section className="bg-gradient-to-r from-primary to-primary/80 text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-0">Parkinson's Disease Treatment</h1>
          <p className="text-lg text-white/90">Holistic Ayurvedic Approach to Managing Parkinson's</p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <Card className="p-6 sm:p-8 md:p-10 shadow-lg mb-8 md:mb-12 bg-gradient-to-br from-primary/5 to-secondary/5">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-primary mb-0">Begin Your Healing Journey</h2>
            <p className="text-foreground mb-6 max-w-2xl mx-auto">
              Consult with our experienced Ayurvedic specialists for personalized Parkinson's management and improve your quality of life naturally.
            </p>
            <Button size="lg" className="font-semibold">Schedule Consultation</Button>
          </div>
        </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-0">Neuroprotection</h3>
            <p className="text-muted-foreground">
              Herbal therapies that support and protect nervous tissue from degeneration
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            ...
            <p className="text-muted-foreground">
              Specialized treatments to pacify aggravated Vata dosha and restore equilibrium
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">🌿</div>
            <h3 className="text-xl font-semibold mb-0">Natural Management</h3>
            <p className="text-muted-foreground">
              Time-tested Ayurvedic herbs and therapies for symptom control and improved mobility
            </p>
          </Card>
        </div>
      </section>
