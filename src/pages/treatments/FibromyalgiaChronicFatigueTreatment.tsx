...
const topCenters: TreatmentCenter[] = [
  {
    ...
    city: "Bangalore",
    location: "Bangalore",
    description: "India's first NABH-accredited AYUSH Hospital integrating Ayurveda, Homeopathy, Yoga & Naturopathy on a 30-acre organic farm, specializing in chronic condition care.",
    rating: 4.9,
    reviews: 500,
...
const FibromyalgiaChronicFatigueTreatment = () => (
  <TreatmentPageTemplate
    ...
    introImage="/Treatments-images/FibromyalgiaChronicFatigue/Ayurvedic Treatment for Fibromyalgia and Chronic Fatigue.jpg"
    ...
    faqItems={faqItems}
    ctaImage="/Treatments-images/FibromyalgiaChronicFatigue/Ayurvedic Treatment for Fibromyalgia and Chronic Fatigue.jpg"
