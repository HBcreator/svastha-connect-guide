...
const Stress = () => {
  ...
  useEffect(() => {
    fetch("/content/Treatments/Ayurvedic Treatment for Stress.txt")
      .then((res) => res.text())
    ...
    <Layout>
      <section className="bg-gradient-to-r from-primary to-primary/80 text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Stress</h1>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="mb-8 rounded-lg overflow-hidden shadow-lg w-full aspect-video">
          <img 
            ...
            alt="Stress Management Treatment" 
        ...
        <Card className="p-6 sm:p-8 md:p-10 shadow-lg mb-8 md:mb-12 bg-gradient-to-br from-primary/5 to-secondary/5">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-primary mb-4">Find Your Inner Peace</h2>
            <p className="text-foreground mb-6 max-w-2xl mx-auto">
              Experience transformative Ayurvedic therapies like Shirodhara, Abhyanga, and meditation to calm your nervous system, reduce anxiety, and restore emotional balance naturally.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-2">Shirodhara</h3>
            <p className="text-muted-foreground">
              Continuous oil stream on forehead to deeply calm the nervous system and quiet the mind
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">💆</div>
            <h3 className="text-xl font-semibold mb-2">Abhyanga</h3>
            <p className="text-muted-foreground">
              Full-body oil massage to pacify Vata and provide deep relaxation and security
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">🌿</div>
            <h3 className="text-xl font-semibold mb-2">Lifestyle Balance</h3>
            <p className="text-muted-foreground">
              Daily routine, breathing exercises, and meditation for lasting mental peace
            </p>
          </Card>
        </div>
      </section>
