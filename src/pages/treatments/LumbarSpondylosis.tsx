...
import {
  Calendar, MapPin, Star, Leaf, Activity,
  ChevronLeft, ChevronRight, CheckCircle2, UtensilsCrossed, ArrowRight,
  Search, Phone, X, ClipboardList, ShieldAlert, Wind, Clock, Flame
} from "lucide-react";
...
const coreTherapies = [
  {
    ...
    text: "The cornerstone therapy. A dough ring on the lumbar region holds warm, medicated, analgesic oil to deeply lubricate discs, nourish nerves, and provide immediate relief from pain and stiffness.",
    icon: DropletIcon
  },
  {
    title: "Patra Pinda Sweda",
    sanskrit: "Elakizhi",
    text: "Therapeutic sweating using warm boluses made from fresh anti-inflammatory leaves fried in medicated oil. Highly effective for reducing pain, inflammation, and muscle spasms.",
    icon: Flame
  },
  {
    title: "Basti",
    sanskrit: "Medicated Enema",
    text: "Considered the ultimate treatment for pacifying Vata. Administering medicated oils and decoctions rectally has a profoundly calming and strengthening effect on the entire nervous system.",
    icon: Leaf
  },
  {
    title: "Abhyanga & Swedana",
    sanskrit: "Massage & Herbal Steam",
    text: "Gentle massage with specific medicated oils over the back, followed by localized herbal steam, helps to relax muscles, improve circulation, and relieve stiffness.",
    icon: Activity
  }
];
...
const dietaryGuidelines = {
  favour: [
    "Warm, moist, and nourishing foods that pacify Vata.",
    "Healthy fats like ghee and sesame oil for internal lubrication.",
    "Spices with anti-inflammatory properties like ginger and garlic."
  ],
  avoid: [
    "Cold, dry, and processed foods that increase Vata.",
    "Gas-forming foods like certain beans and raw vegetables.",
    "Excessively light or astringent foods."
  ]
};

const lifestyleAdjustments = [
  "Posture is Key: Maintain correct posture while sitting and standing. Use a chair with good lumbar support.",
  "Gentle Yoga: Practice poses like Bhujangasana (Cobra Pose) and Marjariasana (Cat-Cow Pose) under expert guidance.",
  "Avoid Strain: Do not lift heavy objects. When lifting, always bend from your knees, not your waist.",
  "Stay Warm: Protect your lower back from exposure to cold wind and drafts."
];

const packages = [
  {
    name: "14-Day Essential Pain Relief",
    duration: "14 Days",
    cost: "$1,200 - $2,200 USD",
    focus: "Designed to provide quick relief from acute lower back pain and stiffness. Focuses on localized therapies like Kati Vasti and Abhyanga to lubricate the spine and reduce muscle spasms.",
    image: "/Treatments-images/knee_pain_pack_1.png",
  },
  {
    name: "21-Day Spine Rejuvenation",
    duration: "21 Days",
    cost: "$2,500 - $4,500 USD",
    focus: "The standard and most recommended protocol. Incorporates the full Basti sequence along with Elakizhi to deeply nourish degenerative discs, calm the nervous system, and address root-cause Vata imbalance.",
    image: "/Treatments-images/knee_pain_pack_2.png",
  },
  {
    name: "28-Day Advanced Structural Healing",
    duration: "28 - 35+ Days",
    cost: "$3,500 - $6,500+ USD",
    focus: "An intensive healing journey for chronic or severe spondylosis accompanied by sciatica. Combines rigorous therapies for complete structural support and long-term prevention of surgery.",
...
const patientReviews = [
  {
    name: "Reinhold Bergmann", location: "Dresden, Germany", condition: "Lumbar Spondylosis",
    title: "Eight Years of Lower Back Pain—Resolved in Twenty-One Days.",
    review: "For eight years, I managed my lumbar spondylosis with NSAIDs and steroid injections, with each intervention providing shorter relief than the last. The Ayurvedic physician in India diagnosed my condition as Katigraha and prescribed a program of Kati Basti and medicated enemas. The radiating pain down my left leg, a daily companion for two years, reduced by seventy percent within ten days. By day twenty-one, I was walking freely without any analgesic support.",
  ...
  {
    name: "Thierry Blanchard", location: "Nantes, France", condition: "Spondylosis & Sciatica",
    title: "My Sciatica and Spondylosis—Both Treated as a Single Condition.",
    review: "The radiating sciatic pain had become more debilitating than the back pain itself. The Ayurvedic physician designed a protocol to address both simultaneously. The Basti medicated enema sequence, combined with Kati Basti oil therapy and daily yoga, reduced my sciatic pain from a daily 8/10 to a manageable 2/10 over thirty days.",
    rating: 5, verified: true
  },
  {
    name: "Pieter Claassen", location: "Rotterdam, Netherlands", condition: "Chronic Back Stiffness",
    title: "Kati Basti Did in One Week What Physiotherapy Had Not in Six Months.",
    review: "Six months of physiotherapy had strengthened my core muscles without addressing the underlying spinal degeneration. The Kati Basti procedure—warm Mahanarayana oil retained over my lumbar spine daily—produced a depth of spinal nourishment that no physical therapy could replicate. The stiffness that had made getting out of bed an ordeal was gone.",
    rating: 5, verified: true
  },
  {
    name: "Astrid Henriksen", location: "Oslo, Norway", condition: "Nerve Compression",
    title: "I Avoided Surgery and My Spine Has Its Resilience Back.",
    review: "My neurosurgeon had recommended spinal decompression surgery for my nerve compression. I requested three months to try Ayurveda first. The 21-day Panchakarma program, which included Snehana, Kati Basti, and a complete Basti sequence, addressed the degeneration and nerve inflammation systematically. At my three-month review, my surgeon agreed surgery could be deferred indefinitely.",
    rating: 5, verified: true
  }
];

const faqItems = [
  { question: "Is Ayurveda an alternative to spinal surgery for Lumbar Spondylosis?", answer: "In many cases, yes. While severe structural emergencies may require surgery, Ayurveda successfully manages the majority of disc degeneration and nerve compression cases by pacifying Vata and deeply nourishing the spinal tissues through therapies like Kati Basti and Basti." },
  { question: "How quickly can I expect relief from lower back pain?", answer: "Most patients experience significant pain reduction within the first 7 to 10 days of intensive therapies like Kati Basti and Elakizhi. However, the complete 21-28 day program is required to address the underlying degeneration and prevent recurrence." },
  { question: "What exactly is Kati Basti?", answer: "Kati Basti is the cornerstone Ayurvedic therapy for lower back pain. A reservoir made of black gram dough is placed over the lumbar spine, and warm, medicated, analgesic oil is continuously pooled inside. This deeply lubricates the joints, nourishes nerves, and relieves muscle spasms." },
  { question: "Will my radiating leg pain (Sciatica) be treated too?", answer: "Yes. The radiating pain is often caused by nerve compression in the lumbar region due to Spondylosis. By treating the lumbar spine and administering Basti (medicated enemas) to calm the nervous system, the sciatic pain is simultaneously relieved." },
  { question: "What are the lifestyle rules after the treatment program?", answer: "Post-treatment care is crucial. You must maintain correct posture, avoid lifting heavy objects incorrectly, practice prescribed gentle yoga (like Bhujangasana), and follow a Vata-pacifying diet (warm, nourishing foods with healthy fats like ghee)." }
];
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              <p className="text-sm md:text-base uppercase tracking-[0.2em] text-white/80">Spine Rejuvenation</p>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">Lumbar Spondylosis Treatment in India</h1>
              <p className="text-lg md:text-xl text-white/90">A Holistic Path to Back Pain Relief. Heal the root cause of disc degeneration and restore pain-free mobility for the long term.</p>
      ...
      <main className="container mx-auto px-4 pt-6 pb-2 md:pt-8 md:pb-4 max-w-6xl space-y-14 md:space-y-16">
        ...
        <section id="intro" className="scroll-mt-24 mb-0">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="relative rounded-2xl overflow-hidden shadow-lg group">
              <img 
                src="/Treatments-images/Lumbar Spondylosis Treatment.jpg" 
                alt="Lumbar Spondylosis Treatment in India" 
                className="w-full h-[300px] md:h-[450px] object-cover transition-transform duration-700 hover:scale-105" 
              />
            </div>
            <div className="space-y-6 text-center md:text-left">
              <h2 className="text-2xl md:text-3xl lg:text-[2rem] xl:text-[2.2rem] font-bold text-[#335765] leading-tight">Understanding Kati Sandhigata Vata</h2>
              <p className="text-[#7F543D] leading-relaxed text-lg">
                In Ayurveda, Lumbar Spondylosis is known as Kati Sandhigata Vata. The root of the problem lies in a severely aggravated Vata dosha, which is dry, cold, and degenerative by nature.
              </p>
              <p className="text-[#7F543D] leading-relaxed text-lg">
                This imbalance dries out the lubricating fluid between the vertebrae, causing the discs to lose their cushioning ability and leading to chronic pain, morning stiffness, and radiating sciatic pain.
              </p>
              <div className="pt-2">
        ...
        <section id="therapies" className="scroll-mt-24 space-y-12">
          <div className="text-center mb-10 max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-[#335765] mb-4">Core Ayurvedic Therapies for Lumbar Spondylosis</h2>
            <p className="text-[#7F543D] text-lg">The treatment protocol focuses on powerful, localized therapies that pacify Vata, reduce inflammation, and deeply nourish the spine.</p>
          </div>
            ...
            <div className="grid md:grid-cols-2">
              <div className="p-8 md:p-12 space-y-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl font-bold">The Critical Role of Diet (Ahara)</h3>
                </div>
                <p className="text-white/80 leading-relaxed mb-6">A Vata-pacifying diet is essential to prevent further internal dryness and degeneration of the spinal discs.</p>
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <ul className="space-y-4">
                    {lifestyleAdjustments.map((item, i) => {
                      ...
                      return (
                        <li key={i} className="bg-white/10 p-4 rounded-xl border border-white/20">
        ...
        <section id="cost-duration" className="scroll-mt-24 space-y-10">
           <div className="text-center max-w-3xl mx-auto">
             <h2 className="text-3xl md:text-4xl font-bold text-[#335765] mb-4">Suggested Packages, Cost & Duration For Lumbar Spondylosis Treatment in India</h2>
             <p className="text-lg text-[#7F543D]">Select a timeline that matches your healing goals. Each package includes daily physician consultation, prescribed spine therapies, medicines, and sattvic diet.</p>
           </div>
      ...
      {/* Patient Reviews */}
        ...
        <section id="top-centers" className="scroll-mt-24 space-y-8">
          <div className="text-center space-y-2 md:space-y-3 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-[#335765]">Top Ayurveda Centers for Lumbar Spondylosis Treatment in India</h2>
        ...
        <section className="scroll-mt-24 w-full max-w-5xl mx-auto rounded-3xl overflow-hidden shadow-2xl bg-[#335765] text-white">
          <div className="grid md:grid-cols-2 h-full">
            <div className="relative h-[220px] md:h-auto overflow-hidden md:order-2">
              <img
                src="/Treatments-images/Lumbar Spondylosis Treatment.jpg"
                alt="Lumbar Spondylosis Treatment consultation"
            ...
            <div className="p-6 md:p-12 space-y-6 flex flex-col justify-center md:order-1">
              <h2 className="text-2xl md:text-[2.05rem] font-bold leading-tight">Book Your Lumbar Spondylosis Treatment Program in India</h2>
              ...
              <div className="space-y-3 mt-4 max-w-xl">
                <a
                  href="https://wa.me/918028432737?text=Hi%2C%20I%20want%20to%20book%20a%20free%20consultation%20for%20Lumbar%20Spondylosis%20Treatment."
                  target="_blank"
                  rel="noreferrer"
