...
const BackPain = () => {
  ...
  useEffect(() => {
    fetch("/content/Treatments/Back pain Treatment.txt")
      .then((res) => res.text())
    ...
    <Layout>
      <section className="bg-gradient-to-r from-primary to-primary/80 text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-0">Back Pain</h1>
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <Card className="p-6 sm:p-8 md:p-10 shadow-lg mb-8 md:mb-12 bg-gradient-to-br from-primary/5 to-secondary/5">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-primary mb-0">Experience Lasting Relief</h2>
            <p className="text-foreground mb-6 max-w-2xl mx-auto">
              Get comprehensive Ayurvedic care with Kati Vasti, therapeutic massages, and herbal medicines to eliminate back pain and restore your mobility naturally.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            ...
            <p className="text-muted-foreground">
              Warm medicated oil pool therapy on lower back for deep tissue nourishment
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">💆</div>
            <h3 className="text-xl font-semibold mb-0">Therapeutic Massage</h3>
            <p className="text-muted-foreground">
              Specialized Abhyanga and Swedana to relieve muscle spasms and stiffness
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">🌿</div>
            ...
            <p className="text-muted-foreground">
              Herbal medicines and diet to pacify Vata and strengthen spinal tissues
            </p>
          </Card>
        </div>
      </section>
