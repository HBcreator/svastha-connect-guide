...
import {
  ...
  Search, Phone, X, ClipboardList, Clock, Leaf
} from "lucide-react";

const coreTherapies = [
  {
    title: "Kati Vasti",
    sanskrit: "The Lumbar Oil Pool",
    text: "The cornerstone of back pain treatment. Warm, analgesic oil is pooled on the lower back inside a dough ring, deeply lubricating spinal joints and relieving chronic muscle spasms.",
    icon: Droplet
  },
  {
    title: "Patra Pinda Sweda",
    sanskrit: "Herbal Poultice Massage",
    text: "Rhythmic application of warm herbal poultices (Elakizhi) filled with anti-inflammatory leaves. Extremely effective in reducing localized stiffness and deep tissue inflammation.",
    icon: Wind
  },
  {
    title: "Basti Therapy",
    sanskrit: "Medicated Enema",
    text: "The ultimate therapy for pacifying Vata dosha at its root. Administering medicated oils rectally has a profoundly calming and strengthening effect on the entire lower back and nervous system.",
    icon: ShieldCheck
  },
  {
    title: "Abhyanga & Swedana",
    sanskrit: "Massage & Herbal Steam",
    text: "A gentle full-body massage with specific Ayurvedic oils, followed by localized herbal steam to melt away muscular tension and improve blood circulation to the spine.",
    icon: Dumbbell
  }
];
...
const dietaryGuidelines = {
  favour: [
    "Healthy Fats: A Vata-pacifying diet is essential. Include healthy fats like Ghee and sesame oil to combat dryness.",
    "Warm, Moist Foods: Favour nourishing, cooked meals like stews, soups, and kitchari.",
    "Anti-inflammatory Spices: Incorporate spices like ginger, garlic, and turmeric into your daily meals.",
    "Bone-Nourishing Foods: Include calcium-rich foods and herbs that strengthen Asthi Dhatu (bone tissue)."
  ],
  avoid: [
    "Cold & Dry Foods: Strictly avoid crackers, dry cereals, and cold salads which severely aggravate Vata.",
    "Gas-Forming Foods: Reduce beans, raw cabbage, and excessive potatoes. Abdominal gas increases pressure on the lower spine.",
    "Processed Foods: Avoid junk food which creates Ama (toxins) and increases systemic inflammation.",
    "Iced Beverages: Cold drinks shock the digestive system and cause immediate muscular tightening."
  ]
};

const lifestyleAdjustments = [
  "Posture is Paramount: Maintaining correct posture while sitting, standing, and sleeping is the most crucial step in managing back pain.",
  "Gentle Yoga: Under expert guidance, poses like Bhujangasana (Cobra Pose) and Marjariasana (Cat-Cow Pose) improve spinal flexibility.",
  "Avoid Strain: Never lift heavy objects by bending at the waist. Always bend your knees and keep your back straight.",
  "Stay Warm: Protect your lower back from exposure to cold wind, air conditioning, and drafts, as coldness aggravates Vata."
];

const packages = [
  {
    name: "14-Day Postural Relief",
    duration: "14 Days",
    cost: "$1,200 - $2,200 USD",
    focus: "Perfect for desk-job back pain. Focuses on Kati Basti and Swedana to release chronic muscular tension and stiffness.",
    image: "/Treatments-images/Lumbar Spondylosis Treatment.jpg",
  },
  {
    name: "21-Day Deep Spinal Nourishment",
    duration: "21 Days",
    cost: "$2,500 - $4,500 USD",
    focus: "The standard protocol. Adds intensive Basti therapies to systematically pacify Vata and structurally strengthen the lower back.",
    image: "/Treatments-images/Sciatica Treatment.jpg",
  },
  {
    name: "28-Day Comprehensive Recovery",
    duration: "28 - 35+ Days",
    cost: "$3,500 - $6,500+ USD",
    focus: "For severe chronic pain or unresolved sports injuries. Focuses on deep tissue healing, nerve repair, and long-term mobility.",
...
const patientReviews = [
  {
    name: "Volkmar Schreiber", location: "Cologne, Germany", condition: "Chronic Lower Back Pain",
    title: "Chronic Back Pain Gone in Seven Sessions—No Painkillers Needed.",
    review: "For five years, I was in a cycle of temporary relief for my chronic lower back pain. The Ayurvedic physician identified aggravated Vata as the root cause and prescribed Kati Basti oil therapy. The warm, medicated oil penetrated the lumbar muscles and dissolved a chronic stiffness that no physical therapy had ever reached. By session five, my morning back pain had ceased entirely.",
  ...
  {
    name: "Élodie Marchand", location: "Paris, France", condition: "Stress-Induced Back Pain",
    title: "My Stress-Induced Back Pain Was Addressed at the Root.",
    review: "My chronic back pain was significantly stress-driven. The Ayurvedic physician addressed both dimensions simultaneously. The Kati Basti and Patra Pinda Sweda sessions released the physical muscular tension, while the Shirodhara and guided Pranayama recalibrated the nervous system that was driving it. This combined program produced a quality of physical ease that no isolated therapy ever had.",
    rating: 5, verified: true
  },
  {
  ...
  {
    name: "Catriona Fleming", location: "Glasgow, UK", condition: "Sports Injury Back Pain",
    title: "This Reached Where Years of Physiotherapy Had Not.",
    review: "My lower back pain from a sports injury had persisted for three years despite physiotherapy and cortisone injections. The physician explained how Vata derangement had prevented the tissue from healing. The Kati Basti with warm Ksheerbala oil, combined with Patra Pinda Sweda and oral herbal formulations, addressed the residual tissue damage directly. The functional recovery I achieved in fourteen days surpassed what three years of conventional rehabilitation had managed.",
    rating: 5, verified: true
  }
];
      ...
      <section className="bg-[#335765] text-white py-10 md:py-14">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            {/* Left Aligned Container (No text-center classes) */}
            <div className="space-y-4">
              <p className="text-sm md:text-base uppercase tracking-[0.2em] text-white/80">A Holistic Path to Lasting Relief</p>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">Back Pain Treatment in India</h1>
              <p className="text-lg md:text-xl text-white/90">Ayurveda focuses on pacifying the underlying imbalances, strengthening the spinal structure, and restoring long-term, pain-free mobility without painkillers.</p>
      ...
      <main className="container mx-auto px-4 pt-6 pb-2 md:pt-8 md:pb-4 max-w-6xl space-y-14 md:space-y-16">
        ...
        <section id="intro" className="scroll-mt-24 mb-0">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center text-left">
            ...
            <div className="space-y-6 text-center md:text-left">
              <h2 className="text-2xl md:text-3xl lg:text-[2rem] xl:text-[2.2rem] font-bold text-[#335765] leading-tight">The Root Cause (Kati Shula)</h2>
              <p className="text-[#7F543D] leading-relaxed text-lg">
                In Ayurveda, lower back pain is referred to as <strong className="text-[#335765]">Kati Shula</strong>. It is almost always identified as a classic disorder caused by an aggravation of the <strong className="text-[#335765]">Vata dosha</strong> (the principle of movement and dryness).
              </p>
              <p className="text-[#7F543D] leading-relaxed text-lg">
                When Vata accumulates in the colon and spreads to the lower back, it dries out the lubricating fluid in the spinal joints, depletes bone tissue, and causes the muscles to go into painful spasms. Our treatments deeply pacify this Vata imbalance.
              </p>
        ...
        <section id="therapies" className="scroll-mt-24 space-y-12">
          <div className="text-center mb-10 max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-[#335765] mb-4">Core Therapies for Back Pain</h2>
            <p className="text-[#7F543D] text-lg">Powerful, localized Ayurvedic therapies designed to deeply lubricate the spine, relieve spasms, and nourish the nervous system.</p>
          </div>
        ...
        {/* Why Choose India (New Section for Back Pain) */}
        <section id="why-india" className="scroll-mt-24 space-y-8 bg-[#F8F4E7] rounded-3xl p-8 md:p-12 border border-[#d8d0ae]/50">
          ...
          <div className="grid md:grid-cols-3 gap-6">
             <div className="bg-white p-6 rounded-2xl shadow-sm space-y-3">
               ...
               <h3 className="text-xl font-bold text-[#335765]">Unmatched Authenticity</h3>
               <p className="text-sm text-[#7F543D] leading-relaxed">Receive treatment from Vaidyas (physicians) and therapists who possess an inherited, deep understanding of neurological disorders.</p>
             </div>
             <div className="bg-white p-6 rounded-2xl shadow-sm space-y-3">
               <Leaf className="h-10 w-10 text-green-500" />
               <h3 className="text-xl font-bold text-[#335765]">Potent Herbal Oils</h3>
               <p className="text-sm text-[#7F543D] leading-relaxed">The fresh, high-quality herbs used to prepare the specialized medicated oils (like Ksheerbala) are crucial for penetrating deep spinal tissues.</p>
             </div>
             <div className="bg-white p-6 rounded-2xl shadow-sm space-y-3">
               <Wind className="h-10 w-10 text-sky-500" />
               <h3 className="text-xl font-bold text-[#335765]">Immersive Environment</h3>
               <p className="text-sm text-[#7F543D] leading-relaxed">A dedicated wellness center allows you to fully disconnect from daily stressors and postural habits, significantly accelerating recovery.</p>
             </div>
          </div>
        </section>
          ...
          <div className="bg-[#335765] text-white rounded-3xl overflow-hidden shadow-xl">
            <div className="grid md:grid-cols-2 text-left">
              <div className="p-8 md:p-12 space-y-6">
                ...
                <p className="text-white/80 leading-relaxed mb-6">A strict Vata-pacifying diet is essential to lubricate the joints and prevent pressure build-up in the lower back.</p>
              ...
              <div className="relative p-8 md:p-12 space-y-6 bg-[#2F5B5D] overflow-hidden flex flex-col justify-center h-full">
                <div className="relative z-10 space-y-6">
                  <div className="flex flex-col md:flex-row items-center md:items-start gap-3 mb-4 text-center md:text-left">
                    <Dumbbell className="text-sky-300 h-8 w-8 drop-shadow-md shrink-0" />
        ...
        <section id="cost-duration" className="scroll-mt-24 space-y-10">
           <div className="text-center max-w-3xl mx-auto">
             <h2 className="text-3xl md:text-4xl font-bold text-[#335765] mb-4">Suggested Packages, Cost & Duration For Back Pain Treatment in India</h2>
             <p className="text-lg text-[#7F543D]">Select a timeline that matches your healing goals. Each package includes daily physician consultation, targeted therapies, and medicated oils.</p>
           </div>
      ...
      {/* Patient Reviews */}
        <section id="reviews" className="scroll-mt-24 bg-transparent w-full">
          <div className="container mx-auto px-4 max-w-6xl text-left">
            <div className="text-center mb-6 md:mb-8 space-y-3">
              ...
              <p className="text-base md:text-lg px-4" style={{ color: "#7F543D" }}>Hear from our patients who reclaimed their pain-free mobility</p>
            </div>
        ...
        <section id="top-centers" className="scroll-mt-24 space-y-8">
          <div className="text-center space-y-2 md:space-y-3 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-[#335765]">Top Ayurveda Centers for Back Pain Treatment in India</h2>
            <p className="text-sm md:text-base text-[#7F543D] max-w-2xl mx-auto">Handpicked hospitals and retreats with specialized orthopedic care and expert Vaidyas.</p>
          </div>
        ...
        <section className="scroll-mt-24 w-full max-w-5xl mx-auto rounded-3xl overflow-hidden shadow-2xl bg-[#335765] text-white">
          <div className="grid md:grid-cols-2 h-full text-left">
            <div className="relative h-[220px] md:h-auto overflow-hidden md:order-2">
              <img
                src="/Treatments-images/Back pain Treatment.jpg"
                alt="Back Pain Treatment consultation"
            ...
            <div className="p-6 md:p-12 space-y-6 flex flex-col justify-center md:order-1 text-left">
              <h2 className="text-2xl md:text-[2.05rem] font-bold leading-tight">Book Your Back Pain Treatment Program in India</h2>
              <p className="mt-3 text-sm md:text-base text-white/90 max-w-xl text-left">
                Reclaim your mobility and live pain-free. Connect with India's most authentic Ayurvedic orthopedic centers.
              </p>
              <div className="space-y-3 mt-4 max-w-xl">
                <a
                  href="https://wa.me/918028432737?text=Hi%2C%20I%20want%20to%20book%20a%20free%20consultation%20for%20Back%20Pain%20Treatment."
                  target="_blank"
                  rel="noreferrer"
          ...
          <div className="p-4 pb-4 bg-[#335765] text-white relative overflow-hidden">
            ...
            <div className="flex items-center gap-2.5 p-2.5 bg-white/5 rounded-xl border border-white/10 relative z-10 backdrop-blur-sm">
              ...
              <p className="text-[11px] md:text-xs text-white/70 leading-relaxed italic text-left">
                "Jump directly to any section in this back pain program page."
              </p>
            </div>
          </div>
