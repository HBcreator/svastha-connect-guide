...
const GastroesophagealRefluxDisease = () => {
  ...
  useEffect(() => {
    fetch("/content/Treatments/Gastroesophageal Reflux Disease Treatment.txt")
      .then((res) => res.text())
    ...
    <Layout>
      <section className="bg-gradient-to-r from-primary to-primary/80 text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-0">GERD Treatment</h1>
          <p className="text-lg text-white/90">Holistic Path to Soothing Digestion</p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <Card className="p-6 sm:p-8 md:p-10 shadow-lg mb-8 md:mb-12 bg-gradient-to-br from-primary/5 to-secondary/5">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-primary mb-0">Get Relief from GERD</h2>
            <p className="text-foreground mb-6 max-w-2xl mx-auto">
              Experience powerful Virechana detoxification, Pitta-pacifying therapies, and personalized dietary guidance for lasting relief from acid reflux and heartburn.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-0">Virechana Therapy</h3>
            <p className="text-muted-foreground">
              Medicated purgation removes excess Pitta dosha from digestive tract for profound relief
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">🧘</div>
            <h3 className="text-xl font-semibold mb-0">Stress Management</h3>
            <p className="text-muted-foreground">
              Ksheeradhara and Takradhara therapies calm nervous system and reduce stress triggers
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">🥗</div>
            <h3 className="text-xl font-semibold mb-0">Pitta-Pacifying Diet</h3>
            <p className="text-muted-foreground">
              Cooling foods and herbs like coconut water and aloe vera for digestive balance
            </p>
          </Card>
        </div>
      </section>
