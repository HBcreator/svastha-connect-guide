...
const coreTherapies = [
  {
    ...
    text: "The cornerstone therapy. Safely removes the excess, aggravated Pitta dosha from the liver and digestive tract, providing profound and lasting relief from acidity.",
    icon: Flame
  },
  {
    title: "Vamana",
    sanskrit: "Medicated Emesis",
    text: "In cases where there is also a significant Kapha imbalance along with Pitta in the stomach, a physician may recommend Vamana to cleanse the upper gastrointestinal tract.",
    icon: Activity
  },
  {
    title: "Takradhara",
    sanskrit: "Continuous Buttermilk Stream",
    text: "A gentle but powerful therapy where medicated buttermilk is streamed over the forehead. Incredibly effective at calming the nervous system, reducing stress, and pacifying Pitta.",
    icon: Droplet
  },
  {
    title: "Pitta-Shamana Chikitsa",
    sanskrit: "Internal Medicine",
    text: "Customized herbal formulations designed to cool the digestive tract, heal the inflamed esophageal lining, and strengthen the lower esophageal sphincter.",
    icon: Leaf
  }
];
...
const dietaryGuidelines = {
  favour: [
    "Cooling Foods: Naturally sweet, bitter, and astringent foods.",
    "Sweet fruits like ripe bananas, melons, pears, and pomegranates.",
    "Cooling vegetables like cucumber, leafy greens, and zucchini.",
    "Beverages: Coconut water and aloe vera juice are highly beneficial."
  ],
  avoid: [
    "Pungent & Sour Foods: Chillies, garlic, raw onions, tomatoes, and citrus fruits.",
    "Oily & Fried Foods: All forms of deep-fried food must be avoided.",
    "Fermented Foods: Yogurt (especially sour), pickles, and fermented batters.",
    "Stimulants: Drastically reduce or eliminate coffee, tea, and alcohol."
  ]
};

const lifestyleAdjustments = [
  "Eat on Time: Do not skip meals. Eat three balanced meals at regular times each day.",
  "Mindful Eating: Eat in a calm environment and chew your food thoroughly. Do not overeat.",
  "The Dinner Rule: Eat your last meal at least 2-3 hours before you go to bed.",
  "Sleep Position: Sleeping on your left side can naturally reduce acid reflux. Elevate the head of your bed slightly."
];

const packages = [
  {
    name: "14-Day Digestive Reset",
    duration: "14 Days",
    cost: "$1,200 - $2,200 USD",
    focus: "Focuses on immediate relief and diet correction, incorporating mild detox and Takradhara for stress management to calm the aggravated Pitta.",
    image: "/Treatments-images/Gastroesophageal Reflux Disease Treatment.jpg",
  },
  {
    name: "21-Day Deep Pitta Pacification",
    duration: "21 Days",
    cost: "$2,500 - $4,500 USD",
    focus: "The standard protocol. Incorporates Virechana for a deep cleanse of the liver and GI tract, establishing lasting remission and healing the esophageal lining.",
    image: "/Treatments-images/Ulcerative Colitis Treatment.jpg",
  },
  {
    name: "28-Day Advanced Gut Healing",
    duration: "28 - 35+ Days",
    cost: "$3,500 - $6,500+ USD",
    focus: "An intensive program for chronic GERD with complications. Focuses on rebuilding the esophageal lining and complete systemic reset of the digestive fire (Agni).",
...
const patientReviews = [
  {
    name: "Leopold Kaufmann", location: "Vienna, Austria", condition: "Chronic GERD",
    title: "Ten Years on PPIs—Off Them Completely in Thirty Days.",
    review: "I had been taking PPIs for chronic GERD for ten years, with no alternative offered by my gastroenterologist. The Ayurvedic physician in India identified it as Urdhvaga Amlapitta and prescribed Virechana purgation to eliminate the excess Pitta. The Takra Dhara and medicated ghee protocol then healed my esophageal lining. By day thirty, I had discontinued my PPIs entirely—something my Austrian doctor had told me was unlikely to be achievable.",
    rating: 5, verified: true
  },
  {
    name: "Sorcha O'Brien", location: "Limerick, Ireland", condition: "Acid Reflux & Bloating",
    title: "Acid Reflux, Bloating, and Chest Pain—All Three Resolved Together.",
    review: "My GERD had progressed to the point where it was disrupting my daily life, and my endoscopy had confirmed pre-cancerous changes. The Ayurvedic program—combining Virechana purgation, Ksheeravasthi medicated milk enemas, and oral herbal formulations—produced complete symptom remission within twenty-eight days. The Pitta-pacifying diet I brought home has maintained that remission for nine months.",
    rating: 5, verified: true
  },
  {
    name: "Beatrice Fontaine", location: "Grenoble, France", condition: "Diet-Induced Reflux",
    title: "The Diet Change Alone Proved Food Was My Medicine and My Poison.",
    review: "The Ayurvedic physician spent considerable time on my dietary history, identifying tomatoes, citrus, and alcohol as my primary triggers. The complete elimination of these foods, alongside a Panchakarma detox, produced results in two weeks that three years of French gastroenterology had not. The Shirodhara sessions also addressed the stress component, an insight that changed everything.",
    rating: 5, verified: true
  },
  {
    name: "Niels Christensen", location: "Aarhus, Denmark", condition: "GERD & IBS",
    title: "My GERD and IBS Were Treated as One Root Imbalance.",
    review: "I had been managing GERD and IBS with separate medications for four years. The Ayurvedic doctor in India identified both as expressions of the same digestive fire impairment. The Virechana cleared the excess Pitta driving the acid reflux, while the Basti enemas normalized the Vata irregularity underlying my IBS. Within thirty days, my acid reflux frequency had reduced by ninety percent.",
    rating: 5, verified: true
  },
  {
    name: "Marta Wieczorek", location: "Krakow, Poland", condition: "Stress-Driven GERD",
    title: "Ayurveda Understood My Stress-Driven GERD When My Doctor Did Not.",
    review: "The Ayurvedic physician explained the Vata-Pitta mechanism—how chronic stress weakens the esophageal sphincter while increasing acid production. The Shirodhara and guided Pranayama addressed the stress physiology directly, while Takra Dhara healed the esophageal inflammation. All three components working together resolved my GERD completely within three weeks.",
    rating: 5, verified: true
  }
];
...
const faqItems = [
  ...
  { question: "Will I have to eat a bland diet forever?", answer: "During the treatment, the diet is strict to allow healing. Post-treatment, as your Agni (digestive fire) strengthens, you can enjoy a wider variety of foods, though moderation with extreme triggers (like alcohol and chillies) is always recommended." }
];
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              <p className="text-sm md:text-base uppercase tracking-[0.2em] text-white/80">Soothing Digestion</p>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight">Gastroesophageal Reflux Disease Treatment in India</h1>
              <p className="text-lg md:text-xl text-white/90">A Holistic Path to Soothing Digestion. Heal the digestive tract, pacify internal fire, and establish long-lasting wellness.</p>
      ...
      <main className="container mx-auto px-4 pt-6 pb-2 md:pt-8 md:pb-4 max-w-6xl space-y-14 md:space-y-16">
        ...
        <section id="intro" className="scroll-mt-24 mb-0">
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="relative rounded-2xl overflow-hidden shadow-lg group">
              <img 
                src="/Treatments-images/Gastroesophageal Reflux Disease Treatment.jpg" 
                alt="GERD Treatment in India" 
                className="w-full h-[300px] md:h-[450px] object-cover transition-transform duration-700 hover:scale-105" 
              />
            </div>
            <div className="space-y-6 text-center md:text-left">
              <h2 className="text-2xl md:text-3xl lg:text-[2rem] xl:text-[2.2rem] font-bold text-[#335765] leading-tight">Understanding Amla Pitta</h2>
              <p className="text-[#7F543D] leading-relaxed text-lg">
                In Ayurveda, GERD is known as Amla Pitta. The condition is seen as a direct result of an aggravated and imbalanced Pitta dosha, which becomes overly hot, sharp, acidic, and liquid.
              </p>
              <p className="text-[#7F543D] leading-relaxed text-lg">
                While antacids may offer temporary relief, Ayurveda provides a holistic solution. By treating the weak digestive fire (Agni) and pacifying the internal heat, we can eliminate the acidic toxins (Ama) and strengthen the esophageal sphincter for good.
              </p>
              <div className="pt-2">
        ...
        <section id="therapies" className="scroll-mt-24 space-y-12">
          <div className="text-center mb-10 max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-[#335765] mb-4">Core Ayurvedic Therapies for GERD</h2>
            <p className="text-[#7F543D] text-lg">The treatment focuses on pacifying Pitta, eliminating deeply seated toxins, and actively healing the digestive system lining.</p>
          </div>
          ...
          <div className="bg-[#335765] text-white rounded-3xl overflow-hidden shadow-xl">
            <div className="grid md:grid-cols-2">
              <div className="p-8 md:p-12 space-y-6">
                ...
                <p className="text-white/80 leading-relaxed mb-6">Dietary management is non-negotiable for healing GERD. Your food is your primary medicine.</p>
        ...
        <section id="cost-duration" className="scroll-mt-24 space-y-10">
           <div className="text-center max-w-3xl mx-auto">
             <h2 className="text-3xl md:text-4xl font-bold text-[#335765] mb-4">Suggested Packages, Cost & Duration For Gastroesophageal Reflux Disease Treatment in India</h2>
      ...
      {/* Patient Reviews */}
        ...
        <section id="top-centers" className="scroll-mt-24 space-y-8">
          <div className="text-center space-y-2 md:space-y-3 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-[#335765]">Top Ayurveda Centers for Gastroesophageal Reflux Disease Treatment in India</h2>
        ...
        <section className="scroll-mt-24 w-full max-w-5xl mx-auto rounded-3xl overflow-hidden shadow-2xl bg-[#335765] text-white">
          <div className="grid md:grid-cols-2 h-full">
            <div className="relative h-[220px] md:h-auto overflow-hidden md:order-2">
              <img
                src="/Treatments-images/Gastroesophageal Reflux Disease Treatment.jpg"
                alt="Gastroesophageal Reflux Disease Treatment consultation"
            ...
            <div className="p-6 md:p-12 space-y-6 flex flex-col justify-center md:order-1">
              <h2 className="text-2xl md:text-[2.05rem] font-bold leading-tight">Book Your Gastroesophageal Reflux Disease Treatment Program in India</h2>
              ...
              <div className="space-y-3 mt-4 max-w-xl">
                <a
                  href="https://wa.me/918028432737?text=Hi%2C%20I%20want%20to%20book%20a%20free%20consultation%20for%20Gastroesophageal%20Reflux%20Disease%20Treatment."
                  target="_blank"
                  rel="noreferrer"
