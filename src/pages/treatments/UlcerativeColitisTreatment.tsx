...
const UlcerativeColitisTreatment = () => {
  ...
  useEffect(() => {
    fetch("/content/Treatments/Ulcerative Colitis Treatment.txt")
      .then((res) => res.text())
    ...
    <Layout>
      <section className="bg-gradient-to-r from-primary to-primary/80 text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-0">Ulcerative Colitis Treatment</h1>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="mb-8 rounded-lg overflow-hidden shadow-lg w-full aspect-video">
          <img 
            ...
            alt="Ulcerative Colitis Treatment" 
        ...
        <Card className="p-6 sm:p-8 md:p-10 shadow-lg mb-8 md:mb-12 bg-gradient-to-br from-primary/5 to-secondary/5">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-primary mb-0">Heal Your Gut Naturally</h2>
            <p className="text-foreground mb-6 max-w-2xl mx-auto">
              Experience comprehensive Ayurvedic treatment with cooling therapies, anti-inflammatory diet, and herbal medicines to restore intestinal health and prevent flare-ups.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-0">Pitta Pacifying</h3>
            <p className="text-muted-foreground">
              Cooling therapies and herbs to reduce intestinal inflammation and promote healing
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">🥗</div>
            <h3 className="text-xl font-semibold mb-0">Dietary Management</h3>
            <p className="text-muted-foreground">
              Personalized anti-inflammatory diet plans to support gut healing and prevent triggers
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">💊</div>
            <h3 className="text-xl font-semibold mb-0">Herbal Formulations</h3>
            <p className="text-muted-foreground">
              Specialized herbs to strengthen intestinal lining and restore healthy digestion
            </p>
          </Card>
        </div>
      </section>
