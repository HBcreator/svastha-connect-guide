...
const AyurvedaTreatment = () => {
  ...
  useEffect(() => {
    fetch("/content/Treatments/Ayurveda Treatment.txt")
      .then((res) => res.text())
    ...
    <Layout>
      ...
      <section className="bg-gradient-to-r from-primary to-primary/80 text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-0">Ayurveda Treatment</h1>
          <p className="text-lg text-white/90">
            Experience the ancient science of holistic healing
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-primary mb-0">Ancient Wisdom</h3>
            <p className="text-muted-foreground">
              5000+ years of traditional Ayurvedic knowledge and healing practices
            </p>
          </Card>
          <Card className="p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-3">⚖️</div>
            <h3 className="text-xl font-semibold text-primary mb-0">Dosha Balance</h3>
            <p className="text-muted-foreground">
              Personalized treatments to harmonize Vata, Pitta, and Kapha energies
            </p>
          </Card>
          <Card className="p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-3">🩺</div>
            <h3 className="text-xl font-semibold text-primary mb-0">Holistic Healing</h3>
            <p className="text-muted-foreground">
              Complete mind, body, and spirit wellness through natural therapies
            </p>
          </Card>
        </div>
      </section>
