...
const ArthritisTreatment = () => {
  ...
  useEffect(() => {
    fetch("/content/Treatments/Arthritis treatment.txt")
      .then((res) => res.text())
    ...
    <Layout>
      <section className="bg-gradient-to-r from-primary to-primary/80 text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-0">Arthritis Treatment</h1>
          <p className="text-lg text-white/90">Precise Ayurvedic Solutions for Joint Health</p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <Card className="p-6 sm:p-8 md:p-10 shadow-lg mb-8 md:mb-12 bg-gradient-to-br from-primary/5 to-secondary/5">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-primary mb-0">Manage Arthritis Naturally</h2>
            <p className="text-foreground mb-6 max-w-2xl mx-auto">
              Experience targeted therapies for osteoarthritis and rheumatoid arthritis—from Janu Vasti for joints to Virechana for inflammation—customized to your condition.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-0">Osteoarthritis Care</h3>
            <p className="text-muted-foreground">
              Janu/Kati Vasti and Pizhichil therapies lubricate joints and pacify Vata dosha
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">🔥</div>
            <h3 className="text-xl font-semibold mb-0">Rheumatoid Relief</h3>
            <p className="text-muted-foreground">
              Virechana and Elakizhi detoxify Ama and reduce inflammatory Pitta dosha
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">🧘</div>
            <h3 className="text-xl font-semibold mb-0">Lifestyle Support</h3>
            <p className="text-muted-foreground">
              Customized diet plans and gentle yoga to strengthen joints and maintain healthy weight
            </p>
          </Card>
        </div>
      </section>
