...
const topAyurvedicCenters = [
  {
    ...
    description: "Renowned for its holistic approach, SOUKYA offers specialized postnatal care programs that integrate Ayurveda and Yoga to restore a mother's physical and emotional health in a serene 30-acre organic farm.",
    rating: 4.9, reviews: 500, image: "/Center Images/SOUKYA/top center Thumb.jpg", link: "/centers/bangalore/soukya",
  },
  {
    name: "AyurvedaGram Heritage Wellness Centre",
    city: "Bengaluru, Karnataka, India",
    description: "A heritage center providing authentic Soothika Paricharya treatments. Their experienced Vaidyas specialize in Vata-balancing therapies and herbal nutrition specifically for new mothers.",
  ...
  },
  {
    ...
    description: "A serene retreat focused on authentic Ayurveda and yogic living. The center provides personalized recovery-focused plans with guided yoga and mindful routines.",
  ...
  },
  {
    ...
    description: "Located in the heart of Kerala, Kairali offers a dedicated postnatal recovery village environment where mothers receive traditional Abhyanga and herbal baths in a peaceful setting.",
  ...
  },
  {
    ...
    description: "A premium beachside center known for authentic Panchakarma and postnatal care, offering experienced doctors and personalized recovery plans.",
  ...
  },
  {
    ...
    description: "The world's first Ayurveda resort provides classical postnatal care with a focus on uterine cleansing, lactation support, and mental wellness through traditional Kerala therapies.",
  ...
  },
  {
    ...
    city: "Palakkad, Kerala, India",
    description: "A premium 'Palace for Ayurveda' where postnatal care is treated as a sacred ritual. Deeply personalized treatments and a strict healing environment ensure complete rejuvenation.",
    rating: 4.9, reviews: 280, image: "/Center Images/Kalari Kovilakom/Thumb.jpg", link: "/centers/kerala/kalari-kovilakom",
  },
  {
    name: "Athreya Ayurvedic Centre",
    city: "Kottayam, Kerala, India",
    description: "A highly regarded clinic specializing in clinical Ayurveda. Their postnatal protocols are known for precision in herbal formulations and therapeutic intensity.",
    rating: 4.8, reviews: 320, image: "/Center Images/Athreya Ayurvedic Centre/CTA.jpg", link: "/centers/kerala/athreya",
  },
  {
    name: "Ananda in the Himalayas",
    city: "Rishikesh, Uttarakhand, India",
    description: "A world-class healing sanctuary in the Himalayas. Ananda offers deeply immersive postnatal retreats that combine Ayurveda with modern wellness practices for complete restoration.",
    rating: 4.9, reviews: 190, image: "/Center Images/Ananda in the Himalayas/Thumb.jpg", link: "/centers/rishikesh/ananda",
  },
];
