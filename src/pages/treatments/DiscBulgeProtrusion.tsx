...
const DiscBulgeProtrusion = () => {
  ...
  useEffect(() => {
    fetch("/content/Treatments/Ayurvedic Treatment for Disc Bulge.txt")
      .then((res) => res.text())
    ...
    <Layout>
      <section className="bg-gradient-to-r from-primary to-primary/80 text-white py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-0">Disc Bulge Protrusion</h1>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="mb-8 rounded-lg overflow-hidden shadow-lg w-full aspect-video">
          <img 
            src="/Treatments-images/Ayurvedic Treatment for Disc Bulge.jpg" 
            alt="Disc Bulge Protrusion Treatment" 
        ...
        <Card className="p-6 sm:p-8 md:p-10 shadow-lg mb-8 md:mb-12 bg-gradient-to-br from-primary/5 to-secondary/5">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-primary mb-0">Heal Your Spine Naturally</h2>
            <p className="text-foreground mb-6 max-w-2xl mx-auto">
              Experience powerful Ayurvedic therapies like Kati Vasti, Basti, and specialized herbal oils to relieve nerve compression, strengthen your spine, and avoid surgery.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            ...
            <p className="text-muted-foreground">
              Warm medicated oil therapy directly on the spine to nourish discs and relieve pain
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">💪</div>
            <h3 className="text-xl font-semibold mb-0">Vata Pacification</h3>
            <p className="text-muted-foreground">
              Specialized treatments and herbs to balance Vata dosha and strengthen spinal tissues
            </p>
          </Card>
          <Card className="p-6 text-center hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-4">🌿</div>
            <h3 className="text-xl font-semibold mb-0">Natural Healing</h3>
            <p className="text-muted-foreground">
              Non-invasive alternative to surgery with lasting results and prevention
            </p>
          </Card>
        </div>
      </section>
