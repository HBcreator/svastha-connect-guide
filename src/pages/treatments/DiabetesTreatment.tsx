...
const topCenters: TreatmentCenter[] = [
  {
    ...
    city: "Bangalore",
    location: "Bangalore",
    description: "India's first NABH-accredited AYUSH Hospital integrating Ayurveda, Homeopathy, Yoga & Naturopathy on a 30-acre organic farm, with strong clinical protocols for chronic metabolic conditions.",
    rating: 4.9,
    reviews: 500,
...
const DiabetesTreatment = () => (
  <TreatmentPageTemplate
    ...
    introImage="/Treatments-images/Diabetes/Ayurvedic Treatment for Diabetes Management.jpg"
    ...
    faqItems={faqItems}
    ctaImage="/Treatments-images/Diabetes/Ayurvedic Treatment for Diabetes Management.jpg"
