...
const KalariMarma = () => {
  ...
  useEffect(() => {
    fetch('/content/services/Kalari & Marma Treatment.txt')
      .then((res) => res.text())
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-12 md:py-16">
        ...
        <div className="text-center mb-6 md:mb-8">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-3 md:mb-4">
            Kalari & Marma: Ancient Martial Healing Art
          </h1>
          <p className="text-base md:text-lg text-muted-foreground max-w-3xl mx-auto">
            Unlock your body's vital energy points through Kerala's sacred healing tradition
          </p>
        </div>
        ...
        <div className="mb-8 md:mb-12 max-w-4xl mx-auto">
          <div className="aspect-video w-full overflow-hidden rounded-lg shadow-lg">
            <img
              src="/Services-images/Kalari & Marma.png"
              alt="Kalari and Marma Therapy"
        ...
        <Card className="p-6 sm:p-8 md:p-10 shadow-lg mb-8 md:mb-12 bg-gradient-to-br from-primary/5 to-secondary/5 border-primary/20">
          <div className="text-center">
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
              Discover the profound healing power of Marma therapy with authentic Kalari masters. Unlock your body's vital energy for deep transformation.
            </p>
            <button className="bg-primary text-white px-6 md:px-8 py-3 md:py-4 rounded-lg text-base md:text-lg font-semibold hover:bg-primary/90 transition-colors">
              Book Your Kalari & Marma Treatment
            </button>
          </div>
        </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-primary mb-2">Martial Heritage</h3>
            <p className="text-muted-foreground">
              Ancient Kalaripayattu wisdom passed through generations
            </p>
          </Card>
          <Card className="p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-3">⚡</div>
            <h3 className="text-xl font-semibold text-primary mb-2">Vital Points</h3>
            <p className="text-muted-foreground">
              Precise treatment of 108 marma energy centers
            </p>
          </Card>
          <Card className="p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-3">🌟</div>
            ...
            <p className="text-muted-foreground">
              Profound physical and energetic transformation
            </p>
          </Card>
        </div>
      </div>
