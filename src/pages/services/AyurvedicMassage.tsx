...
export default function AyurvedicMassageService() {
  const [content, setContent] = useState<string>("")

  useEffect(() => {
    fetch('/content/services/Ayurvedic Massage.txt')
  ...
  const renderContent = () => {
    ...
    lines.forEach((line, index) => {
      ...
      // Numbered items with ** (like 1. **Title**)
      ...
      // Bullet points
        ...
        const bulletText = trimmedLine.startsWith('*   ') ? trimmedLine.substring(4).trim() : trimmedLine.substring(1).trim()
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-12 md:py-16">
        ...
        <div className="text-center mb-6 md:mb-8">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-3 md:mb-4">
            Ayurvedic Massage: Healing Through Touch
          </h1>
          <p className="text-base md:text-lg text-muted-foreground max-w-3xl mx-auto">
            Experience therapeutic massage with medicated oils for deep relaxation and healing
          </p>
        </div>
        ...
        <div className="mb-8 md:mb-12 max-w-4xl mx-auto">
          <div className="aspect-video w-full overflow-hidden rounded-lg shadow-lg">
            <img
              src="/Services-images/Ayurvedic Massage.jpg"
        ...
        <Card className="p-6 sm:p-8 md:p-10 shadow-lg mb-8 md:mb-12 bg-gradient-to-br from-primary/5 to-secondary/5 border-primary/20">
          <div className="text-center">
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
              Book an authentic Ayurvedic massage session with our skilled therapists. Let healing oils and expert techniques restore your vitality.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold text-primary mb-2">Expert Therapists</h3>
            <p className="text-muted-foreground">
              Skilled practitioners trained in traditional techniques
            </p>
          </Card>
          <Card className="p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-3">🌿</div>
            <h3 className="text-xl font-semibold text-primary mb-2">Herbal Oils</h3>
            <p className="text-muted-foreground">
              Medicated oils customized for your dosha and condition
            </p>
          </Card>
          <Card className="p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-3">✨</div>
            <h3 className="text-xl font-semibold text-primary mb-2">Deep Healing</h3>
            <p className="text-muted-foreground">
              Relieves pain, stress, and promotes overall wellness
            </p>
          </Card>
        </div>
      </div>
