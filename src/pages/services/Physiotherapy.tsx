...
const Physiotherapy = () => {
  ...
  useEffect(() => {
    fetch('/content/services/Physiotherapy in India.txt')
      .then((res) => res.text())
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-8 sm:py-12 md:py-16">
        ...
        <div className="text-center mb-6 md:mb-8">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-3 md:mb-4">
            Physiotherapy: Modern Rehabilitation Excellence
          </h1>
          <p className="text-base md:text-lg text-muted-foreground max-w-3xl mx-auto">
            Evidence-based physiotherapy combining modern techniques with holistic healing approaches
          </p>
        </div>
        ...
        <div className="mb-8 md:mb-12 max-w-4xl mx-auto">
          <div className="aspect-video w-full overflow-hidden rounded-lg shadow-lg">
            <img
              src="/Services-images/Physiotherapy.png"
        ...
        <Card className="p-6 sm:p-8 md:p-10 shadow-lg mb-8 md:mb-12 bg-gradient-to-br from-primary/5 to-secondary/5 border-primary/20">
          <div className="text-center">
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
              Get expert physiotherapy care from certified professionals. We combine modern rehabilitation techniques with holistic wellness approaches.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-muted-foreground">
              Certified physiotherapists with years of experience
            </p>
          </Card>
          <Card className="p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-3">💪</div>
            <h3 className="text-xl font-semibold text-primary mb-2">Pain Relief</h3>
            <p className="text-muted-foreground">
              Effective treatment for chronic pain and injuries
            </p>
          </Card>
          <Card className="p-6 text-center shadow-md hover:shadow-lg transition-shadow">
            <div className="text-4xl mb-3">🎯</div>
            ...
            <p className="text-muted-foreground">
              Modern techniques with traditional wellness wisdom
            </p>
          </Card>
        </div>
      </div>
