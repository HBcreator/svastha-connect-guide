...
import { MapPin, Star, Calendar, ChevronLeft, ChevronRight, ClipboardCheck, ClipboardList, X, Activity, Brain, Leaf, Thermometer, Wind, CircleCheck, AlertTriangle, XCircle, Sparkles, Phone, Search, HeartPulse, TrendingUp, Stethoscope, ReceiptIndianRupee, BedDouble, UtensilsCrossed, Pill, CheckCircle2, HelpCircle, Building2, ArrowRight, ShieldCheck, Globe2, CalendarCheck2, Route, Headset, UserCog, UserCheck, Droplet } from "lucide-react";
...
const TherapySection = () => (
  <Card id="therapy-section" className="scroll-mt-24 h-full shadow-sm !mt-6 md:!mt-10 border-[#d8d0ae] bg-[#EDE8D0]">
    <CardContent className="p-6 md:p-8">
      <h2 className="text-2xl font-bold text-[#335765] mb-3 text-center uppercase tracking-wide">The Science of Burnout Recovery</h2>
