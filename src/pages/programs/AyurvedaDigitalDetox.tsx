...
const galleryImages = [
  ...
  "/program-images/digital-detox/5.png",
  "/program-images/digital-detox/6.png",
];

const AyurvedaDigitalDetox = () => {
        ...
        <div className="container mx-auto px-4 pt-6 pb-2 md:pt-8 md:pb-4 max-w-6xl space-y-20 md:space-y-24">
          ...
          <section id="gallery" className="scroll-mt-24 mb-0">
            <div className="flex items-center justify-center mb-5 text-center">
              <h2 className="text-2xl md:text-3xl font-bold text-[#335765]">Program Gallery for Ayurveda + Digital Detox in India</h2>
            </div>
            <div className="relative rounded-2xl overflow-hidden shadow-lg group">
              <img src={galleryImages[selectedImage]} alt="Ayurveda and Digital Detox retreat program gallery" className="w-full h-[260px] md:h-[460px] object-cover" />
              <button
              ...
              <CardContent className="p-4 md:p-6 space-y-4">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                  ...
                  <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] p-3">
                    ...
                    <p className="mt-1 text-sm md:text-base font-semibold text-[#335765]">Kerala, Rishikesh</p>
                  </div>
                  <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] p-3">
                    <p className="text-[13px] uppercase tracking-[0.12em] text-[#7F543D] font-bold">Ideal For</p>
                    <p className="mt-1 text-sm md:text-base font-semibold text-[#335765]">Tech Burnout</p>
                  </div>
                  <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] p-3">
                    <p className="text-[13px] uppercase tracking-[0.12em] text-[#7F543D] font-bold">Avg Cost</p>
                    <p className="mt-1 text-sm md:text-base font-semibold text-[#335765]">$1,200 - $3,500</p>
                  </div>
                </div>
              ...
              <Card className="h-full shadow-sm">
                <CardContent className="p-6 md:p-8 space-y-4">
                  ...
                  <p className="text-[#5f4636] leading-relaxed font-semibold text-lg text-justify md:text-left">
                    Our 7–14 day digital fasting retreat focuses on deep detoxification and nervous system repair. This dual approach clears stagnant tension from the physical body, while specialized therapies and mindfulness practices address screen fatigue, aiming for long-term cognitive clarity.{" "}
                    <button
                      type="button"
                    ...
                    Svastha Global to connect with the best of authentic <span className="italic">Ayurveda and Mindfulness</span> in India.
                  </p>
                </CardContent>
              </Card>
            </div>
              ...
              <CardContent className="p-6 md:p-8">
                <div className="grid grid-cols-3 gap-2 md:gap-6 mb-8 md:mb-10">
                  <div className="bg-white rounded-xl md:rounded-2xl p-2.5 md:p-6 shadow-sm border border-[#d8d0ae]/30 flex flex-col items-center justify-center text-center">
                    ...
                    <div className="text-[9px] md:text-sm font-medium text-[#7F543D] leading-[1.1] md:leading-tight">Retreat Attendees</div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl md:rounded-2xl p-2.5 md:p-6 shadow-sm border border-[#d8d0ae]/30 flex flex-col items-center justify-center text-center">
                    ...
                    <div className="text-[9px] md:text-sm font-medium text-[#7F543D] leading-[1.1] md:leading-tight">Overall Satisfaction Index</div>
                  </div>
                  ...
                  <div className="bg-white rounded-xl md:rounded-2xl p-2.5 md:p-6 shadow-sm border border-[#d8d0ae]/30 flex flex-col items-center justify-center text-center">
                    ...
                    <div className="text-[9px] md:text-sm font-medium text-[#7F543D] leading-[1.1] md:leading-tight">Cognitive Rejuvenation Result</div>
                  </div>
                </div>
                <h2 className="text-3xl md:text-4xl font-bold text-[#335765] mb-4 text-center">Core Therapies in Ayurveda + Digital Detox</h2>
                <p className="text-[#7F543D] leading-relaxed mb-6 text-center max-w-3xl mx-auto">
                  Your Vaidya prescribes the precise combination of these practices based on your stress levels, dosha constitution, and tech-addiction severity.
                </p>
          ...
          <section id="week-breakdown" className="scroll-mt-24 !mt-6 md:!mt-10 rounded-3xl p-6 md:p-10 border border-[#e5dfc1]" style={{ backgroundColor: "#EDE8D0" }}>
            <div className="text-center mb-7">
              <h2 className="text-2xl md:text-3xl font-bold text-[#335765]">Ayurveda + Digital Detox — Step by Step</h2>
              <p className="text-[#7F543D] mt-2">A highly structured holistic approach for deep mental repair and cognitive rejuvenation.</p>
            </div>
          ...
          <section id="benefits" className="scroll-mt-24 !mt-6 md:!mt-10">
                      ...
                      {benefitsSectionImages.map((image, idx) => (
                        <div key={`benefit-mobile-${idx}`} className="w-full flex-shrink-0 px-1.5">
                          <div className="bg-white rounded-xl p-2 shadow-sm border border-[#d6decf]">
                            <img
                              src={image}
                              alt="Ayurveda Digital Detox benefits visual"
            ...
            <h2 className="text-3xl font-bold text-[#335765] mb-6 text-center">Benefits of Ayurveda + Digital Detox</h2>
          ...
          <section id="cost" className="scroll-mt-24 !mt-6 md:!mt-10 mb-12 md:mb-16 space-y-6">
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-3xl font-bold text-[#335765]">Cost of Ayurveda + Digital Detox in India</h2>
              <p className="mt-2 text-[#7F543D]">
                India offers world-class holistic care at a fraction of what equivalent premium wellness retreats cost abroad.
              </p>
            </div>
              ...
              <CardContent className="p-5 md:p-6 space-y-5">
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="rounded-2xl border border-[#d9cfae] bg-[#F8F4E7] p-4 text-center">
                    ...
                    <p className="mt-1 text-sm text-[#6F6B5C]">Optimal time for deep nervous system repair.</p>
                  </div>
                  <div className="rounded-2xl border border-[#d9cfae] bg-[#F8F4E7] p-4 text-center">
                    <p className="text-xs uppercase tracking-[0.14em] text-[#7F543D] font-semibold">Typical Budget</p>
                    <p className="mt-2 text-2xl font-bold text-[#335765]">$1,200 - $3,500</p>
                  ...
                  <div className="rounded-2xl border border-[#d9cfae] bg-[#F8F4E7] p-4 text-center">
                    ...
                    <p className="mt-1 text-sm text-[#6F6B5C]">Covers food, stay, therapies, and consultations.</p>
                  </div>
                </div>
                ...
                <div className="rounded-2xl border border-[#d9cfae] overflow-hidden">
                  <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-3 bg-[#EFE8CB] px-4 py-3 text-center sm:text-left">
                    <p className="font-semibold text-[#335765]">Most popular - Essential Digital Detox</p>
          ...
          <section id="why-india" className="scroll-mt-24 !mt-6 md:!mt-10 mb-10 md:mb-14">
            <Card className="h-full shadow-sm border-[#d8d0ae] bg-[#EDE8D0] w-full">
              <CardContent className="p-6 md:p-8 space-y-6">
                <h2 className="text-2xl md:text-3xl font-bold text-[#335765] text-center">Why Choose India for Digital Detox?</h2>
          ...
          >
            <div className="text-center max-w-3xl mx-auto">
              <h2 className="text-3xl font-bold text-[#335765] mb-3">Why Choose Us for Your Retreat Journey</h2>
          ...
          <section id="inclusions" className="scroll-mt-24 !mt-8 md:!mt-9 mb-10 md:mb-14 space-y-5">
            <div className="text-center space-y-2">
              ...
              <p className="text-[#7F543D]">Everything essential for deep mind-body healing and digital disconnect.</p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] px-4 py-3 text-center">
                ...
                <p className="text-lg font-bold text-[#335765] mt-1">Sattvic Meals</p>
              </div>
              <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] px-4 py-3 text-center">
                <p className="text-[13px] uppercase tracking-[0.12em] text-[#7F543D] font-bold">Detox</p>
                <p className="text-lg font-bold text-[#335765] mt-1">Screen-Free Zones</p>
              </div>
            </div>
          ...
          <section id="consultation" className="scroll-mt-24 !mt-6 md:!mt-10 overflow-hidden bg-[#335765] rounded-3xl text-white shadow-2xl">
            <div className="grid md:grid-cols-2 gap-0">
              <div className="relative h-[220px] md:h-auto overflow-hidden md:order-2">
                <img
                  src="/program-images/digital-detox/5.png"
                  alt="Ayurveda Digital Detox consultation"
              ...
              <div className="p-6 md:p-12 space-y-6 flex flex-col justify-center md:order-1">
                <h2 className="text-2xl md:text-[2.05rem] font-bold leading-tight">Book Your Digital Detox Retreat in India</h2>
                ...
                <div className="space-y-3 mt-4 max-w-xl">
                  <a
                    href="https://wa.me/918028432737?text=Hi%2C%20I%20want%20to%20book%20a%20free%20consultation%20for%20the%20Ayurveda Digital Detox%20program."
                    target="_blank"
                    rel="noreferrer"
          ...
          <section id="faq" className="scroll-mt-24 !mt-6 md:!mt-10">
            <div className="text-center mb-8">
              ...
              <p className="text-[#7F543D] mt-2 font-medium">Common queries about the Ayurveda + Digital Detox in India.</p>
            </div>
          ...
          <section id="top-centers" className="scroll-mt-24 !mt-10 md:!mt-16 space-y-8">
            <div className="text-center space-y-2 md:space-y-3 px-4">
              <h2 className="text-2xl md:text-4xl font-bold text-[#335765]">Top Ayurvedic Centers for Digital Detox Program in India</h2>
              <p className="text-sm md:text-base text-[#7F543D] max-w-2xl mx-auto">Handpicked resorts and clinics offering authentic retreats.</p>
            </div>
