  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden font-poppins">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              ...
              <p className="text-lg md:text-xl text-white/90">
                Advanced clinical protocols to manage inflammation, reduce joint pain, and address autoimmune roots naturally.
              </p>
      ...
      <main className="container mx-auto px-4 pt-6 pb-2 md:pt-8 md:pb-4 max-w-6xl space-y-20 md:space-y-24">
        {/* 1. Program Gallery for Rheumatoid Arthritis Treatment in India */}
        <section id="gallery" className="scroll-mt-24 mb-0">
          <div className="flex items-center justify-center mb-5 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#335765]">Program Gallery for Rheumatoid Arthritis Treatment in India</h2>
          </div>
          <div className="relative rounded-2xl overflow-hidden shadow-lg group">
            <img src={galleryImages[selectedImage]} alt="Rheumatoid Arthritis treatment program" className="w-full h-[260px] md:h-[460px] object-cover" />
            <button
            ...
            <CardContent className="p-4 md:p-6 space-y-4">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] p-3">
                  ...
                  <p className="mt-1 text-sm md:text-base font-semibold text-[#335765]">Joint Pain, Inflammation</p>
                </div>
                <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] p-3">
            ...
            <CardContent className="p-6 md:p-8">
              ...
              <div className="grid grid-cols-3 gap-2 md:gap-6 mb-8 md:mb-10">
                <div className="bg-white rounded-xl md:rounded-2xl p-2.5 md:p-6 shadow-sm border border-[#d8d0ae]/30 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="text-[16px] md:text-3xl font-black text-[#335765] mb-0.5 md:mb-1">1200+</div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#335765] mb-4 text-center">Core Ayurvedic Therapies for Rheumatoid Arthritis</h2>
              <p className="text-[#7F543D] leading-relaxed mb-6 text-center max-w-3xl mx-auto">
                Your Vaidya prescribes the precise combination of these therapies based on your joint condition, dosha constitution, and response to the treatment protocol.
              </p>
        ...
        <section id="week-breakdown" className="scroll-mt-24 !mt-6 md:!mt-10 rounded-3xl p-6 md:p-10 border border-[#e5dfc1]" style={{ backgroundColor: "#EDE8D0" }}>
          <div className="text-center mb-7">
            ...
            <p className="text-[#7F543D] mt-2">A highly structured clinical approach specifically designed for autoimmune detox and joint recovery.</p>
          </div>
        ...
        <section id="benefits" className="scroll-mt-24 !mt-6 md:!mt-10">
                    ...
                    {benefitsSectionImages.map((image, idx) => (
                      <div key={`benefit-mobile-${idx}`} className="w-full flex-shrink-0 px-1.5">
                        <div className="bg-white rounded-xl p-2 shadow-sm border border-[#d6decf]">
                          <img
                            src={image}
                            alt="Rheumatoid Arthritis benefits visual"
          ...
          <h2 className="text-3xl font-bold text-[#335765] mb-6 text-center">Benefits of Ayurvedic Rheumatoid Arthritis Treatment</h2>
        ...
        <section id="cost" className="scroll-mt-24 !mt-6 md:!mt-10 mb-12 md:mb-16 space-y-6">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-[#335765]">Cost of Ayurvedic Rheumatoid Arthritis Treatment in India</h2>
            <p className="mt-2 text-[#7F543D]">
              India offers world-class Ayurvedic autoimmune care at a fraction of what equivalent holistic treatment would cost abroad.
            </p>
          </div>
            ...
            <CardContent className="p-5 md:p-6 space-y-5">
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="rounded-2xl border border-[#d9cfae] bg-[#F8F4E7] p-4 text-center">
                  ...
                  <p className="mt-1 text-sm text-[#6F6B5C]">Designed for autoimmune patients with a focus on joint repair.</p>
                </div>
              </div>
        ...
        <section id="why-india" className="scroll-mt-24 !mt-6 md:!mt-10 mb-10 md:mb-14">
          <Card className="h-full shadow-sm border-[#d8d0ae] bg-[#EDE8D0] w-full">
            <CardContent className="p-6 md:p-8 space-y-6">
              <h2 className="text-2xl md:text-3xl font-bold text-[#335765] text-center">Why Choose India for Rheumatoid Arthritis Treatment?</h2>
        ...
        <section id="consultation" className="scroll-mt-24 !mt-6 md:!mt-10 overflow-hidden bg-[#335765] rounded-3xl text-white shadow-2xl">
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-6 md:p-12 space-y-6 flex flex-col justify-center md:order-1">
              <h2 className="text-2xl md:text-[2.05rem] font-bold leading-tight">Book Your Rheumatoid Arthritis Treatment Program in India</h2>
              <p className="mt-3 text-sm md:text-base text-white/90 max-w-xl">
                Begin with a no-obligation consultation. We help you choose the right center, dates, and package for your autoimmune condition and budget.
              </p>
              <div className="space-y-3 mt-4 max-w-xl">
                <a
                  href="https://wa.me/918028432737?text=Hi%2C%20I%20want%20to%20book%20a%20free%20consultation%20for%20the%20Rheumatoid%20Arthritis%20treatment%20program."
                  target="_blank"
                  rel="noreferrer"
        ...
        <section id="top-centers" className="scroll-mt-24 !mt-10 md:!mt-16 space-y-8">
          <div className="text-center space-y-2 md:space-y-3 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-[#335765]">Top Ayurvedic Centers for Rheumatoid Arthritis Treatment in India</h2>
            <p className="text-sm md:text-base text-[#7F543D] max-w-2xl mx-auto">Handpicked hospitals and retreats with specialized care for autoimmune and joint conditions.</p>
          </div>
