      ...
      <section id="gallery" className="scroll-mt-24 mb-0 pt-8 md:pt-12 bg-background">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex items-center justify-center mb-5 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#335765]">Program Gallery for Cervical Spondylosis Treatment in India</h2>
          </div>
          <div className="relative rounded-2xl overflow-hidden shadow-lg group">
            <img src={galleryImages[selectedImage]} alt="Cervical Spondylosis treatment program" className="w-full h-[260px] md:h-[460px] object-cover transition-all duration-500" />
            <button
      ...
      <main className="container mx-auto px-4 pt-4 md:pt-6 pb-6 md:pb-10 max-w-6xl space-y-8 md:space-y-12">
            ...
            <CardContent className="p-6 md:p-10">
              ...
              <div className="grid grid-cols-3 gap-2 md:gap-6 mb-8 md:mb-10">
                <div className="bg-white rounded-xl md:rounded-2xl p-2.5 md:p-6 shadow-sm border border-[#d8d0ae]/30 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="text-[16px] md:text-3xl font-black text-[#335765] mb-0.5 md:mb-1">1100+</div>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-[#335765] mb-4 text-center">The Science of Orthopedic Ayurvedic Relief</h2>
        ...
        <section id="top-centers" className="scroll-mt-24 !mt-6 md:!mt-10 space-y-8">
          <div className="text-center space-y-2 md:space-y-3 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-[#335765]">Top Ayurvedic Centers for Cervical Spondylosis Treatment in India</h2>
