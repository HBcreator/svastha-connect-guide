...
const quickSummaryRows = [
  ["Program Name", "Luxury Ayurveda Retreat Program in India"],
  ["Duration", "14 Days / 13 Nights"],
  ["Who It Is For", "Travelers seeking five-star comfort, complete privacy, and authentic Ayurveda without a disease diagnosis"],
  ["Key Benefit", "Deep relaxation, personalized Rasayana rejuvenation, complete stress reset, five-star hospitality"],
  ["Top Locations", "Kerala, Rajasthan, Rishikesh, Goa"],
  ["Average Cost", "$6,500 - $12,000 USD"],
  ["Supervised By", "Senior Ayurvedic Physicians (Vaidyas) with a dedicated Personal Wellness Concierge"],
  ["Includes", "Private villa or suite, personal Vaidya consultations, bespoke daily therapies, gourmet Ayurvedic cuisine, curated excursions"],
];
...
const therapies = [
  {
    title: "Abhyanga Royale (Four-Hand Oil Massage)",
    text: "A synchronized, four-hand warm oil massage performed by two therapists in perfect rhythm — the signature indulgence of a luxury Ayurveda retreat.",
    icon: Droplet,
  },
  {
    title: "Shirodhara Suite Ritual",
    text: "A continuous, warm stream of medicated oil poured over the forehead in the privacy of your own suite, designed for the deepest possible mental stillness.",
    icon: Sparkles,
  },
  {
    title: "Njavara Kizhi (Rice Bolus Therapy)",
    text: "Warm boluses of medicinal rice simmered in herbal milk are massaged over the body, nourishing tissue and restoring a natural, radiant glow to the skin.",
    icon: Leaf,
  },
  {
    title: "Kalari Chikitsa (Martial Healing Therapy)",
    text: "A rare Kerala martial-arts healing technique using precise foot and hand pressure to release deep muscular tension carried from years of high-performance living.",
    icon: Activity,
  },
  {
    title: "Private Yoga & Pranayama",
    text: "One-on-one sessions with a personal instructor, tailored to your fitness level, mobility, and stress patterns, held in private garden or beachfront pavilions.",
    icon: Heart,
  },
  {
    title: "Rasayana Cuisine & Herbal Cellar",
    text: "A personalized, chef-curated Ayurvedic tasting menu paired with a bespoke selection of rejuvenating herbal tonics prescribed by your Vaidya.",
    icon: UtensilsCrossed,
  },
];

const candidatePoints = [
  "Want a five-star wellness experience without sacrificing authentic Ayurvedic depth",
  "Are celebrating a milestone — honeymoon, anniversary, or retirement — and want complete privacy",
  "Are high-performing executives who need a genuine, uninterrupted disconnect and reset",
  "Prefer a private villa and personal concierge over a shared clinical wellness ward",
  "Want daily indulgent, restorative therapies rather than an intensive clinical detox protocol",
  "Are new to Ayurveda and want a gentle, comfortable, expertly guided introduction",
  "Value complete discretion and a fully personalized, flexible itinerary",
  "Seek meaningful rest, digital detox, and lasting mental clarity in a beautiful setting",
];

const avoidPoints = [
  "Guests seeking intensive clinical treatment for a diagnosed chronic disease (a Disease-Specific program is more suitable)",
  "Pregnant women in trimesters requiring therapy restrictions, without prior physician clearance",
  "People with an active, unmanaged medical emergency requiring hospital-level care",
  "Guests unable to commit to a slower, fully unhurried pace of travel for the full stay",
];

const weekBreakdown = [
  {
    title: "Phase 1 - Arrival & Personal Consultation",
    duration: "Day 1-3",
    focus: "Understanding you, before treating you",
    description:
      "Your Vaidya conducts a private constitution (Prakriti) assessment and pulse diagnosis, then designs your entire 14-day itinerary around your goals, schedule, and preferences. Days begin gently, with orientation to your villa and grounds.",
    bullets: ["Private Vaidya consultation", "Prakriti and pulse assessment", "Bespoke itinerary design", "Gentle introductory Abhyanga"],
    image: "/Ayurvedic Programs/Images/Luxury-Ayurveda-Retreat-Program-India/heritage-courtyard.jpg",
  },
  {
    title: "Phase 2 - Immersive Indulgence",
    duration: "Day 4-10",
    focus: "Daily bespoke therapies and restoration",
    description:
      "The heart of your retreat. Each day brings a curated sequence of signature therapies, private yoga, and gourmet Ayurvedic dining, interspersed with optional curated excursions to nearby heritage sites or nature trails.",
    bullets: ["Abhyanga Royale and Shirodhara", "Njavara Kizhi and Kalari Chikitsa", "Private yoga and pranayama", "Curated cultural excursions"],
    image: "/Ayurvedic Programs/Images/Luxury-Ayurveda-Retreat-Program-India/poolside-luxury.jpg",
  },
  {
    title: "Phase 3 - Rejuvenation & Departure Planning",
    duration: "Day 11-14",
    focus: "Sealing in the results",
    description:
      "Rasayana rejuvenation therapies restore and stabilize your progress, while your Vaidya prepares a personalized take-home wellness plan so the benefits continue well beyond your stay in India.",
    bullets: ["Rasayana rejuvenation therapies", "Personalized home-care plan", "Relaxed farewell days", "Final physician consultation"],
    image: "/Ayurvedic Programs/Images/Luxury-Ayurveda-Retreat-Program-India/gazebo-pool.jpg",
  },
];

const benefits = {
  physical: [
    "Visibly glowing skin and a radiant, rested complexion",
    "Deep muscular relaxation and released chronic tension",
    "Markedly improved sleep quality from the first few days",
    "Balanced digestion, metabolism, and healthy weight support",
    "Enhanced circulation and a lasting sense of physical lightness",
    "Sustained, stable energy without reliance on caffeine",
  ],
  mental: [
    "A genuine, complete stress reset away from work and devices",
    "Sharper mental clarity, focus, and emotional steadiness",
    "Real digital detox benefits from a fully unplugged schedule",
    "A renewed sense of purpose and perspective",
    "Improved mind-body connection and self-awareness",
    "Reduced anxiety and a calmer overall nervous system",
  ],
  longTerm: [
    "A sustainable, personalized wellness routine to take home",
    "Detailed home-ritual guidance from your Vaidya",
    "Stronger immunity and more resilient overall health",
    "A healthier, more mindful relationship with rest",
    "Long-term stress resilience carried into daily life",
    "Lasting memories and a genuinely renewed outlook",
  ],
};
...
const chooseIndiaPoints = [
  {
    ...
    text: "Ayurveda originates in India, giving access to treatment lineages, Vaidya depth, and rare botanicals unavailable at Western spa imitations.",
    icon: Sparkles,
  },
  {
    title: "World-Class Luxury Properties",
    text: "From heritage Rajasthan palaces to beachfront Kerala resorts, India's five-star wellness properties rival any destination globally.",
    icon: Crown,
  },
  {
    title: "Extraordinary Value",
    text: "A luxury retreat of this caliber typically costs 40-60% less than a comparable premium wellness stay in Europe or the US.",
    icon: ReceiptIndianRupee,
  },
  {
    title: "Diverse Healing Landscapes",
    text: "Choose Kerala's backwaters, the Himalayan foothills, Rajasthan's desert palaces, or Goa's coastline to match your ideal retreat setting.",
    icon: Leaf,
  },
  {
    title: "Personalized Vaidya Access",
    text: "Direct, unhurried access to senior physicians is standard, not an upgrade — a rarity even at premium Western wellness destinations.",
    icon: Stethoscope,
  },
  {
    title: "Seamless Concierge Support",
    text: "Private transfers, translated communication, and discreet on-ground support are built into every luxury itinerary.",
    icon: ShieldCheck,
  },
];
...
const whyChooseUsPoints = [
  {
    title: "Handpicked Luxury Partners",
    description: "We work only with five-star and heritage properties that meet strict authenticity and hygiene standards.",
    icon: ShieldCheck,
  },
  {
    title: "Bespoke Itinerary Design",
    description: "No fixed templates — your schedule, therapies, and excursions are fully personalized before you arrive.",
    icon: CalendarCheck2,
  },
  {
    title: "International Guest Expertise",
    description: "Dedicated planning and communication support for discerning travelers from 40+ countries.",
    icon: Globe2,
  },
  {
    title: "Complete Journey Support",
    description: "From property selection to private airport transfers and check-in, every step is coordinated for you.",
    icon: Route,
  },
  {
    title: "Dedicated On-Trip Concierge",
    description: "A single point of contact throughout your stay for any request, adjustment, or excursion booking.",
    icon: Headset,
  },
  {
    title: "Privacy-First Matching",
    description: "Properties and room categories are matched to your privacy and discretion requirements from the outset.",
    icon: UserCog,
  },
];
...
const inclusionsRows = [
  ...
  { label: "Gourmet Meals", details: "Personalized, chef-curated Ayurvedic tasting menus, three meals daily plus herbal teas", icon: UtensilsCrossed },
  { label: "Vaidya Consultations", details: "Private initial assessment plus daily or alternate-day physician review", icon: Stethoscope },
  { label: "Daily Signature Therapies", details: "Abhyanga Royale, Shirodhara, Njavara Kizhi, Kalari Chikitsa, and more as prescribed", icon: Activity },
  { label: "Premium Ayurvedic Medicines", details: "Bespoke herbal formulations and medicated oils sourced for your protocol", icon: Pill },
  { label: "Private Yoga & Meditation", details: "Daily one-on-one sessions with a personal instructor", icon: Brain },
  { label: "Concierge & Excursions", details: "Curated cultural excursions and a dedicated personal wellness concierge", icon: ClipboardCheck },
];

const costComparisonRows = [
  {
    program: "14-Day Luxury Ayurveda Retreat",
    category: "Integrated Retreat",
    cost: "$6,500 - $12,000",
    notes: "Private villas, personal Vaidya, fully bespoke experience",
  },
];

const faqItems = [
  {
    question: "Is this program only for people with an existing health condition?",
    answer: "No. Unlike a clinical Panchakarma detox, this retreat is designed for anyone seeking a restorative, indulgent wellness experience — no disease diagnosis is required to enroll.",
  },
  {
    question: "What makes this different from a standard Panchakarma detox program?",
    answer: "The clinical focus of elimination therapies is replaced with a more indulgent, comfort-first pace: private villas, four-hand massages, personal instructors, and a fully bespoke itinerary rather than a fixed clinical protocol.",
  },
  {
    question: "What is the average cost of a luxury Ayurveda retreat in India?",
    answer: "Most reputable five-star and heritage properties range from $6,500 to $12,000 USD for a 14-day private itinerary, depending on the property, room category, and season.",
  },
  {
    question: "Can couples book this retreat together?",
    answer: "Yes, many guests book this as a couples' retreat for a honeymoon, anniversary, or joint wellness reset, with therapies and excursions scheduled in parallel.",
  },
  {
    question: "Do I need any prior Ayurveda experience?",
    answer: "Not at all. This program is specifically designed as a comfortable, expertly guided introduction for first-time guests as well as experienced Ayurveda travelers.",
  },
  {
    question: "What kind of accommodation is included?",
    answer: "You will stay in a private villa or luxury suite at a handpicked five-star or heritage property, selected based on your privacy and comfort preferences.",
  },
  {
    question: "Can the itinerary be customized to my schedule?",
    answer: "Yes. Your entire 14-day plan is designed around your goals and preferences after your initial private consultation — there is no fixed group schedule.",
  },
  {
    question: "Is this suitable for a honeymoon or anniversary trip?",
    answer: "It is one of the most requested formats for milestone celebrations, combining privacy, indulgence, and genuine wellness in one itinerary.",
  },
  {
    question: "What is the best time of year for a luxury retreat in India?",
    answer: "October to March offers the most comfortable climate across most regions, though many luxury properties operate exceptional experiences year-round.",
  },
  {
    question: "Can I combine this retreat with sightseeing or business travel?",
    answer: "Yes, many guests extend their trip before or after the retreat for sightseeing. We recommend keeping the 14-day program itself free of other commitments for the best results.",
  },
];
...
const patientReviews = [
  {
    name: "Charlotte",
    location: "London, UK",
    condition: "Executive Burnout Reset",
    title: "The Most Restorative Two Weeks of My Life.",
    review:
      "I arrived completely burnt out from a decade in finance. The private villa, the four-hand Abhyanga, and a Vaidya who actually had time for me changed everything. I left with more clarity than any holiday has ever given me.",
    rating: 5,
    verified: true,
  },
  {
    ...
    condition: "Anniversary Wellness Retreat",
    title: "We Booked It For Our Anniversary - We're Already Planning To Return.",
    review:
      "My wife and I wanted something more meaningful than a typical resort holiday. The bespoke itinerary, private yoga sessions, and Shirodhara suite ritual gave us both a genuine sense of renewal we didn't expect.",
    rating: 5,
    verified: true,
  },
  {
    ...
    condition: "Complete Digital Detox",
    title: "I Finally Disconnected Completely - And Loved It.",
    review:
      "As someone who never switches off, the fully unplugged schedule was the real gift. The Kalari Chikitsa therapy released tension I didn't know I was carrying. Every detail felt personal, never generic.",
    rating: 5,
    verified: true,
  },
  {
    ...
    condition: "Milestone Retirement Retreat",
    title: "The Privacy and Personal Attention Were Extraordinary.",
    review:
      "I chose this to mark my retirement and wanted absolute privacy. The concierge handled everything, and my Vaidya adjusted the entire fourteen days around how my body responded. Worth every dollar.",
    rating: 5,
    verified: true,
  },
  {
    ...
    condition: "First Ayurveda Experience",
    title: "A Gentle, Beautiful Introduction To Ayurveda.",
    review:
      "I was nervous as a complete Ayurveda beginner, but the pace was gentle and never overwhelming. The Njavara Kizhi therapy left my skin visibly glowing, and the gourmet Ayurvedic meals were a genuine highlight.",
    rating: 5,
    verified: true,
  },
  {
    ...
    condition: "Stress and Sleep Reset",
    title: "I Slept Properly For The First Time In Years.",
    review:
      "Chronic insomnia had worn me down for years. By day four, I was sleeping deeply through the night. The private setting meant I never felt rushed, and the take-home plan has kept the results going since I returned.",
    rating: 5,
    verified: true,
  },
];

const LuxuryAyurvedaRetreatProgram = () => {
  ...
  const jumpSections = [
    ...
    { id: "week-breakdown", title: "Phase-by-Phase Journey" },
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              ...
              <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold leading-tight">Luxury Ayurveda Retreat Program in India</h1>
              <p className="text-lg md:text-xl text-white/90">Where five-star comfort meets timeless, authentic Ayurvedic healing.</p>
      ...
      <main className="container mx-auto px-4 pt-6 pb-2 md:pt-8 md:pb-4 max-w-6xl space-y-20 md:space-y-24">
        <section id="gallery" className="scroll-mt-24 mb-0">
          <div className="flex items-center justify-center mb-5 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#335765]">Program Gallery for the Luxury Ayurveda Retreat in India</h2>
          </div>
          <div className="relative rounded-2xl overflow-hidden shadow-lg group">
            <img src={galleryImages[selectedImage]} alt="Luxury Ayurveda retreat" className="w-full h-[260px] md:h-[460px] object-cover" />
            <button
            ...
            <CardContent className="p-4 md:p-6 space-y-4">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] p-3">
                  ...
                  <p className="mt-1 text-sm md:text-base font-semibold text-[#335765]">14 Days / 13 Nights</p>
                </div>
                <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] p-3">
                  <p className="text-[13px] uppercase tracking-[0.12em] text-[#7F543D] font-bold">Ideal For</p>
                  <p className="mt-1 text-sm md:text-base font-semibold text-[#335765]">Privacy, Indulgence, Reset</p>
                </div>
                <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] p-3">
                ...
                <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] p-3">
                  ...
                  <p className="mt-1 text-sm md:text-base font-semibold text-[#335765]">$6,500 - $12,000</p>
                </div>
              </div>
          ...
          <div className="grid gap-10 md:gap-12">
            <Card className="h-full shadow-sm">
              <CardContent className="p-6 md:p-8 space-y-4">
                <h2 className="text-2xl font-bold text-[#335765] text-center md:text-left leading-tight">What Is the Luxury Ayurveda Retreat Program?</h2>
                <p className="text-[#7F543D] leading-relaxed text-justify md:text-left">
                  This program is a fully personalized, five-star Ayurvedic retreat designed for travelers who want authentic healing without compromising on comfort or privacy. Unlike a clinical detox protocol, there is no fixed elimination schedule — your Vaidya designs a bespoke itinerary of indulgent, restorative therapies around your goals, pace, and preferences.
                </p>
                <p className="text-[#5f4636] leading-relaxed font-semibold text-lg text-justify md:text-left">
                  The 14-day format allows enough time for a genuine consultation, a full course of signature therapies, and a proper rejuvenation phase, without rushing any part of the experience.{" "}
                  <button
                    type="button"
                    onClick={() => setQuoteModalOpen(true)}
            ...
            <CardContent className="p-6 md:p-8">
              <div className="grid grid-cols-3 gap-2 md:gap-6 mb-8 md:mb-10">
                <div className="bg-white rounded-xl md:rounded-2xl p-2.5 md:p-6 shadow-sm border border-[#d8d0ae]/30 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="text-[16px] md:text-3xl font-black text-[#335765] mb-0.5 md:mb-1">400+</div>
                  <div className="text-[9px] md:text-sm font-medium text-[#7F543D] leading-[1.1] md:leading-tight">Guests Hosted</div>
                </div>
                ...
                <div className="bg-white rounded-xl md:rounded-2xl p-2.5 md:p-6 shadow-sm border border-[#d8d0ae]/30 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="text-[9px] md:text-sm font-medium text-[#7F543D] leading-[1.1] md:leading-tight">Guest Satisfaction Metrics</div>
                </div>

                <div className="bg-white rounded-xl md:rounded-2xl p-2.5 md:p-6 shadow-sm border border-[#d8d0ae]/30 flex flex-col items-center justify-center text-center">
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-blue-50 flex items-center justify-center mb-2 md:mb-3">
                    <Crown className="w-4 h-4 md:w-5 md:h-5 text-blue-600" />
                  </div>
                  <div className="text-[16px] md:text-3xl font-black text-[#335765] mb-0.5 md:mb-1">100%</div>
                  <div className="text-[9px] md:text-sm font-medium text-[#7F543D] leading-[1.1] md:leading-tight">Private Villa Placements</div>
                </div>
              </div>
            ...
            <Card className="h-full border-green-300 bg-white shadow-sm">
              <CardContent className="p-6 md:p-8 space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h2 className="text-2xl font-bold text-[#335765]">Who Is This Retreat For?</h2>
                </div>
            ...
            <Card className="h-full border-green-300 bg-white shadow-sm">
              <CardContent className="p-6 md:p-8 space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-2xl font-bold text-[#335765]">Who Should Consider a Different Program</h3>
                </div>
                <ul className="space-y-3">
        ...
        <section id="week-breakdown" className="scroll-mt-24 !mt-6 md:!mt-10 rounded-3xl p-6 md:p-10 border border-[#e5dfc1]" style={{ backgroundColor: "#EDE8D0" }}>
          <div className="text-center mb-7">
            <h2 className="text-2xl md:text-3xl font-bold text-[#335765]">The 14-Day Retreat - Phase-by-Phase Journey</h2>
            <p className="text-[#7F543D] mt-2">A fully personalized flow, from private consultation to lasting rejuvenation.</p>
          </div>
        ...
        <section id="benefits" className="scroll-mt-24 !mt-6 md:!mt-10">
                    ...
                    {benefitsSectionImages.map((image, idx) => (
                      <div key={`benefit-mobile-${idx}`} className="w-full flex-shrink-0 px-1.5">
                        <div className="bg-white rounded-xl p-2 shadow-sm border border-[#d6decf]">
                          <img
                            src={image}
                            alt="Luxury retreat benefits visual"
          ...
          <h2 className="text-3xl font-bold text-[#335765] mb-6 text-center">Benefits of the Luxury Ayurveda Retreat</h2>
            ...
            <Card className="bg-[#F9FAF9] border-none hover:shadow-lg transition">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="font-bold text-[#335765]">Lasting Value</h3>
                </div>
                <ul className="space-y-2 text-sm text-[#7F543D]">
        ...
        <section id="cost" className="scroll-mt-24 !mt-6 md:!mt-10 mb-12 md:mb-16 space-y-6">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-[#335765]">Cost of the Luxury Ayurveda Retreat in India</h2>
            <p className="mt-2 text-[#7F543D]">
              Reflects private villa accommodation, personal Vaidya access, and a fully bespoke itinerary at India's finest wellness properties.
            </p>
          </div>
            ...
            <CardContent className="p-5 md:p-6 space-y-5">
              <div className="grid md:grid-cols-3 gap-4">
                <div className="rounded-2xl border border-[#d9cfae] bg-[#F8F4E7] p-4 text-center">
                  ...
                  <p className="mt-1 text-sm text-[#6F6B5C]">A fully personalized, unhurried retreat timeline.</p>
                </div>
                <div className="rounded-2xl border border-[#d9cfae] bg-[#F8F4E7] p-4 text-center">
                  <p className="text-xs uppercase tracking-[0.14em] text-[#7F543D] font-semibold">Typical Budget</p>
                  <p className="mt-2 text-2xl font-bold text-[#335765]">$6,500 - $12,000</p>
                  <p className="mt-1 text-sm text-[#6F6B5C]">Reflects five-star and heritage property tiers.</p>
                </div>
                <div className="rounded-2xl border border-[#d9cfae] bg-[#F8F4E7] p-4 text-center">
                  <div className="flex items-center justify-center gap-3 mb-2">
                    <div className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-white ring-1 ring-[#d9cfae] shrink-0">
                      <Crown className="h-5 w-5 text-[#335765]" />
                    </div>
                    <p className="text-xl md:text-2xl font-bold text-[#335765]">MOST EXCLUSIVE</p>
                  </div>
                  <p className="mt-1 text-sm text-[#6F6B5C]">Private villas, bespoke therapies, and a personal concierge throughout.</p>
                </div>
              </div>
        ...
        <section id="why-india" className="scroll-mt-24 !mt-6 md:!mt-10 mb-10 md:mb-14">
          <Card className="h-full shadow-sm border-[#d8d0ae] bg-[#EDE8D0] w-full">
            <CardContent className="p-6 md:p-8 space-y-6">
              <h2 className="text-2xl md:text-3xl font-bold text-[#335765] text-center">Why Choose India for a Luxury Ayurveda Retreat?</h2>
        ...
        >
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-[#335765] mb-3">Why Choose Us for Your Luxury Retreat</h2>
            <p className="text-[#7F543D]">
              Not just booking support - fully personalized guidance from pre-consultation to post-retreat continuity.
            </p>
          </div>
          <div className="mt-5 flex flex-wrap items-center justify-center gap-2.5">
            <span className="inline-flex items-center rounded-full bg-white/80 px-3 py-1 text-xs font-semibold text-[#335765] border border-[#d9cfaa]">Five-Star Verified Partners</span>
            ...
            <span className="inline-flex items-center rounded-full bg-white/80 px-3 py-1 text-xs font-semibold text-[#335765] border border-[#d9cfaa]">Privacy-First Matching</span>
          </div>
        ...
        <section id="inclusions" className="scroll-mt-24 !mt-8 md:!mt-9 mb-10 md:mb-14 space-y-5">
          <div className="text-center space-y-2">
            <h2 className="text-3xl font-bold text-[#335765]">What Is Included in the Luxury Retreat Package?</h2>
            <p className="text-[#7F543D]">Everything essential for a fully private, indulgent, and personally guided retreat.</p>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] px-4 py-3 text-center">
              ...
              <p className="text-lg font-bold text-[#335765] mt-1">Villa + Bespoke Therapies</p>
            </div>
            <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] px-4 py-3 text-center">
              <p className="text-[13px] uppercase tracking-[0.12em] text-[#7F543D] font-bold">Care Model</p>
              <p className="text-lg font-bold text-[#335765] mt-1">Personal Concierge</p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-[#335765] leading-relaxed mt-1">
                  All therapies are recommended by a qualified Ayurvedic physician based on your personal consultation. Specific inclusions may vary slightly between partner properties.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="consultation" className="scroll-mt-24 !mt-6 md:!mt-10 overflow-hidden bg-[#335765] rounded-3xl text-white shadow-2xl">
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="p-6 md:p-12 space-y-6 flex flex-col justify-center md:order-1">
              <h2 className="text-2xl md:text-[2.05rem] font-bold leading-tight">Book Your Luxury Ayurveda Retreat</h2>
              <p className="mt-3 text-sm md:text-base text-white/90 max-w-xl">
                Begin with a private, no-obligation consultation. We help you choose the right property, dates, and bespoke itinerary for your goals.
              </p>
              <div className="space-y-3 mt-4 max-w-xl">
                <a
                  href="https://wa.me/918028432737?text=Hi%2C%20I%20want%20to%20book%20a%20free%20consultation%20for%20the%20Luxury%20Ayurveda%20Retreat%20Program."
                  target="_blank"
                  rel="noreferrer"
        ...
        <section id="top-centers" className="scroll-mt-24 !mt-10 md:!mt-16 space-y-8">
          <div className="text-center space-y-2 md:space-y-3 px-4">
            <h2 className="text-2xl md:text-4xl font-bold text-[#335765]">Top Luxury Ayurveda Retreats in India</h2>
            <p className="text-sm md:text-base text-[#7F543D] max-w-2xl mx-auto">Handpicked five-star and heritage properties offering fully private, bespoke Ayurveda experiences.</p>
          </div>
      ...
      <section id="reviews" className="scroll-mt-24 pt-8 pb-8 md:pt-10 md:pb-12 bg-transparent w-full">
        <div className="container mx-auto px-4 max-w-6xl text-left">
          <div className="text-center mb-6 md:mb-8 space-y-3">
            <h2 className="text-2xl md:text-4xl font-bold text-[#335765]">Guest Stories & Reviews</h2>
            <p className="text-base md:text-lg px-4" style={{ color: "#7F543D" }}>Hear from our guests about their private, transformational retreats</p>
          </div>
          ...
          <div className="p-4 pb-4 bg-[#335765] text-white relative overflow-hidden">
            ...
            <div className="flex items-center gap-2.5 p-2.5 bg-white/5 rounded-xl border border-white/10 relative z-10 backdrop-blur-sm">
              ...
              <p className="text-[11px] md:text-xs text-white/70 leading-relaxed italic text-left">
                "Jump directly to any section in this luxury retreat program page."
              </p>
            </div>
          </div>
...
export default LuxuryAyurvedaRetreatProgram;
