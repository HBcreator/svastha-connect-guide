...
const HairLoss = () => {
  ...
  const goTopCentersPrevious = () => {
    setTopCentersSlide((prev) => (prev > 0 ? prev - 1 : Math.ceil(topAyurvedicCenters.length / topCentersPerSlide) - 1));
  };
  const goTopCentersNext = () => {
    setTopCentersSlide((prev) => (prev + 1) % Math.ceil(topAyurvedicCenters.length / topCentersPerSlide));
  };
  const toggleCenterDescription = (name: string) => {
    setExpandedCenterName(prev => prev === name ? null : name);
  };
  const goReviewPrevious = () => {
    setCurrentReview((prev) => (prev === 0 ? patientReviews.length - 1 : prev - 1));
  };
  const goReviewNext = () => {
    setCurrentReview((prev) => (prev === patientReviews.length - 1 ? 0 : prev + 1));
  };
  ...
  const visibleTopCenters = topAyurvedicCenters.slice(
    ...
    (topCentersSlide + 1) * topCentersPerSlide
  );
  ...
  const jumpSections = [
    { id: "gallery", title: "Program Gallery" },
    { id: "quick-summary", title: "Quick Summary" },
    { id: "program-overview", title: "Overview" },
    { id: "core-therapies", title: "Core Therapies" },
    { id: "who-for", title: "Who is this for?" },
    { id: "week-breakdown", title: "Week by Week Plan" },
    { id: "benefits", title: "Benefits" },
    { id: "cost", title: "Program Cost" },
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden font-poppins">
      ...
      {/* Hero Section - EXACT PSORIASIS STYLE */}
      <section id="hero" className="bg-[#335765] text-white py-10 md:py-14">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              ...
              <p className="text-lg md:text-xl text-white/90">
                Clinically-led Ayurvedic protocols to halt hair thinning and stimulate natural regrowth through deep scalp nourishment and internal detoxification.
              </p>
            ...
            <div className="w-full md:w-[430px] lg:w-[520px] md:ml-auto md:justify-self-end md:translate-x-8 lg:translate-x-16">
              <Button
                className="w-full h-12 rounded-xl bg-white text-[#335765] hover:bg-white/90 font-bold"
      ...
      <main className="container mx-auto px-4 pt-6 pb-2 md:pt-8 md:pb-4 max-w-6xl space-y-20 md:space-y-24">
        ...
        <section id="gallery" className="scroll-mt-24 mb-0">
          <div className="flex items-center justify-center mb-5 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-[#335765]">Program Gallery for Hair Loss Treatment in India</h2>
          </div>
          <div className="relative rounded-2xl overflow-hidden shadow-lg group">
            <img src={galleryImages[selectedImage]} alt="Hair loss treatment program" className="w-full h-[260px] md:h-[460px] object-cover" />
            <button
            ...
            <CardContent className="p-4 md:p-6 space-y-4">
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                ...
                <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] p-3">
                  ...
                  <p className="mt-1 text-sm md:text-base font-semibold text-[#335765]">Chronic Hair Thinning</p>
                </div>
                <div className="rounded-xl border border-[#d9cfae] bg-[#F8F4E7] p-3">
        ...
        <section id="program-overview" className="scroll-mt-24 !mt-6 md:!mt-8 space-y-14 md:space-y-16">
            ...
            <Card className="h-full shadow-sm">
              <CardContent className="p-6 md:p-8 space-y-4">
                ...
                <p className="text-[#5f4636] leading-relaxed font-semibold text-lg text-justify md:text-left">
                  Our 14–21 day Hair Loss program focuses on deep scalp nourishment and systemic blood purification. This dual approach cools the head region, removes dormant toxins blocking the roots, and stimulates new follicular growth organically without chemicals.{" "}
                  <button
                    type="button"
                    onClick={() => setQuoteModalOpen(true)}
          ...
          <Card id="core-therapies" className="h-full shadow-sm !mt-6 md:!mt-10 border-[#d8d0ae] bg-[#EDE8D0] scroll-mt-24">
            <CardContent className="p-6 md:p-8">
              <div className="grid grid-cols-3 gap-2 md:gap-6 mb-8 md:mb-10">
                <div className="bg-white rounded-xl md:rounded-2xl p-2.5 md:p-6 shadow-sm border border-[#d8d0ae]/30 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="text-[16px] md:text-3xl font-black text-[#335765] mb-0.5 md:mb-1">1850+</div>
                ...
                <div className="bg-white rounded-xl md:rounded-2xl p-2.5 md:p-6 shadow-sm border border-[#d8d0ae]/30 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="text-[16px] md:text-3xl font-black text-[#335765] mb-0.5 md:mb-1">94%</div>
                  <div className="text-[9px] md:text-sm font-medium text-[#7F543D] leading-[1.1] md:leading-tight">Clinical Result / Outcome Index</div>
                </div>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#335765] mb-4 text-center">Core Ayurvedic Therapies for Hair Loss</h2>
              <p className="text-[#7F543D] leading-relaxed mb-6 text-center max-w-3xl mx-auto">
                Your Vaidya prescribes the precise combination of these therapies based on your scalp health, dosha constitution, and the severity of your hair thinning.
              </p>
          ...
          <div id="who-for" className="grid lg:grid-cols-2 gap-8 items-stretch !mt-6 md:!mt-10 scroll-mt-24">
        ...
        <section id="week-breakdown" className="scroll-mt-24 !mt-6 md:!mt-10 rounded-3xl p-6 md:p-10 border border-[#e5dfc1]" style={{ backgroundColor: "#EDE8D0" }}>
          <div className="text-center mb-7">
            <h2 className="text-2xl md:text-3xl font-bold text-[#335765]">The 14–21 Day Hair Loss Treatment — Week by Week</h2>
            <p className="text-[#7F543D] mt-2">A highly structured clinical approach for deep scalp nourishment and follicle stimulation.</p>
          </div>
        ...
        <section id="benefits" className="scroll-mt-24 !mt-6 md:!mt-10">
          ...
          <h2 className="text-3xl font-bold text-[#335765] mb-6 text-center">Benefits of Ayurvedic Hair Loss Treatment</h2>
        ...
        <section id="cost" className="scroll-mt-24 !mt-6 md:!mt-10 mb-12 md:mb-16 space-y-6">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-[#335765]">Cost of Ayurvedic Hair Loss Treatment in India</h2>
            <p className="mt-2 text-[#7F543D]">
              India offers world-class clinical scalp care at a fraction of what equivalent therapies or transplants cost abroad.
            </p>
          </div>
            ...
            <CardContent className="p-5 md:p-6 space-y-5">
              <div className="grid md:grid-cols-3 gap-4">
                <div className="rounded-2xl border border-[#d9cfae] bg-[#F8F4E7] p-4 text-center">
                  ...
                  <p className="mt-1 text-sm text-[#6F6B5C]">Structured cellular repair and follicle detox timeline.</p>
                </div>
                <div className="rounded-2xl border border-[#d9cfae] bg-[#F8F4E7] p-4 text-center">
                ...
                <div className="rounded-2xl border border-[#d9cfae] bg-[#F8F4E7] p-4 text-center">
                  ...
                  <p className="mt-1 text-sm text-[#6F6B5C]">Designed for chronic hair patients with a focus on internal detox.</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-[#d9cfae] overflow-hidden">
                <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-3 bg-[#EFE8CB] px-4 py-3 text-center sm:text-left">
                  <p className="font-semibold text-[#335765]">Most popular - Intensive Alopecia Program</p>
        ...
        <section id="why-india" className="scroll-mt-24 !mt-6 md:!mt-10 mb-10 md:mb-14">
          <Card className="h-full shadow-sm border-[#d8d0ae] bg-[#EDE8D0] w-full">
            <CardContent className="p-6 md:p-8 space-y-6">
              <h2 className="text-2xl md:text-3xl font-bold text-[#335765] text-center">Why Choose India for Hair Loss Treatment?</h2>
        ...
        >
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-[#7F543D]">
              Complete clinical support for your hair healing journey, from medical assessment to post-program recovery.
            </p>
          </div>
          <div className="mt-5 flex flex-wrap items-center justify-center gap-2.5">
            <span className="inline-flex items-center rounded-full bg-white/80 px-3 py-1 text-xs font-semibold text-[#335765] border border-[#d9cfaa]">Trichology Specialists</span>
        ...
        <section id="inclusions" className="scroll-mt-24 !mt-8 md:!mt-9 mb-10 md:mb-14 space-y-5">
          <div className="text-center space-y-2">
            <h2 className="text-3xl font-bold text-[#335765]">What Is Included in the Hair Loss Package?</h2>
            <p className="text-[#7F543D]">Everything essential for supervised scalp healing and long-term hair regrowth.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-0">
            <div className="relative h-[220px] md:h-auto overflow-hidden md:order-2">
              <img
                ...
                alt="Ayurvedic Hair Loss consultation"
            ...
            <div className="p-6 md:p-12 space-y-6 flex flex-col justify-center md:order-1">
              <h2 className="text-2xl md:text-[2.05rem] font-bold leading-tight">Book Your Hair Loss Treatment Program in India</h2>
              <p className="mt-3 text-sm md:text-base text-white/90 max-w-xl">
                Begin with a medical review. We help you select the clinical center best suited for your dosha type and hair loss severity.
              </p>
              <div className="space-y-3 mt-4 max-w-xl">
                <a
                  href="https://wa.me/918028432737?text=Hi%2C%20I%20want%20to%20book%20a%20free%20consultation%20for%20the%20Hair%20Loss%20treatment%20program."
                  target="_blank"
                  rel="noreferrer"
        ...
        <section id="faq" className="scroll-mt-24 !mt-6 md:!mt-10">
          <div className="text-center mb-8">
            ...
            <p className="text-[#7F543D] mt-2 font-medium">Common queries about Hair Loss treatment in India.</p>
          </div>
            ...
            {jumpSections.map((section, idx) => (
              <button key={section.id} onClick={() => jumpToSection(section.id)} className="w-full group relative bg-white hover:bg-[#335765] transition-all duration-300 p-3 rounded-xl border-2 border-primary/20 hover:border-primary flex items-center justify-between shadow-md hover:shadow-xl">
                <div className="flex items-center gap-4 relative z-10">
                  <div className="w-9 h-9 rounded-lg bg-primary/5 group-hover:bg-white/10 flex items-center justify-center transition-all duration-200"><span className="text-xs font-black text-primary group-hover:text-white transition-all duration-200">{(idx + 1).toString().padStart(2, "0")}</span></div>
