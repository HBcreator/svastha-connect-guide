...
const GoaCenters = () => {
  ...
  const centers = [
    ...
    },
    {
      ...
      reviews: 380,
      priceRange: "$$$",
      image: "/Anchor pages/Goa centers/images/11.webp",
      slug: undefined,
    },
    {
      name: "Goa Sian Spa",
      ...
      reviews: 320,
      priceRange: "$$$",
      image: "/Anchor pages/Goa centers/images/12.webp",
      slug: undefined,
    },
    {
      name: "Dhara AyurGlow",
    ...
    },
    {
      ...
      city: "Anjuna, Goa, India",
      description:
        "A Kerala-rooted Ayurvedic wellness center offering authentic Panchakarma therapies, rejuvenation plans, and personalized healing programs in a peaceful Goan setting for both visitors and long-stay guests. Guests usually choose this center for structured consultation-led care, personalized therapy plans, and sustainable follow-up lifestyle guidance for long-term wellness outcomes.",
      rating: 4.3,
      reviews: 400,
      priceRange: "$$$",
      image: "/Anchor pages/Goa centers/images/15.webp",
      slug: undefined,
    },
    {
      name: "Anvi Ayurved",
      ...
      reviews: 500,
      priceRange: "$$$",
      image: "/Anchor pages/Goa centers/images/16.webp",
      slug: undefined,
    },
    {
      ...
      reviews: 900,
      priceRange: "$$$$",
      image: "/Anchor pages/Goa centers/images/17.webp",
      slug: undefined,
    },
    {
      ...
      reviews: 550,
      priceRange: "$$$",
      image: "/Anchor pages/Goa centers/images/18.jpg",
      slug: undefined,
    },
    {
      name: "Ayurveda Goa",
      ...
      reviews: 1100,
      priceRange: "$$$",
      image: "/Anchor pages/Goa centers/images/19.jpeg",
      slug: undefined,
    },
    {
      ...
      reviews: 280,
      priceRange: "$$$",
      image: "/Anchor pages/Goa centers/images/20.png",
      slug: undefined,
    },
    {
      ...
      reviews: 480,
      priceRange: "$$$$",
      image: "/Anchor pages/Goa centers/images/21.jpg",
      slug: undefined,
    },
    {
      name: "Abhaya Ayurved",
      ...
      reviews: 300,
      priceRange: "$$$",
      image: "/Anchor pages/Goa centers/images/22.jpg",
      slug: undefined,
    },
    {
      name: "Ayurcare Goa",
      ...
      reviews: 520,
      priceRange: "$$$",
      image: "/Anchor pages/Goa centers/images/23.PNG",
      slug: undefined,
    },
  ];
        ...
        <div className="container mx-auto px-4 max-[380px]:px-2">
          <div className="max-w-7xl mx-auto text-center">
            <h2 className="text-[17px] sm:text-lg md:text-4xl lg:text-5xl font-bold leading-[1.35] md:leading-[1.75] animate-fade-in px-2 md:px-4">
              ...
              <span className="block mt-2 md:mt-4 md:whitespace-nowrap">Goa.</span>
            </h2>
            <p
