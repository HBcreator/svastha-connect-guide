...
const TopCenters = () => {
  ...
  const centers = [
    ...
    },
    {
      name: "Ayurmana",
      city: "Kerala",
      description: "Ayurmana Ayurveda Center is a Kerala wellness retreat focused on authentic therapies, physician-led treatment planning, and restorative lifestyle routines. The center blends classical Panchakarma with calm, nature-driven recovery programs designed to support detoxification, stress balance, and sustainable long-term well-being.",
    ...
    },
    {
      ...
      city: "Kerala",
      description: "Athreya Ayurvedic Centre offers consultation-led Ayurveda with customized treatment protocols based on individual body constitution and current health concerns. Its approach emphasizes authentic Kerala therapies, disciplined daily routines, and doctor-guided recovery plans aimed at sustainable long-term wellness rather than short-term relief.",
      specialties: ["Ayurveda", "Panchakarma", "Wellness"],
      rating: 4.8,
      reviews: 188,
      priceRange: "$$$$",
