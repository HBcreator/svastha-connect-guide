...
with open('src/pages/centers/SanjivaniAyurvedicResearchInstitute.tsx', 'r', encoding='utf-8') as f:
    lines = f.readlines()

new_content = []
for i, line in enumerate(lines):
    new_content.append(line)
    if 'document.querySelector(\'meta[name="description"]\');' in line:
        new_content.append('''    if (metaDesc) metaDesc.setAttribute("content", "Experience authentic Precision Ayurveda, stroke rehabilitation, and joint care under senior Ayurvedic researchers at the NABH-accredited, 40-bed Sanjivani Ayurvedic Institute in Dwarka Sector 13, New Delhi.");
...
with open('src/pages/centers/SanjivaniAyurvedicResearchInstitute.tsx', 'w', encoding='utf-8') as f:
